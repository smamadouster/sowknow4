    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          ...
          <Link href="/collections" className="group">
            <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow p-6 border border-gray-200 h-full">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Smart Collections</h3>
              <p className="text-gray-600 text-sm">Create dynamic collections with AI-powered natural language queries</p>
            </div>
          </Link>

          <Link href="/smart-folders" className="group">
            <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow p-6 border border-gray-200 h-full">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Smart Folders</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center text-sm">
                  <span className="w-2 h-2 bg-blue-500 rounded-full mr-3"></span>
                  <span className="text-gray-700">Relationship Mapping & Clustering</span>
                </li>
                <li className="flex items-center text-sm">
                  <span className="w-2 h-2 bg-blue-500 rounded-full mr-3"></span>
                  <span className="text-gray-700">Timeline Construction & Insights</span>
                </li>
                <li className="flex items-center text-sm">
                  <span className="w-2 h-2 bg-purple-500 rounded-full mr-3"></span>
                  <span className="text-gray-700">Graph-RAG (Coming Soon)</span>
                </li>
                <li className="flex items-center text-sm">
                  <span className="w-2 h-2 bg-purple-500 rounded-full mr-3"></span>
                  <span className="text-gray-700">Multi-Agent Search (Coming Soon)</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-16 text-center text-sm text-gray-500">
          <p>Powered by Gemini Flash &bull; Privacy-first architecture &bull; Context caching for efficiency</p>
        </div>
      </div>
    </div>
  );
