...
[local_deps]: app.models.failed_task, app.models.document, app.services.storage_service, app.utils.security, app.api.deps, app.core.redis_url, app.models.user, app.tasks.pipeline_orchestrator, app.models.article, app.celery_app, app.tasks.pipeline_tasks, app.database, app.models.pipeline, app.api.documents_common, app.schemas.user, app.schemas.admin, app.services.embed_client, app.models.processing, app.services.search_service, app.models.chat, app.models.audit, app.services.whisper_service, app.services.alert_service
[ext_deps]: typing, datetime, os, json, pydantic, time, redis, fastapi, sqlalchemy, uuid, asyncio, logging, concurrent
...
[local_deps]: app.schemas.article, app.tasks.article_tasks, app.models.article, app.api.deps, app.models.user, app.models.document
...
[local_deps]: app.middleware.csrf, app.schemas.token, app.services.token_blacklist, app.schemas.auth, app.utils.constants, app.utils.security, app.api.deps, app.database, app.limiter, app.core.redis_url, app.models.user, app.schemas.user
[ext_deps]: datetime, os, redis, time, fastapi, dotenv, hashlib, sqlalchemy, uuid, httpx, secrets, logging
...
[local_deps]: app.schemas.bookmark, app.schemas.tag, app.services.bookmark_service, app.api.deps, app.database, app.models.user, app.services.space_service
[ext_deps]: logging, sqlalchemy, fastapi, uuid
...
[local_deps]: app.models.chat, app.api.deps, app.database, app.limiter, app.services.input_guard, app.models.user, app.schemas.chat, app.services.chat_service
[ext_deps]: json, fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.models.collection, app.services.collection_chat_service, app.tasks.document_tasks, app.models.article, app.schemas.collection, app.services.llm_gateway, app.api.deps, app.database, app.models.audit, app.services.input_guard, app.models.user, app.services.collection_service
[ext_deps]: typing, datetime, json, fastapi, io, reportlab, sqlalchemy, uuid, logging
...
[local_deps]: app.services.token_blacklist, app.utils.constants, app.utils.security, app.database, app.models.user
...
[local_deps]: app.api.documents_common, app.schemas.document, app.services.storage_service, app.services.similarity_service, app.tasks.pipeline_orchestrator, app.tasks.document_tasks, app.services.search_service, app.models.processing, app.tasks.embedding_tasks, app.tasks.pipeline_tasks, app.api.documents_upload, app.api.deps, app.database, app.models.audit, app.models.pipeline, app.api.documents_journal, app.models.user, app.models.document
[ext_deps]: typing, datetime, time, fastapi, sqlalchemy, uuid, asyncio, logging, concurrent
...
[local_deps]: app.schemas.document, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.core.redis_url, app.models.audit, app.models.pipeline, app.models.user, app.models.document
[ext_deps]: typing, datetime, os, json, pydantic, redis, mimetypes, fastapi, sqlalchemy, uuid, asyncio, logging, concurrent
...
[local_deps]: app.schemas.document, app.services.storage_service, app.services.whisper_service, app.api.deps, app.database, app.models.audit, app.api.documents_common, app.models.user, app.models.document
[ext_deps]: tempfile, datetime, os, fastapi, sqlalchemy, logging
...
[local_deps]: app.services.deduplication_service, app.services.document_orchestrator, app.schemas.document, app.services.storage_service, app.api.deps, app.database, app.models.audit, app.api.documents_common, app.models.user, app.models.document
...
[local_deps]: app.services.graph_rag_service, app.services.temporal_reasoning_service, app.services.search_service, app.services.synthesis_service, app.services.progressive_revelation_service, app.api.deps, app.database, app.models.audit, app.models.user, app.models.document
[ext_deps]: typing, json, fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.utils.security, app.core.redis_url, app.database, app.celery_app
[ext_deps]: typing, datetime, os, redis, fastapi, sqlalchemy, httpx, asyncio, logging, nats
...
[ext_deps]: os, logging, fastapi, sqlalchemy, hmac
...
[local_deps]: app.services.relationship_service, app.models.knowledge_graph, app.services.timeline_service, app.api.deps, app.database, app.models.user, app.models.document, app.services.entity_extraction_service
...
[local_deps]: app.schemas.tag, app.models.note, app.api.deps, app.database, app.schemas.note, app.services.note_service, app.models.note_audio, app.models.user, app.services.space_service
[ext_deps]: datetime, os, fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.tasks.pipeline_orchestrator, app.celery_app, app.core.redis_url, app.api.deps, app.database, app.models.pipeline, app.models.document
[ext_deps]: sqlalchemy, fastapi, asyncio, redis
...
[local_deps]: app.schemas.reports, app.celery_app, app.api.deps, app.models.user, app.tasks.report_tasks
[ext_deps]: typing, celery, logging, fastapi
...
[local_deps]: app.services.embed_client, app.services.search_agent, app.services.search_service, app.api.deps, app.database, app.services.input_guard, app.services.search_models, app.models.user, app.models.document
[ext_deps]: time, json, fastapi, sqlalchemy, uuid, asyncio, logging
...
[ext_deps]: pydantic, fastapi, hashlib, sqlalchemy, uuid, logging
...
[local_deps]: app.schemas.smart_folder, app.models.note, app.models.smart_folder, app.schemas.collection, app.tasks.smart_folder_tasks, app.celery_app, app.tasks.collection_report_tasks, app.api.deps, app.database, app.models.audit, app.models.user
[ext_deps]: typing, celery, json, fastapi, sqlalchemy, uuid, asyncio, logging
...
[local_deps]: app.tasks.space_tasks, app.schemas.tag, app.schemas.space, app.api.deps, app.database, app.models.user, app.services.space_service
[ext_deps]: logging, sqlalchemy, fastapi, uuid
...
[local_deps]: app.tasks.pipeline_orchestrator, app.services.llm_gateway, app.core.redis_url, app.api.deps, app.models.user
...
[local_deps]: app.schemas.subscription, app.tasks.subscription_tasks, app.api.deps, app.database, app.models.user, app.models.subscription
[ext_deps]: logging, sqlalchemy, fastapi, uuid
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.task, app.schemas.tag, app.services.task_service, app.api.deps, app.database, app.models.user, app.services.space_service
[ext_deps]: logging, sqlalchemy, fastapi, uuid
...
[local_deps]: app.services.storage_service, app.models.note, app.services.whisper_service, app.api.deps, app.models.note_audio, app.models.user, app.models.document
[ext_deps]: tempfile, os, io, fastapi, sqlalchemy, uuid, asyncio, logging
...
[ext_deps]: os, pydantic, pydantic_settings, urllib, pathlib, logging
...
[ext_deps]: base64, json, time, os, urllib, cryptography, httpx, logging, struct
...
[ext_deps]: typing, os, collections, fastapi, dotenv, sqlalchemy, pgvector
...
[local_deps]: app.middleware.csrf, app.services.messaging, app.middleware.transaction, app.api, app.core.redis_url, app.database, app.limiter, app.services.prometheus_metrics, app.middleware.rls
[ext_deps]: typing, redis, os, collections, time, fastapi, dotenv, starlette, uvicorn, sqlalchemy, uuid, slowapi, contextlib, logging, threading
...
[local_deps]: app.services.monitoring, app.services.cache_monitor, app.api, app.core.redis_url, app.database, app.services.prometheus_metrics, app.services.embedding_service
[ext_deps]: datetime, os, time, redis, fastapi, dotenv, uvicorn, sqlalchemy, httpx, contextlib, logging
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[local_deps]: app.models.failed_task, app.models.tag, app.models.pattern_insight, app.models.document, app.models.collection, app.models.smart_folder, app.models.note_audio, app.models.user, app.models.subscription, app.models.note, app.models.article, app.models.knowledge_graph, app.models.space, app.models.bookmark, app.models.pipeline, app.models.milestone, app.models.task, app.models.push_subscription, app.models.processing, app.models.chat, app.models.base, app.models.audit
...
[ext_deps]: typing, time, collections, tenacity, httpx, asyncio, logging, functools
...
[local_deps]: app.schemas.pagination, app.schemas.token, app.schemas.document, app.schemas.smart_folder, app.schemas.collection, app.schemas.search, app.schemas.user, app.schemas.chat, app.schemas.admin
...
[ext_deps]: typing, datetime, collections, time, dataclasses, logging, enum
...
[ext_deps]: typing, re, json, dataclasses, logging
...
[local_deps]: app.services.embed_client, app.services.graph_rag_service, app.services.knowledge_graph.traversal, app.services.search_service, app.services.llm_gateway, app.services.knowledge_graph.pool, app.services.knowledge_graph.models, app.services.agent_identity
[ext_deps]: typing, re, collections, json, dataclasses, logging
...
[ext_deps]: typing, json, hashlib, httpx, asyncio, logging
...
[ext_deps]: typing, warnings, datetime, json, sqlalchemy, uuid, logging
...
[ext_deps]: urllib, logging, sqlalchemy, uuid
...
[local_deps]: app.services.context_block_service, app.services.pii_detection_service, app.services.search_service, app.services.llm_gateway, app.services.cache_monitor, app.services.llm_router, app.models.chat, app.database, app.services.prometheus_metrics, app.models.user, app.models.document, app.services.agent_identity
[ext_deps]: typing, re, json, time, collections, sqlalchemy, uuid, asyncio, logging
...
[local_deps]: app.services.context_block_service, app.models.collection, app.services.llm_gateway, app.models.chat, app.models.audit, app.models.user, app.models.document, app.services.agent_identity
[ext_deps]: typing, json, sqlalchemy, uuid, logging
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.models.collection, app.services.search_service, app.schemas.collection, app.services.llm_gateway, app.services.intent_parser, app.models.user, app.models.document, app.services.search_cache, app.services.agent_identity
[ext_deps]: typing, datetime, sqlalchemy, uuid, asyncio, logging
...
[local_deps]: app.services.llm_gateway
[ext_deps]: typing, datetime, os, uuid, logging
...
[ext_deps]: typing, json, traceback, sqlalchemy, asyncio, logging, threading
...
[local_deps]: app.services.deduplication_service, app.schemas.document, app.services.storage_service, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.audit, app.models.pipeline, app.models.user, app.tasks.voice_tasks, app.models.document
[ext_deps]: typing, datetime, json, fastapi, sqlalchemy, asyncio, logging, concurrent
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: os, time, random, httpx, asyncio, logging
[fn]: _base_urls()
...
[ext_deps]: typing, torch, os, gc, psutil, numpy, asyncio, logging, threading, sentence_transformers
...
[ext_deps]: os, transformers, onnxruntime, pathlib, numpy, logging
...
[ext_deps]: typing, warnings, datetime, json, sqlalchemy, asyncio, logging
...
[local_deps]: app.services.context_block_service, app.services.llm_gateway, app.models.knowledge_graph, app.models.document, app.services.agent_identity
[ext_deps]: typing, collections, re, sqlalchemy, logging
...
[ext_deps]: redis, re, dataclasses, hashlib, logging
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: typing, warnings, datetime, re, json, logging, enum
...
[ext_deps]: typing, datetime, os, json, collections, tenacity, httpx, logging
...
[ext_deps]: asyncpg, json, itertools, models, spacy, logging, __future__
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, pydantic, uuid, __future__, enum
...
[ext_deps]: extraction, asyncpg, json, models, logging, __future__
...
[local_deps]: app.services.minimax_service, app.services.pii_detection_service, app.services.ollama_service, app.services.openrouter_service, app.services.kimi_service
...
[ext_deps]: typing, os, collections, asyncio, logging, nats
...
[ext_deps]: typing, subprocess, datetime, os, collections, redis, re, dataclasses, psutil, logging, threading, prometheus_client
...
[ext_deps]: typing, PIL, cv2, os, time, io, pytesseract, paddleocr, PyPDF2, numpy, logging, enum
...
[local_deps]: app.services.base_llm_service
[ext_deps]: typing, os, collections, tenacity, json, httpx, logging
...
[ext_deps]: typing, datetime, os, json, collections, tenacity, redis, hashlib, httpx, asyncio, logging
[fn]: _get_redis_client()
...
[ext_deps]: typing, datetime, psutil, sqlalchemy, logging, sentence_transformers
...
[local_deps]: app.services.llm_gateway, app.models.knowledge_graph, app.models.user, app.models.document, app.services.agent_identity
...
[local_deps]: app.services.context_block_service, app.models.collection, app.services.llm_gateway, app.models.user, app.models.document, app.services.agent_identity
[ext_deps]: typing, datetime, os, io, reportlab, sqlalchemy, uuid, logging
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.context_block_service, app.services.search_service, app.services.llm_router, app.database, app.models.user, app.models.document, app.services.search_cache, app.services.agent_identity
[ext_deps]: typing, re, json, time, sqlalchemy, uuid, asyncio, logging, search_models
...
[local_deps]: app.core.redis_url
[ext_deps]: typing, redis, json, hashlib, logging
[fn]: _get_redis()
...
[local_deps]: app.services.embed_client, app.services.pii_detection_service, app.models.user, app.models.document, app.services.search_cache, app.services.rerank_service
[ext_deps]: typing, re, sqlalchemy, asyncio, logging
...
[ext_deps]: typing, collections, json, dataclasses, logging
...
[ext_deps]: typing, re, sqlalchemy, numpy, logging
...
[local_deps]: app.services.smart_folder.entity_resolver, app.services.smart_folder.report_generator, app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.query_parser
...
[local_deps]: app.models.smart_folder, app.services.smart_folder.agent.executor, app.services.smart_folder.agent.planner, app.services.smart_folder.entity_resolver, app.services.smart_folder.report_generator, app.services.smart_folder.agent.synthesizer, app.models.user, app.services.smart_folder.query_parser
...
[local_deps]: app.services.llm_router
[ext_deps]: typing, datetime, json, dataclasses, logging
...
[ext_deps]: typing, re, json, dataclasses, uuid, logging
...
[local_deps]: app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.base
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.skills.base
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.tools.document_reader, app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.skills.base
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.refinement_parser
...
[ext_deps]: csv, typing, re, json, io, logging
...
[local_deps]: app.models.tag, app.models.note, app.models.space, app.models.bookmark, app.models.user, app.models.document
[ext_deps]: logging, sqlalchemy, uuid
[fn]: _escape_like(value)
...
[ext_deps]: os, logging, symspellpy, typing
[fn]: _get_symspell()
...
[ext_deps]: datetime, base64, os, cryptography, uuid, pathlib, logging
...
[ext_deps]: typing, datetime, os, json, collections, time, sys, pathlib, contextlib, logging
...
[ext_deps]: typing, datetime, json, abc, uuid, asyncio, nats, logging, enum
...
[local_deps]: app.services.messaging
[ext_deps]: typing, datetime, time, json, dataclasses, hashlib, nats, logging, enum
...
[local_deps]: app.services.messaging
[ext_deps]: typing, datetime, json, dataclasses, uuid, asyncio, nats, logging, enum
...
[local_deps]: app.services.messaging
[ext_deps]: typing, datetime, json, logging, nats
...
[local_deps]: app.services.context_block_service, app.services.llm_gateway, app.models.knowledge_graph, app.models.document, app.services.agent_identity
[ext_deps]: typing, datetime, collections, json, sqlalchemy, logging
...
[ext_deps]: datetime, os, json, httpx, logging
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: typing, datetime, collections, sqlalchemy, logging
...
[ext_deps]: typing, subprocess, csv, xml, os, json, re, pptx, sys, pathlib, PyPDF2, ebooklib, zipfile, logging, html, docx
...
[local_deps]: app.tasks.base, app.services.monitoring, app.tasks.pipeline_orchestrator, app.models.processing, app.services.cache_monitor, app.celery_app, app.services.alert_service, app.database, app.core.redis_url, app.models.document
...
[local_deps]: app.services.embed_client, app.tasks.base, app.services.article_generation_service, app.models.article, app.database, app.models.document
[ext_deps]: celery, httpx, uuid, asyncio, logging
...
[local_deps]: app.tasks.article_tasks, app.tasks.pipeline_orchestrator, app.models.article, app.tasks.embedding_tasks, app.database, app.models.document
...
[local_deps]: app.services.report_service, app.tasks.base, app.database, app.models.audit, app.models.user
[ext_deps]: typing, celery, json, sqlalchemy, uuid, asyncio, logging
...
[local_deps]: app.services.text_extractor, app.services.context_block_service, app.services.embed_client, app.services.ocr_service, app.tasks.article_tasks, app.tasks.base, app.tasks.pipeline_orchestrator, app.services.entity_extraction_service, app.models.processing, app.tasks.embedding_tasks, app.services.dlq_service, app.database, app.services.prometheus_metrics, app.models.document, app.services.collection_service, app.services.chunking_service
[ext_deps]: celery, tempfile, datetime, os, langdetect, traceback, sqlalchemy, uuid, asyncio, logging
...
[ext_deps]: time, logging, sentence_transformers, uuid
...
[local_deps]: app.celery_app, app.core.redis_url, app.database, app.models.pipeline, app.models.document
[ext_deps]: email, datetime, os, redis, sqlalchemy, smtplib, logging
[fn]: _smtp_configured()
...
[local_deps]: app.tasks.pipeline_tasks, app.core.redis_url, app.database, app.models.pipeline, app.models.document
[ext_deps]: celery, datetime, redis, uuid, logging
...
[local_deps]: app.tasks.pipeline_orchestrator, app.celery_app, app.core.redis_url, app.database, app.models.pipeline, app.models.document
[ext_deps]: redis, os, datetime, sqlalchemy, logging
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.text_extractor, app.services.embed_client, app.services.ocr_service, app.tasks.article_tasks, app.tasks.document_tasks, app.services.dlq_service, app.celery_app, app.services.knowledge_graph.extraction, app.database, app.models.pipeline, app.services.knowledge_graph.pool, app.models.document, app.services.entity_extraction_service, app.services.chunking_service
[ext_deps]: celery, tempfile, datetime, os, time, gc, traceback, uuid, asyncio, logging
...
[ext_deps]: celery, datetime, os, time, sqlalchemy, fpdf, logging, openpyxl
...
[local_deps]: app.services.smart_folder.agent_runner, app.services.smart_folder_service, app.tasks.base, app.models.smart_folder, app.database, app.models.audit, app.models.user, app.models.document
[ext_deps]: typing, celery, datetime, json, sqlalchemy, uuid, asyncio, logging
...
[local_deps]: app.models.user, app.models.subscription, app.database, app.celery_app
[ext_deps]: email, datetime, os, sqlalchemy, httpx, smtplib, logging, calendar
...
[local_deps]: app.core.push, app.models.task, app.services.task_service, app.models.push_subscription, app.celery_app, app.database
...
[ext_deps]: typing, time, collections, asyncio, logging, threading, functools
...
[ext_deps]: typing, bcrypt, jose, datetime, os, fastapi, dotenv, sqlalchemy, logging
