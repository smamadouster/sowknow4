...
[local_deps]: app.celery_app, app.models.audit, app.models.user, app.models.processing, app.core.redis_url, app.tasks.pipeline_tasks, app.database, app.models.failed_task, app.models.article, app.tasks.pipeline_orchestrator, app.services.storage_service, app.services.alert_service, app.services.embed_client, app.api.deps, app.services.whisper_service, app.schemas.admin, app.models.document, app.utils.security, app.api.documents_common, app.schemas.user, app.models.pipeline, app.models.chat
[ext_deps]: json, redis, asyncio, sqlalchemy, logging, uuid, fastapi, os, typing, pydantic, concurrent, datetime
...
[local_deps]: app.models.document, app.models.article, app.schemas.article, app.tasks.article_tasks, app.models.user, app.api.deps
...
[local_deps]: app.utils.constants, app.utils.security, app.services.token_blacklist, app.models.user, app.schemas.auth, app.limiter, app.schemas.user, app.core.redis_url, app.middleware.csrf, app.api.deps, app.database, app.schemas.token
[ext_deps]: dotenv, redis, hashlib, sqlalchemy, logging, uuid, httpx, fastapi, os, secrets, time, datetime
...
[local_deps]: app.schemas.bookmark, app.services.space_service, app.models.user, app.schemas.tag, app.services.bookmark_service, app.api.deps, app.database
[ext_deps]: logging, uuid, fastapi, sqlalchemy
...
[local_deps]: app.services.chat_service, app.schemas.chat, app.models.user, app.services.input_guard, app.limiter, app.api.deps, app.database, app.models.chat
...
[local_deps]: app.schemas.collection, app.services.collection_chat_service, app.services.llm_gateway, app.models.audit, app.models.article, app.services.collection_service, app.models.user, app.services.input_guard, app.tasks.document_tasks, app.models.collection, app.api.deps, app.database
[ext_deps]: json, datetime, logging, io, uuid, fastapi, typing, reportlab, sqlalchemy
...
[local_deps]: app.utils.security, app.utils.constants, app.services.token_blacklist, app.models.user, app.database
...
[local_deps]: app.services.similarity_service, app.models.document, app.models.pipeline, app.schemas.document, app.models.audit, app.tasks.pipeline_orchestrator, app.tasks.embedding_tasks, app.services.search_service, app.services.storage_service, app.models.user, app.api.documents_common, app.models.processing, app.api.documents_journal, app.tasks.document_tasks, app.api.documents_upload, app.tasks.pipeline_tasks, app.api.deps, app.database
[ext_deps]: asyncio, sqlalchemy, logging, uuid, fastapi, typing, concurrent, datetime
...
[local_deps]: app.models.document, app.schemas.document, app.models.audit, app.tasks.pipeline_orchestrator, app.models.user, app.core.redis_url, app.models.pipeline, app.tasks.pipeline_tasks
[ext_deps]: json, redis, asyncio, sqlalchemy, logging, uuid, fastapi, os, typing, pydantic, mimetypes, concurrent, datetime
...
[local_deps]: app.services.whisper_service, app.models.document, app.schemas.document, app.models.audit, app.services.storage_service, app.models.user, app.api.documents_common, app.api.deps, app.database
[ext_deps]: tempfile, sqlalchemy, logging, fastapi, os, datetime
...
[local_deps]: app.models.document, app.schemas.document, app.models.audit, app.services.storage_service, app.services.document_orchestrator, app.models.user, app.api.documents_common, app.services.deduplication_service, app.api.deps, app.database
[ext_deps]: logging, uuid, fastapi, typing, sqlalchemy
...
[local_deps]: app.services.graph_rag_service, app.models.document, app.models.audit, app.services.search_service, app.models.user, app.services.synthesis_service, app.services.temporal_reasoning_service, app.api.deps, app.database, app.services.progressive_revelation_service
[ext_deps]: json, logging, uuid, fastapi, typing, sqlalchemy
...
[ext_deps]: redis, nats, asyncio, sqlalchemy, logging, httpx, fastapi, os, typing, datetime
...
[local_deps]: app.schemas.document, app.api.documents_upload, app.models.user, app.database
...
[local_deps]: app.services.timeline_service, app.models.document, app.services.entity_extraction_service, app.services.relationship_service, app.models.user, app.models.knowledge_graph, app.api.deps, app.database
[ext_deps]: datetime, logging, uuid, fastapi, typing, sqlalchemy
...
[local_deps]: app.services.space_service, app.models.user, app.models.note, app.services.note_service, app.schemas.tag, app.models.note_audio, app.schemas.note, app.api.deps, app.database
[ext_deps]: datetime, logging, uuid, fastapi, os, sqlalchemy
...
[local_deps]: app.celery_app, app.models.document, app.tasks.pipeline_orchestrator, app.core.redis_url, app.models.pipeline, app.api.deps, app.database
...
[local_deps]: app.schemas.push, app.models.user, app.models.push_subscription, app.api.deps, app.database
...
[local_deps]: app.celery_app, app.schemas.reports, app.models.user, app.tasks.report_tasks, app.api.deps
...
[local_deps]: app.models.document, app.services.search_service, app.models.user, app.services.embed_client, app.services.input_guard, app.services.search_agent, app.api.deps, app.database, app.services.search_models
[ext_deps]: json, asyncio, logging, uuid, fastapi, time, sqlalchemy
...
[ext_deps]: hashlib, logging, uuid, fastapi, pydantic, sqlalchemy
...
[local_deps]: app.models.user, app.api.deps, app.database, app.models.document
[ext_deps]: logging, fastapi, sqlalchemy
...
[local_deps]: app.celery_app, app.schemas.collection, app.models.audit, app.models.user, app.models.note, app.tasks.smart_folder_tasks, app.schemas.smart_folder, app.tasks.collection_report_tasks, app.api.deps, app.database, app.models.smart_folder
[ext_deps]: celery, json, asyncio, logging, uuid, fastapi, typing, sqlalchemy
...
[local_deps]: app.tasks.space_tasks, app.services.space_service, app.models.user, app.schemas.tag, app.schemas.space, app.api.deps, app.database
[ext_deps]: logging, uuid, fastapi, sqlalchemy
...
[local_deps]: app.services.llm_gateway, app.tasks.pipeline_orchestrator, app.models.user, app.core.redis_url, app.api.deps
...
[local_deps]: app.tasks.subscription_tasks, app.models.subscription, app.models.user, app.schemas.subscription, app.api.deps, app.database
[ext_deps]: logging, uuid, fastapi, sqlalchemy
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.task, app.services.space_service, app.models.user, app.services.task_service, app.schemas.tag, app.api.deps, app.database
[ext_deps]: logging, uuid, fastapi, sqlalchemy
...
[local_deps]: app.services.whisper_service, app.models.document, app.services.storage_service, app.models.user, app.models.note, app.models.note_audio, app.api.deps
[ext_deps]: tempfile, asyncio, logging, io, uuid, fastapi, os, sqlalchemy
...
[ext_deps]: urllib, logging, pydantic_settings, os, pathlib, pydantic
...
[ext_deps]: base64, json, struct, urllib, logging, cryptography, httpx, os, time
...
[ext_deps]: dotenv, collections, pgvector, fastapi, os, typing, sqlalchemy
...
[local_deps]: app.services.messaging, app.services.prometheus_metrics, app.api, app.middleware.transaction, app.middleware.rls, app.limiter, app.core.redis_url, app.middleware.csrf, app.database
[ext_deps]: dotenv, contextlib, redis, collections, uvicorn, logging, uuid, fastapi, os, typing, slowapi, threading, starlette, time, sqlalchemy
...
[local_deps]: app.services.cache_monitor, app.services.prometheus_metrics, app.services.embedding_service, app.api, app.core.redis_url, app.services.monitoring, app.database
[ext_deps]: dotenv, contextlib, redis, uvicorn, sqlalchemy, logging, httpx, fastapi, os, time, datetime
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: dataclasses, jose, logging, starlette, sqlalchemy
...
[local_deps]: app.models.audit, app.models.user, app.models.note, app.models.push_subscription, app.models.processing, app.models.bookmark, app.models.failed_task, app.models.article, app.models.tag, app.models.base, app.models.smart_folder, app.models.space, app.models.pattern_insight, app.models.milestone, app.models.task, app.models.note_audio, app.models.knowledge_graph, app.models.document, app.models.subscription, app.models.pipeline, app.models.collection, app.models.chat
...
[ext_deps]: collections, asyncio, functools, logging, tenacity, httpx, typing, time
...
[local_deps]: app.schemas.admin, app.schemas.collection, app.schemas.document, app.schemas.chat, app.schemas.search, app.schemas.user, app.schemas.smart_folder, app.schemas.pagination, app.schemas.token
...
[ext_deps]: typing, uuid, pydantic, datetime
...
[ext_deps]: typing, uuid, enum, re, pydantic, datetime
[class]: UserRole { methods: [] }
...
[ext_deps]: sys, json, xlrd, openpyxl
...
[local_deps]: app.services.agents.agent_orchestrator, app.services.agents.answer_agent, app.services.agents.verification_agent, app.services.agents.clarification_agent, app.services.agents.researcher_agent
...
[ext_deps]: collections, dataclasses, logging, enum, typing, time, datetime
...
[ext_deps]: json, dataclasses, logging, re, typing
...
[local_deps]: app.services.graph_rag_service, app.services.llm_gateway, app.services.knowledge_graph.models, app.services.search_service, app.services.knowledge_graph.pool, app.services.knowledge_graph.traversal, app.services.embed_client, app.services.agent_identity
[ext_deps]: json, typing, collections, dataclasses, logging, re
...
[ext_deps]: json, asyncio, hashlib, logging, httpx, typing
...
[ext_deps]: json, typing, sqlalchemy, logging, uuid, warnings, datetime
...
[local_deps]: app.services.pii_detection_service, app.models.document, app.services.llm_gateway, app.services.prometheus_metrics, app.services.cache_monitor, app.services.search_service, app.services.llm_router, app.models.user, app.services.context_block_service, app.database, app.services.agent_identity, app.models.chat
[ext_deps]: json, typing, collections, asyncio, logging, uuid, re, time, sqlalchemy
...
[local_deps]: app.models.document, app.services.llm_gateway, app.models.audit, app.models.user, app.services.context_block_service, app.models.collection, app.services.agent_identity, app.models.chat
[ext_deps]: json, logging, uuid, typing, sqlalchemy
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.schemas.collection, app.models.document, app.services.llm_gateway, app.services.search_service, app.models.user, app.services.search_cache, app.services.intent_parser, app.models.collection, app.services.agent_identity
[ext_deps]: datetime, asyncio, logging, uuid, typing, sqlalchemy
...
[ext_deps]: json, asyncio, logging, typing, threading, traceback, sqlalchemy
...
[local_deps]: app.models.document, app.schemas.document, app.models.audit, app.tasks.pipeline_orchestrator, app.services.storage_service, app.models.user, app.tasks.voice_tasks, app.services.deduplication_service, app.models.pipeline, app.tasks.pipeline_tasks
[ext_deps]: json, asyncio, sqlalchemy, logging, fastapi, typing, concurrent, datetime
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: random, asyncio, logging, httpx, os, time
[fn]: _base_urls()
...
[ext_deps]: numpy, asyncio, psutil, logging, torch, sentence_transformers, os, typing, gc, threading
...
[ext_deps]: onnxruntime, numpy, logging, transformers, os, pathlib
...
[ext_deps]: json, typing, asyncio, sqlalchemy, logging, warnings, datetime
...
[ext_deps]: collections, logging, re, typing, sqlalchemy
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: json, typing, logging, warnings, enum, re, datetime
...
[ext_deps]: json, collections, logging, tenacity, httpx, os, typing, datetime
...
[ext_deps]: json, asyncpg, spacy, __future__, itertools, logging, models
[fn]: _vec_to_str(vec)
...
[ext_deps]: __future__, uuid, enum, pydantic, datetime
...
[ext_deps]: json, extraction, asyncpg, __future__, logging, models
...
[local_deps]: app.services.pii_detection_service, app.services.kimi_service, app.services.ollama_service, app.services.minimax_service, app.services.openrouter_service
[ext_deps]: collections, dataclasses, logging, enum, typing
...
[ext_deps]: collections, nats, asyncio, logging, os, typing
...
[ext_deps]: json, collections, logging, httpx, os, typing
...
[ext_deps]: redis, collections, prometheus_client, dataclasses, psutil, logging, subprocess, re, os, typing, threading, datetime
...
[ext_deps]: PyPDF2, pytesseract, numpy, PIL, cv2, logging, paddleocr, io, enum, os, typing, time
...
[local_deps]: app.services.base_llm_service
[ext_deps]: json, collections, logging, tenacity, httpx, os, typing
...
[local_deps]: app.services.monitoring, app.services.cache_monitor, app.core.redis_url
[ext_deps]: json, redis, collections, asyncio, hashlib, logging, tenacity, httpx, os, typing, datetime
[fn]: _get_redis_client()
...
[ext_deps]: datetime, psutil, logging, sentence_transformers, typing, sqlalchemy
...
[ext_deps]: collections, functools, logging, typing, time
...
[local_deps]: app.models.document, app.services.llm_gateway, app.models.user, app.services.context_block_service, app.models.collection, app.services.agent_identity
[ext_deps]: sqlalchemy, logging, io, uuid, os, typing, reportlab, datetime
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.models.document, app.services.search_service, app.services.llm_router, app.models.user, app.services.search_cache, app.services.context_block_service, app.database, app.services.agent_identity
[ext_deps]: json, typing, search_models, asyncio, logging, uuid, re, time, sqlalchemy
...
[local_deps]: app.services.pii_detection_service, app.models.document, app.models.user, app.services.embed_client, app.services.search_cache, app.services.rerank_service
[ext_deps]: typing, asyncio, logging, re, sqlalchemy
...
[ext_deps]: json, collections, dataclasses, logging, typing
...
[ext_deps]: numpy, logging, re, typing, sqlalchemy
...
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.query_parser, app.services.smart_folder.entity_resolver, app.services.smart_folder.analysis, app.services.smart_folder.report_generator
...
[local_deps]: app.services.smart_folder.agent.executor, app.services.smart_folder.query_parser, app.services.smart_folder.entity_resolver, app.models.user, app.services.smart_folder.agent.planner, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.report_generator, app.models.smart_folder
[ext_deps]: typing, logging, uuid, re, sqlalchemy
...
[ext_deps]: dataclasses, sqlalchemy, logging, uuid, typing, datetime
...
[ext_deps]: json, typing, dataclasses, logging, uuid, re
...
[local_deps]: app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.base, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.financial_analysis
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader
[ext_deps]: typing, logging
...
[local_deps]: app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader
...
[ext_deps]: json, typing, csv, logging, io, re
...
[local_deps]: app.models.document, app.services.llm_gateway, app.services.search_service, app.models.user, app.models.collection
[ext_deps]: typing, sqlalchemy, logging, uuid, re, datetime
...
[local_deps]: app.models.document, app.models.tag, app.models.user, app.models.note, app.models.bookmark, app.models.space
[ext_deps]: logging, uuid, sqlalchemy
[fn]: _escape_like(value)
...
[ext_deps]: base64, logging, cryptography, uuid, os, pathlib, datetime
...
[ext_deps]: contextlib, json, collections, sys, logging, os, typing, pathlib, time, datetime
...
[ext_deps]: json, abc, nats, asyncio, logging, uuid, enum, typing, datetime
...
[local_deps]: app.services.messaging
[ext_deps]: json, nats, hashlib, dataclasses, logging, enum, typing, time, datetime
...
[local_deps]: app.services.messaging
[ext_deps]: json, nats, asyncio, dataclasses, logging, uuid, enum, typing, datetime
...
[local_deps]: app.services.messaging
[ext_deps]: json, nats, logging, typing, datetime
...
[local_deps]: app.models.document, app.services.llm_gateway, app.services.context_block_service, app.models.knowledge_graph, app.services.agent_identity
[ext_deps]: json, datetime, collections, logging, typing, sqlalchemy
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: datetime, collections, logging, typing, sqlalchemy
...
[ext_deps]: json, PyPDF2, xml, csv, html, sys, pptx, zipfile, logging, subprocess, re, os, typing, ebooklib, pathlib, docx
...
[local_deps]: app.utils.circuit_breaker
[ext_deps]: logging, asyncio, faster_whisper, os
...
[local_deps]: app.celery_app, app.tasks.base, app.models.document, app.services.cache_monitor, app.tasks.pipeline_orchestrator, app.services.alert_service, app.models.processing, app.core.redis_url, app.services.monitoring, app.database
[ext_deps]: celery, redis, asyncio, logging, os, datetime
...
[local_deps]: app.tasks.base, app.models.document, app.models.article, app.services.article_generation_service, app.services.embed_client, app.database
[ext_deps]: celery, asyncio, logging, httpx, uuid
...
[local_deps]: app.models.document, app.tasks.pipeline_orchestrator, app.models.article, app.tasks.embedding_tasks, app.tasks.article_tasks, app.database
...
[local_deps]: app.tasks.base, app.services.report_service, app.models.audit, app.models.user, app.database
[ext_deps]: celery, json, asyncio, logging, uuid, typing, sqlalchemy
...
[local_deps]: app.services.dlq_service, app.services.text_extractor, app.tasks.base, app.models.document, app.services.entity_extraction_service, app.tasks.pipeline_orchestrator, app.services.prometheus_metrics, app.tasks.embedding_tasks, app.services.collection_service, app.services.chunking_service, app.tasks.article_tasks, app.services.embed_client, app.services.context_block_service, app.models.processing, app.services.ocr_service, app.database
[ext_deps]: celery, langdetect, tempfile, asyncio, sqlalchemy, logging, uuid, os, traceback, datetime
...
[local_deps]: app.celery_app, app.tasks.base, app.models.document, app.services.embed_client, app.database
...
[ext_deps]: redis, email, sqlalchemy, logging, smtplib, os, datetime
[fn]: _smtp_configured()
...
[local_deps]: app.models.document, app.core.redis_url, app.models.pipeline, app.tasks.pipeline_tasks, app.database
...
[local_deps]: app.celery_app, app.models.document, app.tasks.pipeline_orchestrator, app.core.redis_url, app.models.pipeline, app.database
[ext_deps]: datetime, os, logging, redis, sqlalchemy
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.celery_app, app.services.dlq_service, app.services.text_extractor, app.models.document, app.services.entity_extraction_service, app.services.chunking_service, app.tasks.article_tasks, app.services.knowledge_graph.pool, app.services.embed_client, app.tasks.document_tasks, app.services.knowledge_graph.extraction, app.models.pipeline, app.services.ocr_service, app.database
[ext_deps]: celery, tempfile, asyncio, logging, uuid, os, gc, time, traceback, datetime
...
[ext_deps]: celery, openpyxl, sqlalchemy, logging, fpdf, os, time, datetime
...
[local_deps]: app.tasks.base, app.services.smart_folder.agent_runner, app.models.document, app.models.audit, app.services.smart_folder_service, app.models.user, app.database, app.models.smart_folder
[ext_deps]: celery, json, datetime, asyncio, logging, uuid, typing, sqlalchemy
...
[ext_deps]: logging, asyncio, celery, sqlalchemy
...
[ext_deps]: calendar, email, sqlalchemy, logging, httpx, smtplib, os, datetime
...
[local_deps]: app.celery_app, app.models.push_subscription, app.models.task, app.services.task_service, app.database, app.core.push
...
[ext_deps]: tempfile, asyncio, logging, os, sqlalchemy
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: collections, asyncio, functools, logging, typing, threading, time
...
[ext_deps]: dotenv, bcrypt, jose, logging, sqlalchemy, fastapi, os, typing, datetime
