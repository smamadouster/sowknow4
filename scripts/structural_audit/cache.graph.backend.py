...
[local_deps]: app.models.pipeline, app.models.user, app.tasks.pipeline_orchestrator, app.models.audit, app.utils.security, app.database, app.services.whisper_service, app.schemas.admin, app.models.processing, app.api.documents_common, app.services.search_service, app.models.document, app.services.embed_client, app.api.deps, app.schemas.user, app.models.failed_task, app.services.storage_service, app.services.alert_service, app.tasks.pipeline_tasks, app.models.article, app.models.chat, app.celery_app, app.core.redis_url
[ext_deps]: fastapi, datetime, sqlalchemy, asyncio, logging, concurrent, pydantic, json, uuid, time, typing, redis, os
...
[local_deps]: app.models.document, app.api.deps, app.schemas.article, app.tasks.article_tasks, app.models.user, app.models.article
...
[local_deps]: app.middleware.csrf, app.services.token_blacklist, app.schemas.auth, app.database, app.api.deps, app.limiter, app.schemas.user, app.core.redis_url, app.models.user, app.schemas.token, app.utils.constants, app.utils.security
[ext_deps]: fastapi, datetime, sqlalchemy, time, logging, httpx, secrets, uuid, hashlib, dotenv, redis, os
...
[local_deps]: app.services.space_service, app.database, app.api.deps, app.models.user, app.services.bookmark_service, app.schemas.bookmark, app.schemas.tag
[ext_deps]: uuid, fastapi, sqlalchemy, logging
...
[local_deps]: app.services.chat_service, app.models.chat, app.database, app.api.deps, app.limiter, app.services.input_guard, app.schemas.chat, app.models.user
[ext_deps]: fastapi, sqlalchemy, logging, json, uuid
...
[local_deps]: app.services.collection_chat_service, app.schemas.collection, app.tasks.document_tasks, app.database, app.api.deps, app.services.input_guard, app.models.user, app.models.audit, app.services.collection_service, app.services.llm_gateway, app.models.article, app.models.collection
[ext_deps]: fastapi, sqlalchemy, io, datetime, logging, json, uuid, typing, reportlab
...
[local_deps]: app.services.token_blacklist, app.database, app.models.user, app.utils.constants, app.utils.security
...
[local_deps]: app.tasks.document_tasks, app.models.pipeline, app.models.user, app.tasks.pipeline_orchestrator, app.models.audit, app.services.similarity_service, app.tasks.embedding_tasks, app.database, app.api.documents_upload, app.schemas.document, app.models.processing, app.api.documents_journal, app.api.documents_common, app.services.search_service, app.models.document, app.api.deps, app.services.storage_service, app.tasks.pipeline_tasks, app.services.semantic_cache
[ext_deps]: fastapi, datetime, sqlalchemy, asyncio, logging, concurrent, uuid, time, typing
...
[local_deps]: app.models.document, app.models.pipeline, app.models.user, app.tasks.pipeline_orchestrator, app.models.audit, app.schemas.document, app.core.redis_url, app.tasks.pipeline_tasks
[ext_deps]: fastapi, datetime, sqlalchemy, asyncio, logging, concurrent, mimetypes, json, uuid, pydantic, typing, redis, os
...
[local_deps]: app.api.documents_common, app.models.document, app.database, app.api.deps, app.services.storage_service, app.models.user, app.models.audit, app.schemas.document, app.services.whisper_service
[ext_deps]: fastapi, datetime, sqlalchemy, logging, tempfile, os
...
[local_deps]: app.api.documents_common, app.models.document, app.database, app.api.deps, app.services.storage_service, app.models.user, app.models.audit, app.schemas.document, app.services.document_orchestrator, app.services.deduplication_service, app.services.semantic_cache
[ext_deps]: fastapi, sqlalchemy, logging, uuid, typing
...
[local_deps]: app.services.graph_rag_service, app.services.temporal_reasoning_service, app.services.search_service, app.models.document, app.database, app.api.deps, app.models.user, app.models.audit, app.services.synthesis_service, app.services.progressive_revelation_service
[ext_deps]: fastapi, sqlalchemy, logging, json, uuid, typing
...
[ext_deps]: fastapi, datetime, sqlalchemy, asyncio, logging, nats, httpx, typing, redis, os
...
[ext_deps]: fastapi, sqlalchemy, hmac, logging, os
...
[local_deps]: app.models.knowledge_graph, app.services.timeline_service, app.models.document, app.database, app.api.deps, app.services.relationship_service, app.models.user, app.services.entity_extraction_service
[ext_deps]: fastapi, sqlalchemy, datetime, logging, uuid, typing
...
[local_deps]: app.models.note_audio, app.services.space_service, app.schemas.note, app.database, app.api.deps, app.models.note, app.models.user, app.services.note_service, app.schemas.tag
[ext_deps]: fastapi, sqlalchemy, datetime, logging, uuid, os
...
[local_deps]: app.models.document, app.database, app.api.deps, app.models.pipeline, app.celery_app, app.tasks.pipeline_orchestrator, app.core.redis_url
...
[local_deps]: app.database, app.api.deps, app.models.user, app.schemas.push, app.models.push_subscription
[ext_deps]: fastapi, sqlalchemy, logging, uuid, os
...
[local_deps]: app.api.deps, app.celery_app, app.models.user, app.tasks.report_tasks, app.schemas.reports
...
[local_deps]: app.services.search_models, app.services.search_agent, app.services.search_service, app.models.document, app.services.embed_client, app.database, app.api.deps, app.services.input_guard, app.models.user
[ext_deps]: fastapi, sqlalchemy, asyncio, logging, json, uuid, time
...
[ext_deps]: fastapi, sqlalchemy, logging, pydantic, uuid, hashlib
...
[local_deps]: app.models.document, app.database, app.api.deps, app.models.user
[ext_deps]: fastapi, sqlalchemy, logging
...
[local_deps]: app.schemas.collection, app.schemas.smart_folder, app.database, app.api.deps, app.models.note, app.tasks.smart_folder_tasks, app.models.user, app.celery_app, app.tasks.collection_report_tasks, app.models.audit, app.models.smart_folder
[ext_deps]: fastapi, sqlalchemy, asyncio, logging, celery, json, uuid, typing
...
[local_deps]: app.services.space_service, app.database, app.api.deps, app.tasks.space_tasks, app.models.user, app.schemas.tag, app.schemas.space
[ext_deps]: uuid, fastapi, sqlalchemy, logging
...
[local_deps]: app.api.deps, app.models.user, app.services.rollback_monitor, app.tasks.pipeline_orchestrator, app.services.llm_gateway, app.core.redis_url
...
[local_deps]: app.schemas.subscription, app.database, app.api.deps, app.tasks.subscription_tasks, app.models.user, app.models.subscription
[ext_deps]: uuid, fastapi, sqlalchemy, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.task, app.services.task_service, app.services.space_service, app.database, app.api.deps, app.models.user, app.schemas.tag
[ext_deps]: uuid, fastapi, sqlalchemy, logging
...
[local_deps]: app.models.note_audio, app.models.document, app.api.deps, app.models.note, app.services.storage_service, app.models.user, app.services.whisper_service
[ext_deps]: io, fastapi, sqlalchemy, asyncio, logging, uuid, tempfile, os
...
[ext_deps]: logging, pathlib, pydantic, urllib, pydantic_settings, os
...
[ext_deps]: logging, base64, httpx, json, urllib, cryptography, time, struct, os
...
[ext_deps]: fastapi, sqlalchemy, pgvector, dotenv, typing, collections, os
...
[ext_deps]: slowapi, urllib, os
[fn]: _limiter_redis_url()

---
### FILE: backend/app/main.py
[local_deps]: app.middleware.csrf, app.services.messaging, app.api, app.services.prometheus_metrics, app.database, app.limiter, app.services.openrouter_service, app.services.llm_http_client, app.core.config, app.middleware.rls, app.core.redis_url, app.services.search_cache, app.middleware.transaction
[ext_deps]: slowapi, contextlib, fastapi, sqlalchemy, starlette, logging, dotenv, uuid, threading, time, typing, redis, uvicorn, collections, os
...
[local_deps]: app.api, app.services.prometheus_metrics, app.database, app.services.monitoring, app.services.embedding_service, app.services.llm_http_client, app.services.cache_monitor, app.core.redis_url, app.core.config
[ext_deps]: contextlib, datetime, fastapi, sqlalchemy, logging, httpx, dotenv, time, redis, uvicorn, os
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: starlette, hmac, secrets, logging
...
[ext_deps]: sqlalchemy, dataclasses, starlette, logging, jose
...
[local_deps]: app.models.tag, app.models.pipeline, app.models.user, app.models.audit, app.models.note_audio, app.models.push_subscription, app.models.space, app.models.processing, app.models.subscription, app.models.bookmark, app.models.knowledge_graph, app.models.document, app.models.milestone, app.models.failed_task, app.models.note, app.models.pattern_insight, app.models.article, app.models.task, app.models.collection, app.models.chat, app.models.base, app.models.smart_folder
...
[local_deps]: app.models.base
[ext_deps]: datetime, sqlalchemy, enum, uuid
...
[ext_deps]: tenacity, asyncio, functools, logging, httpx, time, typing, collections
...
[local_deps]: app.database
[ext_deps]: functools, sqlalchemy, json, hashlib
...
[local_deps]: app.schemas.collection, app.schemas.pagination, app.schemas.smart_folder, app.schemas.user, app.schemas.search, app.schemas.chat, app.schemas.token, app.schemas.document, app.schemas.admin
...
[ext_deps]: datetime, pydantic, uuid, typing, enum
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: typing, datetime, uuid, pydantic
...
[ext_deps]: datetime, pydantic, uuid, re, typing, enum
[class]: UserRole { methods: [] }
...
[ext_deps]: xlrd, sys, json, openpyxl
...
[local_deps]: app.services.agents.agent_orchestrator, app.services.agents.answer_agent, app.services.agents.researcher_agent, app.services.agents.clarification_agent, app.services.agents.verification_agent
...
[ext_deps]: datetime, dataclasses, logging, time, typing, enum, collections
...
[ext_deps]: dataclasses, logging, json, re, typing
...
[local_deps]: app.services.knowledge_graph.pool, app.services.graph_rag_service, app.services.search_service, app.services.embed_client, app.services.knowledge_graph.models, app.services.llm_gateway, app.services.knowledge_graph.traversal, app.services.agent_identity
[ext_deps]: dataclasses, logging, json, re, typing, collections
...
[ext_deps]: asyncio, logging, httpx, json, hashlib, typing
...
[ext_deps]: datetime, sqlalchemy, logging, warnings, json, uuid, typing
...
[local_deps]: app.models.chat, app.services.prometheus_metrics, app.services.search_service, app.models.document, app.services.pii_detection_service, app.database, app.models.user, app.services.llm_gateway, app.services.context_block_service, app.services.cache_monitor, app.services.agent_identity
[ext_deps]: sqlalchemy, asyncio, logging, json, uuid, time, collections, typing, re
...
[local_deps]: app.models.chat, app.models.document, app.models.user, app.models.audit, app.services.llm_gateway, app.services.context_block_service, app.models.collection, app.services.agent_identity
[ext_deps]: sqlalchemy, logging, json, uuid, typing
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.schemas.collection, app.services.search_service, app.models.document, app.services.intent_parser, app.models.user, app.services.llm_gateway, app.services.search_cache, app.models.collection, app.services.agent_identity
[ext_deps]: datetime, sqlalchemy, asyncio, logging, uuid, typing
...
[ext_deps]: sqlalchemy, datetime, logging, difflib, hashlib
...
[local_deps]: app.services.llm_gateway
[ext_deps]: datetime, logging, uuid, typing, os
...
[ext_deps]: sqlalchemy, traceback, asyncio, logging, json, threading, typing
...
[local_deps]: app.tasks.voice_tasks, app.models.document, app.services.storage_service, app.models.pipeline, app.models.user, app.tasks.pipeline_orchestrator, app.models.audit, app.schemas.document, app.services.deduplication_service, app.tasks.pipeline_tasks
[ext_deps]: fastapi, datetime, sqlalchemy, asyncio, logging, concurrent, json, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: sendgrid, datetime, logging, os
...
[ext_deps]: asyncio, logging, random, httpx, time, atexit, os
[fn]: _base_urls()
...
[ext_deps]: torch, sentence_transformers, numpy, asyncio, logging, gc, psutil, threading, typing, os
...
[ext_deps]: transformers, numpy, onnxruntime, logging, pathlib, os
...
[ext_deps]: datetime, sqlalchemy, asyncio, logging, warnings, json, typing
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.services.llm_gateway, app.services.context_block_service, app.services.agent_identity
[ext_deps]: sqlalchemy, logging, re, typing, collections
...
[ext_deps]: dataclasses, logging, hashlib, re, redis
...
[ext_deps]: datetime, logging, warnings, json, re, typing, enum
...
[ext_deps]: datetime, tenacity, logging, httpx, json, typing, collections, os
...
[ext_deps]: traversal, extraction, models

---
### FILE: backend/app/services/knowledge_graph/extraction.py
[ext_deps]: __future__, logging, models, spacy, json, itertools, asyncpg
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, __future__, pydantic, uuid, enum
...
[ext_deps]: __future__, logging, models, json, asyncpg, extraction
...
[local_deps]: app.services.user_quota, app.services.token_utils, app.core.context, app.services.monitoring, app.services.rollback_monitor, app.services.llm_router, app.services.semantic_cache
[ext_deps]: asyncio, logging, time, typing, collections
...
[local_deps]: app.services.pii_detection_service, app.services.openrouter_service, app.services.ollama_service, app.services.minimax_service, app.services.together_service, app.services.kimi_service
...
[ext_deps]: asyncio, logging, nats, typing, collections, os
...
[ext_deps]: logging, httpx, json, typing, collections, os
...
[ext_deps]: datetime, dataclasses, subprocess, logging, psutil, prometheus_client, threading, re, typing, redis, collections, os
...
[ext_deps]: io, paddleocr, numpy, pytesseract, logging, PyPDF2, PIL, time, typing, enum, cv2, os
...
[ext_deps]: tenacity, logging, httpx, json, typing, collections, os
...
[local_deps]: app.services.token_utils, app.services.monitoring, app.services.openrouter_throttle, app.services.llm_http_client, app.services.cache_monitor, app.core.redis_url
[ext_deps]: datetime, tenacity, asyncio, logging, httpx, json, hashlib, typing, redis, collections, os
...
[ext_deps]: datetime, __future__, logging, time, typing
...
[ext_deps]: datetime, sqlalchemy, sentence_transformers, logging, psutil, typing
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.models.user, app.services.llm_gateway, app.services.agent_identity
...
[local_deps]: app.models.document, app.services.monitoring, app.models.user, app.services.rollback_monitor, app.services.llm_gateway, app.services.context_block_service, app.models.collection, app.services.agent_identity
[ext_deps]: io, datetime, sqlalchemy, logging, uuid, typing, reportlab, os
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.core.redis_url
[ext_deps]: datetime, logging, time, typing, redis, collections, os
[fn]: _get_redis()
...
[local_deps]: app.services.search_service, app.models.document, app.database, app.models.user, app.services.context_block_service, app.services.search_cache, app.services.llm_router, app.services.agent_identity
[ext_deps]: sqlalchemy, asyncio, logging, json, uuid, time, typing, search_models, re
...
[local_deps]: app.core.redis_url
[ext_deps]: logging, json, hashlib, typing, redis
[fn]: close_redis_client()
[fn]: _get_redis()
...
[local_deps]: app.models.document, app.services.embed_client, app.services.rerank_service, app.services.pii_detection_service, app.models.user, app.services.search_cache
[ext_deps]: sqlalchemy, asyncio, logging, re, typing
...
[local_deps]: app.services.search_cache, app.services.embed_client, app.services.openrouter_service
[ext_deps]: numpy, __future__, logging, json, hashlib, time, typing
...
[ext_deps]: sqlalchemy, numpy, logging, re, typing
...
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.entity_resolver
...
[local_deps]: app.services.smart_folder.agent.planner, app.services.smart_folder.agent.synthesizer, app.models.user, app.services.smart_folder.query_parser, app.services.smart_folder.agent.executor, app.services.smart_folder.report_generator, app.services.smart_folder.entity_resolver, app.models.smart_folder
[ext_deps]: sqlalchemy, logging, uuid, re, typing
...
[ext_deps]: datetime, sqlalchemy, dataclasses, logging, uuid, typing
...
[ext_deps]: datetime, dataclasses, logging, json, typing
...
[ext_deps]: dataclasses, logging, json, uuid, re, typing
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.skills.base, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.ratio_calculator
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.tools.document_reader, app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.report_generator
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.ratio_calculator
...
[ext_deps]: io, csv, logging, json, re, typing
...
[local_deps]: app.services.search_service, app.models.document, app.models.user, app.services.llm_gateway, app.models.collection
[ext_deps]: datetime, sqlalchemy, logging, uuid, re, typing
...
[local_deps]: app.models.tag, app.models.document, app.models.note, app.models.user, app.models.space, app.models.bookmark
[ext_deps]: uuid, sqlalchemy, logging
[fn]: _escape_like(value)
...
[ext_deps]: datetime, logging, base64, pathlib, cryptography, uuid, os
...
[ext_deps]: contextlib, sys, datetime, logging, pathlib, json, time, typing, collections, os
...
[ext_deps]: flock_alerter, hitl_bridge, registry, base_agent

---
### FILE: backend/app/services/swarm/v2/base_agent.py
[local_deps]: app.services.messaging
[ext_deps]: datetime, asyncio, logging, nats, enum, json, uuid, typing, abc
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, dataclasses, logging, nats, json, hashlib, time, typing, enum
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, dataclasses, asyncio, logging, nats, json, uuid, typing, enum
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, logging, nats, json, typing
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.services.rollback_monitor, app.services.llm_gateway, app.services.context_block_service, app.services.agent_identity
[ext_deps]: sqlalchemy, datetime, logging, json, typing, collections
...
[ext_deps]: datetime, logging, httpx, json, os
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: sqlalchemy, datetime, logging, typing, collections
...
[ext_deps]: xml, sys, csv, subprocess, docx, logging, PyPDF2, pathlib, ebooklib, json, html, re, typing, zipfile, pptx, os
...
[local_deps]: app.services.llm_http_client, app.services.base_llm_service, app.services.token_utils
[ext_deps]: datetime, logging, httpx, json, typing, collections, os
...
[local_deps]: app.models.document, app.services.monitoring, app.database, app.core.redis_url, app.celery_app, app.tasks.pipeline_orchestrator, app.tasks.base, app.services.cache_monitor, app.services.alert_service, app.models.processing
[ext_deps]: datetime, asyncio, logging, celery, redis, os
...
[local_deps]: app.models.document, app.services.embed_client, app.database, app.tasks.base, app.models.article, app.services.article_generation_service
...
[local_deps]: app.tasks.embedding_tasks, app.models.document, app.database, app.tasks.article_tasks, app.tasks.pipeline_orchestrator, app.models.article
...
[ext_deps]: traceback, asyncio, logging, psutil, os
...
[local_deps]: app.services.report_service, app.database, app.models.user, app.models.audit, app.tasks.base
[ext_deps]: sqlalchemy, asyncio, logging, celery, json, uuid, typing
...
[local_deps]: app.tasks.embedding_tasks, app.services.prometheus_metrics, app.models.document, app.services.embed_client, app.database, app.services.chunking_service, app.services.ocr_service, app.tasks.article_tasks, app.tasks.pipeline_orchestrator, app.services.entity_extraction_service, app.services.text_extractor, app.services.dlq_service, app.tasks.base, app.services.collection_service, app.services.context_block_service, app.models.processing
[ext_deps]: datetime, sqlalchemy, langdetect, traceback, asyncio, logging, celery, uuid, tempfile, os
...
[local_deps]: app.models.document, app.services.embed_client, app.database, app.celery_app, app.tasks.base
...
[local_deps]: app.models.document, app.database, app.models.pipeline, app.celery_app, app.core.redis_url
[ext_deps]: smtplib, datetime, sqlalchemy, email, logging, redis, os
[fn]: _smtp_configured()
...
[ext_deps]: datetime, logging, celery, uuid, redis
...
[local_deps]: app.models.document, app.database, app.models.pipeline, app.celery_app, app.tasks.pipeline_orchestrator, app.core.redis_url
[ext_deps]: sqlalchemy, datetime, logging, redis, os
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.knowledge_graph.pool, app.tasks.document_tasks, app.models.document, app.services.chunking_service, app.database, app.services.embed_client, app.services.ocr_service, app.models.pipeline, app.celery_app, app.tasks.article_tasks, app.services.entity_extraction_service, app.services.text_extractor, app.services.knowledge_graph.extraction, app.services.dlq_service
[ext_deps]: datetime, traceback, asyncio, logging, celery, gc, uuid, time, tempfile, os
...
[local_deps]: app.models.document, app.database, app.tasks.base, app.models.audit
[ext_deps]: datetime, sqlalchemy, logging, celery, fpdf, openpyxl, time, os
...
[local_deps]: app.models.document, app.database, app.models.user, app.models.audit, app.tasks.base, app.services.smart_folder_service, app.services.smart_folder.agent_runner, app.models.smart_folder
[ext_deps]: sqlalchemy, datetime, asyncio, logging, celery, json, uuid, typing
...
[local_deps]: app.models.subscription, app.database, app.models.user, app.celery_app
[ext_deps]: smtplib, datetime, sqlalchemy, email, logging, httpx, calendar, os
...
[local_deps]: app.services.task_service, app.database, app.celery_app, app.core.push, app.models.push_subscription, app.models.task
[ext_deps]: sqlalchemy, logging
[fn]: check_task_alarms()

---
### FILE: backend/app/tasks/voice_tasks.py
[local_deps]: app.database, app.services.storage_service, app.services.whisper_service, app.celery_app
...
[ext_deps]: asyncio, functools, logging, threading, time, typing, collections
...
[ext_deps]: fastapi, datetime, sqlalchemy, logging, jose, dotenv, bcrypt, typing, os
