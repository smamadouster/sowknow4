...
[local_deps]: app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.schemas.user, app.services.embed_client, app.celery_app, app.utils.security, app.services.whisper_service, app.models.document, app.services.alert_service, app.schemas.admin, app.services.search_service, app.models.chat, app.models.processing, app.core.redis_url, app.models.article, app.api.documents_common, app.models.failed_task, app.database, app.api.deps, app.services.storage_service, app.models.pipeline, app.models.user, app.models.audit
[ext_deps]: uuid, time, typing, sqlalchemy, os, asyncio, urllib, concurrent, json, pydantic, redis, fastapi, datetime, logging
...
[local_deps]: app.models.article, app.tasks.article_tasks, app.api.deps, app.models.user, app.models.document, app.schemas.article
[ext_deps]: sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.database, app.core.redis_url, app.schemas.user, app.utils.constants, app.api.deps, app.services.token_blacklist, app.utils.security, app.schemas.token, app.schemas.auth, app.models.user, app.limiter, app.middleware.csrf
[ext_deps]: hmac, uuid, time, sqlalchemy, os, secrets, httpx, hashlib, redis, dotenv, fastapi, datetime, logging
...
[local_deps]: app.database, app.services.space_service, app.services.bookmark_service, app.api.deps, app.schemas.tag, app.schemas.bookmark, app.models.user
[ext_deps]: sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.database, app.api.deps, app.services.chat_service, app.services.input_guard, app.models.user, app.models.chat, app.limiter, app.schemas.chat
[ext_deps]: uuid, sqlalchemy, json, fastapi, logging
...
[local_deps]: app.database, app.schemas.collection, app.models.article, app.services.collection_service, app.api.deps, app.models.collection, app.services.input_guard, app.models.user, app.models.audit, app.services.llm_gateway, app.services.collection_chat_service, app.tasks.document_tasks
[ext_deps]: io, uuid, typing, sqlalchemy, json, reportlab, fastapi, datetime, logging
...
[local_deps]: app.database, app.utils.constants, app.services.token_blacklist, app.utils.security, app.models.user
...
[local_deps]: app.tasks.pipeline_orchestrator, app.services.semantic_cache, app.tasks.pipeline_tasks, app.models.document, app.schemas.document, app.api.documents_upload, app.services.search_service, app.tasks.document_tasks, app.models.processing, app.tasks.embedding_tasks, app.api.documents_common, app.database, app.api.deps, app.services.storage_service, app.models.pipeline, app.models.user, app.services.similarity_service, app.models.audit, app.api.documents_journal
[ext_deps]: uuid, time, typing, sqlalchemy, asyncio, concurrent, fastapi, datetime, logging
...
[local_deps]: app.schemas.document, app.tasks.pipeline_orchestrator, app.core.redis_url, app.tasks.pipeline_tasks, app.models.pipeline, app.models.user, app.models.document, app.models.audit
[ext_deps]: mimetypes, uuid, typing, sqlalchemy, os, asyncio, redis, json, pydantic, concurrent, fastapi, datetime, logging
...
[local_deps]: app.schemas.document, app.database, app.api.deps, app.services.storage_service, app.services.whisper_service, app.models.document, app.models.user, app.models.audit, app.api.documents_common
[ext_deps]: tempfile, sqlalchemy, os, fastapi, datetime, logging
...
[local_deps]: app.schemas.document, app.database, app.services.semantic_cache, app.api.deps, app.services.storage_service, app.services.deduplication_service, app.services.document_orchestrator, app.models.document, app.models.user, app.models.audit, app.api.documents_common
[ext_deps]: uuid, typing, sqlalchemy, fastapi, logging
...
[local_deps]: app.database, app.services.progressive_revelation_service, app.api.deps, app.services.synthesis_service, app.services.search_service, app.models.user, app.models.document, app.models.audit, app.services.graph_rag_service, app.services.temporal_reasoning_service
[ext_deps]: uuid, typing, sqlalchemy, json, fastapi, logging
...
[ext_deps]: typing, sqlalchemy, os, asyncio, httpx, nats, redis, fastapi, datetime, logging
...
[ext_deps]: hmac, sqlalchemy, os, fastapi, logging
...
[local_deps]: app.database, app.services.entity_extraction_service, app.api.deps, app.models.user, app.services.relationship_service, app.models.document, app.models.knowledge_graph, app.services.timeline_service
[ext_deps]: uuid, typing, sqlalchemy, fastapi, datetime, logging
...
[local_deps]: app.core.redis_url, app.services.cache_monitor, app.services.monitoring, app.services.embedding_service, app.services.prometheus_metrics, app.main
[ext_deps]: time, typing, os, redis, fastapi, datetime, logging
[fn]: _get_redis_info()
...
[local_deps]: app.database, app.schemas.note, app.services.space_service, app.models.note_audio, app.api.deps, app.services.note_service, app.schemas.tag, app.models.note, app.models.user
[ext_deps]: uuid, sqlalchemy, os, fastapi, datetime, logging
...
[local_deps]: app.database, app.core.redis_url, app.tasks.pipeline_orchestrator, app.api.deps, app.celery_app, app.models.pipeline, app.models.document
[ext_deps]: sqlalchemy, redis, asyncio, fastapi
[async_fn]: pipeline_status(db)
[async_fn]: retry_failed_pipeline_stages(stage, limit, db)

---
### FILE: backend/app/api/push.py
[local_deps]: app.database, app.api.deps, app.models.push_subscription, app.schemas.push, app.models.user
...
[local_deps]: app.database, app.services.embed_client, app.api.deps, app.services.agents.agent_orchestrator, app.services.search_models, app.services.input_guard, app.services.search_service, app.models.user, app.models.document, app.services.search_agent
[ext_deps]: time, uuid, sqlalchemy, asyncio, json, fastapi, logging
...
[ext_deps]: uuid, sqlalchemy, hashlib, pydantic, fastapi, logging
...
[local_deps]: app.database, app.schemas.collection, app.schemas.smart_folder, app.api.deps, app.models.smart_folder, app.celery_app, app.models.note, app.tasks.smart_folder_tasks, app.models.user, app.tasks.collection_report_tasks, app.models.audit
[ext_deps]: celery, uuid, typing, sqlalchemy, asyncio, json, fastapi, logging
...
[local_deps]: app.schemas.space, app.database, app.services.space_service, app.api.deps, app.schemas.tag, app.models.user, app.tasks.space_tasks
[ext_deps]: sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.tasks.pipeline_orchestrator, app.core.redis_url, app.services.rollback_monitor, app.api.deps, app.models.user, app.services.llm_gateway
...
[local_deps]: app.database, app.schemas.subscription, app.api.deps, app.tasks.subscription_tasks, app.models.subscription, app.models.user
[ext_deps]: sqlalchemy, fastapi, logging, uuid
[fn]: _parse_uuid(s)
...
[local_deps]: app.database, app.services.space_service, app.api.deps, app.services.task_service, app.schemas.tag, app.models.user, app.schemas.task
[ext_deps]: sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.models.note_audio, app.api.deps, app.services.storage_service, app.services.whisper_service, app.models.note, app.models.user, app.models.document
[ext_deps]: io, uuid, tempfile, sqlalchemy, os, asyncio, fastapi, logging
...
[ext_deps]: pydantic_settings, os, pathlib, urllib, pydantic, logging
...
[ext_deps]: time, os, urllib, json, struct, base64, cryptography, httpx, logging
...
[ext_deps]: pgvector, typing, sqlalchemy, os, dotenv, fastapi, collections
...
[ext_deps]: starlette, os, slowapi, urllib
[fn]: _limiter_redis_url()
[fn]: _get_client_ip(request)

---
### FILE: backend/app/main.py
[local_deps]: app.middleware.rls, app.database, app.core.redis_url, app.services.search_cache, app.api, app.middleware.transaction, app.services.openrouter_service, app.services.llm_http_client, app.core.config, app.services.prometheus_metrics, app.services.monitoring, app.limiter, app.middleware.csrf
[ext_deps]: threading, time, uuid, typing, sqlalchemy, os, contextlib, redis, starlette, dotenv, fastapi, collections, slowapi, uvicorn, logging
...
[ext_deps]: dataclasses, sqlalchemy, starlette, jose, logging
...
[local_deps]: app.models.document, app.models.note_audio, app.models.base, app.models.chat, app.models.processing, app.models.milestone, app.models.article, app.models.push_subscription, app.models.space, app.models.note, app.models.bookmark, app.models.knowledge_graph, app.models.failed_task, app.models.pattern_insight, app.models.tag, app.models.audit, app.models.task, app.models.subscription, app.models.collection, app.models.pipeline, app.models.user, app.models.smart_folder

---
### FILE: backend/app/models/article.py
[local_deps]: app.models.base, app.models.document
[ext_deps]: enum, pgvector, uuid, sqlalchemy
...
[local_deps]: app.models.base
[ext_deps]: enum, datetime, uuid, sqlalchemy
...
[ext_deps]: time, typing, tenacity, asyncio, functools, collections, httpx, logging
...
[local_deps]: app.schemas.document, app.schemas.collection, app.schemas.user, app.schemas.smart_folder, app.schemas.search, app.schemas.pagination, app.schemas.admin, app.schemas.token, app.schemas.chat
...
[ext_deps]: enum, datetime, pydantic, uuid
[class]: BookmarkBucket { methods: [] }
...
[ext_deps]: uuid, typing, pydantic, enum, datetime
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: typing, pydantic, json, base64
...
[ext_deps]: typing, datetime, pydantic, uuid
...
[ext_deps]: uuid, typing, re, pydantic, enum, datetime
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.clarification_agent, app.services.agents.agent_orchestrator, app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.answer_agent
...
[ext_deps]: time, typing, dataclasses, collections, enum, datetime, logging
...
[ext_deps]: typing, dataclasses, re, json, logging
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: typing, dataclasses, json, logging
...
[local_deps]: app.services.knowledge_graph.models, app.services.embed_client, app.services.knowledge_graph.traversal, app.services.knowledge_graph.pool, app.services.agent_identity, app.services.search_service, app.services.graph_rag_service, app.services.llm_gateway
[ext_deps]: typing, dataclasses, re, json, collections, logging
...
[ext_deps]: typing, asyncio, hashlib, json, httpx, logging
...
[local_deps]: app.models.tag, app.services.agent_identity, app.models.document, app.services.llm_gateway
[ext_deps]: warnings, uuid, typing, sqlalchemy, json, datetime, logging
...
[ext_deps]: sqlalchemy, urllib, logging, uuid
...
[ext_deps]: threading, typing, json, datetime, logging
...
[local_deps]: app.database, app.services.context_block_service, app.services.cache_monitor, app.services.pii_detection_service, app.services.agent_identity, app.services.search_service, app.models.user, app.models.chat, app.services.prometheus_metrics, app.models.document, app.services.llm_gateway
[ext_deps]: time, uuid, typing, sqlalchemy, asyncio, re, json, collections, logging
...
[local_deps]: app.services.context_block_service, app.models.collection, app.services.agent_identity, app.models.user, app.models.chat, app.models.document, app.models.audit, app.services.llm_gateway
[ext_deps]: uuid, typing, sqlalchemy, json, logging
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.intent_parser, app.schemas.collection, app.models.collection, app.services.agent_identity, app.services.search_service, app.models.user, app.models.document, app.services.llm_gateway, app.services.search_cache
[ext_deps]: uuid, typing, sqlalchemy, asyncio, datetime, logging
...
[ext_deps]: threading, typing, sqlalchemy, asyncio, json, traceback, logging
...
[local_deps]: app.schemas.document, app.tasks.pipeline_orchestrator, app.tasks.voice_tasks, app.tasks.pipeline_tasks, app.services.storage_service, app.services.deduplication_service, app.models.pipeline, app.models.user, app.models.document, app.models.audit
[ext_deps]: typing, sqlalchemy, asyncio, concurrent, json, fastapi, datetime, logging
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: sendgrid, os, datetime, logging
...
[ext_deps]: random, time, os, asyncio, atexit, httpx, logging
[fn]: _base_urls()
...
[ext_deps]: numpy, threading, psutil, gc, typing, os, asyncio, sentence_transformers, torch, logging
...
[ext_deps]: numpy, onnxruntime, os, transformers, pathlib, logging
...
[local_deps]: app.services.rollback_monitor, app.services.agent_identity, app.models.document, app.services.llm_gateway, app.models.knowledge_graph
[ext_deps]: warnings, typing, sqlalchemy, asyncio, json, datetime, logging
...
[local_deps]: app.services.context_block_service, app.services.agent_identity, app.models.document, app.services.llm_gateway, app.models.knowledge_graph
[ext_deps]: typing, sqlalchemy, re, collections, logging
...
[ext_deps]: warnings, typing, re, json, enum, datetime, logging
...
[ext_deps]: typing, os, tenacity, httpx, json, collections, datetime, logging
...
[ext_deps]: __future__, asyncpg, json, spacy, itertools, models, logging
[fn]: _vec_to_str(vec)
...
[ext_deps]: uuid, __future__, pydantic, enum, datetime
...
[ext_deps]: __future__, asyncpg, json, extraction, models, logging
...
[local_deps]: app.services.llm_router, app.services.semantic_cache, app.services.rollback_monitor, app.services.token_utils, app.services.monitoring, app.core.context, app.services.user_quota
[ext_deps]: time, typing, asyncio, collections, logging
...
[local_deps]: app.services.minimax_service, app.services.openrouter_service, app.services.pii_detection_service, app.services.kimi_service
[ext_deps]: typing, dataclasses, collections, enum, logging
...
[ext_deps]: typing, os, asyncio, nats, collections, logging
...
[ext_deps]: typing, os, json, collections, httpx, logging
...
[ext_deps]: threading, psutil, typing, dataclasses, os, prometheus_client, re, redis, subprocess, collections, datetime, logging
...
[ext_deps]: sqlalchemy, logging, uuid
[fn]: _escape_like(value)
...
[ext_deps]: PIL, io, numpy, PyPDF2, time, typing, os, paddleocr, pytesseract, enum, cv2, logging
...
[ext_deps]: typing, os, tenacity, json, collections, httpx, logging
...
[local_deps]: app.services.openrouter_throttle, app.core.redis_url, app.services.token_utils, app.services.cache_monitor, app.services.llm_http_client, app.services.monitoring, app.services.prometheus_metrics
[ext_deps]: typing, os, tenacity, asyncio, httpx, hashlib, redis, json, collections, datetime, logging
...
[ext_deps]: time, typing, __future__, datetime, logging
...
[ext_deps]: psutil, typing, sqlalchemy, sentence_transformers, datetime, logging
...
[local_deps]: app.services.agent_identity, app.models.user, app.models.document, app.services.llm_gateway, app.models.knowledge_graph
...
[ext_deps]: logging, time, typing, collections, functools
...
[local_deps]: app.services.rollback_monitor, app.services.context_block_service, app.models.collection, app.services.agent_identity, app.services.monitoring, app.models.user, app.models.document, app.services.llm_gateway
[ext_deps]: io, uuid, typing, sqlalchemy, os, reportlab, datetime, logging
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.core.redis_url
[ext_deps]: time, typing, os, redis, collections, datetime, logging
[fn]: _get_redis()
...
[local_deps]: app.services.llm_router, app.database, app.services.context_block_service, app.services.agent_identity, app.services.search_service, app.models.user, app.models.document, app.services.search_cache
[ext_deps]: time, uuid, typing, sqlalchemy, asyncio, re, search_models, json, logging
...
[local_deps]: app.services.search_cache, app.services.embed_client, app.services.pii_detection_service, app.models.user, app.models.document, app.services.rerank_service
[ext_deps]: typing, sqlalchemy, asyncio, re, logging
...
[local_deps]: app.utils.query_normalizer, app.services.embed_client, app.services.openrouter_service, app.services.prometheus_metrics, app.services.search_cache
[ext_deps]: numpy, time, typing, os, hashlib, __future__, json, logging
...
[ext_deps]: typing, dataclasses, json, collections, logging
...
[ext_deps]: numpy, typing, sqlalchemy, re, logging
...
[local_deps]: app.services.smart_folder.entity_resolver, app.services.smart_folder.retrieval, app.services.smart_folder.analysis, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator
...
[local_deps]: app.services.smart_folder.agent.synthesizer, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.executor, app.services.smart_folder.query_parser, app.services.smart_folder.agent.planner, app.models.user, app.models.smart_folder, app.services.smart_folder.report_generator
[ext_deps]: uuid, typing, sqlalchemy, re, logging
...
[ext_deps]: uuid, typing, dataclasses, sqlalchemy, datetime, logging
...
[ext_deps]: typing, dataclasses, sqlalchemy, difflib, logging
...
[ext_deps]: typing, dataclasses, json, datetime, logging
...
[ext_deps]: uuid, typing, dataclasses, re, json, logging
...
[local_deps]: app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.base, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.custom_query
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.skills.base, app.services.smart_folder.analysis, app.services.smart_folder.report_generator, app.services.smart_folder.tools.document_reader
...
[local_deps]: app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.refinement_parser

---
### FILE: backend/app/services/smart_folder/tools/asset_reader.py
[local_deps]: app.models.document
[ext_deps]: typing, sqlalchemy, logging, uuid
...
[ext_deps]: io, typing, re, csv, json, logging
...
[local_deps]: app.models.collection, app.services.search_service, app.models.user, app.models.document, app.services.llm_gateway
[ext_deps]: uuid, typing, sqlalchemy, re, datetime, logging
...
[local_deps]: app.models.space, app.models.note, app.models.document, app.models.user, app.models.bookmark, app.models.tag
[ext_deps]: sqlalchemy, logging, uuid
[fn]: _escape_like(value)
...
[ext_deps]: typing, os, logging, symspellpy
[fn]: _get_symspell()
...
[ext_deps]: uuid, os, pathlib, base64, cryptography, datetime, logging
...
[ext_deps]: sys, time, typing, os, pathlib, contextlib, json, collections, datetime, logging
...
[ext_deps]: uuid, typing, asyncio, nats, json, enum, datetime, logging, abc
...
[local_deps]: app.services.messaging
[ext_deps]: time, typing, dataclasses, nats, hashlib, json, enum, datetime, logging
...
[local_deps]: app.services.messaging
[ext_deps]: uuid, typing, dataclasses, asyncio, nats, json, enum, datetime, logging
...
[local_deps]: app.services.messaging
[ext_deps]: typing, nats, json, datetime, logging
...
[local_deps]: app.services.rollback_monitor, app.services.context_block_service, app.services.agent_identity, app.models.document, app.services.llm_gateway, app.models.knowledge_graph
[ext_deps]: typing, sqlalchemy, json, collections, datetime, logging
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: typing, sqlalchemy, collections, datetime, logging
...
[ext_deps]: sys, PyPDF2, typing, xml, os, ebooklib, pathlib, zipfile, pptx, re, csv, html, json, docx, subprocess, logging
...
[local_deps]: app.services.token_utils, app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: typing, os, httpx, json, collections, datetime, logging
...
[ext_deps]: typing, tiktoken, logging
...
[local_deps]: app.database, app.tasks.pipeline_orchestrator, app.core.redis_url, app.services.cache_monitor, app.celery_app, app.services.alert_service, app.tasks.base, app.services.monitoring, app.models.document, app.models.processing
[ext_deps]: celery, os, asyncio, redis, datetime, logging
...
[local_deps]: app.database, app.services.embed_client, app.models.article, app.tasks.base, app.models.document, app.services.article_generation_service
[ext_deps]: celery, uuid, asyncio, httpx, logging
...
[local_deps]: app.database, app.tasks.pipeline_orchestrator, app.tasks.article_tasks, app.models.article, app.tasks.embedding_tasks, app.models.document
...
[ext_deps]: psutil, os, asyncio, traceback, logging
...
[local_deps]: app.database, app.tasks.base, app.models.user, app.models.audit, app.services.report_service
[ext_deps]: celery, uuid, typing, sqlalchemy, asyncio, json, logging
...
[local_deps]: app.services.dlq_service, app.services.chunking_service, app.database, app.tasks.pipeline_orchestrator, app.services.entity_extraction_service, app.services.embed_client, app.services.text_extractor, app.services.collection_service, app.tasks.embedding_tasks, app.tasks.article_tasks, app.services.context_block_service, app.tasks.base, app.services.auto_tagging_service, app.services.ocr_service, app.models.document, app.services.prometheus_metrics, app.models.processing
[ext_deps]: celery, uuid, tempfile, sqlalchemy, os, asyncio, langdetect, traceback, datetime, logging
...
[local_deps]: app.database, app.services.embed_client, app.celery_app, app.tasks.base, app.models.document
...
[local_deps]: app.database, app.core.redis_url, app.celery_app, app.models.pipeline, app.models.document
[ext_deps]: email, sqlalchemy, os, redis, smtplib, datetime, logging
[fn]: _smtp_configured()
...
[local_deps]: app.database, app.core.redis_url, app.tasks.pipeline_tasks, app.models.pipeline, app.models.document
...
[local_deps]: app.database, app.core.redis_url, app.tasks.pipeline_orchestrator, app.celery_app, app.models.pipeline, app.models.document
[ext_deps]: sqlalchemy, os, redis, datetime, logging
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.dlq_service, app.services.chunking_service, app.database, app.services.entity_extraction_service, app.services.embed_client, app.services.text_extractor, app.tasks.article_tasks, app.services.knowledge_graph.extraction, app.services.knowledge_graph.pool, app.celery_app, app.models.pipeline, app.services.ocr_service, app.models.document, app.tasks.document_tasks
[ext_deps]: celery, time, uuid, gc, sqlalchemy, os, tempfile, asyncio, traceback, datetime, logging
...
[ext_deps]: celery, time, openpyxl, sqlalchemy, os, fpdf, datetime, logging
...
[local_deps]: app.database, app.models.audit, app.services.smart_folder.agent_runner, app.services.smart_folder_service, app.tasks.base, app.models.user, app.models.document, app.models.smart_folder
[ext_deps]: celery, uuid, typing, sqlalchemy, asyncio, json, datetime, logging
...
[local_deps]: app.tasks.base, app.database, app.models.space, app.services.space_service
...
[local_deps]: app.database, app.models.user, app.celery_app, app.models.subscription
[ext_deps]: email, sqlalchemy, os, httpx, smtplib, calendar, datetime, logging
...
[ext_deps]: tempfile, sqlalchemy, os, asyncio, logging
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: threading, logging, time, typing, asyncio, collections, functools
...
[ext_deps]: bcrypt, typing, sqlalchemy, os, dotenv, fastapi, jose, datetime, logging
