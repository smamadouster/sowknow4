...
[local_deps]: app.celery_app, app.models.failed_task, app.database, app.api.deps, app.schemas.user, app.api.documents_common, app.tasks.pipeline_orchestrator, app.services.search_service, app.services.embed_client, app.tasks.pipeline_tasks, app.utils.security, app.services.alert_service, app.services.whisper_service, app.models.processing, app.core.redis_url, app.models.article, app.models.audit, app.schemas.admin, app.models.chat, app.services.storage_service, app.models.pipeline, app.models.document, app.models.user
[ext_deps]: json, os, redis, fastapi, sqlalchemy, time, logging, typing, concurrent, asyncio, uuid, pydantic, datetime, urllib
...
[local_deps]: app.models.article, app.schemas.article, app.tasks.article_tasks, app.models.document, app.api.deps, app.models.user
...
[local_deps]: app.middleware.csrf, app.utils.security, app.schemas.token, app.utils.constants, app.database, app.services.token_blacklist, app.api.deps, app.schemas.auth, app.limiter, app.core.redis_url, app.schemas.user, app.models.user
[ext_deps]: os, secrets, redis, datetime, fastapi, sqlalchemy, time, logging, dotenv, httpx, uuid, hmac, hashlib
...
[local_deps]: app.schemas.tag, app.services.space_service, app.database, app.api.deps, app.models.user, app.services.bookmark_service, app.schemas.bookmark
[ext_deps]: fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.schemas.chat, app.services.input_guard, app.models.chat, app.database, app.services.chat_service, app.api.deps, app.limiter, app.models.user
[ext_deps]: json, fastapi, sqlalchemy, logging, uuid
...
[local_deps]: app.models.article, app.models.audit, app.services.collection_chat_service, app.schemas.collection, app.services.input_guard, app.tasks.document_tasks, app.models.collection, app.database, app.services.collection_service, app.api.deps, app.models.user, app.services.llm_gateway
[ext_deps]: json, io, reportlab, fastapi, sqlalchemy, logging, typing, uuid, datetime
...
[local_deps]: app.api.documents_journal, app.database, app.api.deps, app.api.documents_common, app.tasks.pipeline_orchestrator, app.services.search_service, app.schemas.document, app.services.semantic_cache, app.tasks.pipeline_tasks, app.services.similarity_service, app.tasks.document_tasks, app.api.documents_upload, app.models.processing, app.models.audit, app.services.storage_service, app.tasks.embedding_tasks, app.models.pipeline, app.models.document, app.models.user
[ext_deps]: fastapi, sqlalchemy, time, logging, typing, concurrent, asyncio, uuid, datetime
...
[local_deps]: app.models.audit, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.schemas.document, app.models.pipeline, app.models.document, app.models.user, app.core.redis_url
[ext_deps]: json, mimetypes, os, redis, fastapi, sqlalchemy, logging, typing, concurrent, asyncio, uuid, pydantic, datetime
...
[local_deps]: app.models.audit, app.schemas.document, app.services.whisper_service, app.services.storage_service, app.database, app.models.document, app.api.deps, app.models.user, app.api.documents_common
[ext_deps]: os, fastapi, sqlalchemy, tempfile, logging, datetime
...
[local_deps]: app.models.audit, app.schemas.document, app.services.deduplication_service, app.services.storage_service, app.database, app.models.document, app.api.deps, app.services.document_orchestrator, app.models.user, app.services.semantic_cache, app.api.documents_common
[ext_deps]: fastapi, sqlalchemy, logging, typing, uuid
...
[local_deps]: app.models.audit, app.services.search_service, app.services.graph_rag_service, app.services.progressive_revelation_service, app.services.synthesis_service, app.database, app.models.document, app.api.deps, app.models.user, app.services.temporal_reasoning_service
[ext_deps]: json, fastapi, sqlalchemy, logging, typing, uuid
...
[local_deps]: app.core.redis_url, app.database, app.utils.security, app.celery_app
[ext_deps]: os, redis, fastapi, sqlalchemy, logging, typing, nats, httpx, asyncio, datetime
...
[ext_deps]: os, fastapi, sqlalchemy, logging, hmac
...
[local_deps]: app.services.timeline_service, app.models.knowledge_graph, app.services.entity_extraction_service, app.database, app.models.document, app.api.deps, app.models.user, app.services.relationship_service
[ext_deps]: fastapi, sqlalchemy, logging, typing, uuid, datetime
...
[local_deps]: app.services.embedding_service, app.services.prometheus_metrics, app.services.cache_monitor, app.core.redis_url, app.main, app.services.monitoring
[ext_deps]: os, redis, fastapi, time, logging, typing, datetime
[fn]: _get_redis_info()
...
[local_deps]: app.schemas.note, app.services.note_service, app.schemas.tag, app.services.space_service, app.database, app.api.deps, app.models.user, app.models.note, app.models.note_audio
[ext_deps]: os, fastapi, sqlalchemy, logging, uuid, datetime
...
[local_deps]: app.tasks.pipeline_orchestrator, app.celery_app, app.models.pipeline, app.database, app.models.document, app.api.deps, app.core.redis_url
...
[ext_deps]: os, fastapi, sqlalchemy, logging, uuid
...
[local_deps]: app.schemas.reports, app.celery_app, app.tasks.report_tasks, app.api.deps, app.models.user
...
[local_deps]: app.services.search_agent, app.services.input_guard, app.services.search_service, app.services.agents.agent_orchestrator, app.database, app.models.document, app.api.deps, app.services.search_models, app.services.embed_client, app.models.user
[ext_deps]: json, fastapi, time, sqlalchemy, logging, asyncio, uuid
...
[ext_deps]: fastapi, sqlalchemy, logging, uuid, pydantic, hashlib
...
[local_deps]: app.tasks.smart_folder_tasks, app.models.audit, app.celery_app, app.schemas.collection, app.tasks.collection_report_tasks, app.database, app.models.smart_folder, app.api.deps, app.models.user, app.models.note, app.schemas.smart_folder
[ext_deps]: json, celery, fastapi, sqlalchemy, logging, typing, asyncio, uuid
...
[local_deps]: app.schemas.space, app.schemas.tag, app.services.space_service, app.database, app.api.deps, app.tasks.space_tasks, app.models.user
[ext_deps]: fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.tasks.pipeline_orchestrator, app.api.deps, app.models.user, app.core.redis_url, app.services.rollback_monitor, app.services.llm_gateway
...
[local_deps]: app.models.subscription, app.schemas.subscription, app.database, app.tasks.subscription_tasks, app.api.deps, app.models.user
[ext_deps]: fastapi, sqlalchemy, uuid, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.task, app.schemas.tag, app.services.space_service, app.database, app.api.deps, app.services.task_service, app.models.user
[ext_deps]: fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.services.whisper_service, app.services.storage_service, app.models.document, app.api.deps, app.models.user, app.models.note, app.models.note_audio
[ext_deps]: io, os, fastapi, sqlalchemy, tempfile, logging, asyncio, uuid
...
[ext_deps]: os, pathlib, logging, urllib, pydantic_settings, pydantic
...
[ext_deps]: json, os, struct, time, base64, logging, urllib, httpx, cryptography
...
[ext_deps]: os, fastapi, sqlalchemy, dotenv, typing, collections, pgvector
...
[local_deps]: app.middleware.rls, app.middleware.csrf, app.core.config, app.api, app.database, app.services.prometheus_metrics, app.services.monitoring, app.services.llm_http_client, app.limiter, app.core.redis_url, app.middleware.transaction, app.services.search_cache, app.services.openrouter_service
[ext_deps]: os, uvicorn, starlette, redis, contextlib, fastapi, time, sqlalchemy, logging, typing, threading, dotenv, collections, uuid, slowapi
...
[ext_deps]: starlette, dataclasses, sqlalchemy, logging, jose
...
[local_deps]: app.models.bookmark, app.models.failed_task, app.models.base, app.models.note, app.models.subscription, app.models.collection, app.models.tag, app.models.processing, app.models.pattern_insight, app.models.space, app.models.push_subscription, app.models.article, app.models.audit, app.models.knowledge_graph, app.models.task, app.models.chat, app.models.pipeline, app.models.document, app.models.smart_folder, app.models.user, app.models.note_audio, app.models.milestone
...
[ext_deps]: functools, tenacity, time, logging, typing, httpx, collections, asyncio
...
[local_deps]: app.schemas.chat, app.schemas.admin, app.schemas.document, app.schemas.token, app.schemas.collection, app.schemas.pagination, app.schemas.search, app.schemas.user, app.schemas.smart_folder

---
### FILE: backend/app/schemas/admin.py
[local_deps]: app.schemas.user
[ext_deps]: re, uuid, pydantic, datetime
...
[ext_deps]: enum, typing, uuid, pydantic, datetime
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: json, base64, pydantic, typing
...
[ext_deps]: uuid, pydantic, datetime, typing
...
[ext_deps]: enum, re, typing, uuid, pydantic, datetime
[class]: UserRole { methods: [] }
...
[ext_deps]: json, openpyxl, xlrd, sys
...
[local_deps]: app.services.agents.clarification_agent, app.services.agents.agent_orchestrator, app.services.agents.answer_agent, app.services.agents.verification_agent, app.services.agents.researcher_agent

---
### FILE: backend/app/services/agents/agent_orchestrator.py
[local_deps]: app.services.agents.answer_agent, app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.clarification_agent
[ext_deps]: enum, dataclasses, time, logging, typing, collections, datetime
...
[ext_deps]: json, dataclasses, re, logging, typing
...
[local_deps]: app.services.search_service, app.services.agent_identity, app.services.graph_rag_service, app.services.knowledge_graph.pool, app.services.knowledge_graph.traversal, app.services.knowledge_graph.models, app.services.embed_client, app.services.llm_gateway
[ext_deps]: json, re, dataclasses, logging, typing, collections
...
[ext_deps]: json, logging, typing, httpx, asyncio, hashlib
...
[ext_deps]: json, warnings, sqlalchemy, logging, typing, uuid, datetime
...
[ext_deps]: json, logging, typing, threading, datetime
...
[local_deps]: app.services.search_service, app.services.agent_identity, app.services.context_block_service, app.models.chat, app.services.pii_detection_service, app.database, app.services.prometheus_metrics, app.models.document, app.services.cache_monitor, app.models.user, app.services.llm_gateway
[ext_deps]: json, re, time, sqlalchemy, logging, typing, collections, asyncio, uuid
...
[local_deps]: app.models.audit, app.services.agent_identity, app.services.context_block_service, app.models.collection, app.models.chat, app.models.document, app.models.user, app.services.llm_gateway
[ext_deps]: json, sqlalchemy, logging, typing, uuid
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.schemas.collection, app.services.search_service, app.services.agent_identity, app.models.collection, app.services.intent_parser, app.models.document, app.models.user, app.services.search_cache, app.services.llm_gateway
[ext_deps]: sqlalchemy, logging, typing, asyncio, uuid, datetime
...
[ext_deps]: difflib, hashlib, sqlalchemy, logging, datetime
...
[local_deps]: app.services.llm_gateway
[ext_deps]: os, logging, typing, uuid, datetime
...
[ext_deps]: json, traceback, sqlalchemy, logging, typing, threading, asyncio
...
[local_deps]: app.models.audit, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.services.deduplication_service, app.schemas.document, app.tasks.voice_tasks, app.services.storage_service, app.models.pipeline, app.models.document, app.models.user
[ext_deps]: json, fastapi, sqlalchemy, logging, typing, concurrent, asyncio, datetime
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: atexit, os, httpx, time, logging, random, asyncio
[fn]: _base_urls()
...
[ext_deps]: os, torch, psutil, sentence_transformers, logging, typing, threading, numpy, asyncio, gc
...
[ext_deps]: os, pathlib, logging, onnxruntime, numpy, transformers
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.models.document, app.services.rollback_monitor, app.services.llm_gateway
[ext_deps]: json, warnings, sqlalchemy, logging, typing, asyncio, datetime
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.context_block_service, app.models.document, app.services.llm_gateway
[ext_deps]: re, sqlalchemy, logging, typing, collections
...
[ext_deps]: redis, re, dataclasses, logging, hashlib
...
[ext_deps]: json, warnings, enum, re, logging, typing, datetime
...
[ext_deps]: json, os, tenacity, logging, typing, httpx, collections, datetime
...
[ext_deps]: json, itertools, logging, asyncpg, __future__, spacy, models
[fn]: _vec_to_str(vec)
...
[ext_deps]: json, extraction, logging, asyncpg, __future__, models
...
[local_deps]: app.services.llm_router, app.services.token_utils, app.core.context, app.services.user_quota, app.services.semantic_cache, app.services.rollback_monitor, app.services.monitoring
[ext_deps]: time, logging, typing, collections, asyncio
...
[ext_deps]: enum, dataclasses, logging, typing, collections
...
[ext_deps]: os, logging, typing, nats, collections, asyncio
...
[ext_deps]: json, os, logging, typing, httpx, collections
...
[ext_deps]: os, subprocess, redis, psutil, dataclasses, re, logging, typing, threading, prometheus_client, collections, datetime
...
[ext_deps]: cv2, io, os, enum, PIL, PyPDF2, time, pytesseract, paddleocr, logging, typing, numpy
...
[ext_deps]: json, os, tenacity, logging, typing, httpx, collections
...
[local_deps]: app.services.token_utils, app.services.prometheus_metrics, app.services.cache_monitor, app.services.llm_http_client, app.core.redis_url, app.services.monitoring, app.services.openrouter_throttle
[ext_deps]: json, os, redis, tenacity, logging, typing, httpx, collections, asyncio, datetime, hashlib
...
[ext_deps]: time, logging, typing, __future__, datetime
...
[ext_deps]: psutil, sentence_transformers, sqlalchemy, logging, typing, datetime
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.models.document, app.models.user, app.services.llm_gateway
...
[ext_deps]: functools, time, logging, typing, collections
...
[local_deps]: app.services.agent_identity, app.services.context_block_service, app.models.collection, app.models.document, app.models.user, app.services.rollback_monitor, app.services.monitoring, app.services.llm_gateway
[ext_deps]: io, os, reportlab, sqlalchemy, logging, typing, uuid, datetime
[class]: ReportFormat { methods: [] }
...
[ext_deps]: httpx, os, logging, typing
[fn]: _get_client()
...
[local_deps]: app.core.redis_url
[ext_deps]: os, redis, time, logging, typing, collections, datetime
[fn]: _get_redis()
...
[local_deps]: app.services.search_service, app.services.agent_identity, app.services.context_block_service, app.services.llm_router, app.database, app.models.document, app.models.user, app.services.search_cache
[ext_deps]: json, re, time, sqlalchemy, logging, typing, asyncio, uuid, search_models
...
[ext_deps]: json, redis, logging, typing, hashlib
[fn]: close_redis_client()
[fn]: _get_redis()
...
[local_deps]: app.services.rerank_service, app.services.pii_detection_service, app.services.embed_client, app.models.document, app.models.user, app.services.search_cache
[ext_deps]: re, sqlalchemy, logging, typing, asyncio
...
[local_deps]: app.utils.query_normalizer, app.services.embed_client, app.services.prometheus_metrics, app.services.search_cache, app.services.openrouter_service
[ext_deps]: json, os, time, logging, typing, __future__, numpy, hashlib
...
[ext_deps]: json, dataclasses, logging, typing, collections
...
[ext_deps]: re, sqlalchemy, logging, typing, numpy
...
[local_deps]: app.services.smart_folder.entity_resolver, app.services.smart_folder.report_generator, app.services.smart_folder.analysis, app.services.smart_folder.query_parser, app.services.smart_folder.retrieval
...
[local_deps]: app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.planner, app.services.smart_folder.report_generator, app.models.smart_folder, app.services.smart_folder.agent.synthesizer, app.models.user, app.services.smart_folder.query_parser, app.services.smart_folder.agent.executor
[ext_deps]: re, sqlalchemy, logging, typing, uuid
...
[ext_deps]: dataclasses, sqlalchemy, logging, typing, uuid, datetime
...
[ext_deps]: difflib, dataclasses, sqlalchemy, logging, typing
...
[ext_deps]: json, dataclasses, logging, typing, datetime
...
[local_deps]: app.services.smart_folder.analysis, app.services.token_utils, app.services.llm_router, app.services.smart_folder.retrieval
[ext_deps]: json, re, dataclasses, logging, typing, uuid
...
[local_deps]: app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.base, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.sentiment_tracker
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.skills.base, app.services.smart_folder.tools.chart_generator
[ext_deps]: logging, typing
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.analysis, app.services.smart_folder.report_generator, app.services.smart_folder.tools.document_reader, app.services.smart_folder.retrieval
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.chart_generator
...
[ext_deps]: json, io, csv, re, logging, typing
...
[local_deps]: app.services.search_service, app.models.collection, app.models.document, app.models.user, app.services.llm_gateway
[ext_deps]: re, sqlalchemy, logging, typing, uuid, datetime
...
[local_deps]: app.models.bookmark, app.models.document, app.models.note, app.models.user, app.models.space, app.models.tag
[ext_deps]: sqlalchemy, uuid, logging
[fn]: _escape_like(value)
...
[ext_deps]: os, base64, pathlib, logging, cryptography, uuid, datetime
...
[ext_deps]: json, os, sys, time, pathlib, logging, typing, collections, contextlib, datetime
...
[ext_deps]: hitl_bridge, flock_alerter, base_agent, registry

---
### FILE: backend/app/services/swarm/v2/base_agent.py
[local_deps]: app.services.messaging
[ext_deps]: json, enum, abc, logging, typing, nats, asyncio, uuid, datetime
...
[local_deps]: app.services.messaging
[ext_deps]: json, enum, dataclasses, time, logging, typing, nats, datetime, hashlib
...
[local_deps]: app.services.messaging
[ext_deps]: json, enum, dataclasses, logging, typing, nats, asyncio, uuid, datetime
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.context_block_service, app.models.document, app.services.rollback_monitor, app.services.llm_gateway
[ext_deps]: json, sqlalchemy, logging, typing, collections, datetime
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: sqlalchemy, logging, typing, collections, datetime
...
[ext_deps]: json, xml, html, os, subprocess, zipfile, csv, sys, PyPDF2, re, pptx, ebooklib, pathlib, logging, typing, docx
...
[local_deps]: app.services.token_utils, app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: json, os, logging, typing, httpx, collections, datetime
...
[local_deps]: app.tasks.pipeline_orchestrator, app.celery_app, app.services.alert_service, app.models.processing, app.database, app.models.document, app.services.cache_monitor, app.tasks.base, app.core.redis_url, app.services.monitoring
[ext_deps]: celery, os, redis, logging, asyncio, datetime
...
[local_deps]: app.models.article, app.services.article_generation_service, app.database, app.models.document, app.services.embed_client, app.tasks.base
[ext_deps]: celery, logging, httpx, asyncio, uuid
...
[local_deps]: app.models.article, app.tasks.pipeline_orchestrator, app.tasks.article_tasks, app.tasks.embedding_tasks, app.database, app.models.document
...
[ext_deps]: os, traceback, psutil, logging, asyncio
...
[local_deps]: app.models.audit, app.services.report_service, app.database, app.tasks.base, app.models.user
[ext_deps]: json, celery, sqlalchemy, logging, typing, asyncio, uuid
...
[local_deps]: app.services.text_extractor, app.tasks.pipeline_orchestrator, app.services.chunking_service, app.services.auto_tagging_service, app.services.context_block_service, app.models.processing, app.tasks.embedding_tasks, app.services.entity_extraction_service, app.database, app.models.document, app.services.embed_client, app.services.collection_service, app.tasks.base, app.services.prometheus_metrics, app.tasks.article_tasks, app.services.dlq_service, app.services.ocr_service
[ext_deps]: celery, os, traceback, sqlalchemy, tempfile, logging, langdetect, asyncio, uuid, datetime
...
[local_deps]: app.celery_app, app.models.pipeline, app.database, app.models.document, app.core.redis_url
[ext_deps]: os, smtplib, email, redis, sqlalchemy, logging, datetime
[fn]: _smtp_configured()
...
[ext_deps]: celery, redis, logging, uuid, datetime
...
[local_deps]: app.tasks.pipeline_orchestrator, app.celery_app, app.models.pipeline, app.database, app.models.document, app.core.redis_url
[ext_deps]: os, redis, sqlalchemy, logging, datetime
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.text_extractor, app.services.chunking_service, app.celery_app, app.services.knowledge_graph.extraction, app.tasks.document_tasks, app.tasks.article_tasks, app.models.pipeline, app.services.entity_extraction_service, app.database, app.models.document, app.services.embed_client, app.services.dlq_service, app.services.ocr_service, app.services.knowledge_graph.pool
[ext_deps]: celery, os, gc, traceback, time, sqlalchemy, tempfile, logging, asyncio, uuid, datetime
...
[ext_deps]: celery, os, fpdf, time, sqlalchemy, logging, openpyxl, datetime
...
[local_deps]: app.models.audit, app.services.smart_folder.agent_runner, app.database, app.models.smart_folder, app.models.document, app.tasks.base, app.models.user, app.services.smart_folder_service
[ext_deps]: json, celery, sqlalchemy, logging, typing, asyncio, uuid, datetime
...
[ext_deps]: os, smtplib, email, calendar, sqlalchemy, logging, httpx, datetime
...
[local_deps]: app.core.push, app.celery_app, app.models.task, app.database, app.services.task_service, app.models.push_subscription
...
[ext_deps]: os, sqlalchemy, tempfile, logging, asyncio
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: functools, time, logging, typing, threading, collections, asyncio
...
[ext_deps]: bcrypt, os, fastapi, sqlalchemy, logging, typing, dotenv, datetime, jose
