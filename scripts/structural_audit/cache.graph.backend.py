...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.failed_task, app.models.article, app.api.documents_common, app.api.deps, app.tasks.pipeline_tasks, app.utils.security, app.services.search_service, app.schemas.user, app.database, app.services.alert_service, app.core.redis_url, app.models.processing, app.models.user, app.services.embed_client, app.services.whisper_service, app.models.audit, app.celery_app, app.schemas.admin, app.models.document, app.models.pipeline, app.models.chat, app.services.storage_service
[ext_deps]: json, typing, os, time, logging, fastapi, datetime, concurrent, pydantic, sqlalchemy, redis, uuid, asyncio
...
[local_deps]: app.utils.security, app.limiter, app.schemas.token, app.schemas.user, app.utils.constants, app.services.token_blacklist, app.middleware.csrf, app.database, app.api.deps, app.core.redis_url, app.models.user, app.schemas.auth
[ext_deps]: hashlib, time, os, dotenv, logging, fastapi, datetime, secrets, redis, uuid, sqlalchemy, httpx
...
[local_deps]: app.schemas.tag, app.services.bookmark_service, app.database, app.services.space_service, app.api.deps, app.schemas.bookmark, app.models.user
[ext_deps]: fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.limiter, app.schemas.chat, app.services.input_guard, app.database, app.models.chat, app.api.deps, app.services.chat_service, app.models.user
[ext_deps]: json, fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.tasks.document_tasks, app.models.audit, app.services.collection_service, app.services.llm_gateway, app.models.article, app.schemas.collection, app.services.collection_chat_service, app.services.input_guard, app.database, app.api.deps, app.models.collection, app.models.user
[ext_deps]: json, typing, fastapi, logging, reportlab, datetime, sqlalchemy, uuid, io
...
[local_deps]: app.utils.security, app.utils.constants, app.services.token_blacklist, app.database, app.models.user
...
[local_deps]: app.schemas.document, app.tasks.document_tasks, app.models.audit, app.tasks.pipeline_orchestrator, app.api.documents_upload, app.services.search_service, app.api.documents_common, app.tasks.embedding_tasks, app.models.document, app.database, app.models.pipeline, app.api.deps, app.services.similarity_service, app.models.processing, app.tasks.pipeline_tasks, app.services.storage_service, app.models.user, app.api.documents_journal
[ext_deps]: typing, time, logging, fastapi, datetime, concurrent, sqlalchemy, uuid, asyncio
...
[local_deps]: app.schemas.document, app.tasks.pipeline_orchestrator, app.models.audit, app.models.document, app.models.pipeline, app.core.redis_url, app.tasks.pipeline_tasks, app.models.user
[ext_deps]: json, typing, os, logging, fastapi, datetime, concurrent, pydantic, mimetypes, sqlalchemy, uuid, redis, asyncio
...
[local_deps]: app.schemas.document, app.models.audit, app.api.documents_common, app.models.document, app.database, app.api.deps, app.services.whisper_service, app.services.storage_service, app.models.user
[ext_deps]: tempfile, os, fastapi, logging, datetime, sqlalchemy
...
[local_deps]: app.schemas.document, app.models.audit, app.services.document_orchestrator, app.api.documents_common, app.models.document, app.database, app.api.deps, app.services.storage_service, app.models.user, app.services.deduplication_service
[ext_deps]: typing, fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.services.temporal_reasoning_service, app.models.audit, app.services.synthesis_service, app.services.search_service, app.services.graph_rag_service, app.models.document, app.database, app.api.deps, app.services.progressive_revelation_service, app.models.user
[ext_deps]: json, typing, fastapi, logging, sqlalchemy, uuid
...
[ext_deps]: typing, os, logging, fastapi, datetime, sqlalchemy, redis, httpx, asyncio, nats
...
[ext_deps]: hmac, os, fastapi, logging, sqlalchemy
...
[local_deps]: app.services.relationship_service, app.services.timeline_service, app.models.knowledge_graph, app.services.entity_extraction_service, app.models.document, app.database, app.api.deps, app.models.user
[ext_deps]: typing, fastapi, logging, datetime, sqlalchemy, uuid
...
[local_deps]: app.models.note_audio, app.schemas.tag, app.models.note, app.database, app.services.note_service, app.services.space_service, app.api.deps, app.schemas.note, app.models.user
[ext_deps]: os, fastapi, logging, datetime, sqlalchemy, uuid
...
[local_deps]: app.tasks.pipeline_orchestrator, app.celery_app, app.models.document, app.models.pipeline, app.database, app.api.deps, app.core.redis_url
...
[local_deps]: app.models.push_subscription, app.schemas.push, app.database, app.api.deps, app.models.user
[ext_deps]: os, fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.services.search_agent, app.services.search_service, app.services.embed_client, app.models.document, app.services.input_guard, app.database, app.api.deps, app.models.user, app.services.search_models
[ext_deps]: json, time, logging, fastapi, sqlalchemy, uuid, asyncio
...
[ext_deps]: hashlib, fastapi, logging, pydantic, sqlalchemy, uuid
...
[local_deps]: app.models.document, app.database, app.models.user, app.api.deps
[ext_deps]: fastapi, logging, sqlalchemy
...
[local_deps]: app.models.audit, app.celery_app, app.schemas.collection, app.schemas.smart_folder, app.models.note, app.tasks.smart_folder_tasks, app.tasks.collection_report_tasks, app.database, app.api.deps, app.models.smart_folder, app.models.user
[ext_deps]: json, typing, fastapi, logging, sqlalchemy, uuid, asyncio, celery
...
[local_deps]: app.schemas.space, app.schemas.tag, app.database, app.services.space_service, app.api.deps, app.tasks.space_tasks, app.models.user
[ext_deps]: fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.tasks.subscription_tasks, app.schemas.subscription, app.database, app.api.deps, app.models.subscription, app.models.user
[ext_deps]: fastapi, logging, sqlalchemy, uuid
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.tag, app.services.task_service, app.database, app.services.space_service, app.api.deps, app.schemas.task, app.models.user
[ext_deps]: fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.models.note_audio, app.models.note, app.models.document, app.api.deps, app.services.whisper_service, app.services.storage_service, app.models.user
[ext_deps]: tempfile, os, logging, fastapi, sqlalchemy, uuid, io, asyncio
...
[ext_deps]: os, logging, pydantic, pydantic_settings, pathlib, urllib
...
[ext_deps]: json, cryptography, time, os, struct, logging, urllib, httpx, base64
...
[ext_deps]: typing, os, pgvector, dotenv, fastapi, collections, sqlalchemy
...
[local_deps]: app.limiter, app.middleware.transaction, app.services.messaging, app.middleware.rls, app.middleware.csrf, app.database, app.api, app.services.prometheus_metrics, app.core.redis_url
[ext_deps]: uvicorn, threading, time, os, typing, dotenv, logging, fastapi, slowapi, collections, sqlalchemy, contextlib, uuid, redis, starlette
...
[local_deps]: app.services.cache_monitor, app.database, app.services.monitoring, app.api, app.services.prometheus_metrics, app.core.redis_url, app.services.embedding_service
[ext_deps]: uvicorn, time, os, dotenv, logging, fastapi, datetime, sqlalchemy, contextlib, redis, httpx
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: logging, sqlalchemy, dataclasses, starlette, jose
...
[local_deps]: app.models.push_subscription, app.models.failed_task, app.models.base, app.models.article, app.models.knowledge_graph, app.models.pattern_insight, app.models.space, app.models.tag, app.models.bookmark, app.models.processing, app.models.subscription, app.models.smart_folder, app.models.user, app.models.audit, app.models.note_audio, app.models.task, app.models.note, app.models.document, app.models.pipeline, app.models.chat, app.models.milestone, app.models.collection

---
### FILE: backend/app/models/article.py
[local_deps]: app.models.document, app.models.base
[ext_deps]: enum, sqlalchemy, pgvector, uuid
...
[ext_deps]: functools, tenacity, time, typing, logging, collections, httpx, asyncio
...
[local_deps]: app.database
[ext_deps]: hashlib, functools, json, sqlalchemy
...
[local_deps]: app.schemas.document, app.schemas.admin, app.schemas.user, app.schemas.smart_folder, app.schemas.collection, app.schemas.chat, app.schemas.pagination, app.schemas.search, app.schemas.token
...
[ext_deps]: enum, pydantic, datetime, uuid
[class]: BookmarkBucket { methods: [] }
...
[ext_deps]: typing, datetime, enum, pydantic, uuid
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: typing, re, datetime, enum, pydantic, uuid
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.answer_agent, app.services.agents.verification_agent, app.services.agents.clarification_agent, app.services.agents.researcher_agent, app.services.agents.agent_orchestrator
...
[ext_deps]: typing, time, logging, datetime, collections, enum, dataclasses
...
[ext_deps]: json, typing, re, logging, dataclasses
...
[local_deps]: app.services.llm_gateway, app.services.search_service, app.services.knowledge_graph.models, app.services.embed_client, app.services.graph_rag_service, app.services.agent_identity, app.services.knowledge_graph.pool, app.services.knowledge_graph.traversal
[ext_deps]: json, typing, re, logging, collections, dataclasses
...
[ext_deps]: hashlib, json, typing, logging, httpx, asyncio
...
[ext_deps]: json, typing, logging, datetime, sqlalchemy, uuid, warnings
...
[ext_deps]: json, threading, typing, logging, datetime
...
[local_deps]: app.services.cache_monitor, app.services.llm_gateway, app.services.search_service, app.services.context_block_service, app.services.pii_detection_service, app.models.document, app.services.prometheus_metrics, app.database, app.models.chat, app.services.agent_identity, app.models.user, app.services.llm_router
[ext_deps]: json, time, typing, re, logging, collections, sqlalchemy, uuid, asyncio
...
[local_deps]: app.models.audit, app.services.llm_gateway, app.services.context_block_service, app.models.document, app.models.chat, app.services.agent_identity, app.models.collection, app.models.user
[ext_deps]: json, typing, logging, sqlalchemy, uuid
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.intent_parser, app.services.llm_gateway, app.services.search_service, app.schemas.collection, app.models.document, app.services.agent_identity, app.models.collection, app.services.search_cache, app.models.user
[ext_deps]: typing, logging, datetime, sqlalchemy, uuid, asyncio
...
[ext_deps]: redis, logging, sqlalchemy, datetime
[fn]: _get_redis()
...
[ext_deps]: hashlib, logging, datetime, sqlalchemy, difflib
...
[local_deps]: app.services.llm_gateway
[ext_deps]: typing, os, logging, datetime, uuid
...
[ext_deps]: json, threading, typing, traceback, logging, sqlalchemy, asyncio
...
[local_deps]: app.schemas.document, app.tasks.pipeline_orchestrator, app.models.audit, app.tasks.voice_tasks, app.models.document, app.models.pipeline, app.tasks.pipeline_tasks, app.services.storage_service, app.models.user, app.services.deduplication_service
[ext_deps]: json, typing, logging, fastapi, datetime, concurrent, sqlalchemy, asyncio
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: random, time, os, logging, httpx, asyncio
[fn]: _base_urls()
...
[ext_deps]: gc, threading, typing, os, logging, sentence_transformers, psutil, numpy, torch, asyncio
...
[ext_deps]: os, logging, transformers, onnxruntime, pathlib, numpy
...
[local_deps]: app.models.document, app.models.knowledge_graph, app.services.agent_identity, app.services.llm_gateway
[ext_deps]: json, typing, logging, datetime, sqlalchemy, warnings, asyncio
...
[local_deps]: app.services.llm_gateway, app.models.knowledge_graph, app.services.context_block_service, app.models.document, app.services.agent_identity
[ext_deps]: typing, re, logging, collections, sqlalchemy
...
[ext_deps]: hashlib, re, logging, redis, dataclasses
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: json, typing, re, logging, datetime, enum, warnings
...
[ext_deps]: json, tenacity, typing, os, logging, datetime, collections, httpx
...
[ext_deps]: json, __future__, logging, itertools, asyncpg, models, spacy
[fn]: _vec_to_str(vec)
...
[ext_deps]: __future__, datetime, enum, pydantic, uuid
...
[ext_deps]: json, __future__, extraction, logging, asyncpg, models
...
[ext_deps]: typing, logging, collections
...
[local_deps]: app.services.minimax_service, app.services.kimi_service, app.services.pii_detection_service, app.services.ollama_service, app.services.openrouter_service
[ext_deps]: typing, logging, collections, enum, dataclasses
...
[ext_deps]: typing, os, logging, collections, asyncio, nats
...
[ext_deps]: json, typing, os, logging, collections, httpx
...
[ext_deps]: threading, typing, os, re, logging, datetime, collections, psutil, dataclasses, redis, prometheus_client, subprocess
...
[ext_deps]: PyPDF2, time, os, typing, pytesseract, logging, enum, PIL, cv2, io, numpy, paddleocr
...
[local_deps]: app.services.base_llm_service
[ext_deps]: json, tenacity, typing, os, logging, collections, httpx
...
[local_deps]: app.services.cache_monitor, app.services.monitoring, app.core.redis_url
[ext_deps]: hashlib, json, tenacity, typing, os, logging, collections, datetime, redis, httpx, asyncio
[fn]: _get_redis_client()
...
[ext_deps]: typing, logging, datetime, sentence_transformers, psutil, sqlalchemy
...
[local_deps]: app.services.llm_gateway, app.models.knowledge_graph, app.models.document, app.services.agent_identity, app.models.user
...
[ext_deps]: functools, typing, time, logging, collections
...
[local_deps]: app.services.llm_gateway, app.services.context_block_service, app.models.document, app.services.agent_identity, app.models.collection, app.models.user
[ext_deps]: typing, os, logging, reportlab, datetime, sqlalchemy, uuid, io
[class]: ReportFormat { methods: [] }
...
[ext_deps]: httpx, logging, typing, os
[fn]: _get_client()
...
[local_deps]: app.services.search_service, app.services.context_block_service, app.models.document, app.database, app.services.agent_identity, app.services.search_cache, app.models.user, app.services.llm_router
[ext_deps]: json, time, typing, search_models, re, logging, sqlalchemy, uuid, asyncio
...
[local_deps]: app.core.redis_url
[ext_deps]: hashlib, json, typing, logging, redis
[fn]: _get_redis()
...
[local_deps]: app.services.rerank_service, app.services.embed_client, app.services.pii_detection_service, app.models.document, app.services.search_cache, app.models.user
[ext_deps]: typing, re, logging, sqlalchemy, asyncio
...
[ext_deps]: json, typing, logging, collections, dataclasses
...
[ext_deps]: typing, re, logging, sqlalchemy, numpy
...
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.query_parser, app.services.smart_folder.retrieval, app.services.smart_folder.entity_resolver, app.services.smart_folder.analysis
...
[local_deps]: app.services.smart_folder.agent.synthesizer, app.services.smart_folder.report_generator, app.services.smart_folder.query_parser, app.services.smart_folder.agent.planner, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.executor, app.models.smart_folder, app.models.user
[ext_deps]: typing, re, logging, sqlalchemy, uuid
...
[ext_deps]: typing, logging, datetime, sqlalchemy, dataclasses, uuid
...
[ext_deps]: typing, logging, sqlalchemy, dataclasses, difflib
...
[local_deps]: app.services.llm_router
[ext_deps]: json, typing, logging, datetime, dataclasses
...
[ext_deps]: json, typing, re, logging, dataclasses, uuid
...
[local_deps]: app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.base
...
[local_deps]: app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.ratio_calculator
[ext_deps]: logging, typing
...
[local_deps]: app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.ratio_calculator
...
[ext_deps]: csv, json, typing, re, logging, io
...
[local_deps]: app.services.llm_gateway, app.services.search_service, app.models.document, app.models.collection, app.models.user
[ext_deps]: typing, re, logging, datetime, sqlalchemy, uuid
...
[local_deps]: app.models.tag, app.models.note, app.models.document, app.models.bookmark, app.models.space, app.models.user
[ext_deps]: logging, sqlalchemy, uuid
[fn]: _escape_like(value)
...
[ext_deps]: cryptography, os, logging, datetime, pathlib, uuid, base64
...
[ext_deps]: json, typing, os, time, logging, collections, datetime, contextlib, pathlib, sys
...
[ext_deps]: flock_alerter, base_agent, registry, hitl_bridge

---
### FILE: backend/app/services/swarm/v2/base_agent.py
[local_deps]: app.services.messaging
[ext_deps]: json, typing, logging, datetime, enum, abc, uuid, asyncio, nats
...
[local_deps]: app.services.messaging
[ext_deps]: hashlib, json, time, typing, logging, datetime, enum, dataclasses, nats
...
[local_deps]: app.services.messaging
[ext_deps]: json, typing, logging, datetime, enum, dataclasses, uuid, asyncio, nats
...
[local_deps]: app.services.messaging
[ext_deps]: json, typing, logging, datetime, nats
...
[local_deps]: app.services.llm_gateway, app.models.knowledge_graph, app.services.context_block_service, app.models.document, app.services.agent_identity
[ext_deps]: json, typing, logging, datetime, collections, sqlalchemy
...
[ext_deps]: json, os, logging, datetime, httpx
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: typing, logging, datetime, collections, sqlalchemy
...
[ext_deps]: csv, json, pptx, PyPDF2, typing, os, re, logging, xml, sys, ebooklib, docx, zipfile, pathlib, html, subprocess
...
[local_deps]: app.utils.circuit_breaker
[ext_deps]: logging, faster_whisper, asyncio, os
...
[local_deps]: app.tasks.pipeline_orchestrator, app.services.cache_monitor, app.celery_app, app.models.document, app.services.monitoring, app.database, app.services.alert_service, app.core.redis_url, app.models.processing, app.tasks.base
[ext_deps]: os, logging, datetime, redis, asyncio, celery
...
[local_deps]: app.models.article, app.services.embed_client, app.models.document, app.database, app.services.article_generation_service, app.tasks.base
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.article, app.tasks.embedding_tasks, app.tasks.article_tasks, app.models.document, app.database
...
[ext_deps]: traceback, os, logging, psutil, asyncio
...
[ext_deps]: json, typing, logging, sqlalchemy, uuid, asyncio, celery
...
[local_deps]: app.tasks.pipeline_orchestrator, app.services.collection_service, app.services.embed_client, app.services.entity_extraction_service, app.services.ocr_service, app.tasks.embedding_tasks, app.models.document, app.services.chunking_service, app.database, app.services.prometheus_metrics, app.tasks.article_tasks, app.services.context_block_service, app.services.dlq_service, app.models.processing, app.tasks.base, app.services.text_extractor
[ext_deps]: tempfile, traceback, os, langdetect, logging, datetime, sqlalchemy, uuid, asyncio, celery
...
[local_deps]: app.celery_app, app.services.embed_client, app.models.document, app.database, app.tasks.base
[ext_deps]: sentence_transformers, logging, time, uuid
...
[local_deps]: app.celery_app, app.models.document, app.database, app.models.pipeline, app.core.redis_url
[ext_deps]: email, os, logging, datetime, smtplib, sqlalchemy, redis
[fn]: _smtp_configured()
...
[ext_deps]: logging, datetime, redis, uuid, celery
...
[local_deps]: app.tasks.pipeline_orchestrator, app.celery_app, app.models.document, app.database, app.models.pipeline, app.core.redis_url
[ext_deps]: os, logging, datetime, sqlalchemy, redis
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.knowledge_graph.extraction, app.tasks.document_tasks, app.celery_app, app.services.embed_client, app.services.entity_extraction_service, app.services.ocr_service, app.tasks.article_tasks, app.models.document, app.services.chunking_service, app.database, app.models.pipeline, app.services.dlq_service, app.services.knowledge_graph.pool, app.services.text_extractor
[ext_deps]: gc, tempfile, time, os, traceback, logging, datetime, uuid, asyncio, celery
...
[ext_deps]: time, os, logging, datetime, fpdf, openpyxl, sqlalchemy, celery
...
[local_deps]: app.services.smart_folder.agent_runner, app.models.audit, app.services.smart_folder_service, app.models.document, app.database, app.tasks.base, app.models.smart_folder, app.models.user
[ext_deps]: json, typing, logging, datetime, sqlalchemy, uuid, asyncio, celery
...
[local_deps]: app.tasks.base, app.database, app.services.space_service, app.models.space
...
[ext_deps]: email, os, logging, datetime, calendar, smtplib, sqlalchemy, httpx
...
[local_deps]: app.models.push_subscription, app.models.task, app.celery_app, app.services.task_service, app.database, app.core.push
[ext_deps]: logging, sqlalchemy
[fn]: check_task_alarms()

---
### FILE: backend/app/tasks/voice_tasks.py
[local_deps]: app.services.whisper_service, app.database, app.services.storage_service, app.celery_app
[ext_deps]: tempfile, os, logging, sqlalchemy, asyncio
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: functools, threading, time, typing, logging, collections, asyncio
...
[ext_deps]: typing, os, dotenv, logging, fastapi, datetime, bcrypt, sqlalchemy, jose
