...
[local_deps]: app.api.deps, app.utils.security, app.api.documents_common, app.tasks.pipeline_tasks, app.services.storage_service, app.models.failed_task, app.services.alert_service, app.models.document, app.models.user, app.services.embed_client, app.models.processing, app.models.audit, app.schemas.admin, app.tasks.pipeline_orchestrator, app.models.chat, app.models.pipeline, app.database, app.schemas.user, app.models.article, app.services.whisper_service, app.core.redis_url, app.celery_app
[ext_deps]: sqlalchemy, typing, uuid, redis, concurrent, json, logging, datetime, fastapi, os, pydantic, asyncio
...
[local_deps]: app.api.deps, app.models.article, app.tasks.article_tasks, app.schemas.article, app.models.document, app.models.user
[ext_deps]: sqlalchemy, logging, fastapi, uuid
...
[local_deps]: app.schemas.user, app.api.deps, app.middleware.csrf, app.database, app.utils.constants, app.utils.security, app.core.redis_url, app.limiter, app.schemas.auth, app.services.token_blacklist, app.models.user, app.schemas.token
[ext_deps]: hashlib, sqlalchemy, uuid, time, secrets, httpx, redis, logging, datetime, fastapi, dotenv, os
...
[local_deps]: app.services.space_service, app.api.deps, app.database, app.schemas.bookmark, app.services.bookmark_service, app.schemas.tag, app.models.user
[ext_deps]: sqlalchemy, logging, fastapi, uuid
...
[local_deps]: app.api.deps, app.database, app.services.chat_service, app.limiter, app.models.chat, app.schemas.chat, app.services.input_guard, app.models.user
[ext_deps]: sqlalchemy, uuid, json, logging, fastapi
...
[local_deps]: app.schemas.collection, app.tasks.document_tasks, app.models.article, app.api.deps, app.models.audit, app.database, app.services.collection_chat_service, app.services.collection_service, app.models.collection, app.services.llm_gateway, app.services.input_guard, app.models.user
[ext_deps]: sqlalchemy, typing, io, uuid, reportlab, json, logging, datetime, fastapi
...
[local_deps]: app.schemas.document, app.models.processing, app.api.deps, app.database, app.models.audit, app.services.similarity_service, app.tasks.document_tasks, app.models.pipeline, app.api.documents_common, app.services.search_service, app.api.documents_journal, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.document, app.api.documents_upload, app.models.user, app.services.storage_service
[ext_deps]: sqlalchemy, typing, uuid, concurrent, logging, datetime, fastapi, asyncio
...
[local_deps]: app.schemas.document, app.models.pipeline, app.models.audit, app.core.redis_url, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.document, app.models.user
[ext_deps]: sqlalchemy, typing, uuid, pydantic, redis, concurrent, json, logging, datetime, fastapi, os, mimetypes, asyncio
...
[local_deps]: app.schemas.document, app.api.deps, app.database, app.models.audit, app.services.whisper_service, app.api.documents_common, app.models.document, app.models.user, app.services.storage_service
[ext_deps]: tempfile, sqlalchemy, logging, datetime, fastapi, os
...
[local_deps]: app.schemas.document, app.api.deps, app.database, app.models.audit, app.api.documents_common, app.services.document_orchestrator, app.services.deduplication_service, app.models.document, app.models.user, app.services.storage_service
[ext_deps]: sqlalchemy, typing, uuid, logging, fastapi
...
[local_deps]: app.api.deps, app.database, app.models.audit, app.services.synthesis_service, app.services.graph_rag_service, app.services.search_service, app.models.document, app.services.progressive_revelation_service, app.models.user, app.services.temporal_reasoning_service
[ext_deps]: sqlalchemy, typing, uuid, json, logging, fastapi
...
[ext_deps]: sqlalchemy, typing, httpx, redis, nats, logging, datetime, fastapi, os, asyncio
...
[local_deps]: app.schemas.document, app.api.documents_upload, app.database, app.models.user
...
[local_deps]: app.api.deps, app.database, app.services.timeline_service, app.models.knowledge_graph, app.services.entity_extraction_service, app.services.relationship_service, app.models.document, app.models.user
[ext_deps]: sqlalchemy, typing, uuid, logging, datetime, fastapi
...
[local_deps]: app.services.space_service, app.api.deps, app.database, app.schemas.note, app.models.note, app.models.note_audio, app.services.note_service, app.schemas.tag, app.models.user
[ext_deps]: sqlalchemy, uuid, logging, datetime, fastapi, os
...
[local_deps]: app.models.pipeline, app.api.deps, app.database, app.core.redis_url, app.celery_app, app.tasks.pipeline_orchestrator, app.models.document
...
[ext_deps]: sqlalchemy, uuid, logging, fastapi, os
...
[local_deps]: app.api.deps, app.schemas.reports, app.celery_app, app.tasks.report_tasks, app.models.user
...
[local_deps]: app.api.deps, app.database, app.services.search_service, app.services.search_models, app.models.document, app.services.input_guard, app.models.user, app.services.search_agent
[ext_deps]: sqlalchemy, time, uuid, json, logging, fastapi, asyncio
...
[ext_deps]: hashlib, sqlalchemy, uuid, logging, fastapi, pydantic
...
[local_deps]: app.models.smart_folder, app.schemas.collection, app.api.deps, app.database, app.models.audit, app.models.note, app.tasks.smart_folder_tasks, app.celery_app, app.tasks.collection_report_tasks, app.schemas.smart_folder, app.models.user
[ext_deps]: sqlalchemy, typing, uuid, json, logging, fastapi, celery, asyncio
...
[local_deps]: app.services.space_service, app.api.deps, app.database, app.tasks.space_tasks, app.schemas.space, app.schemas.tag, app.models.user
[ext_deps]: sqlalchemy, logging, fastapi, uuid
...
[local_deps]: app.api.deps, app.core.redis_url, app.tasks.pipeline_orchestrator, app.services.llm_gateway, app.models.user
...
[local_deps]: app.tasks.subscription_tasks, app.api.deps, app.models.subscription, app.database, app.schemas.subscription, app.models.user
[ext_deps]: sqlalchemy, logging, fastapi, uuid
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.task, app.services.space_service, app.api.deps, app.database, app.services.task_service, app.schemas.tag, app.models.user
[ext_deps]: sqlalchemy, logging, fastapi, uuid
...
[ext_deps]: tempfile, sqlalchemy, io, uuid, logging, fastapi, os, asyncio
...
[ext_deps]: urllib, pydantic_settings, logging, os, pathlib, pydantic
...
[ext_deps]: cryptography, base64, time, urllib, struct, httpx, json, logging, os
...
[ext_deps]: pgvector, sqlalchemy, typing, collections, fastapi, dotenv, os
...
[local_deps]: app.services.prometheus_metrics, app.database, app.middleware.csrf, app.core.redis_url, app.services.messaging, app.limiter, app.middleware.rls, app.middleware.transaction, app.api
[ext_deps]: sqlalchemy, typing, threading, contextlib, uuid, time, starlette, uvicorn, slowapi, redis, collections, logging, fastapi, dotenv, os
...
[local_deps]: app.services.prometheus_metrics, app.services.monitoring, app.database, app.core.redis_url, app.services.cache_monitor, app.services.embedding_service, app.api
[ext_deps]: sqlalchemy, contextlib, time, uvicorn, httpx, redis, logging, datetime, fastapi, dotenv, os
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[local_deps]: app.models.base, app.models.bookmark, app.models.pattern_insight, app.models.collection, app.models.task, app.models.smart_folder, app.models.failed_task, app.models.milestone, app.models.space, app.models.document, app.models.user, app.models.processing, app.models.subscription, app.models.audit, app.models.knowledge_graph, app.models.note_audio, app.models.chat, app.models.pipeline, app.models.article, app.models.note, app.models.tag, app.models.push_subscription
...
[ext_deps]: typing, time, httpx, collections, logging, functools, tenacity, asyncio
...
[local_deps]: app.schemas.document, app.schemas.user, app.schemas.collection, app.schemas.admin, app.schemas.pagination, app.schemas.chat, app.schemas.smart_folder, app.schemas.token, app.schemas.search
...
[ext_deps]: typing, uuid, enum, datetime, pydantic
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: typing, uuid, enum, datetime, re, pydantic
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.agent_orchestrator, app.services.agents.researcher_agent, app.services.agents.answer_agent, app.services.agents.verification_agent, app.services.agents.clarification_agent

---
### FILE: backend/app/services/agents/agent_orchestrator.py
[local_deps]: app.services.agents.verification_agent, app.services.agents.answer_agent, app.services.agents.researcher_agent, app.services.agents.clarification_agent
[ext_deps]: typing, time, enum, dataclasses, collections, logging, datetime
...
[local_deps]: app.services.knowledge_graph.models, app.services.agent_identity, app.services.search_service, app.services.graph_rag_service, app.services.knowledge_graph.traversal, app.services.llm_gateway, app.services.knowledge_graph.pool, app.services.embed_client
...
[ext_deps]: hashlib, typing, httpx, json, logging, asyncio
...
[ext_deps]: sqlalchemy, typing, uuid, warnings, json, logging, datetime
...
[ext_deps]: urllib, sqlalchemy, logging, uuid
...
[ext_deps]: typing, threading, json, logging, datetime
...
[local_deps]: app.services.prometheus_metrics, app.database, app.services.agent_identity, app.services.context_block_service, app.services.search_service, app.services.llm_router, app.services.cache_monitor, app.services.pii_detection_service, app.services.llm_gateway, app.models.chat, app.models.user, app.models.document
[ext_deps]: sqlalchemy, typing, time, uuid, collections, json, logging, re, asyncio
...
[local_deps]: app.services.agent_identity, app.models.audit, app.services.context_block_service, app.models.collection, app.services.llm_gateway, app.models.chat, app.models.user, app.models.document
[ext_deps]: sqlalchemy, typing, uuid, json, logging
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.schemas.collection, app.services.agent_identity, app.services.search_cache, app.services.search_service, app.services.llm_gateway, app.models.collection, app.services.intent_parser, app.models.document, app.models.user
[ext_deps]: sqlalchemy, typing, uuid, logging, datetime, asyncio
...
[ext_deps]: sqlalchemy, typing, threading, json, logging, traceback, asyncio
...
[local_deps]: app.schemas.document, app.models.pipeline, app.models.audit, app.tasks.pipeline_orchestrator, app.services.deduplication_service, app.tasks.pipeline_tasks, app.models.document, app.tasks.voice_tasks, app.models.user, app.services.storage_service
[ext_deps]: sqlalchemy, typing, concurrent, json, logging, datetime, fastapi, asyncio
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: os, sendgrid, logging, datetime
...
[ext_deps]: time, httpx, random, logging, os, asyncio
[fn]: _base_urls()
...
[ext_deps]: typing, threading, numpy, sentence_transformers, psutil, logging, gc, torch, os, asyncio
...
[ext_deps]: numpy, onnxruntime, logging, transformers, os, pathlib
...
[ext_deps]: sqlalchemy, typing, warnings, json, logging, datetime, asyncio
...
[ext_deps]: sqlalchemy, typing, collections, logging, re
...
[ext_deps]: hashlib, redis, dataclasses, logging, re
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: typing, enum, warnings, json, logging, datetime, re
...
[ext_deps]: typing, httpx, collections, json, logging, datetime, os, tenacity
...
[ext_deps]: itertools, spacy, json, logging, asyncpg, __future__, models
[fn]: _vec_to_str(vec)
...
[ext_deps]: uuid, enum, datetime, __future__, pydantic
...
[ext_deps]: extraction, json, logging, asyncpg, __future__, models
...
[local_deps]: app.services.minimax_service, app.services.ollama_service, app.services.kimi_service, app.services.openrouter_service, app.services.pii_detection_service
[ext_deps]: typing, enum, dataclasses, collections, logging
...
[ext_deps]: typing, nats, collections, logging, os, asyncio
...
[ext_deps]: typing, httpx, collections, json, logging, os
...
[ext_deps]: prometheus_client, typing, threading, psutil, redis, dataclasses, collections, subprocess, logging, datetime, os, re
...
[ext_deps]: pytesseract, PyPDF2, typing, io, numpy, time, paddleocr, enum, cv2, logging, PIL, os
...
[local_deps]: app.services.base_llm_service
[ext_deps]: typing, httpx, collections, json, logging, os, tenacity
...
[ext_deps]: hashlib, typing, httpx, redis, collections, json, logging, datetime, os, tenacity, asyncio
[fn]: _get_redis_client()
...
[ext_deps]: sqlalchemy, typing, sentence_transformers, psutil, logging, datetime
...
[local_deps]: app.services.agent_identity, app.services.context_block_service, app.models.collection, app.services.llm_gateway, app.models.document, app.models.user
[ext_deps]: sqlalchemy, typing, io, uuid, reportlab, logging, datetime, os
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.database, app.services.agent_identity, app.services.context_block_service, app.services.search_cache, app.services.search_service, app.services.llm_router, app.models.document, app.models.user
[ext_deps]: search_models, sqlalchemy, typing, time, uuid, json, logging, re, asyncio
...
[local_deps]: app.services.search_cache, app.services.rerank_service, app.services.pii_detection_service, app.models.document, app.models.user, app.services.embed_client
[ext_deps]: sqlalchemy, typing, logging, re, asyncio
[class]: SearchResult { methods: [__init__] }
[fn]: _get_regconfig(language_code)
[class]: HybridSearchService { methods: [__init__, _get_user_bucket_filter, semantic_search, keyword_search, tag_search, _filename_search, article_semantic_search, _trigram_fallback_search, _substring_fallback_search, article_keyword_search, hybrid_search, _sanitize_tsquery, _keyword_search, _keyword_search_with_metadata, _get_highlighted_text, _get_bucket_filter_for_role, _search_bookmarks, _search_notes, _search_spaces, search_all_types, _search_documents_simple] }
...
[ext_deps]: sqlalchemy, typing, numpy, logging, re
...
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.report_generator, app.services.smart_folder.analysis, app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser
...
[local_deps]: app.models.smart_folder, app.services.smart_folder.report_generator, app.services.smart_folder.agent.planner, app.models.user, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser, app.services.smart_folder.agent.executor
...
[ext_deps]: sqlalchemy, typing, uuid, dataclasses, logging, datetime
...
[ext_deps]: sqlalchemy, typing, dataclasses, difflib, logging
...
[local_deps]: app.services.llm_router
[ext_deps]: typing, dataclasses, json, logging, datetime
...
[ext_deps]: typing, uuid, dataclasses, json, logging, re
...
[local_deps]: app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.base, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.sentiment_tracker
...
[local_deps]: app.services.smart_folder.tools.document_reader, app.services.smart_folder.retrieval, app.services.smart_folder.skills.base, app.services.smart_folder.report_generator, app.services.smart_folder.analysis
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.citation_marker
...
[local_deps]: app.models.note, app.models.bookmark, app.models.space, app.models.tag, app.models.document, app.models.user
[ext_deps]: sqlalchemy, logging, uuid
[fn]: _escape_like(value)
...
[ext_deps]: cryptography, base64, uuid, logging, datetime, os, pathlib
...
[ext_deps]: typing, contextlib, time, sys, collections, json, logging, datetime, os, pathlib
...
[ext_deps]: typing, uuid, enum, abc, json, logging, datetime, nats, asyncio
...
[local_deps]: app.services.messaging
[ext_deps]: hashlib, typing, time, enum, dataclasses, json, logging, datetime, nats
...
[local_deps]: app.services.messaging
[ext_deps]: typing, uuid, enum, dataclasses, json, logging, datetime, nats, asyncio
...
[local_deps]: app.services.messaging
[ext_deps]: typing, json, logging, datetime, nats
...
[local_deps]: app.services.agent_identity, app.services.context_block_service, app.models.knowledge_graph, app.services.llm_gateway, app.models.document
[ext_deps]: sqlalchemy, typing, collections, json, logging, datetime
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: sqlalchemy, typing, collections, logging, datetime
...
[ext_deps]: PyPDF2, pptx, typing, csv, xml, sys, ebooklib, subprocess, zipfile, json, logging, html, os, docx, pathlib, re
...
[local_deps]: app.services.monitoring, app.models.processing, app.database, app.tasks.base, app.services.alert_service, app.celery_app, app.core.redis_url, app.services.cache_monitor, app.tasks.pipeline_orchestrator, app.models.document
[ext_deps]: redis, logging, datetime, os, celery, asyncio
...
[local_deps]: app.database, app.models.article, app.tasks.base, app.services.article_generation_service, app.models.document, app.services.embed_client
[ext_deps]: uuid, httpx, logging, celery, asyncio
...
[local_deps]: app.database, app.models.article, app.tasks.embedding_tasks, app.tasks.article_tasks, app.tasks.pipeline_orchestrator, app.models.document
...
[ext_deps]: psutil, logging, traceback, os, asyncio
...
[local_deps]: app.database, app.models.audit, app.tasks.base, app.services.report_service, app.models.user
[ext_deps]: sqlalchemy, typing, uuid, json, logging, celery, asyncio
...
[local_deps]: app.services.prometheus_metrics, app.models.processing, app.database, app.tasks.base, app.services.ocr_service, app.services.context_block_service, app.services.entity_extraction_service, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.tasks.article_tasks, app.services.dlq_service, app.services.collection_service, app.models.document, app.services.chunking_service, app.services.text_extractor, app.services.embed_client
[ext_deps]: tempfile, sqlalchemy, uuid, logging, datetime, traceback, os, langdetect, celery, asyncio
...
[ext_deps]: sqlalchemy, email, redis, smtplib, logging, datetime, os
[fn]: _smtp_configured()
...
[local_deps]: app.models.pipeline, app.database, app.core.redis_url, app.tasks.pipeline_tasks, app.models.document
...
[local_deps]: app.models.pipeline, app.database, app.core.redis_url, app.celery_app, app.tasks.pipeline_orchestrator, app.models.document
[ext_deps]: sqlalchemy, redis, logging, datetime, os
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.tasks.document_tasks, app.models.pipeline, app.database, app.services.knowledge_graph.pool, app.services.ocr_service, app.services.entity_extraction_service, app.celery_app, app.tasks.article_tasks, app.services.knowledge_graph.extraction, app.services.dlq_service, app.models.document, app.services.chunking_service, app.services.text_extractor, app.services.embed_client
[ext_deps]: tempfile, time, uuid, logging, gc, datetime, traceback, os, celery, asyncio
...
[ext_deps]: openpyxl, sqlalchemy, time, logging, datetime, fpdf, os, celery
...
[local_deps]: app.models.smart_folder, app.database, app.models.audit, app.tasks.base, app.services.smart_folder.agent_runner, app.services.smart_folder_service, app.models.user, app.models.document
[ext_deps]: sqlalchemy, typing, uuid, json, logging, datetime, celery, asyncio
...
[local_deps]: app.models.space, app.services.space_service, app.database, app.tasks.base
...
[ext_deps]: sqlalchemy, email, httpx, calendar, smtplib, logging, datetime, os
...
[local_deps]: app.database, app.celery_app, app.services.task_service, app.core.push, app.models.task, app.models.push_subscription
[ext_deps]: sqlalchemy, logging
[fn]: check_task_alarms()

---
### FILE: backend/app/tasks/voice_tasks.py
[local_deps]: app.services.storage_service, app.database, app.celery_app, app.services.whisper_service
[ext_deps]: tempfile, sqlalchemy, logging, os, asyncio
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: typing, threading, time, collections, logging, functools, asyncio
...
[ext_deps]: sqlalchemy, typing, jose, logging, datetime, fastapi, dotenv, os, bcrypt
