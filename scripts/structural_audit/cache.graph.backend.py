...
[local_deps]: app.celery_app, app.services.embed_client, app.services.whisper_service, app.models.user, app.models.processing, app.api.deps, app.tasks.pipeline_orchestrator, app.models.article, app.services.storage_service, app.tasks.pipeline_tasks, app.models.failed_task, app.services.search_service, app.api.documents_common, app.database, app.models.pipeline, app.schemas.user, app.services.alert_service, app.schemas.admin, app.models.chat, app.models.audit, app.utils.security, app.models.document, app.core.redis_url
[ext_deps]: pydantic, os, json, datetime, redis, time, fastapi, uuid, logging, asyncio, sqlalchemy, typing, concurrent
...
[local_deps]: app.models.article, app.api.deps, app.models.document, app.tasks.article_tasks, app.models.user, app.schemas.article
...
[local_deps]: app.utils.constants, app.schemas.user, app.schemas.auth, app.middleware.csrf, app.limiter, app.api.deps, app.services.token_blacklist, app.utils.security, app.core.redis_url, app.schemas.token, app.models.user, app.database
[ext_deps]: os, datetime, redis, time, httpx, fastapi, uuid, logging, dotenv, secrets, sqlalchemy, hashlib
...
[local_deps]: app.services.space_service, app.schemas.tag, app.api.deps, app.services.bookmark_service, app.schemas.bookmark, app.models.user, app.database
[ext_deps]: sqlalchemy, uuid, logging, fastapi
...
[local_deps]: app.schemas.chat, app.services.chat_service, app.services.input_guard, app.models.chat, app.limiter, app.api.deps, app.models.user, app.database
[ext_deps]: json, fastapi, uuid, logging, sqlalchemy
...
[local_deps]: app.schemas.collection, app.tasks.document_tasks, app.models.article, app.services.collection_chat_service, app.services.input_guard, app.models.audit, app.services.llm_gateway, app.models.collection, app.models.user, app.services.collection_service, app.api.deps, app.database
[ext_deps]: json, io, datetime, reportlab, fastapi, uuid, logging, sqlalchemy, typing
...
[local_deps]: app.utils.constants, app.services.token_blacklist, app.utils.security, app.models.user, app.database
...
[local_deps]: app.api.documents_upload, app.models.processing, app.services.similarity_service, app.tasks.document_tasks, app.tasks.pipeline_orchestrator, app.models.pipeline, app.services.storage_service, app.tasks.pipeline_tasks, app.tasks.embedding_tasks, app.models.audit, app.services.search_service, app.schemas.document, app.models.document, app.api.documents_common, app.models.user, app.api.documents_journal, app.api.deps, app.database
[ext_deps]: datetime, time, fastapi, uuid, logging, asyncio, sqlalchemy, typing, concurrent
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.pipeline, app.tasks.pipeline_tasks, app.models.audit, app.schemas.document, app.models.document, app.core.redis_url, app.models.user
[ext_deps]: pydantic, os, json, datetime, redis, mimetypes, logging, uuid, asyncio, fastapi, sqlalchemy, typing, concurrent
...
[local_deps]: app.services.storage_service, app.services.whisper_service, app.models.audit, app.schemas.document, app.models.document, app.api.documents_common, app.models.user, app.api.deps, app.database
[ext_deps]: os, datetime, tempfile, fastapi, logging, sqlalchemy
...
[local_deps]: app.services.storage_service, app.services.deduplication_service, app.models.audit, app.schemas.document, app.models.document, app.services.document_orchestrator, app.api.documents_common, app.models.user, app.api.deps, app.database
[ext_deps]: fastapi, uuid, logging, sqlalchemy, typing
...
[local_deps]: app.services.temporal_reasoning_service, app.services.progressive_revelation_service, app.services.synthesis_service, app.models.audit, app.api.deps, app.services.search_service, app.models.document, app.services.graph_rag_service, app.models.user, app.database
[ext_deps]: json, fastapi, uuid, logging, sqlalchemy, typing
...
[ext_deps]: os, datetime, redis, nats, httpx, fastapi, logging, asyncio, sqlalchemy, typing
...
[local_deps]: app.api.documents_upload, app.schemas.document, app.models.user, app.database
[ext_deps]: os, hmac, fastapi, logging, sqlalchemy
...
[local_deps]: app.models.knowledge_graph, app.services.relationship_service, app.api.deps, app.services.timeline_service, app.models.document, app.database, app.models.user, app.services.entity_extraction_service
[ext_deps]: datetime, fastapi, uuid, logging, sqlalchemy, typing
...
[local_deps]: app.services.space_service, app.models.note, app.schemas.note, app.models.note_audio, app.schemas.tag, app.api.deps, app.services.note_service, app.models.user, app.database
[ext_deps]: os, datetime, fastapi, uuid, logging, sqlalchemy
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.pipeline, app.celery_app, app.models.document, app.core.redis_url, app.api.deps, app.database
...
[local_deps]: app.schemas.push, app.models.push_subscription, app.api.deps, app.models.user, app.database
[ext_deps]: os, fastapi, uuid, logging, sqlalchemy
...
[ext_deps]: celery, typing, logging, fastapi
...
[local_deps]: app.services.input_guard, app.api.deps, app.services.search_agent, app.services.search_service, app.models.document, app.services.embed_client, app.services.search_models, app.models.user, app.database
[ext_deps]: json, time, fastapi, uuid, logging, asyncio, sqlalchemy
...
[ext_deps]: fastapi, uuid, logging, sqlalchemy, hashlib, pydantic
...
[local_deps]: app.models.note, app.schemas.collection, app.schemas.smart_folder, app.tasks.collection_report_tasks, app.celery_app, app.models.smart_folder, app.models.audit, app.tasks.smart_folder_tasks, app.models.user, app.api.deps, app.database
[ext_deps]: json, celery, fastapi, uuid, logging, asyncio, sqlalchemy, typing
...
[local_deps]: app.services.space_service, app.tasks.space_tasks, app.schemas.tag, app.api.deps, app.schemas.space, app.models.user, app.database
[ext_deps]: sqlalchemy, uuid, logging, fastapi
...
[local_deps]: app.tasks.pipeline_orchestrator, app.services.llm_gateway, app.api.deps, app.core.redis_url, app.models.user
...
[local_deps]: app.tasks.subscription_tasks, app.models.subscription, app.api.deps, app.schemas.subscription, app.models.user, app.database
[ext_deps]: sqlalchemy, uuid, logging, fastapi
[fn]: _parse_uuid(s)
...
[local_deps]: app.services.space_service, app.services.task_service, app.schemas.tag, app.schemas.task, app.api.deps, app.models.user, app.database
[ext_deps]: sqlalchemy, uuid, logging, fastapi
...
[local_deps]: app.models.note, app.models.note_audio, app.services.storage_service, app.api.deps, app.models.document, app.services.whisper_service, app.models.user
[ext_deps]: os, io, tempfile, fastapi, logging, uuid, asyncio, sqlalchemy
...
[ext_deps]: os, pathlib, pydantic_settings, logging, urllib, pydantic
...
[ext_deps]: os, json, time, httpx, logging, struct, cryptography, urllib, base64
...
[ext_deps]: os, collections, fastapi, dotenv, sqlalchemy, typing, pgvector
...
[ext_deps]: os, slowapi, urllib
[fn]: _limiter_redis_url()

---
### FILE: backend/app/main.py
[local_deps]: app.core.config, app.api, app.services.messaging, app.middleware.csrf, app.middleware.transaction, app.services.prometheus_metrics, app.limiter, app.services.llm_http_client, app.core.redis_url, app.middleware.rls, app.database
[ext_deps]: os, redis, time, slowapi, collections, fastapi, uuid, logging, contextlib, dotenv, starlette, uvicorn, threading, sqlalchemy, typing
...
[local_deps]: app.services.monitoring, app.api, app.services.embedding_service, app.services.cache_monitor, app.services.prometheus_metrics, app.core.redis_url, app.database
[ext_deps]: os, datetime, redis, time, httpx, fastapi, contextlib, logging, dotenv, uvicorn, sqlalchemy
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: logging, dataclasses, starlette, sqlalchemy, jose
...
[local_deps]: app.models.task, app.models.bookmark, app.models.space, app.models.user, app.models.processing, app.models.article, app.models.note_audio, app.models.failed_task, app.models.tag, app.models.note, app.models.pipeline, app.models.knowledge_graph, app.models.push_subscription, app.models.subscription, app.models.pattern_insight, app.models.collection, app.models.milestone, app.models.base, app.models.chat, app.models.audit, app.models.smart_folder, app.models.document
...
[ext_deps]: tenacity, time, httpx, collections, logging, asyncio, typing, functools
...
[local_deps]: app.schemas.smart_folder, app.schemas.pagination, app.schemas.admin, app.schemas.collection, app.schemas.search, app.schemas.user, app.schemas.chat, app.schemas.document, app.schemas.token

---
### FILE: backend/app/schemas/admin.py
[local_deps]: app.schemas.user
[ext_deps]: re, datetime, pydantic, uuid
...
[ext_deps]: datetime, enum, uuid, typing, pydantic
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: pydantic, typing, json, base64
...
[ext_deps]: pydantic, datetime, typing, uuid
...
[ext_deps]: pydantic, re, datetime, enum, uuid, typing
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.answer_agent, app.services.agents.clarification_agent
[ext_deps]: datetime, enum, time, collections, logging, dataclasses, typing
...
[ext_deps]: re, json, logging, dataclasses, typing
...
[local_deps]: app.services.agent_identity, app.services.knowledge_graph.traversal, app.services.llm_gateway, app.services.embed_client, app.services.search_service, app.services.knowledge_graph.models, app.services.graph_rag_service, app.services.knowledge_graph.pool
[ext_deps]: re, json, collections, logging, dataclasses, typing
...
[ext_deps]: json, httpx, logging, asyncio, hashlib, typing
...
[local_deps]: app.services.agent_identity, app.models.tag, app.services.llm_gateway, app.models.document
[ext_deps]: datetime, json, uuid, logging, warnings, sqlalchemy, typing
...
[local_deps]: app.services.agent_identity, app.services.cache_monitor, app.models.chat, app.services.prometheus_metrics, app.services.llm_gateway, app.services.search_service, app.services.pii_detection_service, app.models.document, app.services.context_block_service, app.models.user, app.database
[ext_deps]: re, json, time, collections, logging, uuid, asyncio, sqlalchemy, typing
...
[local_deps]: app.services.agent_identity, app.models.chat, app.models.audit, app.services.llm_gateway, app.models.collection, app.models.document, app.services.context_block_service, app.models.user
...
[local_deps]: app.schemas.collection, app.services.agent_identity, app.services.search_cache, app.services.intent_parser, app.services.llm_gateway, app.models.collection, app.services.search_service, app.models.document, app.models.user
[ext_deps]: datetime, uuid, logging, asyncio, sqlalchemy, typing
...
[ext_deps]: datetime, logging, sqlalchemy, difflib, hashlib
...
[local_deps]: app.services.llm_gateway
[ext_deps]: os, datetime, uuid, logging, typing
...
[ext_deps]: json, logging, asyncio, traceback, threading, sqlalchemy, typing
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.pipeline, app.services.storage_service, app.tasks.voice_tasks, app.tasks.pipeline_tasks, app.models.audit, app.schemas.document, app.models.document, app.models.user, app.services.deduplication_service
[ext_deps]: json, datetime, fastapi, logging, asyncio, sqlalchemy, typing, concurrent
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: os, time, httpx, logging, asyncio, random
[fn]: _base_urls()
...
[ext_deps]: os, sentence_transformers, logging, asyncio, threading, torch, numpy, psutil, typing, gc
...
[ext_deps]: os, pathlib, onnxruntime, logging, transformers, numpy
...
[ext_deps]: json, datetime, logging, asyncio, warnings, sqlalchemy, typing
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.llm_gateway, app.models.document, app.services.context_block_service
[ext_deps]: re, collections, logging, sqlalchemy, typing
...
[ext_deps]: re, redis, logging, dataclasses, hashlib
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: re, json, datetime, enum, logging, warnings, typing
...
[ext_deps]: os, json, datetime, tenacity, httpx, collections, logging, typing
...
[ext_deps]: json, __future__, logging, itertools, models, asyncpg, spacy
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, __future__, enum, uuid, pydantic
...
[ext_deps]: json, __future__, logging, extraction, models, asyncpg
...
[local_deps]: app.services.monitoring, app.services.user_quota, app.core.context, app.services.llm_router, app.services.semantic_cache
[ext_deps]: collections, typing, logging, asyncio
...
[local_deps]: app.services.minimax_service, app.services.ollama_service, app.services.openrouter_service, app.services.kimi_service, app.services.pii_detection_service
[ext_deps]: enum, collections, logging, dataclasses, typing
...
[ext_deps]: os, nats, collections, logging, asyncio, typing
...
[ext_deps]: os, json, httpx, collections, logging, typing
...
[ext_deps]: os, datetime, redis, prometheus_client, re, collections, logging, dataclasses, threading, psutil, subprocess, typing
...
[ext_deps]: os, io, cv2, PIL, enum, time, PyPDF2, logging, pytesseract, numpy, paddleocr, typing
...
[local_deps]: app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: os, tenacity, json, httpx, collections, logging, typing
...
[local_deps]: app.services.monitoring, app.services.cache_monitor, app.services.llm_http_client, app.services.openrouter_throttle, app.core.redis_url
[ext_deps]: os, json, datetime, tenacity, redis, httpx, collections, logging, asyncio, hashlib, typing
[fn]: _get_redis_client()
...
[ext_deps]: datetime, __future__, time, logging, typing
...
[ext_deps]: datetime, sentence_transformers, logging, psutil, sqlalchemy, typing
...
[ext_deps]: time, collections, logging, typing, functools
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway, app.models.collection, app.models.document, app.services.context_block_service, app.models.user
[ext_deps]: os, datetime, io, reportlab, uuid, logging, sqlalchemy, typing
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.agent_identity, app.services.search_cache, app.services.llm_router, app.services.search_service, app.models.document, app.services.context_block_service, app.models.user, app.database
[ext_deps]: re, json, time, search_models, logging, uuid, asyncio, sqlalchemy, typing
...
[local_deps]: app.core.redis_url
[ext_deps]: json, redis, logging, hashlib, typing
[fn]: _get_redis()
...
[local_deps]: app.services.rerank_service, app.services.search_cache, app.services.embed_client, app.services.pii_detection_service, app.models.document, app.models.user
...
[ext_deps]: json, __future__, time, logging, numpy, hashlib, typing
...
[ext_deps]: json, collections, logging, dataclasses, typing
...
[ext_deps]: re, logging, numpy, sqlalchemy, typing
...
[local_deps]: app.services.smart_folder.query_parser, app.services.smart_folder.analysis, app.services.smart_folder.entity_resolver, app.services.smart_folder.report_generator, app.services.smart_folder.retrieval
...
[local_deps]: app.services.smart_folder.agent.executor, app.services.smart_folder.query_parser, app.services.smart_folder.agent.planner, app.models.smart_folder, app.services.smart_folder.entity_resolver, app.services.smart_folder.report_generator, app.models.user, app.services.smart_folder.agent.synthesizer
[ext_deps]: re, uuid, logging, sqlalchemy, typing
...
[ext_deps]: datetime, uuid, logging, dataclasses, sqlalchemy, typing
...
[ext_deps]: logging, dataclasses, sqlalchemy, difflib, typing
...
[ext_deps]: json, datetime, logging, dataclasses, typing
...
[ext_deps]: re, json, logging, uuid, dataclasses, typing
...
[local_deps]: app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.base, app.services.smart_folder.skills.sentiment_tracker
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.skills.base, app.services.smart_folder.tools.table_extractor
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.report_generator, app.services.smart_folder.tools.document_reader, app.services.smart_folder.skills.base, app.services.smart_folder.retrieval
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.table_extractor
...
[ext_deps]: re, json, io, logging, typing, csv
...
[local_deps]: app.services.llm_gateway, app.models.collection, app.services.search_service, app.models.document, app.models.user
[ext_deps]: re, datetime, uuid, logging, sqlalchemy, typing
...
[ext_deps]: os, typing, logging, symspellpy
[fn]: _get_symspell()
...
[ext_deps]: os, datetime, pathlib, uuid, logging, cryptography, base64
...
[ext_deps]: os, json, datetime, pathlib, time, collections, logging, contextlib, sys, typing
...
[ext_deps]: abc, json, datetime, enum, nats, uuid, logging, asyncio, typing
...
[local_deps]: app.services.messaging
[ext_deps]: json, datetime, enum, time, nats, logging, dataclasses, hashlib, typing
...
[local_deps]: app.services.messaging
[ext_deps]: json, datetime, enum, nats, uuid, logging, dataclasses, asyncio, typing
...
[local_deps]: app.services.messaging
[ext_deps]: json, datetime, nats, logging, typing
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.llm_gateway, app.models.document, app.services.context_block_service
[ext_deps]: datetime, json, collections, logging, sqlalchemy, typing
...
[ext_deps]: os, json, datetime, httpx, logging
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: datetime, collections, logging, sqlalchemy, typing
...
[ext_deps]: os, pathlib, json, re, pptx, html, zipfile, docx, PyPDF2, logging, ebooklib, sys, xml, subprocess, typing, csv
...
[ext_deps]: logging, datetime, typing, __future__
...
[local_deps]: app.services.monitoring, app.tasks.pipeline_orchestrator, app.services.cache_monitor, app.tasks.base, app.celery_app, app.models.document, app.core.redis_url, app.database, app.services.alert_service, app.models.processing
[ext_deps]: os, datetime, redis, celery, logging, asyncio
...
[local_deps]: app.models.article, app.tasks.base, app.services.article_generation_service, app.services.embed_client, app.models.document, app.database
[ext_deps]: httpx, celery, uuid, logging, asyncio
...
[local_deps]: app.services.dlq_service, app.tasks.pipeline_orchestrator, app.services.context_block_service, app.tasks.base, app.services.ocr_service, app.services.text_extractor, app.services.prometheus_metrics, app.services.chunking_service, app.tasks.embedding_tasks, app.services.embed_client, app.models.document, app.tasks.article_tasks, app.services.collection_service, app.database, app.services.entity_extraction_service, app.models.processing
[ext_deps]: os, datetime, langdetect, tempfile, celery, uuid, logging, asyncio, traceback, sqlalchemy
...
[local_deps]: app.tasks.base, app.celery_app, app.services.embed_client, app.models.document, app.database
[ext_deps]: time, sentence_transformers, uuid, logging
...
[ext_deps]: os, datetime, redis, email, smtplib, logging, sqlalchemy
[fn]: _smtp_configured()
...
[ext_deps]: datetime, redis, celery, uuid, logging
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.pipeline, app.celery_app, app.models.document, app.core.redis_url, app.database
[ext_deps]: os, datetime, redis, logging, sqlalchemy
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.knowledge_graph.pool, app.services.dlq_service, app.tasks.document_tasks, app.models.pipeline, app.services.knowledge_graph.extraction, app.celery_app, app.services.ocr_service, app.services.text_extractor, app.services.chunking_service, app.services.embed_client, app.models.document, app.tasks.article_tasks, app.services.entity_extraction_service, app.database
[ext_deps]: os, datetime, tempfile, time, celery, uuid, logging, asyncio, traceback, gc
...
[ext_deps]: os, datetime, fpdf, time, celery, logging, openpyxl, sqlalchemy
...
[local_deps]: app.services.smart_folder_service, app.services.smart_folder.agent_runner, app.tasks.base, app.models.smart_folder, app.models.audit, app.models.document, app.models.user, app.database
[ext_deps]: datetime, json, celery, uuid, logging, asyncio, sqlalchemy, typing
...
[ext_deps]: os, datetime, email, smtplib, httpx, logging, sqlalchemy, calendar
...
[local_deps]: app.models.task, app.core.push, app.services.task_service, app.models.push_subscription, app.celery_app, app.database
...
[ext_deps]: os, tempfile, logging, asyncio, sqlalchemy
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: time, collections, logging, asyncio, threading, typing, functools
...
[ext_deps]: os, datetime, fastapi, logging, dotenv, bcrypt, sqlalchemy, typing, jose
