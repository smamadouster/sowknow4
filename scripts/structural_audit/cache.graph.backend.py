...
[local_deps]: app.api.documents_common, app.services.alert_service, app.database, app.utils.security, app.celery_app, app.services.storage_service, app.models.chat, app.services.embed_client, app.models.document, app.tasks.pipeline_orchestrator, app.models.audit, app.core.redis_url, app.models.pipeline, app.schemas.user, app.services.whisper_service, app.models.article, app.api.deps, app.models.user, app.tasks.pipeline_tasks, app.models.processing, app.models.failed_task, app.schemas.admin
[ext_deps]: logging, sqlalchemy, concurrent, asyncio, os, fastapi, redis, datetime, uuid, json, pydantic, typing
...
[local_deps]: app.api.deps, app.models.document, app.tasks.article_tasks, app.models.user, app.schemas.article, app.models.article
...
[local_deps]: app.api.deps, app.core.redis_url, app.services.token_blacklist, app.utils.constants, app.models.user, app.schemas.token, app.limiter, app.middleware.csrf, app.database, app.schemas.user, app.schemas.auth, app.utils.security
[ext_deps]: sqlalchemy, os, fastapi, redis, dotenv, time, hashlib, logging, uuid, datetime, httpx, secrets
...
[local_deps]: app.api.deps, app.services.space_service, app.services.bookmark_service, app.schemas.tag, app.models.user, app.database, app.schemas.bookmark
[ext_deps]: uuid, sqlalchemy, fastapi, logging
...
[local_deps]: app.services.chat_service, app.api.deps, app.schemas.chat, app.services.input_guard, app.models.user, app.limiter, app.database, app.models.chat
[ext_deps]: sqlalchemy, fastapi, logging, uuid, json
...
[local_deps]: app.services.collection_service, app.api.deps, app.models.audit, app.services.input_guard, app.models.user, app.services.collection_chat_service, app.services.llm_gateway, app.database, app.tasks.document_tasks, app.models.collection, app.models.article, app.schemas.collection
[ext_deps]: reportlab, sqlalchemy, datetime, io, fastapi, logging, uuid, json, typing
...
[local_deps]: app.api.documents_common, app.api.deps, app.models.document, app.tasks.pipeline_orchestrator, app.api.documents_upload, app.models.audit, app.models.pipeline, app.models.user, app.schemas.document, app.tasks.pipeline_tasks, app.services.storage_service, app.database, app.services.similarity_service, app.tasks.document_tasks, app.api.documents_journal, app.models.processing, app.tasks.embedding_tasks
[ext_deps]: logging, sqlalchemy, concurrent, asyncio, fastapi, datetime, uuid, typing
...
[local_deps]: app.models.document, app.core.redis_url, app.models.audit, app.tasks.pipeline_orchestrator, app.models.pipeline, app.models.user, app.schemas.document, app.tasks.pipeline_tasks
[ext_deps]: sqlalchemy, concurrent, datetime, asyncio, os, fastapi, redis, logging, uuid, json, mimetypes, pydantic, typing
...
[local_deps]: app.api.documents_common, app.api.deps, app.models.document, app.models.audit, app.models.user, app.schemas.document, app.services.storage_service, app.database, app.services.whisper_service
[ext_deps]: logging, sqlalchemy, os, fastapi, tempfile, datetime
...
[local_deps]: app.api.documents_common, app.api.deps, app.models.document, app.models.audit, app.services.deduplication_service, app.models.user, app.schemas.document, app.services.storage_service, app.services.document_orchestrator, app.database
...
[local_deps]: app.api.deps, app.models.document, app.models.audit, app.models.user, app.services.search_service, app.services.graph_rag_service, app.database, app.services.progressive_revelation_service, app.services.temporal_reasoning_service, app.services.synthesis_service
[ext_deps]: sqlalchemy, fastapi, logging, uuid, json, typing
...
[ext_deps]: logging, sqlalchemy, asyncio, os, fastapi, redis, nats, datetime, httpx, typing
...
[local_deps]: app.database, app.schemas.document, app.api.documents_upload, app.models.user
...
[local_deps]: app.api.deps, app.models.document, app.services.entity_extraction_service, app.models.user, app.models.knowledge_graph, app.services.timeline_service, app.database, app.services.relationship_service
[ext_deps]: sqlalchemy, fastapi, logging, uuid, datetime, typing
...
[local_deps]: app.schemas.note, app.models.note_audio, app.api.deps, app.services.space_service, app.models.note, app.schemas.tag, app.models.user, app.services.note_service, app.database
[ext_deps]: sqlalchemy, os, fastapi, logging, uuid, datetime
...
[local_deps]: app.api.deps, app.core.redis_url, app.tasks.pipeline_orchestrator, app.models.document, app.models.pipeline, app.database, app.celery_app
...
[local_deps]: app.api.deps, app.models.user, app.models.push_subscription, app.schemas.push, app.database
[ext_deps]: sqlalchemy, os, fastapi, logging, uuid
...
[local_deps]: app.api.deps, app.schemas.reports, app.models.user, app.tasks.report_tasks, app.celery_app
...
[local_deps]: app.services.search_models, app.api.deps, app.models.document, app.services.input_guard, app.models.user, app.services.search_service, app.database, app.services.search_agent
[ext_deps]: sqlalchemy, asyncio, fastapi, time, logging, uuid, json
...
[ext_deps]: sqlalchemy, fastapi, hashlib, logging, uuid, pydantic
...
[local_deps]: app.schemas.smart_folder, app.api.deps, app.models.audit, app.models.note, app.models.smart_folder, app.models.user, app.tasks.smart_folder_tasks, app.database, app.celery_app, app.tasks.collection_report_tasks, app.schemas.collection
[ext_deps]: sqlalchemy, asyncio, fastapi, celery, logging, uuid, json, typing
...
[local_deps]: app.api.deps, app.services.space_service, app.schemas.tag, app.models.user, app.schemas.space, app.database, app.tasks.space_tasks
[ext_deps]: uuid, sqlalchemy, fastapi, logging
...
[local_deps]: app.api.deps, app.models.subscription, app.models.user, app.database, app.tasks.subscription_tasks, app.schemas.subscription
[ext_deps]: uuid, sqlalchemy, fastapi, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.api.deps, app.services.space_service, app.schemas.tag, app.models.user, app.database, app.services.task_service, app.schemas.task
[ext_deps]: uuid, sqlalchemy, fastapi, logging
...
[local_deps]: app.models.note_audio, app.api.deps, app.models.document, app.models.note, app.models.user, app.services.storage_service, app.services.whisper_service
[ext_deps]: sqlalchemy, asyncio, io, os, fastapi, tempfile, logging, uuid
...
[ext_deps]: pathlib, pydantic_settings, os, urllib, logging, pydantic
...
[ext_deps]: os, time, base64, struct, urllib, logging, httpx, json, cryptography
...
[ext_deps]: sqlalchemy, os, fastapi, pgvector, dotenv, collections, typing
...
[local_deps]: app.core.redis_url, app.middleware.rls, app.limiter, app.services.prometheus_metrics, app.database, app.middleware.csrf, app.api, app.services.messaging, app.middleware.transaction
[ext_deps]: slowapi, sqlalchemy, uvicorn, threading, os, fastapi, time, dotenv, redis, starlette, collections, logging, uuid, contextlib, typing
...
[local_deps]: app.services.embedding_service, app.core.redis_url, app.services.monitoring, app.services.prometheus_metrics, app.database, app.api, app.services.cache_monitor
[ext_deps]: logging, sqlalchemy, uvicorn, os, fastapi, time, dotenv, redis, datetime, httpx, contextlib
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: sqlalchemy, starlette, logging, dataclasses, jose
...
[local_deps]: app.models.note_audio, app.models.base, app.models.task, app.models.note, app.models.pattern_insight, app.models.chat, app.models.document, app.models.audit, app.models.pipeline, app.models.push_subscription, app.models.milestone, app.models.article, app.models.bookmark, app.models.tag, app.models.space, app.models.subscription, app.models.smart_folder, app.models.user, app.models.knowledge_graph, app.models.collection, app.models.processing, app.models.failed_task
...
[local_deps]: app.models.base
[ext_deps]: enum, datetime, sqlalchemy, uuid
...
[ext_deps]: tenacity, asyncio, time, functools, collections, logging, httpx, typing
...
[local_deps]: app.database
[ext_deps]: sqlalchemy, functools, hashlib, json
...
[local_deps]: app.schemas.smart_folder, app.schemas.pagination, app.schemas.chat, app.schemas.token, app.schemas.document, app.schemas.search, app.schemas.user, app.schemas.collection, app.schemas.admin
...
[ext_deps]: enum, datetime, uuid, pydantic, typing
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: enum, datetime, uuid, re, pydantic, typing
[class]: UserRole { methods: [] }
...
[ext_deps]: logging, time, enum, collections, datetime, dataclasses, typing
...
[ext_deps]: json, logging, dataclasses, re, typing
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway, app.services.search_service, app.services.graph_rag_service, app.services.knowledge_graph.models, app.services.knowledge_graph.pool, app.services.knowledge_graph.traversal, app.services.embed_client
[ext_deps]: json, collections, logging, dataclasses, re, typing
...
[ext_deps]: asyncio, hashlib, logging, httpx, json, typing
...
[ext_deps]: logging, sqlalchemy, warnings, datetime, uuid, json, typing
...
[local_deps]: app.services.pii_detection_service, app.models.document, app.services.llm_router, app.services.agent_identity, app.services.context_block_service, app.models.user, app.services.llm_gateway, app.services.search_service, app.services.prometheus_metrics, app.database, app.services.cache_monitor, app.models.chat
[ext_deps]: sqlalchemy, asyncio, time, collections, logging, uuid, json, re, typing
...
[local_deps]: app.models.document, app.services.agent_identity, app.models.audit, app.services.context_block_service, app.models.user, app.services.llm_gateway, app.models.collection, app.models.chat
[ext_deps]: sqlalchemy, logging, uuid, json, typing
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.models.document, app.services.agent_identity, app.services.search_cache, app.models.user, app.services.llm_gateway, app.services.search_service, app.models.collection, app.services.intent_parser, app.schemas.collection
[ext_deps]: logging, sqlalchemy, asyncio, datetime, uuid, typing
...
[ext_deps]: logging, sqlalchemy, difflib, hashlib, datetime
...
[local_deps]: app.services.llm_gateway
[ext_deps]: logging, os, datetime, uuid, typing
...
[ext_deps]: sqlalchemy, threading, traceback, asyncio, logging, json, typing
...
[local_deps]: app.models.document, app.tasks.pipeline_orchestrator, app.models.audit, app.services.deduplication_service, app.models.pipeline, app.models.user, app.schemas.document, app.tasks.pipeline_tasks, app.services.storage_service, app.tasks.voice_tasks
[ext_deps]: logging, sqlalchemy, concurrent, asyncio, fastapi, datetime, json, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: logging, random, asyncio, os, time, httpx
[fn]: _base_urls()
...
[ext_deps]: numpy, threading, psutil, asyncio, os, gc, torch, logging, sentence_transformers, typing
...
[local_deps]: app.services.llm_gateway, app.models.document, app.services.agent_identity, app.models.knowledge_graph
[ext_deps]: logging, sqlalchemy, warnings, asyncio, datetime, json, typing
...
[local_deps]: app.models.document, app.services.agent_identity, app.services.context_block_service, app.services.llm_gateway, app.models.knowledge_graph
[ext_deps]: sqlalchemy, collections, logging, re, typing
...
[ext_deps]: redis, hashlib, logging, dataclasses, re
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: logging, warnings, enum, datetime, json, re, typing
...
[ext_deps]: logging, tenacity, os, collections, datetime, httpx, json, typing
...
[ext_deps]: itertools, models, __future__, spacy, asyncpg, logging, json
[fn]: _vec_to_str(vec)
...
[ext_deps]: models, extraction, __future__, asyncpg, logging, json
...
[ext_deps]: typing, collections, logging
...
[local_deps]: app.services.pii_detection_service, app.services.minimax_service, app.services.openrouter_service, app.services.ollama_service, app.services.kimi_service
...
[ext_deps]: asyncio, os, nats, collections, logging, typing
...
[ext_deps]: os, collections, logging, httpx, json, typing
...
[ext_deps]: logging, psutil, threading, os, redis, collections, datetime, prometheus_client, dataclasses, re, subprocess, typing
...
[ext_deps]: numpy, pytesseract, paddleocr, PyPDF2, io, PIL, os, time, enum, logging, cv2, typing
...
[local_deps]: app.services.base_llm_service
[ext_deps]: logging, tenacity, os, collections, httpx, json, typing
...
[ext_deps]: logging, datetime, tenacity, os, redis, collections, hashlib, httpx, json, typing
[fn]: _get_redis_client()
...
[ext_deps]: logging, sqlalchemy, psutil, datetime, sentence_transformers, typing
...
[local_deps]: app.models.document, app.services.agent_identity, app.models.user, app.services.llm_gateway, app.models.knowledge_graph
...
[ext_deps]: time, functools, collections, logging, typing
...
[local_deps]: app.models.document, app.services.agent_identity, app.services.context_block_service, app.models.user, app.services.llm_gateway, app.models.collection
[ext_deps]: reportlab, logging, sqlalchemy, os, io, uuid, datetime, typing
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.models.document, app.services.llm_router, app.services.agent_identity, app.services.context_block_service, app.services.search_cache, app.models.user, app.services.search_service, app.database
[ext_deps]: search_models, sqlalchemy, asyncio, time, logging, uuid, json, re, typing
...
[local_deps]: app.services.pii_detection_service, app.models.document, app.services.rerank_service, app.services.search_cache, app.models.user, app.services.embed_client
...
[ext_deps]: collections, logging, dataclasses, json, typing
...
[local_deps]: app.services.smart_folder.entity_resolver, app.models.smart_folder, app.models.user, app.services.smart_folder.agent.executor, app.services.smart_folder.query_parser, app.services.smart_folder.agent.planner, app.services.smart_folder.report_generator, app.services.smart_folder.agent.synthesizer
...
[local_deps]: app.services.llm_router
[ext_deps]: logging, datetime, dataclasses, json, typing
...
[ext_deps]: logging, uuid, dataclasses, json, re, typing
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.custom_query
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.retrieval, app.services.smart_folder.tools.document_reader, app.services.smart_folder.report_generator, app.services.smart_folder.analysis
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader
...
[local_deps]: app.models.document, app.models.user, app.services.llm_gateway, app.services.search_service, app.models.collection
...
[local_deps]: app.models.tag, app.models.space, app.models.document, app.models.note, app.models.user, app.models.bookmark
[ext_deps]: uuid, sqlalchemy, logging
[fn]: _escape_like(value)
...
[ext_deps]: pathlib, os, base64, logging, uuid, datetime, cryptography
...
[ext_deps]: pathlib, contextlib, datetime, os, time, sys, collections, logging, json, typing
...
[ext_deps]: abc, datetime, asyncio, nats, enum, logging, uuid, json, typing
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, time, nats, enum, hashlib, logging, dataclasses, json, typing
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, asyncio, nats, enum, logging, uuid, json, dataclasses, typing
...
[local_deps]: app.models.document, app.services.agent_identity, app.services.context_block_service, app.services.llm_gateway, app.models.knowledge_graph
[ext_deps]: logging, sqlalchemy, collections, datetime, json, typing
...
[ext_deps]: logging, datetime, os, httpx, json
...
[ext_deps]: pathlib, zipfile, PyPDF2, ebooklib, xml, os, csv, docx, pptx, sys, logging, html, json, subprocess, re, typing
...
[local_deps]: app.models.document, app.tasks.pipeline_orchestrator, app.core.redis_url, app.services.monitoring, app.tasks.base, app.services.alert_service, app.database, app.models.processing, app.services.cache_monitor, app.celery_app
[ext_deps]: logging, asyncio, os, redis, celery, datetime
...
[local_deps]: app.models.document, app.tasks.base, app.database, app.services.article_generation_service, app.models.article, app.services.embed_client
...
[local_deps]: app.models.document, app.tasks.pipeline_orchestrator, app.tasks.article_tasks, app.database, app.models.article, app.tasks.embedding_tasks
...
[ext_deps]: psutil, traceback, asyncio, os, logging
...
[local_deps]: app.models.audit, app.models.user, app.tasks.base, app.database, app.services.report_service
[ext_deps]: sqlalchemy, asyncio, celery, logging, uuid, json, typing
...
[local_deps]: app.services.collection_service, app.models.document, app.tasks.pipeline_orchestrator, app.services.ocr_service, app.services.text_extractor, app.services.chunking_service, app.services.entity_extraction_service, app.tasks.article_tasks, app.services.context_block_service, app.tasks.base, app.services.prometheus_metrics, app.services.dlq_service, app.database, app.models.processing, app.services.embed_client, app.tasks.embedding_tasks
[ext_deps]: logging, sqlalchemy, langdetect, asyncio, traceback, os, tempfile, celery, datetime, uuid
...
[local_deps]: app.models.document, app.tasks.base, app.database, app.services.embed_client, app.celery_app
...
[local_deps]: app.models.document, app.core.redis_url, app.models.pipeline, app.database, app.celery_app
[ext_deps]: logging, sqlalchemy, smtplib, os, redis, email, datetime
[fn]: _smtp_configured()
...
[ext_deps]: logging, redis, celery, datetime, uuid
...
[local_deps]: app.core.redis_url, app.tasks.pipeline_orchestrator, app.models.document, app.models.pipeline, app.database, app.celery_app
[ext_deps]: logging, sqlalchemy, os, redis, datetime
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.models.document, app.services.ocr_service, app.services.text_extractor, app.services.chunking_service, app.models.pipeline, app.tasks.article_tasks, app.services.entity_extraction_service, app.services.knowledge_graph.extraction, app.services.dlq_service, app.database, app.tasks.document_tasks, app.services.knowledge_graph.pool, app.services.embed_client, app.celery_app
[ext_deps]: asyncio, traceback, os, time, tempfile, celery, gc, logging, uuid, datetime
...
[ext_deps]: logging, sqlalchemy, os, time, celery, openpyxl, fpdf, datetime
...
[local_deps]: app.services.smart_folder_service, app.models.document, app.models.audit, app.models.smart_folder, app.models.user, app.services.smart_folder.agent_runner, app.tasks.base, app.database
[ext_deps]: sqlalchemy, json, asyncio, celery, logging, uuid, datetime, typing
...
[local_deps]: app.database, app.models.subscription, app.models.user, app.celery_app
[ext_deps]: logging, sqlalchemy, smtplib, os, email, datetime, calendar, httpx
...
[local_deps]: app.core.push, app.models.push_subscription, app.database, app.services.task_service, app.models.task, app.celery_app
...
[ext_deps]: sqlalchemy, asyncio, os, tempfile, logging
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: threading, asyncio, time, functools, collections, logging, typing
...
[ext_deps]: logging, sqlalchemy, bcrypt, os, fastapi, dotenv, datetime, jose, typing
