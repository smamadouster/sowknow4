...
[local_deps]: app.services.whisper_service, app.core.redis_url, app.models.chat, app.tasks.pipeline_orchestrator, app.schemas.admin, app.models.processing, app.services.storage_service, app.services.search_service, app.models.failed_task, app.models.audit, app.utils.security, app.tasks.pipeline_tasks, app.celery_app, app.models.article, app.services.alert_service, app.api.documents_common, app.models.user, app.api.deps, app.services.embed_client, app.models.pipeline, app.models.document, app.database, app.schemas.user
[ext_deps]: datetime, concurrent, redis, fastapi, urllib, logging, json, pydantic, time, typing, uuid, sqlalchemy, os, asyncio
...
[local_deps]: app.schemas.article, app.api.deps, app.tasks.article_tasks, app.models.article, app.models.document, app.models.user
...
[local_deps]: app.schemas.auth, app.limiter, app.api.deps, app.services.token_blacklist, app.utils.security, app.utils.constants, app.core.redis_url, app.middleware.csrf, app.schemas.user, app.schemas.token, app.database, app.models.user
[ext_deps]: datetime, secrets, hashlib, redis, httpx, hmac, fastapi, logging, time, uuid, dotenv, sqlalchemy, os
...
[local_deps]: app.services.bookmark_service, app.api.deps, app.schemas.bookmark, app.schemas.tag, app.services.space_service, app.database, app.models.user
[ext_deps]: uuid, sqlalchemy, fastapi, logging
...
[local_deps]: app.limiter, app.services.input_guard, app.api.deps, app.schemas.chat, app.services.chat_service, app.models.chat, app.database, app.models.user
[ext_deps]: fastapi, logging, json, uuid, sqlalchemy
...
[local_deps]: app.models.collection, app.services.collection_service, app.models.audit, app.services.input_guard, app.tasks.document_tasks, app.api.deps, app.schemas.collection, app.services.llm_gateway, app.models.article, app.services.collection_chat_service, app.database, app.models.user
[ext_deps]: datetime, io, reportlab, fastapi, logging, json, typing, uuid, sqlalchemy
...
[local_deps]: app.database, app.services.token_blacklist, app.utils.security, app.utils.constants, app.models.user
...
[local_deps]: app.tasks.embedding_tasks, app.tasks.document_tasks, app.services.semantic_cache, app.tasks.pipeline_orchestrator, app.models.processing, app.services.storage_service, app.services.search_service, app.api.documents_journal, app.models.audit, app.tasks.pipeline_tasks, app.services.similarity_service, app.api.documents_common, app.models.user, app.api.deps, app.schemas.document, app.api.documents_upload, app.models.pipeline, app.models.document, app.database
[ext_deps]: datetime, concurrent, fastapi, logging, time, typing, uuid, sqlalchemy, asyncio
...
[local_deps]: app.models.audit, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.schemas.document, app.core.redis_url, app.models.pipeline, app.models.document, app.models.user
[ext_deps]: datetime, redis, concurrent, fastapi, logging, uuid, json, pydantic, typing, asyncio, sqlalchemy, os, mimetypes
...
[local_deps]: app.services.whisper_service, app.models.audit, app.api.deps, app.schemas.document, app.services.storage_service, app.api.documents_common, app.models.document, app.database, app.models.user
[ext_deps]: datetime, fastapi, logging, tempfile, sqlalchemy, os
...
[local_deps]: app.models.audit, app.services.semantic_cache, app.api.deps, app.schemas.document, app.services.deduplication_service, app.services.storage_service, app.api.documents_common, app.services.document_orchestrator, app.models.document, app.database, app.models.user
[ext_deps]: fastapi, logging, typing, uuid, sqlalchemy
...
[local_deps]: app.services.graph_rag_service, app.models.audit, app.api.deps, app.services.progressive_revelation_service, app.services.synthesis_service, app.services.temporal_reasoning_service, app.services.search_service, app.models.document, app.database, app.models.user
[ext_deps]: fastapi, logging, json, typing, uuid, sqlalchemy
...
[ext_deps]: datetime, redis, httpx, nats, fastapi, logging, typing, asyncio, sqlalchemy, os
...
[local_deps]: app.api.documents_upload, app.schemas.document, app.database, app.models.user
[ext_deps]: hmac, fastapi, logging, sqlalchemy, os
...
[local_deps]: app.models.knowledge_graph, app.api.deps, app.services.entity_extraction_service, app.services.timeline_service, app.services.relationship_service, app.models.document, app.database, app.models.user
[ext_deps]: datetime, fastapi, logging, typing, uuid, sqlalchemy
...
[local_deps]: app.services.monitoring, app.services.prometheus_metrics, app.services.cache_monitor, app.services.embedding_service, app.core.redis_url, app.main
[ext_deps]: datetime, redis, fastapi, logging, time, typing, os
[fn]: _get_redis_info()
...
[local_deps]: app.services.note_service, app.models.note, app.api.deps, app.schemas.tag, app.models.note_audio, app.schemas.note, app.services.space_service, app.database, app.models.user
[ext_deps]: datetime, fastapi, logging, uuid, sqlalchemy, os
...
[local_deps]: app.tasks.pipeline_orchestrator, app.api.deps, app.celery_app, app.core.redis_url, app.models.pipeline, app.models.document, app.database
[ext_deps]: asyncio, sqlalchemy, fastapi, redis
[async_fn]: pipeline_status(db)
[async_fn]: retry_failed_pipeline_stages(stage, limit, db)

---
### FILE: backend/app/api/push.py
[local_deps]: app.models.push_subscription, app.api.deps, app.schemas.push, app.database, app.models.user
[ext_deps]: fastapi, logging, uuid, sqlalchemy, os
...
[local_deps]: app.schemas.reports, app.api.deps, app.celery_app, app.tasks.report_tasks, app.models.user
...
[local_deps]: app.services.input_guard, app.api.deps, app.services.embed_client, app.services.search_agent, app.services.agents.agent_orchestrator, app.services.search_models, app.services.search_service, app.models.document, app.database, app.models.user
[ext_deps]: fastapi, logging, json, time, asyncio, sqlalchemy, uuid
...
[ext_deps]: hashlib, fastapi, logging, pydantic, uuid, sqlalchemy
...
[local_deps]: app.api.deps, app.models.document, app.database, app.models.user
[ext_deps]: sqlalchemy, fastapi, logging
...
[local_deps]: app.tasks.collection_report_tasks, app.models.note, app.models.audit, app.schemas.smart_folder, app.api.deps, app.schemas.collection, app.models.smart_folder, app.celery_app, app.tasks.smart_folder_tasks, app.database, app.models.user
[ext_deps]: celery, fastapi, logging, json, typing, uuid, sqlalchemy, asyncio
...
[local_deps]: app.tasks.space_tasks, app.api.deps, app.schemas.tag, app.services.space_service, app.schemas.space, app.database, app.models.user
[ext_deps]: uuid, sqlalchemy, fastapi, logging
...
[local_deps]: app.tasks.pipeline_orchestrator, app.api.deps, app.services.rollback_monitor, app.core.redis_url, app.services.llm_gateway, app.models.user
...
[local_deps]: app.api.deps, app.schemas.subscription, app.tasks.subscription_tasks, app.models.subscription, app.database, app.models.user
[ext_deps]: uuid, sqlalchemy, fastapi, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.services.task_service, app.api.deps, app.schemas.tag, app.schemas.task, app.services.space_service, app.database, app.models.user
[ext_deps]: uuid, sqlalchemy, fastapi, logging
...
[local_deps]: app.services.whisper_service, app.models.note, app.api.deps, app.models.note_audio, app.services.storage_service, app.models.document, app.models.user
[ext_deps]: io, fastapi, logging, tempfile, asyncio, sqlalchemy, os, uuid
...
[ext_deps]: pathlib, urllib, logging, pydantic_settings, pydantic, os
...
[ext_deps]: httpx, base64, urllib, logging, json, time, struct, cryptography, os
...
[ext_deps]: pgvector, fastapi, collections, typing, dotenv, sqlalchemy, os
...
[ext_deps]: starlette, urllib, slowapi, os
[fn]: _limiter_redis_url()
[fn]: _get_client_ip(request)

---
### FILE: backend/app/main.py
[local_deps]: app.services.monitoring, app.services.prometheus_metrics, app.services.search_cache, app.api, app.limiter, app.middleware.rls, app.core.redis_url, app.middleware.csrf, app.core.config, app.services.llm_http_client, app.services.openrouter_service, app.middleware.transaction, app.database
[ext_deps]: starlette, redis, slowapi, fastapi, typing, logging, collections, threading, time, uvicorn, contextlib, uuid, dotenv, sqlalchemy, os
...
[ext_deps]: hmac, secrets, logging, starlette
...
[ext_deps]: starlette, dataclasses, logging, jose, sqlalchemy
...
[local_deps]: app.models.collection, app.models.smart_folder, app.models.bookmark, app.models.base, app.models.chat, app.models.push_subscription, app.models.knowledge_graph, app.models.note_audio, app.models.processing, app.models.pattern_insight, app.models.failed_task, app.models.audit, app.models.space, app.models.milestone, app.models.article, app.models.user, app.models.note, app.models.document, app.models.tag, app.models.task, app.models.pipeline, app.models.subscription
...
[ext_deps]: httpx, logging, collections, time, typing, asyncio, tenacity, functools
...
[local_deps]: app.schemas.pagination, app.schemas.smart_folder, app.schemas.collection, app.schemas.document, app.schemas.admin, app.schemas.chat, app.schemas.token, app.schemas.search, app.schemas.user
...
[ext_deps]: uuid, pydantic, datetime, enum
[class]: BookmarkBucket { methods: [] }
...
[ext_deps]: datetime, enum, pydantic, typing, uuid
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: datetime, re, enum, pydantic, typing, uuid
[class]: UserRole { methods: [] }
...
[ext_deps]: openpyxl, json, sys, xlrd
...
[ext_deps]: datetime, dataclasses, enum, logging, collections, time, typing
...
[ext_deps]: re, dataclasses, logging, json, typing
...
[local_deps]: app.services.knowledge_graph.models, app.services.graph_rag_service, app.services.agent_identity, app.services.embed_client, app.services.knowledge_graph.pool, app.services.llm_gateway, app.services.knowledge_graph.traversal, app.services.search_service
[ext_deps]: re, dataclasses, logging, collections, json, typing
...
[ext_deps]: hashlib, httpx, logging, json, typing, asyncio
...
[ext_deps]: datetime, warnings, logging, json, typing, uuid, sqlalchemy
...
[ext_deps]: uuid, sqlalchemy, urllib, logging
...
[local_deps]: app.services.prometheus_metrics, app.services.cache_monitor, app.models.document, app.services.agent_identity, app.services.context_block_service, app.services.pii_detection_service, app.services.llm_gateway, app.models.chat, app.services.search_service, app.database, app.models.user
[ext_deps]: re, logging, collections, json, time, typing, asyncio, sqlalchemy, uuid
...
[local_deps]: app.models.collection, app.models.audit, app.services.agent_identity, app.services.context_block_service, app.services.llm_gateway, app.models.chat, app.models.document, app.models.user
[ext_deps]: logging, json, typing, uuid, sqlalchemy
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.search_cache, app.models.collection, app.services.agent_identity, app.services.intent_parser, app.schemas.collection, app.services.llm_gateway, app.services.search_service, app.models.document, app.models.user
[ext_deps]: datetime, logging, typing, uuid, sqlalchemy, asyncio
...
[ext_deps]: datetime, hashlib, logging, difflib, sqlalchemy
...
[local_deps]: app.services.llm_gateway
[ext_deps]: datetime, logging, typing, uuid, os
...
[ext_deps]: logging, json, threading, typing, asyncio, sqlalchemy, traceback
...
[local_deps]: app.models.audit, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.schemas.document, app.services.deduplication_service, app.tasks.voice_tasks, app.services.storage_service, app.models.pipeline, app.models.document, app.models.user
[ext_deps]: datetime, concurrent, fastapi, logging, json, typing, asyncio, sqlalchemy
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: httpx, logging, time, asyncio, os, atexit, random
[fn]: _base_urls()
...
[ext_deps]: gc, numpy, torch, sentence_transformers, logging, threading, psutil, typing, asyncio, os
...
[ext_deps]: numpy, pathlib, logging, transformers, os, onnxruntime
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.rollback_monitor, app.services.llm_gateway, app.models.document
[ext_deps]: datetime, warnings, logging, json, typing, asyncio, sqlalchemy
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.context_block_service, app.services.llm_gateway, app.models.document
[ext_deps]: re, logging, collections, typing, sqlalchemy
...
[ext_deps]: redis, hashlib, re, dataclasses, logging
...
[ext_deps]: datetime, re, enum, warnings, logging, json, typing
...
[ext_deps]: datetime, httpx, logging, collections, json, typing, tenacity, os
...
[ext_deps]: models, spacy, __future__, itertools, logging, json, asyncpg
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, __future__, enum, pydantic, uuid
...
[ext_deps]: extraction, models, __future__, logging, json, asyncpg
...
[local_deps]: app.services.monitoring, app.services.user_quota, app.services.semantic_cache, app.services.token_utils, app.services.rollback_monitor, app.services.llm_router, app.core.context
[ext_deps]: logging, collections, time, typing, asyncio
...
[ext_deps]: dataclasses, enum, logging, collections, typing
...
[ext_deps]: nats, logging, collections, typing, asyncio, os
...
[ext_deps]: httpx, logging, collections, json, typing, os
...
[ext_deps]: datetime, redis, re, dataclasses, prometheus_client, logging, collections, threading, psutil, typing, subprocess, os
...
[ext_deps]: PyPDF2, io, numpy, pytesseract, enum, logging, cv2, paddleocr, time, typing, PIL, os
...
[ext_deps]: httpx, logging, collections, json, typing, tenacity, os
...
[local_deps]: app.services.monitoring, app.services.prometheus_metrics, app.services.cache_monitor, app.services.token_utils, app.core.redis_url, app.services.openrouter_throttle, app.services.llm_http_client
[ext_deps]: datetime, redis, hashlib, httpx, logging, collections, json, typing, asyncio, tenacity, os
...
[ext_deps]: datetime, sentence_transformers, logging, psutil, typing, sqlalchemy
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.llm_gateway, app.models.document, app.models.user
...
[local_deps]: app.services.monitoring, app.models.collection, app.services.agent_identity, app.services.context_block_service, app.services.rollback_monitor, app.services.llm_gateway, app.models.document, app.models.user
[ext_deps]: datetime, io, reportlab, logging, typing, uuid, sqlalchemy, os
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.core.redis_url
[ext_deps]: datetime, redis, logging, collections, time, typing, os
[fn]: _get_redis()
...
[local_deps]: app.services.search_cache, app.services.agent_identity, app.services.context_block_service, app.services.llm_router, app.services.search_service, app.models.document, app.database, app.models.user
[ext_deps]: re, logging, search_models, json, time, typing, asyncio, sqlalchemy, uuid
...
[ext_deps]: redis, hashlib, logging, json, typing
[fn]: close_redis_client()
[fn]: _get_redis()
...
[local_deps]: app.services.search_cache, app.services.embed_client, app.services.pii_detection_service, app.services.rerank_service, app.models.document, app.models.user
[ext_deps]: re, logging, typing, asyncio, sqlalchemy
...
[ext_deps]: hashlib, numpy, __future__, logging, json, time, typing, os
...
[ext_deps]: numpy, re, logging, typing, sqlalchemy
...
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.entity_resolver, app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.query_parser
...
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.agent.planner, app.models.user, app.models.smart_folder, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.query_parser, app.services.smart_folder.agent.executor
[ext_deps]: re, logging, typing, uuid, sqlalchemy
...
[ext_deps]: datetime, dataclasses, logging, typing, uuid, sqlalchemy
...
[ext_deps]: dataclasses, logging, difflib, typing, sqlalchemy
...
[ext_deps]: re, dataclasses, logging, json, typing, uuid
...
[local_deps]: app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.base, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.project_postmortem
...
[local_deps]: app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.skills.base, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.asset_reader
[ext_deps]: logging, typing
...
[local_deps]: app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.asset_reader
...
[ext_deps]: io, re, logging, csv, json, typing
...
[ext_deps]: datetime, re, logging, typing, uuid, sqlalchemy
...
[ext_deps]: datetime, pathlib, base64, logging, uuid, cryptography, os
...
[ext_deps]: datetime, pathlib, sys, typing, logging, collections, json, time, contextlib, os
...
[ext_deps]: datetime, nats, abc, enum, logging, json, typing, asyncio, uuid
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, hashlib, nats, dataclasses, enum, logging, json, time, typing
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, nats, dataclasses, enum, logging, json, typing, asyncio, uuid
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.context_block_service, app.services.rollback_monitor, app.services.llm_gateway, app.models.document
[ext_deps]: datetime, logging, collections, json, typing, sqlalchemy
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: datetime, logging, collections, typing, sqlalchemy
...
[ext_deps]: pptx, docx, pathlib, html, sys, re, logging, csv, json, zipfile, xml, ebooklib, typing, subprocess, PyPDF2, os
...
[local_deps]: app.services.token_utils, app.services.llm_http_client, app.services.base_llm_service
[ext_deps]: datetime, httpx, logging, collections, json, typing, os
...
[ext_deps]: asyncio, os, faster_whisper, logging
...
[local_deps]: app.services.monitoring, app.services.cache_monitor, app.tasks.pipeline_orchestrator, app.celery_app, app.core.redis_url, app.tasks.base, app.models.processing, app.services.alert_service, app.models.document, app.database
[ext_deps]: datetime, redis, celery, logging, asyncio, os
...
[local_deps]: app.services.article_generation_service, app.services.embed_client, app.tasks.base, app.models.article, app.models.document, app.database
[ext_deps]: httpx, celery, logging, asyncio, uuid
...
[local_deps]: app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.tasks.article_tasks, app.models.article, app.models.document, app.database
...
[local_deps]: app.models.audit, app.tasks.base, app.services.report_service, app.database, app.models.user
[ext_deps]: celery, logging, json, typing, asyncio, sqlalchemy, uuid
...
[local_deps]: app.services.prometheus_metrics, app.services.collection_service, app.services.text_extractor, app.tasks.pipeline_orchestrator, app.tasks.embedding_tasks, app.services.entity_extraction_service, app.tasks.article_tasks, app.services.context_block_service, app.services.embed_client, app.services.dlq_service, app.services.ocr_service, app.services.auto_tagging_service, app.tasks.base, app.models.processing, app.services.chunking_service, app.models.document, app.database
[ext_deps]: datetime, celery, logging, tempfile, uuid, sqlalchemy, langdetect, traceback, os, asyncio
...
[local_deps]: app.services.embed_client, app.celery_app, app.tasks.base, app.models.document, app.database
...
[local_deps]: app.celery_app, app.core.redis_url, app.models.pipeline, app.models.document, app.database
[ext_deps]: datetime, redis, logging, email, smtplib, sqlalchemy, os
[fn]: _smtp_configured()
...
[ext_deps]: datetime, redis, celery, logging, uuid
...
[local_deps]: app.tasks.pipeline_orchestrator, app.celery_app, app.core.redis_url, app.models.pipeline, app.models.document, app.database
[ext_deps]: datetime, redis, logging, sqlalchemy, os
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.knowledge_graph.extraction, app.services.text_extractor, app.tasks.document_tasks, app.services.dlq_service, app.services.entity_extraction_service, app.tasks.article_tasks, app.services.embed_client, app.services.knowledge_graph.pool, app.services.ocr_service, app.celery_app, app.models.pipeline, app.services.chunking_service, app.models.document, app.database
[ext_deps]: datetime, gc, celery, logging, time, tempfile, asyncio, sqlalchemy, traceback, os, uuid
...
[ext_deps]: openpyxl, fpdf, datetime, celery, logging, time, sqlalchemy, os
...
[local_deps]: app.services.smart_folder_service, app.models.audit, app.models.smart_folder, app.services.smart_folder.agent_runner, app.tasks.base, app.models.document, app.database, app.models.user
[ext_deps]: datetime, celery, logging, json, typing, asyncio, sqlalchemy, uuid
...
[local_deps]: app.services.space_service, app.tasks.base, app.database, app.models.space
...
[ext_deps]: datetime, httpx, logging, calendar, email, smtplib, sqlalchemy, os
...
[local_deps]: app.models.push_subscription, app.services.task_service, app.core.push, app.models.task, app.celery_app, app.database
...
[ext_deps]: logging, tempfile, asyncio, sqlalchemy, os
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: logging, collections, threading, time, typing, asyncio, functools
...
[ext_deps]: datetime, fastapi, logging, jose, bcrypt, typing, dotenv, sqlalchemy, os
