...
[local_deps]: app.models.document, app.services.whisper_service, app.models.pipeline, app.core.redis_url, app.services.embed_client, app.api.deps, app.services.search_service, app.models.article, app.services.storage_service, app.models.user, app.models.processing, app.database, app.api.documents_common, app.models.failed_task, app.models.chat, app.schemas.user, app.celery_app, app.tasks.pipeline_orchestrator, app.models.audit, app.utils.security, app.tasks.pipeline_tasks, app.services.alert_service, app.schemas.admin
[ext_deps]: datetime, fastapi, uuid, typing, json, concurrent, pydantic, redis, sqlalchemy, urllib, asyncio, os, logging, time
...
[local_deps]: app.models.document, app.schemas.article, app.api.deps, app.models.article, app.models.user, app.tasks.article_tasks
[ext_deps]: fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.schemas.auth, app.services.token_blacklist, app.schemas.token, app.core.redis_url, app.middleware.csrf, app.api.deps, app.schemas.user, app.utils.security, app.models.user, app.utils.constants, app.database, app.limiter
[ext_deps]: datetime, fastapi, uuid, hmac, redis, sqlalchemy, hashlib, secrets, time, os, httpx, logging, dotenv
...
[local_deps]: app.services.space_service, app.services.bookmark_service, app.api.deps, app.schemas.bookmark, app.schemas.tag, app.models.user, app.database
[ext_deps]: fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.api.deps, app.services.input_guard, app.models.chat, app.services.chat_service, app.models.user, app.schemas.chat, app.database, app.limiter
...
[local_deps]: app.services.collection_service, app.schemas.collection, app.api.deps, app.services.input_guard, app.models.collection, app.models.article, app.services.llm_gateway, app.models.user, app.tasks.document_tasks, app.services.collection_chat_service, app.models.audit, app.database
[ext_deps]: fastapi, datetime, io, uuid, typing, json, reportlab, sqlalchemy, logging
...
[local_deps]: app.models.document, app.services.similarity_service, app.schemas.document, app.models.pipeline, app.api.deps, app.services.search_service, app.services.storage_service, app.models.user, app.models.processing, app.database, app.api.documents_common, app.api.documents_journal, app.api.documents_upload, app.tasks.pipeline_orchestrator, app.models.audit, app.services.semantic_cache, app.tasks.embedding_tasks, app.tasks.pipeline_tasks, app.tasks.document_tasks
[ext_deps]: fastapi, datetime, typing, uuid, concurrent, sqlalchemy, asyncio, logging, time
...
[local_deps]: app.models.document, app.schemas.document, app.models.pipeline, app.core.redis_url, app.models.user, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.audit
[ext_deps]: datetime, fastapi, uuid, typing, json, concurrent, mimetypes, pydantic, sqlalchemy, redis, asyncio, os, logging
...
[local_deps]: app.api.documents_common, app.models.document, app.schemas.document, app.services.whisper_service, app.api.deps, app.services.storage_service, app.models.user, app.models.audit, app.database
[ext_deps]: datetime, fastapi, tempfile, sqlalchemy, os, logging
...
[local_deps]: app.api.documents_common, app.models.document, app.services.semantic_cache, app.schemas.document, app.services.deduplication_service, app.api.deps, app.services.document_orchestrator, app.services.storage_service, app.models.user, app.models.audit, app.database
...
[local_deps]: app.services.progressive_revelation_service, app.models.document, app.services.synthesis_service, app.api.deps, app.services.search_service, app.models.user, app.services.temporal_reasoning_service, app.services.graph_rag_service, app.models.audit, app.database
[ext_deps]: fastapi, uuid, typing, json, sqlalchemy, logging
...
[ext_deps]: datetime, fastapi, nats, typing, redis, sqlalchemy, asyncio, os, httpx, logging
...
[local_deps]: app.schemas.document, app.models.user, app.api.documents_upload, app.database
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.services.timeline_service, app.api.deps, app.services.entity_extraction_service, app.models.user, app.services.relationship_service, app.database
[ext_deps]: fastapi, datetime, uuid, typing, sqlalchemy, logging
...
[local_deps]: app.services.prometheus_metrics, app.core.redis_url, app.services.monitoring, app.services.cache_monitor, app.main, app.services.embedding_service
[ext_deps]: datetime, fastapi, typing, redis, os, logging, time
[fn]: _get_redis_info()
...
[local_deps]: app.services.space_service, app.models.note, app.api.deps, app.schemas.note, app.schemas.tag, app.models.user, app.services.note_service, app.models.note_audio, app.database
[ext_deps]: fastapi, datetime, uuid, sqlalchemy, os, logging
...
[local_deps]: app.models.document, app.models.pipeline, app.core.redis_url, app.api.deps, app.celery_app, app.tasks.pipeline_orchestrator, app.database
...
[local_deps]: app.schemas.push, app.api.deps, app.models.user, app.models.push_subscription, app.database
[ext_deps]: fastapi, uuid, sqlalchemy, os, logging
...
[local_deps]: app.models.document, app.services.search_agent, app.services.agents.agent_orchestrator, app.services.embed_client, app.api.deps, app.services.input_guard, app.services.search_service, app.services.search_models, app.models.user, app.database
[ext_deps]: fastapi, uuid, json, sqlalchemy, asyncio, logging, time
...
[ext_deps]: fastapi, uuid, pydantic, sqlalchemy, hashlib, logging
...
[local_deps]: app.tasks.smart_folder_tasks, app.models.note, app.schemas.collection, app.api.deps, app.schemas.smart_folder, app.celery_app, app.tasks.collection_report_tasks, app.models.user, app.models.smart_folder, app.models.audit, app.database
[ext_deps]: fastapi, celery, uuid, typing, json, sqlalchemy, asyncio, logging
...
[local_deps]: app.services.space_service, app.schemas.space, app.api.deps, app.tasks.space_tasks, app.schemas.tag, app.models.user, app.database
[ext_deps]: fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.core.redis_url, app.api.deps, app.services.rollback_monitor, app.services.llm_gateway, app.models.user, app.tasks.pipeline_orchestrator
...
[local_deps]: app.api.deps, app.models.subscription, app.tasks.subscription_tasks, app.models.user, app.schemas.subscription, app.database
[ext_deps]: fastapi, logging, sqlalchemy, uuid
[fn]: _parse_uuid(s)
...
[local_deps]: app.services.space_service, app.services.task_service, app.api.deps, app.schemas.tag, app.models.user, app.schemas.task, app.database
[ext_deps]: fastapi, logging, sqlalchemy, uuid
...
[local_deps]: app.models.document, app.models.note, app.api.deps, app.services.storage_service, app.models.user, app.services.whisper_service, app.models.note_audio
[ext_deps]: fastapi, io, uuid, tempfile, sqlalchemy, asyncio, os, logging
...
[ext_deps]: pathlib, pydantic, urllib, os, logging, pydantic_settings
...
[ext_deps]: base64, json, struct, urllib, cryptography, os, httpx, logging, time
...
[ext_deps]: fastapi, typing, collections, sqlalchemy, os, pgvector, dotenv
...
[ext_deps]: os, urllib, slowapi, starlette
[fn]: _limiter_redis_url()
[fn]: _get_client_ip(request)

---
### FILE: backend/app/main.py
[local_deps]: app.services.openrouter_service, app.services.search_cache, app.middleware.transaction, app.services.prometheus_metrics, app.core.redis_url, app.middleware.csrf, app.services.monitoring, app.api, app.middleware.rls, app.services.llm_http_client, app.core.config, app.database, app.limiter
[ext_deps]: starlette, fastapi, threading, uuid, typing, uvicorn, contextlib, slowapi, redis, collections, sqlalchemy, dotenv, os, logging, time
...
[ext_deps]: starlette, dataclasses, sqlalchemy, jose, logging
...
[local_deps]: app.models.document, app.models.milestone, app.models.pattern_insight, app.models.task, app.models.space, app.models.knowledge_graph, app.models.pipeline, app.models.note, app.models.base, app.models.article, app.models.user, app.models.smart_folder, app.models.processing, app.models.note_audio, app.models.bookmark, app.models.failed_task, app.models.collection, app.models.chat, app.models.audit, app.models.subscription, app.models.push_subscription, app.models.tag
...
[local_deps]: app.models.base
[ext_deps]: uuid, pgvector, enum, sqlalchemy
...
[ext_deps]: functools, typing, collections, asyncio, httpx, tenacity, logging, time
...
[local_deps]: app.schemas.document, app.schemas.token, app.schemas.collection, app.schemas.pagination, app.schemas.smart_folder, app.schemas.user, app.schemas.chat, app.schemas.search, app.schemas.admin

---
### FILE: backend/app/schemas/admin.py
[local_deps]: app.schemas.user
[ext_deps]: datetime, re, pydantic, uuid
...
[ext_deps]: datetime, pydantic, enum, uuid
[class]: BookmarkBucket { methods: [] }
...
[ext_deps]: datetime, uuid, typing, pydantic, enum
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: datetime, typing, uuid, pydantic, re, enum
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.agent_orchestrator, app.services.agents.answer_agent, app.services.agents.clarification_agent, app.services.agents.researcher_agent, app.services.agents.verification_agent
...
[ext_deps]: datetime, dataclasses, typing, collections, enum, logging, time
...
[ext_deps]: dataclasses, typing, json, re, logging
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: json, logging, dataclasses, typing
...
[local_deps]: app.services.embed_client, app.services.search_service, app.services.knowledge_graph.pool, app.services.llm_gateway, app.services.agent_identity, app.services.graph_rag_service, app.services.knowledge_graph.models, app.services.knowledge_graph.traversal
[ext_deps]: dataclasses, typing, json, collections, re, logging
...
[ext_deps]: typing, json, hashlib, asyncio, httpx, logging
...
[local_deps]: app.services.agent_identity, app.models.document, app.services.llm_gateway, app.models.tag
[ext_deps]: datetime, typing, uuid, logging, json, sqlalchemy, warnings
...
[ext_deps]: logging, urllib, sqlalchemy, uuid
...
[local_deps]: app.models.document, app.services.prometheus_metrics, app.services.search_service, app.models.chat, app.services.cache_monitor, app.services.llm_gateway, app.services.pii_detection_service, app.models.user, app.services.agent_identity, app.services.context_block_service, app.database
[ext_deps]: typing, uuid, json, collections, sqlalchemy, re, asyncio, logging, time
...
[local_deps]: app.models.document, app.models.collection, app.models.chat, app.services.llm_gateway, app.models.user, app.services.agent_identity, app.services.context_block_service, app.models.audit
...
[local_deps]: app.services.search_cache, app.models.document, app.schemas.collection, app.services.search_service, app.models.collection, app.services.llm_gateway, app.models.user, app.services.agent_identity, app.services.intent_parser
[ext_deps]: datetime, typing, uuid, sqlalchemy, asyncio, logging
...
[ext_deps]: difflib, datetime, sqlalchemy, hashlib, logging
...
[local_deps]: app.services.llm_gateway
[ext_deps]: datetime, uuid, typing, os, logging
...
[ext_deps]: threading, typing, json, sqlalchemy, asyncio, traceback, logging
...
[local_deps]: app.models.document, app.schemas.document, app.services.deduplication_service, app.models.pipeline, app.services.storage_service, app.models.user, app.tasks.pipeline_orchestrator, app.tasks.voice_tasks, app.tasks.pipeline_tasks, app.models.audit
[ext_deps]: fastapi, datetime, typing, json, concurrent, sqlalchemy, asyncio, logging
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: random, asyncio, os, httpx, logging, atexit, time
[fn]: _base_urls()
...
[ext_deps]: threading, torch, typing, numpy, psutil, sentence_transformers, asyncio, os, logging, gc
...
[ext_deps]: pathlib, transformers, numpy, onnxruntime, os, logging
...
[local_deps]: app.models.document, app.models.knowledge_graph, app.services.rollback_monitor, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: datetime, typing, logging, json, sqlalchemy, asyncio, warnings
...
[local_deps]: app.models.document, app.models.knowledge_graph, app.services.llm_gateway, app.services.agent_identity, app.services.context_block_service
[ext_deps]: typing, sqlalchemy, collections, re, logging
...
[ext_deps]: dataclasses, hashlib, re, redis, logging
...
[ext_deps]: datetime, typing, logging, json, re, enum, warnings
...
[ext_deps]: datetime, typing, json, collections, os, httpx, tenacity, logging
...
[ext_deps]: itertools, models, spacy, json, asyncpg, logging, __future__
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, uuid, pydantic, enum, __future__
...
[ext_deps]: extraction, models, json, asyncpg, logging, __future__
...
[local_deps]: app.services.semantic_cache, app.services.user_quota, app.services.monitoring, app.core.context, app.services.rollback_monitor, app.services.llm_router, app.services.token_utils
[ext_deps]: typing, collections, asyncio, logging, time
...
[ext_deps]: httpx, logging, typing
[class]: LLMHTTPClient { methods: [get_client, close] }

---
### FILE: backend/app/services/llm_router.py
[local_deps]: app.services.openrouter_service, app.services.pii_detection_service, app.services.minimax_service, app.services.kimi_service
[ext_deps]: dataclasses, typing, collections, enum, logging
...
[ext_deps]: nats, typing, collections, asyncio, os, logging
...
[local_deps]: app.services.monitoring, app.services.token_utils, app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: typing, json, collections, os, httpx, logging
...
[ext_deps]: datetime, dataclasses, threading, typing, prometheus_client, logging, subprocess, redis, collections, re, os, psutil
...
[ext_deps]: PyPDF2, io, paddleocr, typing, numpy, pytesseract, enum, os, PIL, cv2, logging, time
...
[ext_deps]: typing, json, collections, os, httpx, tenacity, logging
...
[local_deps]: app.services.prometheus_metrics, app.core.redis_url, app.services.monitoring, app.services.cache_monitor, app.services.token_utils, app.services.llm_http_client, app.services.openrouter_throttle
[ext_deps]: datetime, typing, json, redis, collections, hashlib, asyncio, os, httpx, tenacity, logging
...
[ext_deps]: datetime, typing, logging, __future__, time
...
[ext_deps]: datetime, typing, logging, sqlalchemy, sentence_transformers, psutil
...
[local_deps]: app.models.document, app.models.knowledge_graph, app.services.llm_gateway, app.models.user, app.services.agent_identity
[ext_deps]: logging, sqlalchemy, typing
...
[ext_deps]: functools, typing, collections, logging, time
...
[ext_deps]: typing, logging, sqlalchemy, collections
...
[local_deps]: app.models.document, app.services.monitoring, app.models.collection, app.services.rollback_monitor, app.services.llm_gateway, app.models.user, app.services.agent_identity, app.services.context_block_service
[ext_deps]: datetime, io, typing, uuid, reportlab, sqlalchemy, os, logging
[class]: ReportFormat { methods: [] }
...
[ext_deps]: os, httpx, logging, typing
[fn]: _get_client()
...
[local_deps]: app.core.redis_url
[ext_deps]: datetime, typing, redis, collections, os, logging, time
[fn]: _get_redis()
...
[local_deps]: app.services.search_cache, app.models.document, app.services.search_service, app.services.llm_router, app.models.user, app.services.agent_identity, app.services.context_block_service, app.database
[ext_deps]: typing, uuid, json, sqlalchemy, search_models, re, asyncio, logging, time
...
[ext_deps]: typing, json, hashlib, redis, logging
[fn]: close_redis_client()
[fn]: _get_redis()
...
[local_deps]: app.models.document, app.services.embed_client, app.services.pii_detection_service, app.models.user, app.services.search_cache, app.services.rerank_service
[ext_deps]: typing, sqlalchemy, re, asyncio, logging
...
[local_deps]: app.services.search_cache, app.services.prometheus_metrics, app.services.embed_client, app.utils.query_normalizer, app.services.openrouter_service
[ext_deps]: typing, numpy, json, hashlib, os, logging, __future__, time
...
[ext_deps]: dataclasses, typing, json, collections, logging
...
[ext_deps]: typing, numpy, sqlalchemy, re, logging
...
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.retrieval, app.services.smart_folder.entity_resolver
...
[local_deps]: app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.agent.executor, app.services.smart_folder.agent.planner, app.models.user, app.services.smart_folder.agent.synthesizer, app.models.smart_folder, app.services.smart_folder.entity_resolver
...
[ext_deps]: datetime, dataclasses, uuid, typing, sqlalchemy, logging
...
[ext_deps]: difflib, dataclasses, typing, sqlalchemy, logging
...
[ext_deps]: datetime, dataclasses, typing, json, logging
...
[ext_deps]: dataclasses, typing, uuid, json, re, logging
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.custom_query
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator
[ext_deps]: logging, typing
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.tools.document_reader, app.services.smart_folder.skills.base, app.services.smart_folder.report_generator, app.services.smart_folder.retrieval
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.refinement_parser

---
### FILE: backend/app/services/smart_folder/tools/asset_reader.py
[local_deps]: app.models.document
[ext_deps]: uuid, logging, sqlalchemy, typing
...
[ext_deps]: io, csv, typing, json, re, logging
...
[local_deps]: app.models.document, app.services.search_service, app.models.collection, app.services.llm_gateway, app.models.user
[ext_deps]: datetime, typing, uuid, sqlalchemy, re, logging
...
[local_deps]: app.models.document, app.models.bookmark, app.models.note, app.models.space, app.models.user, app.models.tag
[ext_deps]: logging, sqlalchemy, uuid
[fn]: _escape_like(value)
...
[ext_deps]: datetime, pathlib, uuid, base64, cryptography, os, logging
...
[ext_deps]: sys, datetime, pathlib, typing, json, contextlib, collections, os, logging, time
...
[ext_deps]: flock_alerter, hitl_bridge, base_agent, registry

---
### FILE: backend/app/services/swarm/v2/base_agent.py
[local_deps]: app.services.messaging
[ext_deps]: datetime, nats, uuid, typing, json, enum, asyncio, abc, logging
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, nats, dataclasses, typing, json, hashlib, enum, logging, time
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, nats, dataclasses, uuid, typing, json, enum, asyncio, logging
...
[local_deps]: app.models.document, app.models.knowledge_graph, app.services.rollback_monitor, app.services.llm_gateway, app.services.agent_identity, app.services.context_block_service
[ext_deps]: datetime, typing, json, sqlalchemy, collections, logging
...
[ext_deps]: datetime, json, os, httpx, logging
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: datetime, typing, sqlalchemy, collections, logging
...
[ext_deps]: sys, pptx, pathlib, html, csv, typing, xml, subprocess, json, zipfile, ebooklib, re, os, logging, docx, PyPDF2
...
[local_deps]: app.services.token_utils, app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: datetime, typing, json, collections, os, httpx, logging
...
[ext_deps]: datetime, logging, __future__, typing
...
[ext_deps]: os, logging, faster_whisper, asyncio
...
[local_deps]: app.models.document, app.core.redis_url, app.services.monitoring, app.services.cache_monitor, app.services.alert_service, app.celery_app, app.tasks.pipeline_orchestrator, app.tasks.base, app.models.processing, app.database
[ext_deps]: datetime, redis, celery, os, logging, asyncio
...
[local_deps]: app.models.document, app.services.embed_client, app.models.article, app.tasks.base, app.database, app.services.article_generation_service
[ext_deps]: uuid, celery, httpx, logging, asyncio
...
[local_deps]: app.models.document, app.models.article, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.tasks.article_tasks, app.database
...
[ext_deps]: logging, asyncio, os, traceback, psutil
...
[local_deps]: app.models.user, app.services.report_service, app.tasks.base, app.models.audit, app.database
[ext_deps]: typing, uuid, json, sqlalchemy, celery, logging, asyncio
...
[local_deps]: app.models.document, app.services.prometheus_metrics, app.services.embed_client, app.services.collection_service, app.services.chunking_service, app.services.auto_tagging_service, app.tasks.embedding_tasks, app.services.entity_extraction_service, app.services.dlq_service, app.tasks.pipeline_orchestrator, app.tasks.article_tasks, app.services.text_extractor, app.tasks.base, app.services.context_block_service, app.models.processing, app.database, app.services.ocr_service
[ext_deps]: datetime, langdetect, uuid, tempfile, sqlalchemy, celery, os, traceback, logging, asyncio
...
[local_deps]: app.models.document, app.services.embed_client, app.celery_app, app.tasks.base, app.database
...
[ext_deps]: datetime, email, redis, sqlalchemy, smtplib, os, logging
[fn]: _smtp_configured()
...
[local_deps]: app.models.document, app.models.pipeline, app.core.redis_url, app.tasks.pipeline_tasks, app.database
[ext_deps]: datetime, uuid, celery, redis, logging
...
[local_deps]: app.models.document, app.models.pipeline, app.core.redis_url, app.celery_app, app.tasks.pipeline_orchestrator, app.database
[ext_deps]: datetime, redis, sqlalchemy, os, logging
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.models.document, app.models.pipeline, app.services.knowledge_graph.extraction, app.services.embed_client, app.services.knowledge_graph.pool, app.services.chunking_service, app.celery_app, app.services.entity_extraction_service, app.services.dlq_service, app.tasks.article_tasks, app.services.text_extractor, app.tasks.document_tasks, app.database, app.services.ocr_service
[ext_deps]: datetime, celery, gc, uuid, tempfile, sqlalchemy, asyncio, os, traceback, logging, time
...
[ext_deps]: datetime, fpdf, openpyxl, sqlalchemy, celery, os, logging, time
...
[local_deps]: app.services.smart_folder_service, app.models.document, app.tasks.base, app.models.user, app.services.smart_folder.agent_runner, app.models.smart_folder, app.models.audit, app.database
[ext_deps]: datetime, typing, uuid, json, sqlalchemy, celery, logging, asyncio
...
[ext_deps]: logging, asyncio, sqlalchemy, celery
...
[ext_deps]: datetime, email, sqlalchemy, calendar, smtplib, os, httpx, logging
...
[local_deps]: app.models.task, app.core.push, app.celery_app, app.models.push_subscription, app.services.task_service, app.database
[ext_deps]: logging, sqlalchemy
[fn]: check_task_alarms()

---
### FILE: backend/app/tasks/voice_tasks.py
[local_deps]: app.celery_app, app.services.whisper_service, app.database, app.services.storage_service
[ext_deps]: tempfile, sqlalchemy, asyncio, os, logging
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: functools, threading, typing, collections, asyncio, logging, time
...
[ext_deps]: datetime, fastapi, bcrypt, typing, sqlalchemy, os, jose, logging, dotenv
