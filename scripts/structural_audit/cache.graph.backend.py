...
# [hub]: app.database → imported 45 times
...
[local_deps]: app.models.audit, app.models.document, app.models.article, app.services.storage_service, app.models.pipeline, app.services.search_service, app.celery_app, app.models.chat, app.api.deps, app.schemas.user, app.models.user, app.services.alert_service, app.models.processing, app.models.failed_task, app.tasks.pipeline_tasks, app.core.redis_url, app.tasks.pipeline_orchestrator, app.schemas.admin, app.services.embed_client, app.services.whisper_service, app.database, app.utils.security, app.api.documents_common
[ext_deps]: sqlalchemy, os, urllib, fastapi, pydantic, time, uuid, redis, json, asyncio, datetime, concurrent, typing, logging
...
[async_fn]: get_system_config(current_user)
...
[local_deps]: app.models.user, app.tasks.article_tasks, app.models.document, app.models.article, app.schemas.article, app.api.deps
...
[local_deps]: app.models.user, app.middleware.csrf, app.utils.constants, app.schemas.auth, app.services.token_blacklist, app.database, app.api.deps, app.limiter, app.utils.security, app.core.redis_url, app.schemas.token, app.schemas.user
[ext_deps]: sqlalchemy, os, secrets, hashlib, fastapi, hmac, time, uuid, redis, httpx, asyncio, datetime, dotenv, logging
...
[local_deps]: app.models.user, app.schemas.tag, app.schemas.bookmark, app.services.space_service, app.database, app.api.deps, app.services.bookmark_service
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.models.user, app.schemas.chat, app.services.chat_service, app.models.chat, app.database, app.api.deps, app.limiter, app.services.input_guard
[ext_deps]: sqlalchemy, fastapi, uuid, json, logging
...
[local_deps]: app.models.user, app.models.audit, app.models.article, app.models.collection, app.database, app.services.collection_service, app.tasks.document_tasks, app.services.collection_chat_service, app.api.deps, app.services.input_guard, app.services.llm_gateway, app.schemas.collection
[ext_deps]: sqlalchemy, fastapi, uuid, json, reportlab, datetime, typing, io, logging
...
[local_deps]: app.models.user, app.services.token_blacklist, app.database, app.utils.security, app.utils.constants
...
[local_deps]: app.models.audit, app.models.document, app.services.storage_service, app.schemas.document, app.models.pipeline, app.services.semantic_cache, app.services.similarity_service, app.services.search_service, app.tasks.embedding_tasks, app.api.deps, app.models.user, app.api.documents_upload, app.models.processing, app.tasks.pipeline_tasks, app.tasks.document_tasks, app.api.documents_journal, app.tasks.pipeline_orchestrator, app.database, app.api.documents_common
[ext_deps]: sqlalchemy, fastapi, time, uuid, concurrent, asyncio, datetime, typing, logging
...
[local_deps]: app.models.user, app.models.audit, app.models.document, app.schemas.document, app.tasks.pipeline_tasks, app.services.document_orchestrator, app.core.redis_url, app.models.pipeline, app.tasks.pipeline_orchestrator
[ext_deps]: sqlalchemy, os, fastapi, pydantic, uuid, redis, json, asyncio, datetime, concurrent, typing, logging
...
[local_deps]: app.models.user, app.models.audit, app.models.document, app.services.storage_service, app.schemas.document, app.services.whisper_service, app.database, app.api.deps, app.api.documents_common
[ext_deps]: sqlalchemy, os, fastapi, hmac, datetime, tempfile, logging
...
[local_deps]: app.models.user, app.models.audit, app.models.document, app.services.storage_service, app.schemas.document, app.services.document_orchestrator, app.database, app.api.deps, app.limiter, app.api.documents_common, app.services.deduplication_service, app.services.semantic_cache
[ext_deps]: sqlalchemy, fastapi, hmac, uuid, typing, logging
...
[async_fn]: upload_batch_documents(request, files, bucket, x_bot_api_key, current_user, db)
[async_fn]: get_batch_status(batch_id, current_user, db)

---
### FILE: backend/app/api/graph_rag.py
[local_deps]: app.models.user, app.models.audit, app.models.document, app.services.temporal_reasoning_service, app.database, app.api.deps, app.services.synthesis_service, app.services.progressive_revelation_service, app.services.search_service, app.services.graph_rag_service
[ext_deps]: sqlalchemy, fastapi, uuid, json, typing, logging
...
[local_deps]: app.core.redis_url, app.utils.security, app.celery_app, app.database
[ext_deps]: sqlalchemy, nats, os, fastapi, redis, httpx, asyncio, datetime, typing, logging
...
[local_deps]: app.models.user, app.api.documents_upload, app.schemas.document, app.database, app.limiter, app.api.documents_common
[ext_deps]: sqlalchemy, os, fastapi, hmac, logging
...
[local_deps]: app.models.user, app.models.knowledge_graph, app.models.document, app.services.entity_extraction_service, app.database, app.services.timeline_service, app.api.deps, app.services.relationship_service
[ext_deps]: sqlalchemy, fastapi, uuid, datetime, typing, logging
...
[local_deps]: app.services.monitoring, app.services.prometheus_metrics, app.main, app.services.embedding_service, app.core.redis_url, app.services.cache_monitor
[ext_deps]: os, fastapi, time, redis, datetime, typing, logging
[fn]: _get_redis_info()
...
[local_deps]: app.models.user, app.schemas.tag, app.schemas.note, app.services.space_service, app.database, app.models.note, app.services.note_service, app.api.deps, app.models.note_audio
[ext_deps]: sqlalchemy, os, fastapi, uuid, asyncio, datetime, logging
...
[local_deps]: app.models.document, app.celery_app, app.database, app.api.deps, app.core.redis_url, app.models.pipeline, app.tasks.pipeline_orchestrator
...
[local_deps]: app.models.user, app.models.push_subscription, app.database, app.schemas.push, app.api.deps
[ext_deps]: sqlalchemy, os, fastapi, uuid, logging
...
[local_deps]: app.models.user, app.tasks.report_tasks, app.celery_app, app.schemas.reports, app.api.deps
...
[local_deps]: app.models.user, app.models.document, app.services.agents.agent_orchestrator, app.services.embed_client, app.database, app.services.search_agent, app.services.input_guard, app.api.deps, app.services.search_service, app.services.search_models
[ext_deps]: sqlalchemy, fastapi, time, uuid, json, asyncio, logging
...
[async_fn]: search_stream(request, http_request, current_user)
...
[async_fn]: search_orchestrate(request, current_user, db)
...
[ext_deps]: sqlalchemy, fastapi, hashlib, pydantic, uuid, logging
...
[local_deps]: app.models.user, app.models.audit, app.celery_app, app.models.note, app.models.smart_folder, app.database, app.api.deps, app.tasks.smart_folder_tasks, app.tasks.collection_report_tasks, app.schemas.smart_folder, app.schemas.collection
[ext_deps]: sqlalchemy, celery, fastapi, uuid, json, asyncio, typing, logging
...
[local_deps]: app.models.user, app.schemas.tag, app.schemas.space, app.tasks.space_tasks, app.services.space_service, app.database, app.api.deps
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.models.user, app.services.rollback_monitor, app.services.llm_gateway, app.api.deps, app.core.redis_url, app.tasks.pipeline_orchestrator
...
[local_deps]: app.models.user, app.tasks.subscription_tasks, app.database, app.schemas.subscription, app.api.deps, app.models.subscription
[ext_deps]: fastapi, uuid, sqlalchemy, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.models.user, app.schemas.tag, app.services.task_service, app.services.space_service, app.database, app.api.deps, app.schemas.task
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.models.user, app.models.document, app.services.storage_service, app.services.whisper_service, app.models.note, app.api.deps, app.models.note_audio
[ext_deps]: sqlalchemy, os, fastapi, uuid, asyncio, tempfile, io, logging
...
[ext_deps]: os, urllib, pydantic, pydantic_settings, pathlib, logging
...
[ext_deps]: os, urllib, base64, struct, time, cryptography, json, httpx, logging
...
[ext_deps]: sqlalchemy, os, fastapi, pgvector, typing, dotenv, collections
...
[local_deps]: app.middleware.csrf, app.middleware.rls, app.services.llm_http_client, app.services.monitoring, app.core.config, app.services.prometheus_metrics, app.api, app.services.openrouter_service, app.database, app.services.search_cache, app.middleware.transaction, app.limiter, app.core.redis_url
[ext_deps]: uvicorn, sqlalchemy, os, slowapi, fastapi, threading, logging, time, uuid, starlette, redis, typing, dotenv, collections, contextlib
...
[class]: PrometheusHttpMetricsMiddleware { methods: [dispatch] }
...
[ext_deps]: secrets, hmac, starlette, logging
...
[ext_deps]: dataclasses, sqlalchemy, jose, starlette, logging
...
[local_deps]: app.models.knowledge_graph, app.models.audit, app.models.document, app.models.article, app.models.pattern_insight, app.models.pipeline, app.models.chat, app.models.space, app.models.tag, app.models.collection, app.models.user, app.models.processing, app.models.failed_task, app.models.note, app.models.milestone, app.models.smart_folder, app.models.note_audio, app.models.bookmark, app.models.base, app.models.push_subscription, app.models.subscription, app.models.task
...
[ext_deps]: sqlalchemy, typing, uuid
...
[local_deps]: app.models.base
[ext_deps]: datetime, uuid, enum, sqlalchemy
...
[ext_deps]: functools, time, logging, httpx, asyncio, typing, tenacity, collections
...
[local_deps]: app.schemas.chat, app.schemas.pagination, app.schemas.document, app.schemas.admin, app.schemas.search, app.schemas.token, app.schemas.smart_folder, app.schemas.collection, app.schemas.user

---
### FILE: backend/app/schemas/admin.py
[local_deps]: app.schemas.user
[ext_deps]: datetime, pydantic, uuid, re
...
[ext_deps]: datetime, pydantic, uuid, enum
[class]: BookmarkBucket { methods: [] }
...
[ext_deps]: datetime, pydantic, typing, uuid
...
[ext_deps]: re, pydantic, uuid, datetime, typing, enum
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.researcher_agent, app.services.agents.agent_orchestrator, app.services.agents.clarification_agent, app.services.agents.verification_agent, app.services.agents.answer_agent
...
[ext_deps]: dataclasses, logging, time, datetime, typing, enum, collections
...
[ext_deps]: dataclasses, re, json, typing, logging
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: dataclasses, typing, json, logging
...
[local_deps]: app.services.agent_identity, app.services.embed_client, app.services.knowledge_graph.pool, app.services.llm_gateway, app.services.knowledge_graph.traversal, app.services.knowledge_graph.models, app.services.search_service, app.services.graph_rag_service
[ext_deps]: dataclasses, re, logging, json, typing, collections
...
[ext_deps]: hashlib, json, asyncio, httpx, typing, logging
...
[ext_deps]: sqlalchemy, uuid, json, datetime, warnings, typing, logging
...
[ext_deps]: threading, json, datetime, typing, logging
...
[local_deps]: app.models.user, app.models.document, app.models.chat, app.services.pii_detection_service, app.services.prometheus_metrics, app.services.context_block_service, app.database, app.services.llm_gateway, app.services.search_service, app.services.cache_monitor, app.services.agent_identity
[ext_deps]: sqlalchemy, collections, re, time, uuid, json, asyncio, typing, logging
...
[local_deps]: app.models.user, app.models.audit, app.models.document, app.models.chat, app.services.context_block_service, app.models.collection, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: sqlalchemy, uuid, json, typing, logging
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.models.user, app.models.document, app.services.intent_parser, app.services.agent_identity, app.models.collection, app.services.search_cache, app.services.llm_gateway, app.services.search_service, app.schemas.collection
[ext_deps]: sqlalchemy, uuid, asyncio, datetime, typing, logging
...
[ext_deps]: datetime, redis, sqlalchemy, logging
[fn]: _get_redis()
...
[ext_deps]: sqlalchemy, hashlib, difflib, datetime, logging
...
[local_deps]: app.services.llm_gateway
[ext_deps]: os, uuid, datetime, typing, logging
...
[ext_deps]: sqlalchemy, threading, traceback, json, asyncio, typing, logging
...
[local_deps]: app.models.user, app.models.audit, app.models.document, app.services.storage_service, app.schemas.document, app.tasks.pipeline_tasks, app.tasks.voice_tasks, app.models.pipeline, app.tasks.pipeline_orchestrator, app.services.deduplication_service
[ext_deps]: sqlalchemy, fastapi, json, asyncio, datetime, concurrent, typing, logging
...
[ext_deps]: datetime, os, sendgrid, logging
...
[ext_deps]: os, atexit, time, httpx, asyncio, random, logging
[fn]: _base_urls()
...
[ext_deps]: os, sentence_transformers, threading, numpy, torch, gc, psutil, asyncio, typing, logging
...
[ext_deps]: os, onnxruntime, numpy, transformers, pathlib, logging
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.services.rollback_monitor, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: sqlalchemy, asyncio, json, datetime, warnings, typing, logging
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.services.context_block_service, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: sqlalchemy, re, logging, typing, collections
...
[ext_deps]: dataclasses, re, hashlib, redis, logging
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity, app.services.rollback_monitor
[ext_deps]: re, json, datetime, warnings, typing, enum, logging
...
[ext_deps]: os, logging, json, httpx, datetime, typing, tenacity, collections
...
[ext_deps]: spacy, asyncpg, __future__, itertools, models, json, logging
[fn]: _vec_to_str(vec)
...
[ext_deps]: pydantic, __future__, uuid, datetime, enum
...
[ext_deps]: asyncpg, __future__, models, json, extraction, logging
...
[local_deps]: app.services.semantic_cache, app.services.monitoring, app.services.llm_router, app.services.token_utils, app.services.rollback_monitor, app.services.user_quota, app.core.context
[ext_deps]: time, logging, asyncio, typing, collections
...
[local_deps]: app.services.pii_detection_service, app.services.minimax_service, app.services.kimi_service, app.services.openrouter_service
[ext_deps]: dataclasses, logging, typing, enum, collections
[class]: RoutingReason { methods: [] }
[class]: LLMProvider { methods: [] }
[class]: TaskTier { methods: [] }
[class]: FallbackTrigger { methods: [] }
[class]: RoutingDecision { methods: [] }
[class]: LLMRouter { methods: [__init__, generate_completion, detect_context_sensitivity, _generate_bullet_summary, generate_report_completion, select_provider, get_provider_for_direct_call] }
[class]: LLMServiceAdapter { methods: [__init__, build_messages, call_service] }
[fn]: _build_router()

---
### FILE: backend/app/services/messaging/__init__.py
[ext_deps]: nats, os, logging, asyncio, typing, collections
...
[local_deps]: app.services.monitoring, app.services.llm_http_client, app.services.base_llm_service, app.services.token_utils
[ext_deps]: os, logging, json, httpx, typing, collections
...
[ext_deps]: dataclasses, prometheus_client, os, collections, re, threading, redis, psutil, shutil, subprocess, datetime, typing, logging
...
[ext_deps]: os, pytesseract, numpy, PIL, time, cv2, PyPDF2, paddleocr, io, typing, enum, logging
...
[ext_deps]: os, logging, httpx, json, typing, tenacity, collections
...
[local_deps]: app.services.llm_http_client, app.services.openrouter_throttle, app.services.token_utils, app.services.monitoring, app.services.prometheus_metrics, app.core.redis_url, app.services.cache_monitor
[ext_deps]: os, collections, hashlib, redis, json, asyncio, datetime, httpx, typing, tenacity, logging
...
[ext_deps]: time, __future__, datetime, typing, logging
...
[ext_deps]: sqlalchemy, sentence_transformers, psutil, datetime, typing, logging
...
[local_deps]: app.models.user, app.models.knowledge_graph, app.models.document, app.services.llm_gateway, app.services.agent_identity
...
[ext_deps]: functools, logging, time, typing, collections
...
[local_deps]: app.models.user, app.models.document, app.services.rollback_monitor, app.services.monitoring, app.services.context_block_service, app.models.collection, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: sqlalchemy, os, uuid, reportlab, datetime, typing, io, logging
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.core.redis_url
[ext_deps]: os, logging, time, redis, datetime, typing, collections
[fn]: _get_redis()
...
[local_deps]: app.models.user, app.models.document, app.services.llm_router, app.services.context_block_service, app.database, app.services.search_cache, app.services.search_service, app.services.agent_identity
[ext_deps]: sqlalchemy, re, time, search_models, uuid, json, asyncio, typing, logging
...
[local_deps]: app.models.user, app.models.document, app.services.pii_detection_service, app.services.embed_client, app.services.rerank_service, app.services.search_cache
[ext_deps]: sqlalchemy, re, asyncio, typing, logging
...
[local_deps]: app.services.embed_client, app.services.prometheus_metrics, app.services.openrouter_service, app.services.search_cache, app.utils.query_normalizer
[ext_deps]: os, hashlib, numpy, time, __future__, json, typing, logging
...
[ext_deps]: dataclasses, logging, json, typing, collections
...
[ext_deps]: sqlalchemy, re, numpy, typing, logging
...
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.entity_resolver, app.services.smart_folder.analysis, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator
...
[local_deps]: app.models.user, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.agent.executor, app.services.smart_folder.agent.planner, app.services.smart_folder.query_parser, app.models.smart_folder, app.services.smart_folder.report_generator
[ext_deps]: sqlalchemy, re, uuid, typing, logging
...
[ext_deps]: dataclasses, sqlalchemy, uuid, datetime, typing, logging
...
[ext_deps]: dataclasses, sqlalchemy, difflib, typing, logging
...
[ext_deps]: dataclasses, json, datetime, typing, logging
...
[local_deps]: app.services.llm_router, app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.token_utils
[ext_deps]: dataclasses, re, uuid, json, typing, logging
...
[local_deps]: app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.base, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.financial_analysis
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.skills.base, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.ratio_calculator
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.analysis, app.services.smart_folder.skills.base, app.services.smart_folder.report_generator, app.services.smart_folder.tools.document_reader
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.ratio_calculator
...
[ext_deps]: csv, re, json, typing, io, logging
...
[local_deps]: app.models.user, app.models.document, app.models.collection, app.services.llm_gateway, app.services.search_service
[ext_deps]: sqlalchemy, re, uuid, datetime, typing, logging
...
[local_deps]: app.models.user, app.models.document, app.models.space, app.models.tag, app.models.note, app.models.bookmark
[ext_deps]: sqlalchemy, uuid, logging
[fn]: _escape_like(value)
...
[ext_deps]: os, base64, cryptography, uuid, asyncio, datetime, pathlib, logging
[class]: EncryptionError { methods: [] }
[fn]: _base64_encode(data)
[fn]: get_encryption_key()
[class]: StorageService { methods: [__init__, _init_encryption, encryption_enabled, _ensure_directories, _encrypt_data, _decrypt_data, get_bucket_path, _safe_bucket_file_path, generate_filename, _is_encrypted_file, save_file, save_file_async, delete_file, get_file, get_file_plaintext, encrypt_file, decrypt_file, needs_migration, file_exists, get_file_info] }

---
### FILE: backend/app/services/structured_logging.py
[ext_deps]: os, sys, logging, time, json, datetime, pathlib, typing, collections, contextlib
...
[ext_deps]: nats, uuid, json, asyncio, datetime, typing, enum, logging, abc
...
[local_deps]: app.services.messaging
[ext_deps]: dataclasses, nats, hashlib, time, json, datetime, typing, enum, logging
...
[local_deps]: app.services.messaging
[ext_deps]: dataclasses, nats, uuid, json, asyncio, datetime, typing, enum, logging
...
[local_deps]: app.services.messaging
[ext_deps]: nats, json, datetime, typing, logging
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.services.rollback_monitor, app.services.context_block_service, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: sqlalchemy, logging, json, datetime, typing, collections
...
[ext_deps]: os, httpx, json, datetime, logging
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: sqlalchemy, logging, datetime, typing, collections
...
[ext_deps]: csv, docx, os, sys, re, xml, ebooklib, PyPDF2, subprocess, json, html, pathlib, pptx, typing, logging, zipfile
...
[local_deps]: app.services.llm_http_client, app.services.base_llm_service, app.services.token_utils
[ext_deps]: os, logging, json, httpx, datetime, typing, collections
...
[ext_deps]: datetime, __future__, typing, logging
...
[ext_deps]: faster_whisper, os, logging, asyncio
...
[local_deps]: app.services.alert_service, app.models.document, app.celery_app, app.services.monitoring, app.models.processing, app.database, app.core.redis_url, app.tasks.base, app.tasks.pipeline_orchestrator, app.services.cache_monitor
[ext_deps]: os, celery, redis, asyncio, datetime, logging
...
[local_deps]: app.models.document, app.models.article, app.services.embed_client, app.database, app.services.article_generation_service, app.tasks.base
...
[local_deps]: app.tasks.article_tasks, app.models.document, app.models.article, app.tasks.embedding_tasks, app.database, app.tasks.pipeline_orchestrator
...
[local_deps]: app.models.user, app.models.audit, app.services.report_service, app.database, app.tasks.base
[ext_deps]: sqlalchemy, celery, uuid, json, asyncio, typing, logging
...
[local_deps]: app.tasks.article_tasks, app.services.text_extractor, app.models.document, app.services.auto_tagging_service, app.services.embed_client, app.models.processing, app.services.prometheus_metrics, app.services.context_block_service, app.tasks.embedding_tasks, app.services.entity_extraction_service, app.database, app.services.collection_service, app.tasks.base, app.tasks.pipeline_orchestrator, app.services.chunking_service, app.services.ocr_service, app.services.dlq_service
[ext_deps]: sqlalchemy, os, celery, uuid, traceback, asyncio, datetime, tempfile, langdetect, logging
...
[local_deps]: app.models.document, app.celery_app, app.services.embed_client, app.database, app.tasks.base
...
[local_deps]: app.models.document, app.celery_app, app.database, app.core.redis_url, app.models.pipeline
[ext_deps]: sqlalchemy, os, smtplib, email, redis, datetime, logging
[fn]: _smtp_configured()
...
[ext_deps]: os, psutil, logging, asyncio
[fn]: check_worker_memory(self)

---
### FILE: backend/app/tasks/pipeline_orchestrator.py
[local_deps]: app.models.document, app.tasks.pipeline_tasks, app.database, app.core.redis_url, app.models.pipeline
[ext_deps]: celery, redis, uuid, datetime, logging
...
[fn]: _is_stage_inflight(document_id, stage, skip_recent_pending)
[fn]: dispatch_document(document_id, from_stage, force)
[fn]: dispatch_batch(document_ids)

---
### FILE: backend/app/tasks/pipeline_sweeper.py
[local_deps]: app.models.document, app.celery_app, app.database, app.core.redis_url, app.models.pipeline, app.tasks.pipeline_orchestrator
[ext_deps]: sqlalchemy, os, redis, datetime, logging
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.tasks.article_tasks, app.services.text_extractor, app.models.document, app.celery_app, app.services.embed_client, app.tasks.document_tasks, app.database, app.services.entity_extraction_service, app.services.knowledge_graph.pool, app.services.knowledge_graph.extraction, app.models.pipeline, app.services.chunking_service, app.services.ocr_service, app.services.dlq_service
[ext_deps]: sqlalchemy, os, celery, time, gc, uuid, traceback, asyncio, datetime, tempfile, logging
...
[fn]: _fail_stage_permanently(task, document_id, stage, exc, attempts)
...
[ext_deps]: sqlalchemy, fpdf, os, celery, time, datetime, openpyxl, logging
...
[local_deps]: app.models.user, app.services.smart_folder.agent_runner, app.models.audit, app.models.document, app.services.smart_folder_service, app.database, app.models.smart_folder, app.tasks.base
[ext_deps]: sqlalchemy, celery, uuid, json, asyncio, datetime, typing, logging
...
[local_deps]: app.models.space, app.services.space_service, app.tasks.base, app.database
...
[local_deps]: app.models.user, app.models.subscription, app.celery_app, app.database
[ext_deps]: sqlalchemy, os, smtplib, email, httpx, datetime, calendar, logging
...
[local_deps]: app.celery_app, app.models.push_subscription, app.core.push, app.services.task_service, app.database, app.models.task
[ext_deps]: sqlalchemy, logging
[fn]: check_task_alarms()

---
### FILE: backend/app/tasks/voice_tasks.py
[local_deps]: app.services.whisper_service, app.services.storage_service, app.celery_app, app.database
[ext_deps]: sqlalchemy, os, asyncio, tempfile, logging
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: threading, functools, logging, time, asyncio, typing, collections
...
[ext_deps]: os
[fn]: _prefixed_cookie_name(base, host_prefix)
...
[ext_deps]: sqlalchemy, os, fastapi, dotenv, jose, datetime, typing, bcrypt, logging
