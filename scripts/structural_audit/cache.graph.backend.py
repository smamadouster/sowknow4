...
[local_deps]: app.models.user, app.core.redis_url, app.services.embed_client, app.models.document, app.models.processing, app.services.search_service, app.schemas.admin, app.tasks.pipeline_orchestrator, app.services.storage_service, app.models.failed_task, app.tasks.pipeline_tasks, app.models.article, app.database, app.models.chat, app.utils.security, app.api.deps, app.api.documents_common, app.services.whisper_service, app.schemas.user, app.models.audit, app.services.alert_service, app.celery_app, app.models.pipeline
[ext_deps]: uuid, fastapi, datetime, asyncio, pydantic, time, sqlalchemy, logging, json, concurrent, redis, os, typing
...
[local_deps]: app.models.document, app.schemas.article, app.models.user, app.api.deps, app.tasks.article_tasks, app.models.article
...
[local_deps]: app.middleware.csrf, app.database, app.schemas.token, app.schemas.user, app.utils.security, app.services.token_blacklist, app.models.user, app.api.deps, app.core.redis_url, app.schemas.auth, app.limiter, app.utils.constants
[ext_deps]: uuid, fastapi, hashlib, datetime, dotenv, httpx, sqlalchemy, logging, time, redis, secrets, os
...
[local_deps]: app.schemas.tag, app.database, app.services.space_service, app.models.user, app.api.deps, app.schemas.bookmark, app.services.bookmark_service
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.services.input_guard, app.database, app.models.chat, app.models.user, app.api.deps, app.schemas.chat, app.limiter, app.services.chat_service
[ext_deps]: fastapi, uuid, sqlalchemy, logging, json
...
[local_deps]: app.services.input_guard, app.database, app.services.collection_service, app.services.collection_chat_service, app.models.user, app.models.audit, app.api.deps, app.tasks.document_tasks, app.models.collection, app.schemas.collection, app.services.llm_gateway, app.models.article
[ext_deps]: fastapi, uuid, reportlab, datetime, sqlalchemy, logging, json, io, typing
...
[local_deps]: app.utils.security, app.database, app.services.token_blacklist, app.models.user, app.utils.constants
...
[local_deps]: app.services.similarity_service, app.models.document, app.database, app.schemas.document, app.models.processing, app.tasks.embedding_tasks, app.api.documents_journal, app.api.documents_upload, app.models.user, app.api.deps, app.models.audit, app.services.search_service, app.tasks.document_tasks, app.tasks.pipeline_orchestrator, app.services.storage_service, app.models.pipeline, app.tasks.pipeline_tasks, app.api.documents_common
[ext_deps]: fastapi, uuid, datetime, asyncio, time, sqlalchemy, logging, concurrent, typing
...
[local_deps]: app.models.document, app.schemas.document, app.models.user, app.models.audit, app.core.redis_url, app.tasks.pipeline_orchestrator, app.models.pipeline, app.tasks.pipeline_tasks
[ext_deps]: uuid, fastapi, datetime, asyncio, pydantic, sqlalchemy, logging, json, concurrent, mimetypes, redis, os, typing
...
[local_deps]: app.models.document, app.database, app.services.whisper_service, app.schemas.document, app.models.user, app.models.audit, app.api.deps, app.services.storage_service, app.api.documents_common
[ext_deps]: fastapi, tempfile, datetime, sqlalchemy, logging, os
...
[local_deps]: app.models.document, app.database, app.services.document_orchestrator, app.schemas.document, app.models.user, app.models.audit, app.api.deps, app.services.deduplication_service, app.services.storage_service, app.api.documents_common
[ext_deps]: fastapi, uuid, sqlalchemy, logging, typing
...
[local_deps]: app.models.document, app.database, app.services.synthesis_service, app.services.search_service, app.models.user, app.models.audit, app.api.deps, app.services.progressive_revelation_service, app.services.temporal_reasoning_service, app.services.graph_rag_service
[ext_deps]: fastapi, uuid, sqlalchemy, logging, json, typing
...
[ext_deps]: fastapi, nats, datetime, asyncio, httpx, sqlalchemy, logging, redis, os, typing
...
[local_deps]: app.models.user, app.api.documents_upload, app.database, app.schemas.document
...
[local_deps]: app.models.document, app.database, app.services.entity_extraction_service, app.models.user, app.api.deps, app.services.relationship_service, app.services.timeline_service, app.models.knowledge_graph
[ext_deps]: fastapi, uuid, datetime, sqlalchemy, logging, typing
...
[local_deps]: app.models.note, app.schemas.note, app.schemas.tag, app.database, app.services.space_service, app.models.user, app.api.deps, app.services.note_service, app.models.note_audio
[ext_deps]: fastapi, uuid, datetime, sqlalchemy, logging, os
...
[local_deps]: app.models.document, app.database, app.api.deps, app.core.redis_url, app.celery_app, app.tasks.pipeline_orchestrator, app.models.pipeline
...
[local_deps]: app.database, app.models.user, app.api.deps, app.schemas.push, app.models.push_subscription
[ext_deps]: fastapi, uuid, sqlalchemy, logging, os
...
[local_deps]: app.tasks.report_tasks, app.models.user, app.api.deps, app.schemas.reports, app.celery_app
...
[local_deps]: app.services.search_models, app.services.input_guard, app.models.document, app.database, app.services.search_agent, app.models.user, app.services.search_service, app.api.deps, app.services.embed_client
[ext_deps]: uuid, fastapi, asyncio, time, sqlalchemy, logging, json
...
[ext_deps]: fastapi, uuid, hashlib, pydantic, sqlalchemy, logging
...
[local_deps]: app.schemas.smart_folder, app.database, app.models.user, app.models.audit, app.api.deps, app.celery_app, app.schemas.collection, app.models.smart_folder, app.models.note, app.tasks.collection_report_tasks, app.tasks.smart_folder_tasks
[ext_deps]: fastapi, uuid, asyncio, sqlalchemy, logging, json, celery, typing
...
[local_deps]: app.schemas.tag, app.database, app.services.space_service, app.models.user, app.api.deps, app.schemas.space, app.tasks.space_tasks
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.services.rollback_monitor, app.models.user, app.api.deps, app.core.redis_url, app.tasks.pipeline_orchestrator, app.services.llm_gateway
...
[local_deps]: app.database, app.schemas.subscription, app.tasks.subscription_tasks, app.models.user, app.api.deps, app.models.subscription
[ext_deps]: fastapi, uuid, sqlalchemy, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.tag, app.database, app.services.space_service, app.schemas.task, app.models.user, app.api.deps, app.services.task_service
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.models.document, app.services.whisper_service, app.models.user, app.api.deps, app.services.storage_service, app.models.note, app.models.note_audio
[ext_deps]: uuid, fastapi, tempfile, asyncio, sqlalchemy, logging, io, os
...
[ext_deps]: pydantic_settings, pydantic, pathlib, logging, urllib, os
...
[ext_deps]: cryptography, time, httpx, logging, json, urllib, struct, base64, os
...
[ext_deps]: fastapi, pgvector, dotenv, sqlalchemy, collections, os, typing
...
[local_deps]: app.middleware.csrf, app.middleware.transaction, app.database, app.middleware.rls, app.services.messaging, app.core.redis_url, app.core.config, app.services.llm_http_client, app.limiter, app.api, app.services.prometheus_metrics
[ext_deps]: typing, uuid, threading, fastapi, starlette, uvicorn, dotenv, time, sqlalchemy, logging, slowapi, redis, collections, os, contextlib
...
[local_deps]: app.services.cache_monitor, app.database, app.services.monitoring, app.core.redis_url, app.services.embedding_service, app.api, app.services.prometheus_metrics
[ext_deps]: fastapi, uvicorn, datetime, dotenv, time, httpx, logging, sqlalchemy, redis, os, contextlib
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: hmac, secrets, starlette, logging
...
[ext_deps]: starlette, sqlalchemy, logging, jose, dataclasses
...
[local_deps]: app.models.user, app.models.subscription, app.models.document, app.models.space, app.models.processing, app.models.task, app.models.push_subscription, app.models.note, app.models.knowledge_graph, app.models.failed_task, app.models.note_audio, app.models.article, app.models.chat, app.models.milestone, app.models.base, app.models.collection, app.models.pattern_insight, app.models.audit, app.models.bookmark, app.models.smart_folder, app.models.pipeline, app.models.tag
...
[local_deps]: app.models.base
[ext_deps]: datetime, enum, uuid, sqlalchemy
...
[ext_deps]: asyncio, time, httpx, logging, functools, collections, tenacity, typing
...
[local_deps]: app.database
[ext_deps]: functools, hashlib, sqlalchemy, json
...
[local_deps]: app.schemas.smart_folder, app.schemas.search, app.schemas.user, app.schemas.token, app.schemas.document, app.schemas.pagination, app.schemas.chat, app.schemas.admin, app.schemas.collection
...
[ext_deps]: uuid, datetime, enum, pydantic, typing
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: uuid, datetime, enum, pydantic, re, typing
[class]: UserRole { methods: [] }
...
[ext_deps]: openpyxl, sys, xlrd, json
...
[local_deps]: app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.answer_agent, app.services.agents.agent_orchestrator, app.services.agents.clarification_agent

---
### FILE: backend/app/services/agents/agent_orchestrator.py
[local_deps]: app.services.agents.answer_agent, app.services.agents.researcher_agent, app.services.agents.verification_agent, app.services.agents.clarification_agent
[ext_deps]: datetime, enum, time, logging, dataclasses, collections, typing
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: typing, json, dataclasses, logging
...
[local_deps]: app.services.search_service, app.services.knowledge_graph.pool, app.services.agent_identity, app.services.embed_client, app.services.knowledge_graph.models, app.services.llm_gateway, app.services.graph_rag_service, app.services.knowledge_graph.traversal
[ext_deps]: logging, json, re, dataclasses, collections, typing
...
[ext_deps]: hashlib, asyncio, httpx, logging, json, typing
...
[ext_deps]: uuid, datetime, sqlalchemy, logging, json, warnings, typing
...
[ext_deps]: threading, datetime, logging, json, typing
...
[local_deps]: app.services.cache_monitor, app.models.document, app.database, app.services.context_block_service, app.models.chat, app.services.pii_detection_service, app.services.search_service, app.models.user, app.services.agent_identity, app.services.llm_gateway, app.services.prometheus_metrics
[ext_deps]: uuid, asyncio, time, sqlalchemy, logging, json, re, collections, typing
...
[local_deps]: app.models.document, app.models.chat, app.services.context_block_service, app.models.user, app.models.audit, app.models.collection, app.services.agent_identity, app.services.llm_gateway
...
[local_deps]: app.services.search_cache, app.models.document, app.services.intent_parser, app.services.search_service, app.models.user, app.models.collection, app.services.agent_identity, app.schemas.collection, app.services.llm_gateway
[ext_deps]: uuid, datetime, asyncio, sqlalchemy, logging, typing
...
[ext_deps]: threading, traceback, asyncio, sqlalchemy, json, logging, typing
...
[local_deps]: app.models.document, app.schemas.document, app.models.user, app.services.deduplication_service, app.models.audit, app.tasks.pipeline_orchestrator, app.services.storage_service, app.tasks.voice_tasks, app.models.pipeline, app.tasks.pipeline_tasks
[ext_deps]: fastapi, datetime, asyncio, sqlalchemy, logging, json, concurrent, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: asyncio, time, httpx, logging, random, os
[fn]: _base_urls()
...
[ext_deps]: threading, psutil, numpy, asyncio, torch, logging, gc, os, sentence_transformers, typing
...
[ext_deps]: numpy, pathlib, logging, onnxruntime, transformers, os
...
[local_deps]: app.models.document, app.services.rollback_monitor, app.services.agent_identity, app.models.knowledge_graph, app.services.llm_gateway
[ext_deps]: datetime, asyncio, sqlalchemy, logging, json, warnings, typing
...
[local_deps]: app.models.document, app.services.context_block_service, app.services.agent_identity, app.models.knowledge_graph, app.services.llm_gateway
[ext_deps]: sqlalchemy, logging, re, collections, typing
...
[ext_deps]: hashlib, logging, re, dataclasses, redis
...
[ext_deps]: datetime, enum, logging, json, warnings, re, typing
...
[ext_deps]: tenacity, datetime, httpx, logging, json, collections, os, typing
...
[ext_deps]: asyncpg, models, logging, json, __future__, spacy, itertools
[fn]: _vec_to_str(vec)
...
[ext_deps]: uuid, datetime, enum, pydantic, __future__
...
[ext_deps]: extraction, models, logging, json, __future__, asyncpg
...
[local_deps]: app.services.rollback_monitor, app.services.llm_router, app.services.monitoring, app.services.user_quota, app.core.context, app.services.semantic_cache
[ext_deps]: asyncio, time, logging, collections, typing
[class]: LLMGateway { methods: [__init__, _timed_generate, chat_completion, model, check_cache, invalidate_collection_cache, get_usage_stats, chat_completion_non_stream, health_check] }
...
[local_deps]: app.services.kimi_service, app.services.pii_detection_service, app.services.openrouter_service, app.services.ollama_service, app.services.minimax_service
...
[ext_deps]: nats, asyncio, logging, collections, os, typing
...
[local_deps]: app.services.llm_http_client, app.services.base_llm_service, app.services.monitoring
[ext_deps]: httpx, logging, json, collections, os, typing
...
[ext_deps]: subprocess, threading, psutil, datetime, logging, prometheus_client, dataclasses, redis, collections, re, os, typing
...
[ext_deps]: enum, numpy, time, logging, io, pytesseract, paddleocr, PIL, cv2, PyPDF2, os, typing
...
[local_deps]: app.services.llm_http_client, app.services.base_llm_service
[ext_deps]: tenacity, httpx, logging, json, collections, os, typing
...
[local_deps]: app.services.cache_monitor, app.services.openrouter_throttle, app.services.monitoring, app.core.redis_url, app.services.llm_http_client
[ext_deps]: hashlib, tenacity, datetime, asyncio, httpx, logging, json, redis, collections, os, typing
[fn]: _get_redis_client()
...
[ext_deps]: datetime, time, logging, __future__, typing
...
[ext_deps]: psutil, datetime, sqlalchemy, logging, sentence_transformers, typing
...
[local_deps]: app.models.document, app.models.user, app.services.agent_identity, app.models.knowledge_graph, app.services.llm_gateway
...
[ext_deps]: time, logging, functools, collections, typing
...
[local_deps]: app.models.document, app.services.context_block_service, app.services.rollback_monitor, app.models.user, app.services.monitoring, app.models.collection, app.services.agent_identity, app.services.llm_gateway
[ext_deps]: uuid, reportlab, datetime, sqlalchemy, logging, io, os, typing
[class]: ReportFormat { methods: [] }
...
[ext_deps]: typing, os, httpx, logging
[fn]: _get_client()
...
[local_deps]: app.core.redis_url
[ext_deps]: datetime, time, logging, redis, collections, os, typing
[fn]: _get_redis()
...
[local_deps]: app.services.search_cache, app.models.document, app.database, app.services.context_block_service, app.services.llm_router, app.models.user, app.services.search_service, app.services.agent_identity
[ext_deps]: uuid, asyncio, time, sqlalchemy, logging, json, search_models, re, typing
...
[local_deps]: app.core.redis_url
[ext_deps]: hashlib, logging, json, redis, typing
[fn]: _get_redis()
...
[local_deps]: app.services.search_cache, app.models.document, app.services.pii_detection_service, app.models.user, app.services.rerank_service, app.services.embed_client
[ext_deps]: asyncio, sqlalchemy, logging, re, typing
...
[local_deps]: app.services.openrouter_service, app.services.embed_client
[ext_deps]: hashlib, numpy, time, logging, json, __future__, typing
...
[ext_deps]: logging, json, dataclasses, collections, typing
...
[ext_deps]: numpy, sqlalchemy, logging, re, typing
...
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.retrieval, app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser, app.services.smart_folder.analysis
...
[local_deps]: app.services.smart_folder.report_generator, app.models.user, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.agent.executor, app.models.smart_folder, app.services.smart_folder.agent.planner, app.services.smart_folder.query_parser
[ext_deps]: uuid, sqlalchemy, logging, re, typing
...
[ext_deps]: uuid, datetime, sqlalchemy, logging, dataclasses, typing
...
[ext_deps]: difflib, sqlalchemy, logging, dataclasses, typing
...
[local_deps]: app.services.smart_folder.retrieval, app.services.llm_router, app.services.smart_folder.analysis
[ext_deps]: uuid, logging, json, re, dataclasses, typing
...
[local_deps]: app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.base, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.financial_analysis
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.ratio_calculator
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.report_generator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.document_reader, app.services.smart_folder.analysis
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.refinement_parser
...
[ext_deps]: csv, logging, io, json, re, typing
...
[local_deps]: app.models.document, app.services.search_service, app.models.user, app.models.collection, app.services.llm_gateway
[ext_deps]: uuid, datetime, sqlalchemy, logging, re, typing
...
[local_deps]: app.models.document, app.models.space, app.models.user, app.models.bookmark, app.models.note, app.models.tag
[ext_deps]: uuid, sqlalchemy, logging
[fn]: _escape_like(value)
...
[ext_deps]: uuid, cryptography, datetime, pathlib, logging, base64, os
...
[ext_deps]: typing, datetime, time, pathlib, logging, json, sys, collections, os, contextlib
...
[ext_deps]: uuid, nats, datetime, enum, asyncio, abc, logging, json, typing
...
[local_deps]: app.services.messaging
[ext_deps]: hashlib, nats, datetime, enum, time, logging, json, dataclasses, typing
...
[local_deps]: app.services.messaging
[ext_deps]: uuid, nats, datetime, enum, asyncio, logging, json, dataclasses, typing
...
[local_deps]: app.services.messaging
[ext_deps]: nats, datetime, logging, json, typing
...
[local_deps]: app.models.document, app.services.context_block_service, app.services.rollback_monitor, app.services.agent_identity, app.models.knowledge_graph, app.services.llm_gateway
...
[ext_deps]: datetime, httpx, logging, json, os
...
[ext_deps]: csv, xml, pathlib, logging, json, sys, zipfile, PyPDF2, docx, pptx, ebooklib, subprocess, html, re, os, typing
...
[local_deps]: app.services.cache_monitor, app.models.document, app.database, app.models.processing, app.services.monitoring, app.tasks.base, app.services.alert_service, app.celery_app, app.tasks.pipeline_orchestrator, app.core.redis_url
[ext_deps]: datetime, asyncio, celery, logging, os, redis
...
[local_deps]: app.models.document, app.database, app.tasks.base, app.services.embed_client, app.services.article_generation_service, app.models.article
[ext_deps]: uuid, asyncio, httpx, celery, logging
...
[local_deps]: app.models.document, app.database, app.tasks.embedding_tasks, app.tasks.article_tasks, app.tasks.pipeline_orchestrator, app.models.article
...
[ext_deps]: traceback, psutil, asyncio, logging, os
...
[ext_deps]: uuid, asyncio, celery, logging, sqlalchemy, json, typing
...
[local_deps]: app.models.document, app.database, app.services.entity_extraction_service, app.services.chunking_service, app.models.processing, app.tasks.embedding_tasks, app.services.collection_service, app.services.ocr_service, app.services.context_block_service, app.services.dlq_service, app.tasks.base, app.tasks.article_tasks, app.services.text_extractor, app.tasks.pipeline_orchestrator, app.services.embed_client, app.services.prometheus_metrics
[ext_deps]: uuid, tempfile, traceback, datetime, asyncio, celery, logging, sqlalchemy, langdetect, os
...
[local_deps]: app.models.document, app.database, app.tasks.base, app.celery_app, app.services.embed_client
[ext_deps]: uuid, time, sentence_transformers, logging
...
[ext_deps]: datetime, sqlalchemy, logging, smtplib, redis, email, os
[fn]: _smtp_configured()
...
[local_deps]: app.models.document, app.database, app.core.redis_url, app.models.pipeline, app.tasks.pipeline_tasks
[ext_deps]: uuid, datetime, celery, logging, redis
...
[local_deps]: app.models.document, app.database, app.core.redis_url, app.celery_app, app.tasks.pipeline_orchestrator, app.models.pipeline
[ext_deps]: datetime, sqlalchemy, logging, os, redis
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.models.document, app.database, app.services.entity_extraction_service, app.services.chunking_service, app.services.knowledge_graph.extraction, app.services.dlq_service, app.services.ocr_service, app.tasks.article_tasks, app.services.text_extractor, app.celery_app, app.tasks.document_tasks, app.services.knowledge_graph.pool, app.services.embed_client, app.models.pipeline
[ext_deps]: uuid, tempfile, traceback, datetime, asyncio, time, celery, logging, gc, os
...
[local_deps]: app.models.audit, app.models.document, app.database, app.tasks.base
[ext_deps]: datetime, time, celery, logging, sqlalchemy, openpyxl, fpdf, os
...
[local_deps]: app.models.document, app.database, app.services.smart_folder_service, app.models.user, app.models.audit, app.tasks.base, app.models.smart_folder, app.services.smart_folder.agent_runner
[ext_deps]: uuid, datetime, asyncio, celery, logging, sqlalchemy, json, typing
...
[local_deps]: app.models.space, app.database, app.tasks.base, app.services.space_service
...
[ext_deps]: datetime, httpx, sqlalchemy, logging, os, smtplib, email, calendar
...
[local_deps]: app.database, app.core.push, app.models.task, app.celery_app, app.models.push_subscription, app.services.task_service
...
[ext_deps]: threading, asyncio, time, logging, functools, collections, typing
...
[ext_deps]: fastapi, datetime, dotenv, sqlalchemy, logging, jose, bcrypt, os, typing
