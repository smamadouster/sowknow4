...
[local_deps]: app.models.pipeline, app.schemas.user, app.models.document, app.utils.security, app.models.article, app.services.storage_service, app.models.processing, app.api.documents_common, app.database, app.tasks.pipeline_orchestrator, app.schemas.admin, app.services.whisper_service, app.core.redis_url, app.celery_app, app.services.alert_service, app.tasks.pipeline_tasks, app.models.audit, app.models.failed_task, app.models.user, app.api.deps, app.services.embed_client, app.models.chat
[ext_deps]: redis, fastapi, typing, sqlalchemy, os, concurrent, pydantic, datetime, json, asyncio, logging, uuid
...
[local_deps]: app.models.document, app.tasks.article_tasks, app.models.article, app.models.user, app.schemas.article, app.api.deps
...
[local_deps]: app.middleware.csrf, app.utils.security, app.schemas.token, app.schemas.user, app.database, app.core.redis_url, app.utils.constants, app.models.user, app.schemas.auth, app.services.token_blacklist, app.api.deps, app.limiter
[ext_deps]: redis, dotenv, fastapi, secrets, time, sqlalchemy, os, httpx, hashlib, datetime, logging, uuid
...
[local_deps]: app.services.space_service, app.database, app.schemas.tag, app.models.user, app.services.bookmark_service, app.schemas.bookmark, app.api.deps
[ext_deps]: uuid, fastapi, sqlalchemy, logging
...
[local_deps]: app.database, app.schemas.chat, app.services.input_guard, app.services.chat_service, app.models.user, app.models.chat, app.api.deps, app.limiter
[ext_deps]: fastapi, sqlalchemy, json, logging, uuid
...
[local_deps]: app.schemas.collection, app.models.audit, app.models.collection, app.database, app.services.collection_chat_service, app.tasks.document_tasks, app.services.input_guard, app.models.article, app.models.user, app.services.collection_service, app.services.llm_gateway, app.api.deps
[ext_deps]: fastapi, typing, reportlab, sqlalchemy, io, datetime, json, logging, uuid
...
[local_deps]: app.utils.security, app.database, app.utils.constants, app.models.user, app.services.token_blacklist
...
[local_deps]: app.schemas.document, app.models.processing, app.api.documents_common, app.models.audit, app.models.document, app.tasks.pipeline_tasks, app.database, app.models.pipeline, app.tasks.document_tasks, app.tasks.pipeline_orchestrator, app.api.documents_upload, app.models.user, app.tasks.embedding_tasks, app.services.similarity_service, app.api.deps, app.services.storage_service, app.api.documents_journal
[ext_deps]: fastapi, typing, sqlalchemy, concurrent, datetime, asyncio, logging, uuid
...
[local_deps]: app.schemas.document, app.models.pipeline, app.models.document, app.models.audit, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.core.redis_url, app.models.user
[ext_deps]: redis, fastapi, logging, typing, sqlalchemy, os, concurrent, pydantic, datetime, json, mimetypes, asyncio, uuid
...
[local_deps]: app.schemas.document, app.models.document, app.models.audit, app.api.documents_common, app.database, app.services.whisper_service, app.models.user, app.api.deps, app.services.storage_service
[ext_deps]: fastapi, sqlalchemy, os, datetime, logging, tempfile
...
[local_deps]: app.schemas.document, app.models.document, app.models.audit, app.api.documents_common, app.services.document_orchestrator, app.database, app.services.deduplication_service, app.models.user, app.api.deps, app.services.storage_service
[ext_deps]: fastapi, typing, sqlalchemy, logging, uuid
...
[local_deps]: app.services.progressive_revelation_service, app.models.document, app.models.audit, app.database, app.services.temporal_reasoning_service, app.services.graph_rag_service, app.models.user, app.services.synthesis_service, app.services.search_service, app.api.deps
[ext_deps]: fastapi, typing, sqlalchemy, json, logging, uuid
...
[local_deps]: app.database, app.utils.security, app.core.redis_url, app.celery_app
[ext_deps]: nats, redis, fastapi, typing, sqlalchemy, os, httpx, datetime, asyncio, logging
...
[local_deps]: app.models.knowledge_graph, app.services.relationship_service, app.models.document, app.database, app.services.timeline_service, app.services.entity_extraction_service, app.models.user, app.api.deps
[ext_deps]: fastapi, typing, sqlalchemy, datetime, logging, uuid
...
[local_deps]: app.services.space_service, app.models.note, app.database, app.services.note_service, app.schemas.tag, app.models.user, app.schemas.note, app.models.note_audio, app.api.deps
[ext_deps]: fastapi, sqlalchemy, os, datetime, logging, uuid
...
[local_deps]: app.models.pipeline, app.models.document, app.database, app.tasks.pipeline_orchestrator, app.core.redis_url, app.celery_app, app.api.deps
...
[ext_deps]: fastapi, sqlalchemy, os, logging, uuid
...
[local_deps]: app.schemas.reports, app.celery_app, app.models.user, app.tasks.report_tasks, app.api.deps
...
[local_deps]: app.models.document, app.database, app.services.input_guard, app.models.user, app.services.search_models, app.services.search_service, app.services.search_agent, app.api.deps
[ext_deps]: fastapi, time, sqlalchemy, json, asyncio, logging, uuid
...
[ext_deps]: fastapi, sqlalchemy, pydantic, hashlib, logging, uuid
...
[local_deps]: app.schemas.collection, app.models.note, app.models.audit, app.models.smart_folder, app.database, app.schemas.smart_folder, app.tasks.smart_folder_tasks, app.celery_app, app.models.user, app.tasks.collection_report_tasks, app.api.deps
[ext_deps]: fastapi, typing, celery, sqlalchemy, json, asyncio, logging, uuid
...
[local_deps]: app.services.space_service, app.database, app.schemas.tag, app.models.user, app.schemas.space, app.api.deps, app.tasks.space_tasks
[ext_deps]: uuid, fastapi, sqlalchemy, logging
...
[local_deps]: app.schemas.subscription, app.models.subscription, app.database, app.tasks.subscription_tasks, app.models.user, app.api.deps
[ext_deps]: uuid, fastapi, sqlalchemy, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.services.space_service, app.database, app.schemas.task, app.schemas.tag, app.services.task_service, app.models.user, app.api.deps
[ext_deps]: uuid, fastapi, sqlalchemy, logging
...
[local_deps]: app.models.document, app.models.note, app.services.whisper_service, app.models.user, app.models.note_audio, app.api.deps, app.services.storage_service
[ext_deps]: fastapi, sqlalchemy, os, io, asyncio, logging, tempfile, uuid
...
[ext_deps]: pathlib, os, pydantic, urllib, pydantic_settings, logging
...
[ext_deps]: struct, time, os, httpx, urllib, json, logging, base64, cryptography
...
[ext_deps]: dotenv, fastapi, typing, collections, os, sqlalchemy, pgvector
...
[local_deps]: app.middleware.csrf, app.api, app.middleware.transaction, app.services.messaging, app.database, app.core.redis_url, app.middleware.rls, app.services.prometheus_metrics, app.limiter
[ext_deps]: dotenv, contextlib, fastapi, slowapi, redis, typing, time, collections, os, sqlalchemy, uvicorn, logging, threading, starlette, uuid
...
[local_deps]: app.services.embedding_service, app.api, app.database, app.core.redis_url, app.services.cache_monitor, app.services.monitoring, app.services.prometheus_metrics
[ext_deps]: dotenv, contextlib, fastapi, redis, time, sqlalchemy, os, httpx, datetime, logging, uvicorn
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: jose, dataclasses, sqlalchemy, logging, starlette
...
[local_deps]: app.models.pipeline, app.models.document, app.models.collection, app.models.article, app.models.tag, app.models.milestone, app.models.base, app.models.processing, app.models.task, app.models.pattern_insight, app.models.push_subscription, app.models.space, app.models.bookmark, app.models.knowledge_graph, app.models.audit, app.models.smart_folder, app.models.subscription, app.models.failed_task, app.models.user, app.models.note, app.models.chat, app.models.note_audio

---
### FILE: backend/app/models/article.py
[local_deps]: app.models.base, app.models.document
[ext_deps]: sqlalchemy, enum, pgvector, uuid
...
[ext_deps]: typing, time, collections, httpx, asyncio, logging, functools, tenacity
...
[local_deps]: app.schemas.collection, app.schemas.document, app.schemas.token, app.schemas.user, app.schemas.smart_folder, app.schemas.chat, app.schemas.admin, app.schemas.pagination, app.schemas.search
...
[ext_deps]: typing, pydantic, datetime, enum, uuid
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: typing, pydantic, datetime, enum, re, uuid
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.agent_orchestrator, app.services.agents.verification_agent, app.services.agents.clarification_agent, app.services.agents.answer_agent, app.services.agents.researcher_agent
...
[ext_deps]: typing, dataclasses, collections, time, datetime, logging, enum
...
[ext_deps]: typing, dataclasses, json, logging, re
...
[local_deps]: app.services.knowledge_graph.models, app.services.embed_client, app.services.knowledge_graph.pool, app.services.graph_rag_service, app.services.search_service, app.services.llm_gateway, app.services.knowledge_graph.traversal, app.services.agent_identity
[ext_deps]: typing, dataclasses, collections, json, logging, re
...
[ext_deps]: typing, httpx, hashlib, json, asyncio, logging
...
[ext_deps]: typing, sqlalchemy, warnings, datetime, json, logging, uuid
...
[ext_deps]: typing, datetime, json, logging, threading
...
[local_deps]: app.services.context_block_service, app.models.document, app.database, app.services.pii_detection_service, app.services.llm_router, app.services.cache_monitor, app.models.user, app.models.chat, app.services.search_service, app.services.prometheus_metrics, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: typing, time, collections, sqlalchemy, json, asyncio, logging, re, uuid
...
[local_deps]: app.services.context_block_service, app.models.audit, app.models.collection, app.models.document, app.models.user, app.models.chat, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: typing, sqlalchemy, json, logging, uuid
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.schemas.collection, app.models.document, app.models.collection, app.services.search_cache, app.services.intent_parser, app.models.user, app.services.search_service, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: typing, sqlalchemy, datetime, asyncio, logging, uuid
...
[ext_deps]: sqlalchemy, difflib, hashlib, datetime, logging
...
[local_deps]: app.services.llm_gateway
[ext_deps]: typing, os, datetime, logging, uuid
...
[ext_deps]: typing, sqlalchemy, json, asyncio, logging, threading, traceback
...
[local_deps]: app.schemas.document, app.models.pipeline, app.models.document, app.models.audit, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.services.deduplication_service, app.tasks.voice_tasks, app.models.user, app.services.storage_service
[ext_deps]: fastapi, typing, sqlalchemy, concurrent, datetime, json, asyncio, logging
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: random, time, os, httpx, asyncio, logging
[fn]: _base_urls()
...
[ext_deps]: typing, os, psutil, sentence_transformers, torch, asyncio, logging, numpy, threading, gc
...
[ext_deps]: pathlib, onnxruntime, os, transformers, logging, numpy
...
[local_deps]: app.services.llm_gateway, app.models.knowledge_graph, app.models.document, app.services.agent_identity
[ext_deps]: typing, sqlalchemy, warnings, datetime, json, asyncio, logging
...
[local_deps]: app.models.knowledge_graph, app.services.context_block_service, app.models.document, app.services.llm_gateway, app.services.agent_identity
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: typing, warnings, datetime, json, logging, enum, re
...
[ext_deps]: typing, collections, os, httpx, datetime, json, logging, tenacity
...
[ext_deps]: __future__, itertools, json, spacy, asyncpg, logging, models
[fn]: _vec_to_str(vec)
...
[ext_deps]: __future__, pydantic, datetime, enum, uuid
...
[ext_deps]: __future__, json, asyncpg, logging, extraction, models
...
[ext_deps]: collections, typing, logging
...
[local_deps]: app.services.ollama_service, app.services.minimax_service, app.services.pii_detection_service, app.services.kimi_service, app.services.openrouter_service
[ext_deps]: typing, dataclasses, collections, logging, enum
...
[ext_deps]: nats, typing, collections, os, asyncio, logging
...
[ext_deps]: typing, collections, os, httpx, json, logging
...
[ext_deps]: redis, prometheus_client, typing, dataclasses, collections, os, datetime, psutil, logging, subprocess, threading, re
...
[ext_deps]: paddleocr, typing, time, os, cv2, io, pytesseract, PIL, logging, numpy, PyPDF2, enum
...
[local_deps]: app.services.base_llm_service
[ext_deps]: typing, collections, os, httpx, json, logging, tenacity
...
[ext_deps]: redis, typing, collections, os, httpx, hashlib, datetime, json, asyncio, logging, tenacity
[fn]: _get_redis_client()
...
[ext_deps]: typing, sqlalchemy, datetime, psutil, logging, sentence_transformers
...
[local_deps]: app.services.context_block_service, app.models.document, app.models.collection, app.models.user, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: typing, reportlab, sqlalchemy, os, io, datetime, logging, uuid
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.context_block_service, app.models.document, app.database, app.services.llm_router, app.services.search_cache, app.models.user, app.services.search_service, app.services.agent_identity
[ext_deps]: search_models, typing, time, sqlalchemy, json, asyncio, logging, re, uuid
...
[local_deps]: app.core.redis_url
[ext_deps]: redis, typing, hashlib, json, logging
[fn]: _get_redis()
...
[local_deps]: app.services.rerank_service, app.services.embed_client, app.models.document, app.services.pii_detection_service, app.services.search_cache, app.models.user
[ext_deps]: typing, sqlalchemy, asyncio, logging, re
...
[ext_deps]: typing, dataclasses, collections, json, logging
...
[ext_deps]: typing, sqlalchemy, logging, numpy, re
...
[local_deps]: app.services.smart_folder.query_parser, app.services.smart_folder.agent.synthesizer, app.models.smart_folder, app.services.smart_folder.agent.executor, app.services.smart_folder.entity_resolver, app.services.smart_folder.report_generator, app.services.smart_folder.agent.planner, app.models.user
[ext_deps]: typing, sqlalchemy, logging, re, uuid
...
[ext_deps]: typing, dataclasses, sqlalchemy, datetime, logging, uuid
...
[local_deps]: app.services.llm_router
[ext_deps]: typing, dataclasses, datetime, json, logging
...
[ext_deps]: typing, dataclasses, json, logging, re, uuid
...
[local_deps]: app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.base, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.sentiment_tracker
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.skills.base, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor
[ext_deps]: typing, logging
...
[local_deps]: app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor
...
[ext_deps]: typing, csv, io, json, logging, re
...
[local_deps]: app.models.document, app.models.collection, app.models.user, app.services.search_service, app.services.llm_gateway
[ext_deps]: typing, sqlalchemy, datetime, logging, re, uuid
...
[local_deps]: app.models.document, app.models.note, app.models.space, app.models.user, app.models.tag, app.models.bookmark
[ext_deps]: uuid, sqlalchemy, logging
[fn]: _escape_like(value)
...
[ext_deps]: pathlib, os, datetime, logging, base64, cryptography, uuid
...
[ext_deps]: contextlib, pathlib, typing, time, collections, os, sys, datetime, json, logging
...
[ext_deps]: nats, typing, datetime, json, asyncio, logging, enum, abc, uuid
...
[local_deps]: app.services.messaging
[ext_deps]: nats, typing, time, dataclasses, hashlib, datetime, json, logging, enum
...
[local_deps]: app.services.messaging
[ext_deps]: nats, typing, dataclasses, datetime, json, asyncio, logging, enum, uuid
...
[local_deps]: app.models.knowledge_graph, app.services.context_block_service, app.models.document, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: typing, collections, sqlalchemy, datetime, json, logging
...
[ext_deps]: os, httpx, datetime, json, logging
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: typing, collections, sqlalchemy, datetime, logging
...
[ext_deps]: pathlib, pptx, ebooklib, typing, os, csv, sys, html, json, docx, xml, logging, subprocess, PyPDF2, zipfile, re
...
[local_deps]: app.models.processing, app.models.document, app.database, app.tasks.pipeline_orchestrator, app.tasks.base, app.celery_app, app.core.redis_url, app.services.cache_monitor, app.services.monitoring, app.services.alert_service
[ext_deps]: redis, celery, os, datetime, asyncio, logging
...
[local_deps]: app.services.embed_client, app.models.document, app.services.article_generation_service, app.database, app.tasks.base, app.models.article
...
[local_deps]: app.models.document, app.database, app.tasks.pipeline_orchestrator, app.tasks.embedding_tasks, app.models.article, app.tasks.article_tasks
...
[ext_deps]: os, psutil, asyncio, logging, traceback
...
[ext_deps]: typing, celery, sqlalchemy, json, asyncio, logging, uuid
...
[local_deps]: app.models.processing, app.models.document, app.services.embed_client, app.services.context_block_service, app.services.dlq_service, app.database, app.tasks.base, app.tasks.pipeline_orchestrator, app.services.chunking_service, app.services.entity_extraction_service, app.services.collection_service, app.tasks.embedding_tasks, app.services.prometheus_metrics, app.services.text_extractor, app.tasks.article_tasks, app.services.ocr_service
[ext_deps]: celery, sqlalchemy, os, datetime, asyncio, logging, langdetect, traceback, tempfile, uuid
...
[local_deps]: app.services.embed_client, app.models.document, app.database, app.tasks.base, app.celery_app
...
[local_deps]: app.models.pipeline, app.models.document, app.database, app.core.redis_url, app.celery_app
[ext_deps]: redis, email, smtplib, sqlalchemy, os, datetime, logging
[fn]: _smtp_configured()
...
[local_deps]: app.models.pipeline, app.tasks.pipeline_tasks, app.models.document, app.database, app.core.redis_url
[ext_deps]: redis, celery, datetime, logging, uuid
...
[local_deps]: app.models.pipeline, app.models.document, app.database, app.tasks.pipeline_orchestrator, app.core.redis_url, app.celery_app
[ext_deps]: redis, sqlalchemy, os, datetime, logging
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.knowledge_graph.extraction, app.models.pipeline, app.services.embed_client, app.models.document, app.services.dlq_service, app.database, app.tasks.document_tasks, app.celery_app, app.services.chunking_service, app.services.entity_extraction_service, app.services.knowledge_graph.pool, app.services.text_extractor, app.tasks.article_tasks, app.services.ocr_service
[ext_deps]: celery, time, os, datetime, asyncio, logging, gc, traceback, tempfile, uuid
...
[ext_deps]: celery, time, sqlalchemy, os, datetime, fpdf, openpyxl, logging
...
[local_deps]: app.models.document, app.models.audit, app.models.smart_folder, app.database, app.services.smart_folder.agent_runner, app.tasks.base, app.services.smart_folder_service, app.models.user
[ext_deps]: typing, celery, sqlalchemy, datetime, json, asyncio, logging, uuid
...
[local_deps]: app.database, app.models.space, app.services.space_service, app.tasks.base
...
[ext_deps]: email, smtplib, sqlalchemy, os, httpx, datetime, logging, calendar
...
[local_deps]: app.models.task, app.core.push, app.database, app.models.push_subscription, app.celery_app, app.services.task_service
...
[ext_deps]: sqlalchemy, os, asyncio, logging, tempfile
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: typing, time, collections, asyncio, logging, functools, threading
...
[ext_deps]: dotenv, fastapi, jose, typing, sqlalchemy, os, datetime, logging, bcrypt
