...
# [hub]: app.models.document → imported 46 times
# [hub]: app.database → imported 41 times
# [hub]: app.models.user → imported 40 times
# [hub]: app.api.deps → imported 21 times
# [hub]: app.models.base → imported 21 times
# [hub]: app.services.llm_gateway → imported 19 times
# [hub]: app.core.redis_url → imported 16 times
...
[local_deps]: app.core.redis_url, app.models.article, app.services.whisper_service, app.models.user, app.schemas.user, app.utils.security, app.schemas.admin, app.models.audit, app.api.deps, app.models.processing, app.services.alert_service, app.models.document, app.models.pipeline, app.tasks.document_tasks, app.models.chat, app.models.failed_task, app.database
[ext_deps]: os, sqlalchemy, typing, fastapi, redis, uuid, datetime, logging, json
...
[local_deps]: app.models.article, app.schemas.article, app.models.user, app.tasks.article_tasks, app.api.deps, app.models.document
...
[local_deps]: app.core.redis_url, app.schemas.auth, app.models.user, app.middleware.csrf, app.limiter, app.schemas.token, app.schemas.user, app.utils.security, app.api.deps, app.utils.constants, app.services.token_blacklist, app.database
[ext_deps]: os, sqlalchemy, hashlib, fastapi, time, datetime, redis, uuid, httpx, dotenv, secrets, logging
...
[local_deps]: app.services.space_service, app.models.user, app.api.deps, app.services.bookmark_service, app.schemas.bookmark, app.schemas.tag, app.database
[ext_deps]: sqlalchemy, logging, uuid, fastapi
...
[local_deps]: app.services.chat_service, app.services.input_guard, app.models.user, app.limiter, app.api.deps, app.models.chat, app.schemas.chat, app.database
[ext_deps]: fastapi, logging, uuid, sqlalchemy, json
...
[local_deps]: app.models.collection, app.models.article, app.services.collection_chat_service, app.services.input_guard, app.models.user, app.models.audit, app.api.deps, app.services.collection_service, app.services.llm_gateway, app.schemas.collection, app.tasks.document_tasks, app.database
[ext_deps]: sqlalchemy, typing, fastapi, uuid, io, reportlab, datetime, logging, json
...
[local_deps]: app.models.user, app.utils.security, app.utils.constants, app.services.token_blacklist, app.database
...
[local_deps]: app.services.similarity_service, app.schemas.document, app.models.user, app.tasks.embedding_tasks, app.models.audit, app.api.deps, app.services.storage_service, app.api.documents_common, app.api.documents_upload, app.models.processing, app.models.document, app.tasks.document_tasks, app.models.pipeline, app.api.documents_journal, app.database
[ext_deps]: sqlalchemy, fastapi, typing, uuid, datetime, logging
...
[local_deps]: app.schemas.document, app.models.user, app.models.audit, app.models.document, app.models.pipeline, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks
[ext_deps]: os, sqlalchemy, typing, fastapi, concurrent, pydantic, uuid, asyncio, datetime, logging, json
...
[local_deps]: app.schemas.document, app.services.whisper_service, app.models.user, app.models.audit, app.api.deps, app.services.storage_service, app.api.documents_common, app.models.document, app.database
[ext_deps]: os, sqlalchemy, fastapi, tempfile, datetime, logging
...
[local_deps]: app.schemas.document, app.models.user, app.models.audit, app.api.deps, app.services.deduplication_service, app.api.documents_common, app.services.storage_service, app.models.document, app.services.document_orchestrator, app.database
...
[local_deps]: app.services.synthesis_service, app.models.user, app.models.audit, app.api.deps, app.services.search_service, app.models.document, app.services.progressive_revelation_service, app.services.temporal_reasoning_service, app.services.graph_rag_service, app.database
[ext_deps]: sqlalchemy, typing, fastapi, uuid, logging, json
...
[ext_deps]: os, sqlalchemy, typing, fastapi, redis, asyncio, httpx, nats, datetime, logging
...
[ext_deps]: os, sqlalchemy, fastapi, hmac, logging
...
[local_deps]: app.models.knowledge_graph, app.models.user, app.services.entity_extraction_service, app.api.deps, app.services.relationship_service, app.services.timeline_service, app.models.document, app.database
[ext_deps]: fastapi, typing, logging, uuid, datetime, sqlalchemy
...
[local_deps]: app.models.note, app.database, app.services.space_service, app.models.user, app.api.deps, app.models.note_audio, app.services.note_service, app.schemas.tag, app.schemas.note
[ext_deps]: os, fastapi, logging, uuid, datetime, sqlalchemy
...
[local_deps]: app.core.redis_url, app.api.deps, app.tasks.pipeline_orchestrator, app.models.pipeline, app.models.document, app.celery_app, app.database
...
[local_deps]: app.models.user, app.api.deps, app.schemas.reports, app.celery_app, app.tasks.report_tasks
[ext_deps]: logging, fastapi, typing, celery
...
[local_deps]: app.services.input_guard, app.models.user, app.api.deps, app.services.search_agent, app.services.search_service, app.models.document, app.services.search_models, app.database
[ext_deps]: sqlalchemy, fastapi, logging, uuid, asyncio, time, json
...
[ext_deps]: sqlalchemy, hashlib, fastapi, pydantic, uuid, logging
...
[local_deps]: app.tasks.smart_folder_tasks, app.models.note, app.models.smart_folder, app.models.user, app.schemas.smart_folder, app.models.audit, app.api.deps, app.schemas.collection, app.celery_app, app.tasks.collection_report_tasks, app.database
[ext_deps]: sqlalchemy, typing, fastapi, uuid, asyncio, logging, json, celery
...
[local_deps]: app.services.space_service, app.models.user, app.tasks.space_tasks, app.schemas.space, app.api.deps, app.schemas.tag, app.database
[ext_deps]: sqlalchemy, logging, uuid, fastapi
...
[local_deps]: app.models.note, app.services.whisper_service, app.models.user, app.api.deps, app.services.storage_service, app.models.note_audio, app.models.document
[ext_deps]: os, sqlalchemy, fastapi, tempfile, uuid, io, asyncio, logging
...
[ext_deps]: os, fastapi, typing, pgvector, collections, dotenv, sqlalchemy
...
[local_deps]: app.services.messaging, app.core.redis_url, app.middleware.csrf, app.limiter, app.services.prometheus_metrics, app.api, app.middleware.transaction, app.database, app.middleware.rls
[ext_deps]: os, sqlalchemy, typing, fastapi, time, contextlib, threading, slowapi, uuid, redis, collections, uvicorn, dotenv, starlette, logging
...
[local_deps]: app.core.redis_url, app.services.monitoring, app.api, app.services.prometheus_metrics, app.services.embedding_service, app.services.cache_monitor, app.database
[ext_deps]: os, sqlalchemy, fastapi, time, contextlib, redis, httpx, uvicorn, dotenv, datetime, logging
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: logging, dataclasses, jose, starlette, sqlalchemy
...
[local_deps]: app.models.collection, app.models.article, app.models.smart_folder, app.models.user, app.models.bookmark, app.models.audit, app.models.tag, app.models.space, app.models.processing, app.models.note_audio, app.models.document, app.models.chat, app.models.pattern_insight, app.models.note, app.models.knowledge_graph, app.models.base, app.models.milestone, app.models.pipeline, app.models.failed_task
...
[ext_deps]: typing, logging, tenacity, functools, asyncio, httpx, collections, time
...
[local_deps]: app.database
[ext_deps]: hashlib, sqlalchemy, json, functools
...
[local_deps]: app.schemas.document, app.schemas.smart_folder, app.schemas.user, app.schemas.token, app.schemas.chat, app.schemas.search, app.schemas.admin, app.schemas.pagination, app.schemas.collection
...
[ext_deps]: typing, pydantic, uuid, enum, datetime
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: datetime, pydantic, uuid, typing
...
[ext_deps]: typing, pydantic, uuid, re, enum, datetime
[class]: UserRole { methods: [] }
...
[ext_deps]: typing, time, dataclasses, enum, collections, datetime, logging
...
[ext_deps]: typing, dataclasses, re, logging, json
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: logging, json, dataclasses, typing
...
[local_deps]: app.services.agent_identity, app.services.knowledge_graph.traversal, app.services.knowledge_graph.models, app.services.llm_gateway, app.services.knowledge_graph.pool, app.services.embed_client, app.services.search_service, app.services.graph_rag_service
[ext_deps]: typing, dataclasses, re, collections, logging, json
...
[local_deps]: app.services.llm_gateway
[ext_deps]: hashlib, typing, asyncio, logging, json
...
[local_deps]: app.models.document, app.models.tag, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: sqlalchemy, warnings, typing, uuid, datetime, logging, json
...
[ext_deps]: urllib, logging, uuid, sqlalchemy
...
[ext_deps]: typing, threading, datetime, logging, json
...
[local_deps]: app.models.user, app.services.agent_identity, app.services.llm_gateway, app.services.llm_router, app.services.prometheus_metrics, app.services.search_service, app.models.document, app.services.context_block_service, app.models.chat, app.services.pii_detection_service, app.services.cache_monitor, app.database
[ext_deps]: sqlalchemy, typing, logging, uuid, asyncio, re, collections, time, json
...
[local_deps]: app.models.collection, app.models.user, app.services.agent_identity, app.models.audit, app.services.llm_gateway, app.models.document, app.services.context_block_service, app.models.chat
[ext_deps]: typing, logging, uuid, sqlalchemy, json
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.models.collection, app.models.user, app.services.agent_identity, app.services.intent_parser, app.services.search_cache, app.services.llm_gateway, app.services.search_service, app.models.document, app.schemas.collection
[ext_deps]: sqlalchemy, typing, uuid, asyncio, datetime, logging
...
[ext_deps]: sqlalchemy, hashlib, datetime, logging, difflib
...
[ext_deps]: typing, logging, threading, traceback, asyncio, sqlalchemy, json
...
[local_deps]: app.schemas.document, app.models.user, app.models.audit, app.tasks.voice_tasks, app.services.deduplication_service, app.services.storage_service, app.models.document, app.models.pipeline, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks
[ext_deps]: sqlalchemy, fastapi, typing, concurrent, asyncio, datetime, logging
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: os, time, asyncio, httpx, logging, itertools
[fn]: _base_urls()
[fn]: _base_url()
...
[ext_deps]: os, gc, typing, torch, threading, numpy, asyncio, psutil, sentence_transformers, logging
...
[local_deps]: app.models.document, app.models.knowledge_graph, app.services.llm_gateway, app.services.agent_identity
[ext_deps]: sqlalchemy, warnings, typing, asyncio, datetime, logging, json
...
[ext_deps]: typing, logging, re, collections, sqlalchemy
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: warnings, typing, re, enum, datetime, logging, json
...
[ext_deps]: os, typing, tenacity, httpx, collections, datetime, logging, json
...
[ext_deps]: spacy, asyncpg, __future__, models, logging, json, itertools
[fn]: _vec_to_str(vec)
...
[ext_deps]: pydantic, uuid, __future__, enum, datetime
...
[ext_deps]: extraction, asyncpg, __future__, models, logging, json
...
[local_deps]: app.services.kimi_service, app.services.openrouter_service, app.services.pii_detection_service, app.services.ollama_service, app.services.minimax_service
[ext_deps]: typing, dataclasses, enum, collections, logging
...
[ext_deps]: os, typing, asyncio, nats, collections, logging
...
[ext_deps]: os, typing, httpx, collections, logging, json
...
[ext_deps]: os, typing, threading, dataclasses, redis, prometheus_client, subprocess, re, psutil, collections, datetime, logging
...
[ext_deps]: os, typing, time, numpy, pytesseract, PIL, cv2, io, PyPDF2, paddleocr, enum, logging
...
[local_deps]: app.services.base_llm_service
[ext_deps]: os, typing, tenacity, httpx, collections, logging, json
...
[ext_deps]: os, hashlib, typing, redis, httpx, collections, datetime, logging, json
...
[ext_deps]: typing, logging, functools, collections, time
...
[ext_deps]: sqlalchemy, logging, collections, typing
...
[local_deps]: app.models.collection, app.models.user, app.services.agent_identity, app.services.llm_gateway, app.models.document, app.services.context_block_service
[ext_deps]: sqlalchemy, os, typing, uuid, io, reportlab, datetime, logging
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.models.user, app.services.agent_identity, app.services.search_cache, app.services.llm_router, app.services.search_service, app.models.document, app.services.context_block_service, app.database
[ext_deps]: sqlalchemy, typing, logging, uuid, asyncio, re, search_models, time, json
...
[local_deps]: app.core.redis_url
[ext_deps]: hashlib, typing, redis, logging, json
[fn]: _get_redis()
...
[local_deps]: app.models.user, app.services.rerank_service, app.services.search_cache, app.services.embed_client, app.models.document, app.services.pii_detection_service
[ext_deps]: typing, logging, asyncio, re, sqlalchemy
...
[ext_deps]: typing, dataclasses, collections, logging, json
...
[ext_deps]: typing, logging, numpy, re, sqlalchemy
...
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator
...
[local_deps]: app.models.smart_folder, app.models.user, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.query_parser, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.executor, app.services.smart_folder.agent.planner, app.services.smart_folder.report_generator
...
[ext_deps]: sqlalchemy, typing, dataclasses, uuid, datetime, logging
...
[ext_deps]: typing, logging, dataclasses, sqlalchemy, difflib
...
[local_deps]: app.services.llm_router
[ext_deps]: typing, dataclasses, datetime, logging, json
...
[ext_deps]: typing, dataclasses, uuid, re, logging, json
...
[local_deps]: app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.base, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.financial_analysis
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor
[ext_deps]: logging, typing
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.tools.document_reader, app.services.smart_folder.report_generator
...
[local_deps]: app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.refinement_parser
...
[ext_deps]: typing, io, re, csv, logging, json
...
[ext_deps]: sqlalchemy, typing, uuid, re, datetime, logging
...
[local_deps]: app.models.note, app.models.user, app.models.bookmark, app.models.space, app.models.document, app.models.tag
[ext_deps]: sqlalchemy, logging, uuid
[fn]: _escape_like(value)
...
[ext_deps]: os, base64, uuid, cryptography, pathlib, datetime, logging
...
[ext_deps]: os, typing, contextlib, time, sys, collections, pathlib, datetime, logging, json
...
[ext_deps]: typing, uuid, asyncio, abc, enum, nats, datetime, logging, json
...
[local_deps]: app.services.messaging
[ext_deps]: hashlib, typing, time, dataclasses, enum, nats, datetime, logging, json
...
[local_deps]: app.services.messaging
[ext_deps]: typing, dataclasses, uuid, asyncio, enum, nats, datetime, logging, json
...
[local_deps]: app.services.messaging
[ext_deps]: typing, nats, datetime, logging, json
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.llm_gateway, app.models.document, app.services.context_block_service
[ext_deps]: sqlalchemy, typing, collections, datetime, logging, json
...
[ext_deps]: os, httpx, datetime, logging, json
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: sqlalchemy, typing, collections, datetime, logging
...
[ext_deps]: typing, xml, zipfile, docx, ebooklib, subprocess, csv, PyPDF2, html, openpyxl, re, pptx, pathlib, logging, json
...
[local_deps]: app.core.redis_url, app.models.processing, app.services.monitoring, app.celery_app, app.services.alert_service, app.tasks.base, app.models.document, app.tasks.document_tasks, app.services.cache_monitor, app.database
[ext_deps]: os, redis, asyncio, datetime, logging, celery
...
[local_deps]: app.models.article, app.services.embed_client, app.tasks.base, app.services.article_generation_service, app.models.document, app.database
...
[local_deps]: app.models.article, app.tasks.article_tasks, app.tasks.embedding_tasks, app.models.document, app.tasks.document_tasks, app.database
...
[ext_deps]: os, asyncio, traceback, psutil, logging
...
[ext_deps]: sqlalchemy, typing, uuid, asyncio, logging, json, celery
...
[local_deps]: app.services.chunking_service, app.tasks.article_tasks, app.services.entity_extraction_service, app.tasks.embedding_tasks, app.models.processing, app.services.collection_service, app.services.embed_client, app.services.prometheus_metrics, app.tasks.base, app.models.document, app.services.context_block_service, app.services.text_extractor, app.services.ocr_service, app.services.dlq_service, app.database
[ext_deps]: sqlalchemy, os, langdetect, tempfile, uuid, asyncio, traceback, datetime, logging, celery
...
[local_deps]: app.core.redis_url, app.models.pipeline, app.tasks.pipeline_tasks, app.database
[ext_deps]: datetime, redis, logging, celery
...
[local_deps]: app.core.redis_url, app.tasks.pipeline_orchestrator, app.models.pipeline, app.models.document, app.celery_app, app.database
[ext_deps]: os, sqlalchemy, redis, datetime, logging
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.knowledge_graph.extraction, app.services.chunking_service, app.tasks.article_tasks, app.services.entity_extraction_service, app.services.knowledge_graph.pool, app.services.embed_client, app.models.pipeline, app.models.document, app.tasks.document_tasks, app.services.text_extractor, app.services.ocr_service, app.services.dlq_service, app.celery_app, app.database
[ext_deps]: os, gc, time, tempfile, uuid, asyncio, traceback, datetime, logging, celery
...
[ext_deps]: os, sqlalchemy, time, openpyxl, datetime, logging, fpdf, celery
...
[local_deps]: app.services.smart_folder_service, app.models.smart_folder, app.models.user, app.models.audit, app.tasks.base, app.models.document, app.services.smart_folder.agent_runner, app.database
[ext_deps]: sqlalchemy, typing, uuid, asyncio, datetime, logging, json, celery
...
[ext_deps]: os, sqlalchemy, tempfile, asyncio, logging
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: typing, logging, threading, functools, asyncio, collections, time
...
[ext_deps]: os, sqlalchemy, typing, fastapi, jose, dotenv, datetime, logging, bcrypt
