...
# [hub]: app.database → imported 42 times
...
# [hub]: app.celery_app → imported 12 times
"""
...
[local_deps]: app.core.redis_url, app.services.whisper_service, app.schemas.user, app.tasks.document_tasks, app.models.article, app.celery_app, app.services.storage_service, app.models.pipeline, app.services.embed_client, app.database, app.utils.security, app.services.alert_service, app.models.processing, app.api.documents_common, app.api.deps, app.tasks.pipeline_tasks, app.models.user, app.schemas.admin, app.models.chat, app.models.document, app.models.failed_task, app.models.audit, app.tasks.pipeline_orchestrator
[ext_deps]: datetime, redis, uuid, sqlalchemy, logging, json, pydantic, os, fastapi, typing
...
[local_deps]: app.api.deps, app.tasks.article_tasks, app.models.document, app.schemas.article, app.models.user, app.models.article
...
[local_deps]: app.api.deps, app.services.token_blacklist, app.schemas.token, app.middleware.csrf, app.core.redis_url, app.schemas.auth, app.models.user, app.utils.constants, app.database, app.schemas.user, app.utils.security, app.limiter
[ext_deps]: secrets, datetime, hashlib, redis, dotenv, uuid, httpx, sqlalchemy, logging, time, os, fastapi
...
[local_deps]: app.api.deps, app.schemas.bookmark, app.database, app.services.space_service, app.models.user, app.schemas.tag, app.services.bookmark_service
[ext_deps]: uuid, sqlalchemy, fastapi, logging
...
[local_deps]: app.api.deps, app.services.chat_service, app.models.chat, app.schemas.chat, app.models.user, app.database, app.services.input_guard, app.limiter
...
[local_deps]: app.api.deps, app.services.collection_chat_service, app.tasks.document_tasks, app.models.user, app.database, app.schemas.collection, app.models.audit, app.services.llm_gateway, app.models.collection, app.services.collection_service, app.services.input_guard, app.models.article
[ext_deps]: io, datetime, uuid, sqlalchemy, logging, json, reportlab, fastapi, typing
...
[local_deps]: app.api.documents_common, app.models.processing, app.api.deps, app.services.similarity_service, app.tasks.embedding_tasks, app.models.document, app.api.documents_upload, app.models.audit, app.services.storage_service, app.models.pipeline, app.models.user, app.database, app.api.documents_journal, app.tasks.document_tasks, app.schemas.document
[ext_deps]: datetime, uuid, sqlalchemy, logging, fastapi, typing
...
[local_deps]: app.core.redis_url, app.models.document, app.models.pipeline, app.tasks.pipeline_tasks, app.models.user, app.models.audit, app.tasks.pipeline_orchestrator, app.schemas.document
[ext_deps]: datetime, asyncio, redis, concurrent, uuid, mimetypes, sqlalchemy, logging, json, pydantic, os, fastapi, typing
...
[local_deps]: app.api.documents_common, app.api.deps, app.services.whisper_service, app.models.document, app.services.storage_service, app.models.user, app.database, app.models.audit, app.schemas.document
[ext_deps]: datetime, tempfile, sqlalchemy, logging, os, fastapi
...
[local_deps]: app.api.documents_common, app.api.deps, app.services.document_orchestrator, app.services.deduplication_service, app.models.document, app.services.storage_service, app.models.user, app.database, app.models.audit, app.schemas.document
[ext_deps]: uuid, sqlalchemy, logging, fastapi, typing
...
[local_deps]: app.services.synthesis_service, app.api.deps, app.services.graph_rag_service, app.database, app.models.document, app.services.search_service, app.services.temporal_reasoning_service, app.models.user, app.models.audit, app.services.progressive_revelation_service
[ext_deps]: uuid, sqlalchemy, logging, json, fastapi, typing
...
[ext_deps]: datetime, asyncio, redis, nats, httpx, sqlalchemy, logging, os, fastapi, typing
...
[ext_deps]: sqlalchemy, logging, hmac, os, fastapi
...
[local_deps]: app.api.deps, app.services.entity_extraction_service, app.models.knowledge_graph, app.services.relationship_service, app.services.timeline_service, app.models.document, app.models.user, app.database
[ext_deps]: datetime, uuid, sqlalchemy, logging, fastapi, typing
...
[local_deps]: app.api.deps, app.schemas.note, app.models.note, app.services.space_service, app.database, app.models.note_audio, app.services.note_service, app.models.user, app.schemas.tag
[ext_deps]: datetime, uuid, sqlalchemy, logging, os, fastapi
...
[local_deps]: app.api.deps, app.core.redis_url, app.celery_app, app.models.document, app.models.pipeline, app.database, app.tasks.pipeline_orchestrator
...
[local_deps]: app.api.deps, app.services.search_models, app.services.search_agent, app.models.document, app.services.search_service, app.models.user, app.database, app.services.input_guard
[ext_deps]: asyncio, uuid, time, logging, json, sqlalchemy, fastapi
...
[ext_deps]: hashlib, uuid, sqlalchemy, logging, pydantic, fastapi
...
[local_deps]: app.api.deps, app.models.note, app.celery_app, app.tasks.collection_report_tasks, app.tasks.smart_folder_tasks, app.schemas.smart_folder, app.models.user, app.database, app.models.smart_folder, app.models.audit, app.schemas.collection
[ext_deps]: celery, asyncio, uuid, sqlalchemy, logging, json, fastapi, typing
...
[local_deps]: app.api.deps, app.tasks.space_tasks, app.schemas.space, app.services.space_service, app.database, app.models.user, app.schemas.tag
[ext_deps]: uuid, sqlalchemy, fastapi, logging
...
[local_deps]: app.api.deps, app.core.redis_url, app.models.user, app.services.llm_gateway, app.tasks.pipeline_orchestrator
...
[local_deps]: app.api.deps, app.services.whisper_service, app.models.document, app.models.note_audio, app.services.storage_service, app.models.user, app.models.note
[ext_deps]: io, asyncio, uuid, tempfile, sqlalchemy, logging, os, fastapi
...
[ext_deps]: pydantic_settings, pathlib, logging, urllib, pydantic, os
...
[ext_deps]: collections, dotenv, sqlalchemy, pgvector, os, fastapi, typing
...
[local_deps]: app.api, app.services.messaging, app.services.prometheus_metrics, app.middleware.csrf, app.middleware.transaction, app.core.redis_url, app.database, app.middleware.rls, app.limiter
[ext_deps]: collections, starlette, redis, uvicorn, contextlib, dotenv, slowapi, uuid, time, logging, threading, sqlalchemy, os, fastapi, typing
...
[local_deps]: app.services.embedding_service, app.api, app.services.prometheus_metrics, app.services.cache_monitor, app.core.redis_url, app.services.monitoring, app.database
[ext_deps]: datetime, redis, uvicorn, contextlib, dotenv, httpx, time, logging, sqlalchemy, os, fastapi
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[local_deps]: app.models.base, app.models.pattern_insight, app.models.collection, app.models.article, app.models.space, app.models.pipeline, app.models.smart_folder, app.models.processing, app.models.knowledge_graph, app.models.tag, app.models.audit, app.models.milestone, app.models.user, app.models.chat, app.models.bookmark, app.models.document, app.models.note_audio, app.models.failed_task, app.models.note
...
[local_deps]: app.models.base
[ext_deps]: uuid, datetime, enum, sqlalchemy
...
[ext_deps]: collections, asyncio, tenacity, httpx, time, logging, functools, typing
...
[local_deps]: app.schemas.admin, app.schemas.pagination, app.schemas.token, app.schemas.search, app.schemas.smart_folder, app.schemas.chat, app.schemas.collection, app.schemas.user, app.schemas.document
...
[ext_deps]: datetime, uuid, enum, pydantic, typing
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: datetime, uuid, enum, re, pydantic, typing
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.researcher_agent, app.services.agents.verification_agent, app.services.agents.clarification_agent, app.services.agents.agent_orchestrator, app.services.agents.answer_agent

---
### FILE: backend/app/services/agents/agent_orchestrator.py
[local_deps]: app.services.agents.answer_agent, app.services.agents.clarification_agent, app.services.agents.researcher_agent, app.services.agents.verification_agent
[ext_deps]: datetime, collections, enum, time, dataclasses, logging, typing
...
[ext_deps]: dataclasses, logging, re, json, typing
...
[local_deps]: app.services.graph_rag_service, app.services.knowledge_graph.models, app.services.knowledge_graph.pool, app.services.knowledge_graph.traversal, app.services.search_service, app.services.embed_client, app.services.agent_identity, app.services.llm_gateway
[ext_deps]: collections, dataclasses, logging, re, json, typing
...
[ext_deps]: datetime, logging, threading, json, typing
...
[local_deps]: app.models.chat, app.database, app.services.prometheus_metrics, app.services.llm_gateway, app.services.cache_monitor, app.services.pii_detection_service, app.services.context_block_service, app.models.document, app.services.search_service, app.models.user, app.services.agent_identity, app.services.llm_router
[ext_deps]: collections, asyncio, uuid, time, logging, re, json, sqlalchemy, typing
...
[local_deps]: app.models.chat, app.models.document, app.services.context_block_service, app.services.agent_identity, app.models.user, app.models.audit, app.services.llm_gateway, app.models.collection
...
[local_deps]: app.services.search_cache, app.services.intent_parser, app.models.document, app.services.search_service, app.schemas.collection, app.models.user, app.services.agent_identity, app.services.llm_gateway, app.models.collection
[ext_deps]: datetime, asyncio, uuid, sqlalchemy, logging, typing
...
[ext_deps]: datetime, hashlib, sqlalchemy, logging, difflib
...
[local_deps]: app.services.llm_gateway
[ext_deps]: datetime, uuid, logging, os, typing
...
[ext_deps]: asyncio, traceback, sqlalchemy, logging, json, threading, typing
...
[local_deps]: app.services.deduplication_service, app.models.document, app.services.storage_service, app.models.pipeline, app.tasks.pipeline_tasks, app.models.user, app.tasks.voice_tasks, app.models.audit, app.tasks.pipeline_orchestrator, app.schemas.document
[ext_deps]: datetime, asyncio, concurrent, sqlalchemy, logging, json, fastapi, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: asyncio, random, httpx, time, logging, os
[fn]: _base_urls()
...
[ext_deps]: asyncio, gc, sentence_transformers, psutil, torch, numpy, logging, threading, os, typing
...
[ext_deps]: datetime, asyncio, sqlalchemy, warnings, logging, json, typing
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.services.context_block_service, app.services.agent_identity, app.services.llm_gateway
[ext_deps]: collections, sqlalchemy, logging, re, typing
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: datetime, enum, warnings, re, logging, json, typing
...
[ext_deps]: datetime, collections, tenacity, httpx, logging, json, os, typing
...
[ext_deps]: itertools, models, asyncpg, __future__, logging, json, spacy
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, uuid, enum, __future__, pydantic
...
[ext_deps]: models, asyncpg, __future__, logging, json, extraction
...
[local_deps]: app.services.ollama_service, app.services.pii_detection_service, app.services.kimi_service, app.services.openrouter_service, app.services.minimax_service
[ext_deps]: collections, enum, dataclasses, logging, typing
...
[ext_deps]: collections, asyncio, nats, logging, os, typing
...
[ext_deps]: collections, httpx, logging, json, os, typing
...
[ext_deps]: datetime, collections, redis, psutil, prometheus_client, subprocess, logging, dataclasses, threading, re, os, typing
...
[ext_deps]: io, PyPDF2, PIL, pytesseract, numpy, enum, time, logging, paddleocr, cv2, os, typing
...
[local_deps]: app.services.base_llm_service
[ext_deps]: collections, tenacity, httpx, logging, json, os, typing
...
[ext_deps]: datetime, hashlib, collections, redis, tenacity, httpx, logging, json, os, typing
[fn]: _get_redis_client()
...
[ext_deps]: datetime, sentence_transformers, psutil, sqlalchemy, logging, typing
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.models.user, app.services.agent_identity, app.services.llm_gateway
...
[ext_deps]: typing, collections, logging, sqlalchemy
...
[local_deps]: app.models.document, app.services.context_block_service, app.models.user, app.services.agent_identity, app.services.llm_gateway, app.models.collection
[ext_deps]: datetime, io, uuid, sqlalchemy, logging, reportlab, os, typing
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.database, app.services.search_cache, app.models.document, app.services.context_block_service, app.services.search_service, app.models.user, app.services.agent_identity, app.services.llm_router
[ext_deps]: search_models, asyncio, uuid, time, logging, re, json, sqlalchemy, typing
...
[local_deps]: app.core.redis_url
[ext_deps]: hashlib, redis, logging, json, typing
[fn]: _get_redis()
...
[ext_deps]: collections, dataclasses, logging, json, typing
...
[local_deps]: app.services.smart_folder.entity_resolver, app.services.smart_folder.analysis, app.services.smart_folder.query_parser, app.services.smart_folder.retrieval, app.services.smart_folder.report_generator
...
[local_deps]: app.services.smart_folder.agent.planner, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.executor, app.services.smart_folder.query_parser, app.services.smart_folder.agent.synthesizer, app.models.user, app.models.smart_folder, app.services.smart_folder.report_generator
...
[ext_deps]: datetime, uuid, sqlalchemy, dataclasses, logging, typing
...
[ext_deps]: uuid, dataclasses, re, logging, json, typing
...
[local_deps]: app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.base, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.financial_analysis
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.vault_search, app.services.smart_folder.skills.base, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.tools.document_reader, app.services.smart_folder.skills.base, app.services.smart_folder.retrieval, app.services.smart_folder.report_generator
...
[ext_deps]: io, csv, logging, re, json, typing
...
[local_deps]: app.models.document, app.services.search_service, app.models.user, app.services.llm_gateway, app.models.collection
[ext_deps]: datetime, uuid, sqlalchemy, logging, re, typing
...
[local_deps]: app.models.tag, app.models.space, app.models.bookmark, app.models.document, app.models.user, app.models.note
[ext_deps]: uuid, sqlalchemy, logging
[fn]: _escape_like(value)
...
[ext_deps]: datetime, pathlib, uuid, cryptography, logging, base64, os
...
[ext_deps]: datetime, collections, contextlib, pathlib, sys, time, logging, json, os, typing
...
[ext_deps]: datetime, asyncio, abc, nats, uuid, enum, logging, json, typing
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, hashlib, nats, enum, time, dataclasses, logging, json, typing
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, asyncio, nats, uuid, enum, logging, dataclasses, json, typing
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.services.context_block_service, app.services.agent_identity, app.services.llm_gateway
[ext_deps]: datetime, collections, sqlalchemy, logging, json, typing
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: datetime, collections, sqlalchemy, logging, typing
...
[ext_deps]: openpyxl, xlrd, PyPDF2, pathlib, csv, html, docx, xml, ebooklib, subprocess, logging, pptx, json, re, zipfile, typing
...
[local_deps]: app.models.processing, app.services.cache_monitor, app.celery_app, app.services.monitoring, app.core.redis_url, app.models.document, app.database, app.tasks.base, app.tasks.document_tasks, app.services.alert_service
[ext_deps]: datetime, celery, redis, asyncio, logging, os
...
[local_deps]: app.models.document, app.services.article_generation_service, app.services.embed_client, app.database, app.tasks.base, app.models.article
[ext_deps]: celery, asyncio, uuid, httpx, logging
...
[local_deps]: app.tasks.embedding_tasks, app.tasks.article_tasks, app.models.document, app.database, app.tasks.document_tasks, app.models.article
...
[ext_deps]: celery, asyncio, uuid, sqlalchemy, logging, json, typing
...
[local_deps]: app.models.processing, app.services.entity_extraction_service, app.services.chunking_service, app.services.prometheus_metrics, app.tasks.embedding_tasks, app.tasks.article_tasks, app.models.document, app.services.context_block_service, app.services.embed_client, app.services.dlq_service, app.database, app.tasks.base, app.services.collection_service, app.services.text_extractor, app.services.ocr_service
[ext_deps]: datetime, celery, asyncio, uuid, traceback, sqlalchemy, logging, langdetect, tempfile, os
...
[local_deps]: app.celery_app, app.models.document, app.services.embed_client, app.database, app.tasks.base
...
[local_deps]: app.core.redis_url, app.celery_app, app.models.document, app.models.pipeline, app.database
[ext_deps]: datetime, redis, sqlalchemy, logging, smtplib, os, email
[fn]: _smtp_configured()
...
[local_deps]: app.core.redis_url, app.models.document, app.tasks.pipeline_tasks, app.models.pipeline, app.database
[ext_deps]: datetime, celery, redis, uuid, logging
...
[local_deps]: app.core.redis_url, app.celery_app, app.models.document, app.models.pipeline, app.database, app.tasks.pipeline_orchestrator
[ext_deps]: datetime, redis, sqlalchemy, logging, os
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.entity_extraction_service, app.services.knowledge_graph.extraction, app.services.chunking_service, app.services.knowledge_graph.pool, app.celery_app, app.tasks.article_tasks, app.models.document, app.models.pipeline, app.services.embed_client, app.database, app.services.text_extractor, app.services.dlq_service, app.tasks.document_tasks, app.services.ocr_service
[ext_deps]: datetime, celery, asyncio, gc, uuid, traceback, time, logging, tempfile, os
...
[local_deps]: app.tasks.base, app.models.audit, app.models.document, app.database
[ext_deps]: datetime, openpyxl, celery, fpdf, time, logging, sqlalchemy, os
...
[local_deps]: app.services.smart_folder_service, app.database, app.models.document, app.services.smart_folder.agent_runner, app.models.smart_folder, app.models.user, app.tasks.base, app.models.audit
[ext_deps]: datetime, celery, asyncio, uuid, sqlalchemy, logging, json, typing
...
[local_deps]: app.tasks.base, app.services.space_service, app.models.space, app.database
...
[ext_deps]: asyncio, tempfile, sqlalchemy, logging, os
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: collections, asyncio, time, logging, threading, functools, typing
...
[ext_deps]: datetime, bcrypt, dotenv, jose, sqlalchemy, logging, os, fastapi, typing
