...
[local_deps]: app.api.documents_common, app.database, app.services.whisper_service, app.services.storage_service, app.models.document, app.api.deps, app.utils.security, app.models.processing, app.models.chat, app.services.embed_client, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.schemas.admin, app.tasks.document_tasks, app.schemas.user, app.models.pipeline, app.services.alert_service, app.models.article, app.models.failed_task, app.celery_app, app.models.user, app.models.audit, app.core.redis_url
[ext_deps]: uuid, logging, datetime, fastapi, redis, pydantic, os, sqlalchemy, typing, json
...
[local_deps]: app.schemas.article, app.models.user, app.api.deps, app.models.article, app.models.document, app.tasks.article_tasks
...
[local_deps]: app.schemas.token, app.database, app.models.user, app.limiter, app.services.token_blacklist, app.api.deps, app.utils.constants, app.utils.security, app.core.redis_url, app.schemas.user, app.middleware.csrf, app.schemas.auth
[ext_deps]: uuid, logging, datetime, httpx, redis, secrets, os, time, sqlalchemy, fastapi, hashlib, dotenv
...
[local_deps]: app.services.space_service, app.database, app.models.user, app.schemas.tag, app.api.deps, app.schemas.bookmark, app.services.bookmark_service
[ext_deps]: sqlalchemy, fastapi, uuid, logging
...
[local_deps]: app.database, app.models.user, app.limiter, app.api.deps, app.services.input_guard, app.models.chat, app.schemas.chat, app.services.chat_service
[ext_deps]: uuid, logging, sqlalchemy, fastapi, json
...
[local_deps]: app.database, app.models.user, app.api.deps, app.services.llm_gateway, app.models.audit, app.services.input_guard, app.tasks.document_tasks, app.services.collection_chat_service, app.models.collection, app.models.article, app.schemas.collection, app.services.collection_service
[ext_deps]: uuid, logging, io, datetime, reportlab, sqlalchemy, fastapi, typing, json
...
[local_deps]: app.api.documents_common, app.database, app.models.user, app.tasks.embedding_tasks, app.api.deps, app.services.storage_service, app.models.audit, app.tasks.document_tasks, app.schemas.document, app.models.processing, app.models.pipeline, app.models.document, app.services.similarity_service, app.api.documents_journal, app.api.documents_upload
...
[local_deps]: app.models.user, app.tasks.pipeline_tasks, app.models.audit, app.core.redis_url, app.schemas.document, app.models.pipeline, app.models.document, app.tasks.pipeline_orchestrator
[ext_deps]: concurrent, uuid, logging, asyncio, datetime, mimetypes, fastapi, redis, pydantic, os, sqlalchemy, typing, json
...
[local_deps]: app.api.documents_common, app.database, app.models.user, app.api.deps, app.services.whisper_service, app.services.storage_service, app.models.audit, app.schemas.document, app.models.document
[ext_deps]: tempfile, logging, datetime, os, sqlalchemy, fastapi
...
[local_deps]: app.api.documents_common, app.database, app.models.user, app.api.deps, app.services.document_orchestrator, app.services.storage_service, app.models.audit, app.schemas.document, app.services.deduplication_service, app.models.document
[ext_deps]: uuid, logging, sqlalchemy, fastapi, typing
...
[local_deps]: app.database, app.models.user, app.services.progressive_revelation_service, app.services.search_service, app.api.deps, app.models.audit, app.services.synthesis_service, app.services.temporal_reasoning_service, app.models.document, app.services.graph_rag_service
[ext_deps]: uuid, logging, sqlalchemy, fastapi, typing, json
...
[ext_deps]: logging, datetime, asyncio, httpx, fastapi, redis, os, sqlalchemy, typing, nats
...
[ext_deps]: logging, hmac, os, sqlalchemy, fastapi
...
[local_deps]: app.models.knowledge_graph, app.database, app.models.user, app.services.timeline_service, app.api.deps, app.services.entity_extraction_service, app.services.relationship_service, app.models.document
[ext_deps]: uuid, logging, datetime, sqlalchemy, fastapi, typing
...
[local_deps]: app.services.space_service, app.database, app.models.user, app.models.note, app.schemas.tag, app.api.deps, app.services.note_service, app.schemas.note, app.models.note_audio
[ext_deps]: uuid, logging, datetime, os, sqlalchemy, fastapi
...
[local_deps]: app.celery_app, app.database, app.api.deps, app.core.redis_url, app.models.pipeline, app.models.document, app.tasks.pipeline_orchestrator
...
[ext_deps]: uuid, logging, os, sqlalchemy, fastapi
...
[local_deps]: app.database, app.models.user, app.services.search_service, app.api.deps, app.services.input_guard, app.models.document, app.services.search_agent, app.services.search_models
[ext_deps]: uuid, logging, asyncio, time, sqlalchemy, fastapi, json
...
[ext_deps]: uuid, logging, pydantic, sqlalchemy, fastapi, hashlib
...
[local_deps]: app.celery_app, app.database, app.models.user, app.models.note, app.tasks.collection_report_tasks, app.api.deps, app.schemas.smart_folder, app.tasks.smart_folder_tasks, app.models.audit, app.models.smart_folder, app.schemas.collection
[ext_deps]: celery, uuid, logging, asyncio, sqlalchemy, fastapi, typing, json
...
[local_deps]: app.services.space_service, app.tasks.space_tasks, app.database, app.models.user, app.schemas.tag, app.schemas.space, app.api.deps
[ext_deps]: sqlalchemy, fastapi, uuid, logging
...
[local_deps]: app.models.user, app.api.deps, app.services.llm_gateway, app.core.redis_url, app.tasks.pipeline_orchestrator
...
[local_deps]: app.database, app.models.user, app.api.deps, app.models.subscription, app.tasks.subscription_tasks, app.schemas.subscription
[ext_deps]: sqlalchemy, fastapi, uuid, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.services.space_service, app.database, app.models.user, app.schemas.tag, app.schemas.task, app.api.deps, app.services.task_service
[ext_deps]: sqlalchemy, fastapi, uuid, logging
...
[local_deps]: app.models.user, app.models.note, app.api.deps, app.services.whisper_service, app.services.storage_service, app.models.document, app.models.note_audio
[ext_deps]: tempfile, io, logging, uuid, asyncio, os, sqlalchemy, fastapi
...
[ext_deps]: logging, pydantic_settings, pathlib, urllib, pydantic, os
...
[ext_deps]: logging, urllib, httpx, base64, os, time, struct, json, cryptography
...
[ext_deps]: pgvector, collections, fastapi, os, sqlalchemy, typing, dotenv
...
[local_deps]: app.database, app.middleware.transaction, app.limiter, app.api, app.services.messaging, app.core.redis_url, app.middleware.rls, app.middleware.csrf, app.services.prometheus_metrics
[ext_deps]: uuid, logging, contextlib, collections, threading, fastapi, redis, slowapi, os, uvicorn, time, sqlalchemy, typing, starlette, dotenv
...
[local_deps]: app.database, app.api, app.services.cache_monitor, app.core.redis_url, app.services.monitoring, app.services.prometheus_metrics, app.services.embedding_service
[ext_deps]: logging, contextlib, datetime, httpx, redis, os, uvicorn, time, sqlalchemy, fastapi, dotenv
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: jose, logging, dataclasses, sqlalchemy, starlette
...
[local_deps]: app.models.bookmark, app.models.note, app.models.smart_folder, app.models.document, app.models.push_subscription, app.models.pattern_insight, app.models.space, app.models.collection, app.models.processing, app.models.base, app.models.chat, app.models.knowledge_graph, app.models.task, app.models.pipeline, app.models.article, app.models.milestone, app.models.note_audio, app.models.failed_task, app.models.user, app.models.subscription, app.models.audit, app.models.tag
...
[ext_deps]: logging, collections, asyncio, httpx, functools, time, tenacity, typing
...
[local_deps]: app.schemas.token, app.schemas.search, app.schemas.smart_folder, app.schemas.admin, app.schemas.pagination, app.schemas.user, app.schemas.document, app.schemas.collection, app.schemas.chat

---
### FILE: backend/app/schemas/admin.py
[local_deps]: app.schemas.user
[ext_deps]: re, datetime, uuid, pydantic
...
[ext_deps]: uuid, datetime, pydantic, enum, typing
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: enum, uuid, datetime, pydantic, re, typing
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.agent_orchestrator, app.services.agents.clarification_agent, app.services.agents.researcher_agent, app.services.agents.answer_agent, app.services.agents.verification_agent
...
[ext_deps]: logging, collections, datetime, dataclasses, time, enum, typing
...
[ext_deps]: logging, dataclasses, re, typing, json
...
[local_deps]: app.services.knowledge_graph.models, app.services.knowledge_graph.pool, app.services.search_service, app.services.agent_identity, app.services.llm_gateway, app.services.embed_client, app.services.graph_rag_service, app.services.knowledge_graph.traversal
[ext_deps]: logging, collections, dataclasses, re, typing, json
...
[ext_deps]: logging, asyncio, httpx, typing, hashlib, json
...
[ext_deps]: uuid, logging, datetime, warnings, sqlalchemy, typing, json
...
[ext_deps]: logging, datetime, threading, typing, json
...
[local_deps]: app.database, app.models.user, app.services.search_service, app.services.pii_detection_service, app.services.context_block_service, app.services.agent_identity, app.services.llm_gateway, app.services.cache_monitor, app.services.prometheus_metrics, app.models.document, app.models.chat, app.services.llm_router
[ext_deps]: uuid, logging, collections, asyncio, time, re, sqlalchemy, typing, json
...
[local_deps]: app.models.user, app.services.context_block_service, app.services.agent_identity, app.services.llm_gateway, app.models.audit, app.models.collection, app.models.document, app.models.chat
...
[local_deps]: app.models.user, app.services.search_service, app.services.intent_parser, app.services.agent_identity, app.services.llm_gateway, app.models.collection, app.models.document, app.schemas.collection, app.services.search_cache
[ext_deps]: uuid, logging, datetime, asyncio, sqlalchemy, typing
...
[local_deps]: app.services.llm_gateway
[ext_deps]: uuid, logging, datetime, os, typing
...
[ext_deps]: logging, asyncio, threading, traceback, sqlalchemy, typing, json
...
[local_deps]: app.models.user, app.tasks.pipeline_tasks, app.services.storage_service, app.models.audit, app.tasks.voice_tasks, app.schemas.document, app.services.deduplication_service, app.models.pipeline, app.models.document, app.tasks.pipeline_orchestrator
[ext_deps]: concurrent, logging, datetime, asyncio, sqlalchemy, fastapi, typing, json
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: logging, httpx, random, asyncio, os, time
[fn]: _base_urls()
...
[ext_deps]: numpy, gc, logging, sentence_transformers, asyncio, psutil, threading, torch, os, typing
...
[ext_deps]: logging, datetime, asyncio, warnings, sqlalchemy, typing, json
...
[ext_deps]: logging, collections, re, sqlalchemy, typing
...
[ext_deps]: logging, dataclasses, redis, re, hashlib
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: enum, logging, datetime, warnings, re, typing, json
...
[ext_deps]: logging, collections, datetime, httpx, os, tenacity, typing, json
...
[ext_deps]: asyncpg, logging, __future__, itertools, spacy, models, json
[fn]: _vec_to_str(vec)
...
[ext_deps]: asyncpg, logging, __future__, extraction, models, json
...
[local_deps]: app.services.openrouter_service, app.services.pii_detection_service, app.services.kimi_service, app.services.ollama_service, app.services.minimax_service
[ext_deps]: logging, collections, dataclasses, enum, typing
...
[ext_deps]: logging, collections, asyncio, os, typing, nats
...
[ext_deps]: logging, collections, httpx, os, typing, json
...
[ext_deps]: logging, collections, prometheus_client, datetime, psutil, threading, dataclasses, redis, subprocess, os, re, typing
...
[ext_deps]: numpy, enum, io, logging, pytesseract, paddleocr, os, time, typing, PyPDF2, PIL, cv2
...
[local_deps]: app.services.base_llm_service
[ext_deps]: logging, collections, httpx, os, tenacity, typing, json
...
[local_deps]: app.core.redis_url, app.services.monitoring, app.services.cache_monitor
[ext_deps]: logging, collections, datetime, httpx, redis, os, tenacity, typing, hashlib, json
[fn]: _get_redis_client()
...
[ext_deps]: logging, sentence_transformers, datetime, psutil, sqlalchemy, typing
...
[local_deps]: app.models.knowledge_graph, app.models.user, app.services.agent_identity, app.services.llm_gateway, app.models.document
...
[ext_deps]: logging, collections, functools, time, typing
...
[local_deps]: app.models.user, app.services.context_block_service, app.services.agent_identity, app.services.llm_gateway, app.models.collection, app.models.document
[ext_deps]: io, uuid, logging, datetime, reportlab, os, sqlalchemy, typing
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.database, app.models.user, app.services.search_service, app.services.context_block_service, app.services.agent_identity, app.models.document, app.services.llm_router, app.services.search_cache
[ext_deps]: uuid, logging, asyncio, time, search_models, re, sqlalchemy, typing, json
...
[local_deps]: app.core.redis_url
[ext_deps]: logging, redis, typing, hashlib, json
[fn]: _get_redis()
...
[local_deps]: app.models.user, app.services.rerank_service, app.services.pii_detection_service, app.models.document, app.services.embed_client, app.services.search_cache
[ext_deps]: logging, asyncio, re, sqlalchemy, typing
...
[ext_deps]: logging, collections, dataclasses, typing, json
...
[ext_deps]: numpy, logging, re, sqlalchemy, typing
...
[local_deps]: app.models.user, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.agent.executor, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.entity_resolver, app.models.smart_folder, app.services.smart_folder.agent.planner
...
[ext_deps]: uuid, logging, datetime, dataclasses, sqlalchemy, typing
...
[ext_deps]: logging, dataclasses, sqlalchemy, typing, difflib
...
[local_deps]: app.services.llm_router
[ext_deps]: logging, datetime, dataclasses, typing, json
...
[ext_deps]: uuid, logging, dataclasses, re, typing, json
...
[local_deps]: app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.base
...
[local_deps]: app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.trend_analyzer
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.report_generator, app.services.smart_folder.analysis, app.services.smart_folder.skills.base, app.services.smart_folder.tools.document_reader
...
[local_deps]: app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer
...
[ext_deps]: io, logging, csv, re, typing, json
...
[local_deps]: app.models.user, app.services.search_service, app.services.llm_gateway, app.models.collection, app.models.document
[ext_deps]: uuid, logging, datetime, re, sqlalchemy, typing
...
[local_deps]: app.models.tag, app.models.bookmark, app.models.note, app.models.user, app.models.space, app.models.document
[ext_deps]: sqlalchemy, uuid, logging
[fn]: _escape_like(value)
...
[ext_deps]: uuid, logging, pathlib, datetime, os, base64, cryptography
...
[ext_deps]: sys, logging, pathlib, contextlib, collections, datetime, os, time, typing, json
...
[ext_deps]: uuid, logging, asyncio, datetime, enum, abc, typing, json, nats
...
[local_deps]: app.services.messaging
[ext_deps]: enum, logging, datetime, dataclasses, time, typing, hashlib, json, nats
...
[local_deps]: app.services.messaging
[ext_deps]: uuid, logging, asyncio, datetime, dataclasses, enum, typing, json, nats
...
[local_deps]: app.services.messaging
[ext_deps]: logging, datetime, typing, json, nats
...
[local_deps]: app.models.knowledge_graph, app.services.context_block_service, app.services.agent_identity, app.services.llm_gateway, app.models.document
[ext_deps]: logging, collections, datetime, sqlalchemy, typing, json
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: logging, collections, datetime, sqlalchemy, typing
...
[ext_deps]: zipfile, logging, pathlib, xlrd, html, re, subprocess, docx, json, csv, ebooklib, pptx, xml, typing, PyPDF2, openpyxl
...
[local_deps]: app.celery_app, app.database, app.services.cache_monitor, app.tasks.document_tasks, app.core.redis_url, app.models.processing, app.services.monitoring, app.services.alert_service, app.models.document, app.tasks.base
[ext_deps]: celery, logging, datetime, asyncio, redis, os
...
[local_deps]: app.database, app.services.article_generation_service, app.models.article, app.models.document, app.services.embed_client, app.tasks.base
[ext_deps]: celery, uuid, logging, httpx, asyncio
...
[local_deps]: app.database, app.tasks.embedding_tasks, app.tasks.document_tasks, app.models.article, app.models.document, app.tasks.article_tasks
...
[ext_deps]: logging, asyncio, psutil, traceback, os
...
[local_deps]: app.database, app.models.user, app.services.report_service, app.models.audit, app.tasks.base
[ext_deps]: celery, uuid, logging, asyncio, sqlalchemy, typing, json
...
[local_deps]: app.database, app.tasks.embedding_tasks, app.services.dlq_service, app.services.context_block_service, app.services.entity_extraction_service, app.services.chunking_service, app.services.text_extractor, app.models.processing, app.tasks.article_tasks, app.services.prometheus_metrics, app.models.document, app.services.ocr_service, app.services.embed_client, app.tasks.base, app.services.collection_service
[ext_deps]: celery, tempfile, uuid, logging, datetime, asyncio, traceback, langdetect, os, sqlalchemy
...
[local_deps]: app.celery_app, app.database, app.models.document, app.services.embed_client, app.tasks.base
...
[local_deps]: app.celery_app, app.database, app.core.redis_url, app.models.pipeline, app.models.document
[ext_deps]: email, logging, datetime, redis, smtplib, os, sqlalchemy
[fn]: _smtp_configured()
...
[local_deps]: app.database, app.tasks.pipeline_tasks, app.core.redis_url, app.models.pipeline, app.models.document
...
[local_deps]: app.celery_app, app.database, app.core.redis_url, app.models.pipeline, app.models.document, app.tasks.pipeline_orchestrator
[ext_deps]: logging, datetime, redis, os, sqlalchemy
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.celery_app, app.database, app.services.knowledge_graph.pool, app.services.dlq_service, app.services.entity_extraction_service, app.services.chunking_service, app.tasks.document_tasks, app.services.text_extractor, app.models.pipeline, app.services.knowledge_graph.extraction, app.models.document, app.services.ocr_service, app.services.embed_client, app.tasks.article_tasks
[ext_deps]: celery, tempfile, uuid, logging, gc, asyncio, datetime, traceback, os, time
...
[ext_deps]: celery, fpdf, logging, datetime, os, time, sqlalchemy, openpyxl
...
[local_deps]: app.services.smart_folder.agent_runner, app.database, app.models.user, app.services.smart_folder_service, app.models.audit, app.models.smart_folder, app.models.document, app.tasks.base
[ext_deps]: celery, uuid, logging, asyncio, datetime, sqlalchemy, typing, json
...
[ext_deps]: email, logging, datetime, httpx, smtplib, os, sqlalchemy, calendar
...
[local_deps]: app.celery_app, app.database, app.models.task, app.core.push, app.models.push_subscription, app.services.task_service
...
[ext_deps]: logging, collections, asyncio, threading, functools, time, typing
...
[ext_deps]: jose, logging, bcrypt, datetime, fastapi, os, sqlalchemy, typing, dotenv
