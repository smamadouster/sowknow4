...
# [hub]: app.models.document → imported 47 times
# [hub]: app.models.user → imported 41 times
# [hub]: app.database → imported 41 times
# [hub]: app.api.deps → imported 22 times
# [hub]: app.models.base → imported 21 times
# [hub]: app.services.llm_gateway → imported 19 times
# [hub]: app.core.redis_url → imported 17 times
# [hub]: app.models.audit → imported 15 times
# [hub]: app.services.agent_identity → imported 15 times
# [hub]: app.models.knowledge_graph → imported 11 times
"""
...
[local_deps]: app.models.article, app.tasks.document_tasks, app.utils.security, app.services.whisper_service, app.schemas.user, app.models.user, app.models.processing, app.schemas.admin, app.models.chat, app.models.document, app.models.failed_task, app.models.audit, app.api.deps, app.models.pipeline, app.database, app.core.redis_url, app.services.alert_service
[ext_deps]: json, sqlalchemy, typing, redis, datetime, uuid, fastapi, os, logging
...
[local_deps]: app.models.article, app.tasks.article_tasks, app.models.user, app.models.document, app.api.deps, app.schemas.article
...
[local_deps]: app.core.redis_url, app.middleware.csrf, app.schemas.auth, app.schemas.user, app.utils.security, app.models.user, app.schemas.token, app.limiter, app.services.token_blacklist, app.utils.constants, app.database, app.api.deps
[ext_deps]: sqlalchemy, dotenv, hashlib, redis, datetime, uuid, time, httpx, fastapi, os, logging, secrets
...
[local_deps]: app.models.user, app.schemas.tag, app.services.bookmark_service, app.services.space_service, app.schemas.bookmark, app.api.deps, app.database
[ext_deps]: sqlalchemy, logging, fastapi, uuid
...
[local_deps]: app.models.user, app.services.chat_service, app.schemas.chat, app.services.input_guard, app.models.chat, app.limiter, app.database, app.api.deps
[ext_deps]: json, sqlalchemy, uuid, fastapi, logging
...
[local_deps]: app.models.article, app.models.collection, app.tasks.document_tasks, app.services.llm_gateway, app.models.user, app.services.collection_chat_service, app.services.input_guard, app.schemas.collection, app.models.audit, app.api.deps, app.database, app.services.collection_service
[ext_deps]: json, sqlalchemy, typing, datetime, uuid, reportlab, io, fastapi, logging
...
[local_deps]: app.utils.security, app.models.user, app.services.token_blacklist, app.utils.constants, app.database
...
[local_deps]: app.schemas.document, app.services.storage_service, app.tasks.document_tasks, app.models.user, app.api.documents_upload, app.models.processing, app.models.document, app.api.documents_journal, app.models.audit, app.services.similarity_service, app.api.deps, app.api.documents_common, app.tasks.embedding_tasks, app.models.pipeline, app.database
[ext_deps]: sqlalchemy, typing, datetime, uuid, fastapi, logging
...
[local_deps]: app.schemas.document, app.tasks.pipeline_orchestrator, app.models.user, app.models.document, app.models.audit, app.tasks.pipeline_tasks, app.models.pipeline
[ext_deps]: json, asyncio, mimetypes, typing, sqlalchemy, datetime, uuid, fastapi, os, logging, concurrent, pydantic
...
[local_deps]: app.schemas.document, app.services.storage_service, app.services.whisper_service, app.models.user, app.models.document, app.models.audit, app.api.deps, app.api.documents_common, app.database
...
[local_deps]: app.schemas.document, app.services.storage_service, app.models.user, app.services.document_orchestrator, app.models.document, app.services.deduplication_service, app.models.audit, app.api.deps, app.api.documents_common, app.database
[ext_deps]: sqlalchemy, typing, uuid, fastapi, logging
...
[local_deps]: app.services.progressive_revelation_service, app.services.temporal_reasoning_service, app.services.graph_rag_service, app.models.user, app.services.search_service, app.models.document, app.models.audit, app.api.deps, app.database, app.services.synthesis_service
[ext_deps]: json, sqlalchemy, typing, uuid, fastapi, logging
...
[ext_deps]: asyncio, sqlalchemy, typing, redis, datetime, httpx, nats, fastapi, os, logging
...
[ext_deps]: sqlalchemy, hmac, fastapi, os, logging
...
[local_deps]: app.models.user, app.services.relationship_service, app.models.document, app.models.knowledge_graph, app.services.timeline_service, app.api.deps, app.services.entity_extraction_service, app.database
[ext_deps]: sqlalchemy, typing, datetime, uuid, fastapi, logging
...
[local_deps]: app.services.note_service, app.models.note_audio, app.models.user, app.schemas.tag, app.services.space_service, app.schemas.note, app.models.note, app.api.deps, app.database
[ext_deps]: sqlalchemy, datetime, uuid, fastapi, os, logging
...
[local_deps]: app.tasks.pipeline_orchestrator, app.celery_app, app.models.document, app.api.deps, app.models.pipeline, app.database, app.core.redis_url
...
[local_deps]: app.celery_app, app.schemas.reports, app.tasks.report_tasks, app.models.user, app.api.deps
...
[local_deps]: app.models.user, app.services.input_guard, app.services.search_service, app.models.document, app.services.search_agent, app.api.deps, app.services.search_models, app.database
[ext_deps]: json, asyncio, sqlalchemy, time, uuid, fastapi, logging
...
[ext_deps]: sqlalchemy, hashlib, uuid, fastapi, logging, pydantic
...
[local_deps]: app.tasks.collection_report_tasks, app.celery_app, app.models.user, app.models.smart_folder, app.schemas.collection, app.models.audit, app.models.note, app.api.deps, app.schemas.smart_folder, app.tasks.smart_folder_tasks, app.database
[ext_deps]: json, asyncio, sqlalchemy, typing, celery, uuid, fastapi, logging
...
[local_deps]: app.tasks.space_tasks, app.models.user, app.schemas.tag, app.services.space_service, app.schemas.space, app.database, app.api.deps
[ext_deps]: sqlalchemy, logging, fastapi, uuid
...
[local_deps]: app.tasks.pipeline_orchestrator, app.services.llm_gateway, app.models.user, app.api.deps, app.core.redis_url
...
[local_deps]: app.services.storage_service, app.models.note_audio, app.services.whisper_service, app.models.user, app.models.document, app.models.note, app.api.deps
[ext_deps]: asyncio, tempfile, sqlalchemy, uuid, io, fastapi, os, logging
...
[ext_deps]: urllib, pydantic_settings, os, logging, pydantic, pathlib
...
[ext_deps]: sqlalchemy, dotenv, typing, pgvector, fastapi, collections, os
...
[local_deps]: app.middleware.rls, app.core.redis_url, app.api, app.middleware.csrf, app.services.prometheus_metrics, app.middleware.transaction, app.limiter, app.database, app.services.messaging
[ext_deps]: uvicorn, slowapi, sqlalchemy, typing, dotenv, starlette, redis, time, uuid, threading, contextlib, fastapi, collections, os, logging
...
[local_deps]: app.services.cache_monitor, app.api, app.services.prometheus_metrics, app.services.embedding_service, app.database, app.services.monitoring, app.core.redis_url
[ext_deps]: uvicorn, sqlalchemy, dotenv, redis, datetime, time, httpx, contextlib, fastapi, os, logging
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: logging, starlette, hmac, secrets
...
[local_deps]: app.models.note_audio, app.models.milestone, app.models.user, app.models.pattern_insight, app.models.failed_task, app.models.pipeline, app.models.article, app.models.bookmark, app.models.smart_folder, app.models.processing, app.models.document, app.models.audit, app.models.base, app.models.knowledge_graph, app.models.collection, app.models.tag, app.models.space, app.models.chat, app.models.note
...
[ext_deps]: asyncio, typing, time, httpx, functools, collections, logging, tenacity
...
[local_deps]: app.schemas.document, app.schemas.user, app.schemas.pagination, app.schemas.chat, app.schemas.admin, app.schemas.token, app.schemas.collection, app.schemas.search, app.schemas.smart_folder
...
[ext_deps]: enum, typing, datetime, uuid, re, pydantic
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.clarification_agent, app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.answer_agent, app.services.agents.agent_orchestrator
...
[ext_deps]: enum, typing, datetime, time, collections, logging, dataclasses
...
[local_deps]: app.services.llm_gateway, app.services.graph_rag_service, app.services.search_service, app.services.embed_client, app.services.knowledge_graph.pool, app.services.knowledge_graph.traversal, app.services.agent_identity, app.services.knowledge_graph.models
[ext_deps]: json, typing, collections, re, logging, dataclasses
...
[ext_deps]: json, asyncio, typing, hashlib, httpx, logging
...
[ext_deps]: json, sqlalchemy, typing, datetime, uuid, logging, warnings
...
[ext_deps]: json, typing, datetime, threading, logging
...
[local_deps]: app.services.cache_monitor, app.services.pii_detection_service, app.services.llm_gateway, app.services.llm_router, app.models.user, app.services.context_block_service, app.services.search_service, app.models.chat, app.services.prometheus_metrics, app.models.document, app.database, app.services.agent_identity
[ext_deps]: json, asyncio, sqlalchemy, typing, time, uuid, collections, re, logging
...
[local_deps]: app.models.collection, app.services.llm_gateway, app.models.user, app.services.context_block_service, app.models.chat, app.models.document, app.models.audit, app.services.agent_identity
...
[local_deps]: app.models.collection, app.services.llm_gateway, app.models.user, app.schemas.collection, app.models.document, app.services.search_cache, app.services.search_service, app.services.intent_parser, app.services.agent_identity
[ext_deps]: asyncio, sqlalchemy, typing, datetime, uuid, logging
...
[ext_deps]: sqlalchemy, hashlib, datetime, difflib, logging
...
[local_deps]: app.services.llm_gateway
[ext_deps]: typing, datetime, uuid, os, logging
...
[ext_deps]: json, asyncio, sqlalchemy, typing, traceback, threading, logging
...
[local_deps]: app.schemas.document, app.services.storage_service, app.tasks.pipeline_orchestrator, app.tasks.voice_tasks, app.models.user, app.models.document, app.services.deduplication_service, app.models.audit, app.tasks.pipeline_tasks, app.models.pipeline
[ext_deps]: json, asyncio, sqlalchemy, typing, datetime, fastapi, logging, concurrent
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: random, asyncio, time, httpx, os, logging
[fn]: _base_urls()
...
[ext_deps]: sentence_transformers, asyncio, typing, torch, psutil, threading, numpy, gc, os, logging
...
[local_deps]: app.models.document, app.services.agent_identity, app.services.llm_gateway, app.models.knowledge_graph
[ext_deps]: json, asyncio, sqlalchemy, typing, datetime, logging, warnings
...
[ext_deps]: hashlib, redis, re, logging, dataclasses
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: json, enum, typing, datetime, re, logging, warnings
...
[ext_deps]: json, typing, datetime, httpx, collections, os, logging, tenacity
...
[ext_deps]: json, itertools, asyncpg, spacy, models, __future__, logging
[fn]: _vec_to_str(vec)
...
[ext_deps]: enum, datetime, uuid, __future__, pydantic
...
[ext_deps]: json, asyncpg, models, extraction, __future__, logging
...
[local_deps]: app.services.pii_detection_service, app.services.kimi_service, app.services.ollama_service, app.services.openrouter_service, app.services.minimax_service
[ext_deps]: enum, typing, collections, logging, dataclasses
...
[ext_deps]: asyncio, typing, nats, collections, os, logging
...
[ext_deps]: json, typing, httpx, collections, os, logging
...
[ext_deps]: prometheus_client, typing, redis, datetime, psutil, threading, subprocess, collections, re, os, logging, dataclasses
...
[ext_deps]: pytesseract, enum, paddleocr, typing, cv2, time, PyPDF2, io, PIL, numpy, os, logging
...
[local_deps]: app.services.base_llm_service
[ext_deps]: json, typing, httpx, collections, os, logging, tenacity
...
[ext_deps]: json, typing, hashlib, redis, datetime, httpx, collections, os, logging, tenacity
...
[ext_deps]: sentence_transformers, sqlalchemy, typing, datetime, psutil, logging
...
[local_deps]: app.services.llm_gateway, app.models.user, app.models.document, app.models.knowledge_graph, app.services.agent_identity
...
[ext_deps]: typing, time, functools, collections, logging
...
[ext_deps]: collections, sqlalchemy, typing, logging
...
[local_deps]: app.models.collection, app.services.llm_gateway, app.models.user, app.services.context_block_service, app.models.document, app.services.agent_identity
[ext_deps]: sqlalchemy, typing, datetime, uuid, reportlab, io, os, logging
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.llm_router, app.models.user, app.services.context_block_service, app.services.search_cache, app.models.document, app.services.search_service, app.database, app.services.agent_identity
[ext_deps]: json, asyncio, sqlalchemy, typing, time, uuid, search_models, re, logging
...
[local_deps]: app.core.redis_url
[ext_deps]: json, typing, hashlib, redis, logging
[fn]: _get_redis()
...
[local_deps]: app.services.pii_detection_service, app.services.rerank_service, app.models.user, app.services.search_cache, app.models.document, app.services.embed_client
[ext_deps]: asyncio, sqlalchemy, typing, re, logging
...
[ext_deps]: json, typing, collections, logging, dataclasses
...
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.query_parser, app.services.smart_folder.entity_resolver, app.services.smart_folder.report_generator
...
[local_deps]: app.services.smart_folder.agent.planner, app.services.smart_folder.agent.synthesizer, app.models.user, app.models.smart_folder, app.services.smart_folder.query_parser, app.services.smart_folder.entity_resolver, app.services.smart_folder.report_generator, app.services.smart_folder.agent.executor
[ext_deps]: sqlalchemy, typing, uuid, re, logging
...
[ext_deps]: sqlalchemy, typing, datetime, uuid, logging, dataclasses
...
[local_deps]: app.services.llm_router
[ext_deps]: json, typing, datetime, logging, dataclasses
...
[ext_deps]: json, typing, uuid, re, logging, dataclasses
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.financial_analysis
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.table_extractor
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.report_generator, app.services.smart_folder.tools.document_reader
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.refinement_parser
...
[ext_deps]: json, typing, io, csv, re, logging
...
[local_deps]: app.models.collection, app.services.llm_gateway, app.models.user, app.services.search_service, app.models.document
[ext_deps]: sqlalchemy, typing, datetime, uuid, re, logging
...
[local_deps]: app.models.tag, app.models.bookmark, app.models.user, app.models.space, app.models.document, app.models.note
[ext_deps]: sqlalchemy, logging, uuid
[fn]: _escape_like(value)
...
[ext_deps]: cryptography, base64, datetime, uuid, os, logging, pathlib
...
[ext_deps]: json, typing, datetime, time, sys, contextlib, collections, os, logging, pathlib
...
[ext_deps]: json, asyncio, enum, abc, typing, datetime, uuid, nats, logging
...
[local_deps]: app.services.messaging
[ext_deps]: json, enum, typing, hashlib, time, datetime, nats, logging, dataclasses
...
[local_deps]: app.services.messaging
[ext_deps]: json, asyncio, enum, typing, datetime, uuid, nats, logging, dataclasses
...
[local_deps]: app.services.llm_gateway, app.services.context_block_service, app.models.document, app.models.knowledge_graph, app.services.agent_identity
[ext_deps]: json, sqlalchemy, typing, datetime, collections, logging
...
[ext_deps]: json, datetime, httpx, os, logging
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: sqlalchemy, typing, datetime, collections, logging
...
[ext_deps]: json, html, zipfile, ebooklib, typing, xml, docx, PyPDF2, pptx, subprocess, openpyxl, csv, re, logging, pathlib
...
[local_deps]: app.services.cache_monitor, app.celery_app, app.tasks.document_tasks, app.tasks.base, app.models.processing, app.models.document, app.database, app.services.monitoring, app.core.redis_url, app.services.alert_service
[ext_deps]: asyncio, redis, datetime, celery, os, logging
...
[local_deps]: app.models.article, app.tasks.base, app.models.document, app.services.embed_client, app.services.article_generation_service, app.database
[ext_deps]: asyncio, celery, uuid, httpx, logging
...
[local_deps]: app.tasks.article_tasks, app.models.article, app.tasks.document_tasks, app.models.document, app.tasks.embedding_tasks, app.database
...
[ext_deps]: asyncio, psutil, traceback, os, logging
...
[local_deps]: app.services.report_service, app.tasks.base, app.models.user, app.models.audit, app.database
[ext_deps]: json, asyncio, sqlalchemy, typing, celery, uuid, logging
...
[local_deps]: app.tasks.article_tasks, app.services.ocr_service, app.tasks.base, app.services.context_block_service, app.services.dlq_service, app.models.processing, app.models.document, app.services.prometheus_metrics, app.services.embed_client, app.tasks.embedding_tasks, app.services.entity_extraction_service, app.database, app.services.text_extractor, app.services.chunking_service, app.services.collection_service
[ext_deps]: asyncio, tempfile, sqlalchemy, celery, datetime, uuid, traceback, langdetect, os, logging
...
[local_deps]: app.models.document, app.tasks.pipeline_tasks, app.models.pipeline, app.database, app.core.redis_url
...
[ext_deps]: sqlalchemy, redis, datetime, os, logging
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.tasks.article_tasks, app.celery_app, app.tasks.document_tasks, app.services.ocr_service, app.services.knowledge_graph.extraction, app.services.dlq_service, app.models.document, app.services.embed_client, app.services.knowledge_graph.pool, app.models.pipeline, app.services.entity_extraction_service, app.database, app.services.text_extractor, app.services.chunking_service
[ext_deps]: asyncio, tempfile, time, uuid, datetime, celery, traceback, gc, os, logging
[class]: _EmbedContinue { methods: [__init__] }
...
[local_deps]: app.tasks.base, app.models.document, app.database, app.models.audit
[ext_deps]: sqlalchemy, datetime, time, celery, openpyxl, fpdf, os, logging
...
[local_deps]: app.services.smart_folder_service, app.tasks.base, app.models.user, app.models.smart_folder, app.models.document, app.models.audit, app.services.smart_folder.agent_runner, app.database
[ext_deps]: json, asyncio, sqlalchemy, typing, celery, uuid, datetime, logging
...
[ext_deps]: asyncio, typing, time, threading, functools, collections, logging
...
[ext_deps]: jose, sqlalchemy, typing, dotenv, bcrypt, datetime, fastapi, os, logging
