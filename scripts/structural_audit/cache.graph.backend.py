...
[local_deps]: app.celery_app, app.services.storage_service, app.services.whisper_service, app.models.processing, app.schemas.user, app.utils.security, app.models.failed_task, app.api.documents_common, app.models.audit, app.api.deps, app.schemas.admin, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.models.pipeline, app.database, app.services.alert_service, app.services.embed_client, app.models.user, app.models.chat, app.models.article, app.core.redis_url, app.tasks.document_tasks, app.models.document
[ext_deps]: datetime, logging, sqlalchemy, redis, json, uuid, pydantic, fastapi, os, typing
...
[local_deps]: app.models.article, app.tasks.article_tasks, app.schemas.article, app.models.document, app.models.user, app.api.deps
...
[local_deps]: app.schemas.token, app.utils.security, app.services.token_blacklist, app.middleware.csrf, app.core.redis_url, app.schemas.user, app.database, app.limiter, app.schemas.auth, app.utils.constants, app.models.user, app.api.deps
[ext_deps]: time, datetime, logging, sqlalchemy, httpx, secrets, redis, hashlib, uuid, dotenv, fastapi, os
...
[local_deps]: app.services.bookmark_service, app.schemas.bookmark, app.database, app.services.space_service, app.models.user, app.schemas.tag, app.api.deps
[ext_deps]: fastapi, logging, uuid, sqlalchemy
...
[local_deps]: app.schemas.chat, app.services.input_guard, app.database, app.limiter, app.services.chat_service, app.models.user, app.models.chat, app.api.deps
...
[local_deps]: app.models.collection, app.services.collection_service, app.models.article, app.models.audit, app.services.collection_chat_service, app.services.input_guard, app.database, app.schemas.collection, app.tasks.document_tasks, app.models.user, app.services.llm_gateway, app.api.deps
[ext_deps]: datetime, logging, sqlalchemy, json, uuid, fastapi, reportlab, io, typing
...
[local_deps]: app.utils.security, app.services.token_blacklist, app.database, app.models.user, app.utils.constants
...
[local_deps]: app.schemas.document, app.services.similarity_service, app.models.processing, app.services.storage_service, app.api.documents_journal, app.api.documents_common, app.api.deps, app.models.audit, app.models.pipeline, app.database, app.tasks.embedding_tasks, app.tasks.document_tasks, app.models.document, app.models.user, app.api.documents_upload
[ext_deps]: datetime, logging, sqlalchemy, uuid, fastapi, typing
...
[local_deps]: app.schemas.document, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.models.audit, app.core.redis_url, app.models.pipeline, app.models.document, app.models.user
[ext_deps]: concurrent, datetime, logging, sqlalchemy, redis, json, asyncio, mimetypes, uuid, pydantic, fastapi, os, typing
...
[local_deps]: app.schemas.document, app.services.storage_service, app.api.documents_common, app.models.audit, app.services.whisper_service, app.database, app.models.document, app.models.user, app.api.deps
[ext_deps]: datetime, logging, sqlalchemy, fastapi, os, tempfile
...
[local_deps]: app.schemas.document, app.services.storage_service, app.api.documents_common, app.models.audit, app.database, app.services.deduplication_service, app.models.document, app.services.document_orchestrator, app.models.user, app.api.deps
[ext_deps]: logging, sqlalchemy, uuid, fastapi, typing
...
[local_deps]: app.services.synthesis_service, app.services.search_service, app.models.audit, app.services.graph_rag_service, app.database, app.services.temporal_reasoning_service, app.services.progressive_revelation_service, app.models.document, app.models.user, app.api.deps
...
[ext_deps]: datetime, logging, sqlalchemy, httpx, redis, asyncio, fastapi, os, nats, typing
...
[local_deps]: app.database, app.schemas.document, app.models.user, app.api.documents_upload
[ext_deps]: logging, sqlalchemy, hmac, fastapi, os
...
[local_deps]: app.database, app.services.relationship_service, app.services.timeline_service, app.services.entity_extraction_service, app.models.document, app.models.knowledge_graph, app.models.user, app.api.deps
[ext_deps]: datetime, logging, sqlalchemy, uuid, fastapi, typing
...
[local_deps]: app.models.note, app.schemas.note, app.services.space_service, app.database, app.services.note_service, app.models.user, app.models.note_audio, app.schemas.tag, app.api.deps
[ext_deps]: datetime, logging, sqlalchemy, uuid, fastapi, os
...
[local_deps]: app.celery_app, app.tasks.pipeline_orchestrator, app.core.redis_url, app.models.pipeline, app.database, app.models.document, app.api.deps
...
[local_deps]: app.models.push_subscription, app.schemas.push, app.database, app.models.user, app.api.deps
[ext_deps]: logging, sqlalchemy, uuid, fastapi, os
...
[local_deps]: app.schemas.reports, app.celery_app, app.tasks.report_tasks, app.models.user, app.api.deps
[ext_deps]: fastapi, logging, celery, typing
...
[local_deps]: app.services.search_service, app.services.input_guard, app.database, app.services.search_models, app.models.document, app.services.search_agent, app.models.user, app.api.deps
[ext_deps]: time, logging, sqlalchemy, json, asyncio, uuid, fastapi
...
[ext_deps]: logging, sqlalchemy, hashlib, uuid, pydantic, fastapi
...
[local_deps]: app.tasks.smart_folder_tasks, app.celery_app, app.models.smart_folder, app.models.note, app.models.audit, app.database, app.schemas.collection, app.tasks.collection_report_tasks, app.schemas.smart_folder, app.models.user, app.api.deps
[ext_deps]: logging, sqlalchemy, json, asyncio, uuid, fastapi, celery, typing
...
[local_deps]: app.tasks.space_tasks, app.services.space_service, app.database, app.models.user, app.schemas.space, app.schemas.tag, app.api.deps
[ext_deps]: fastapi, logging, uuid, sqlalchemy
...
[local_deps]: app.tasks.pipeline_orchestrator, app.core.redis_url, app.models.user, app.services.llm_gateway, app.api.deps
...
[local_deps]: app.tasks.subscription_tasks, app.database, app.schemas.subscription, app.models.user, app.models.subscription, app.api.deps
[ext_deps]: fastapi, logging, uuid, sqlalchemy
[fn]: _parse_uuid(s)
...
[local_deps]: app.services.space_service, app.database, app.services.task_service, app.schemas.task, app.models.user, app.schemas.tag, app.api.deps
[ext_deps]: fastapi, logging, uuid, sqlalchemy
...
[local_deps]: app.services.storage_service, app.models.note, app.services.whisper_service, app.models.document, app.models.user, app.models.note_audio, app.api.deps
[ext_deps]: logging, sqlalchemy, asyncio, uuid, fastapi, os, tempfile, io
...
[ext_deps]: logging, pathlib, pydantic, os, pydantic_settings, urllib
...
[ext_deps]: time, logging, httpx, cryptography, json, base64, os, struct, urllib
...
[ext_deps]: sqlalchemy, pgvector, dotenv, collections, fastapi, os, typing
...
[local_deps]: app.services.messaging, app.middleware.rls, app.middleware.csrf, app.core.redis_url, app.services.prometheus_metrics, app.database, app.limiter, app.middleware.transaction, app.api
[ext_deps]: time, logging, sqlalchemy, contextlib, redis, uvicorn, uuid, dotenv, slowapi, collections, starlette, fastapi, threading, os, typing
...
[local_deps]: app.services.monitoring, app.core.redis_url, app.services.cache_monitor, app.services.prometheus_metrics, app.database, app.services.embedding_service, app.api
[ext_deps]: time, datetime, logging, sqlalchemy, httpx, contextlib, redis, uvicorn, dotenv, fastapi, os
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: logging, sqlalchemy, jose, dataclasses, starlette
...
[local_deps]: app.models.collection, app.models.bookmark, app.models.space, app.models.processing, app.models.task, app.models.failed_task, app.models.smart_folder, app.models.tag, app.models.audit, app.models.subscription, app.models.push_subscription, app.models.document, app.models.note, app.models.pipeline, app.models.base, app.models.knowledge_graph, app.models.user, app.models.chat, app.models.article, app.models.pattern_insight, app.models.milestone, app.models.note_audio
...
[ext_deps]: time, logging, httpx, functools, tenacity, asyncio, collections, typing
...
[local_deps]: app.database
[ext_deps]: json, sqlalchemy, functools, hashlib
...
[local_deps]: app.schemas.document, app.schemas.admin, app.schemas.token, app.schemas.pagination, app.schemas.collection, app.schemas.smart_folder, app.schemas.search, app.schemas.user, app.schemas.chat
...
[ext_deps]: datetime, enum, uuid, pydantic, typing
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: datetime, enum, re, uuid, pydantic, typing
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.clarification_agent, app.services.agents.answer_agent, app.services.agents.agent_orchestrator
...
[ext_deps]: time, datetime, logging, enum, dataclasses, collections, typing
...
[ext_deps]: logging, re, json, dataclasses, typing
...
[local_deps]: app.services.search_service, app.services.knowledge_graph.pool, app.services.knowledge_graph.models, app.services.graph_rag_service, app.services.embed_client, app.services.agent_identity, app.services.llm_gateway, app.services.knowledge_graph.traversal
[ext_deps]: logging, re, json, dataclasses, collections, typing
...
[ext_deps]: logging, httpx, json, asyncio, hashlib, typing
...
[ext_deps]: datetime, logging, sqlalchemy, warnings, json, uuid, typing
...
[local_deps]: app.services.context_block_service, app.services.search_service, app.services.pii_detection_service, app.services.cache_monitor, app.services.prometheus_metrics, app.database, app.services.agent_identity, app.models.document, app.models.user, app.services.llm_gateway, app.services.llm_router, app.models.chat
[ext_deps]: time, logging, sqlalchemy, re, json, asyncio, uuid, collections, typing
...
[local_deps]: app.services.context_block_service, app.models.collection, app.models.audit, app.services.agent_identity, app.models.document, app.models.user, app.services.llm_gateway, app.models.chat
...
[local_deps]: app.models.collection, app.services.llm_gateway, app.services.search_service, app.schemas.collection, app.services.agent_identity, app.models.document, app.services.search_cache, app.models.user, app.services.intent_parser
[ext_deps]: datetime, logging, sqlalchemy, asyncio, uuid, typing
...
[local_deps]: app.services.llm_gateway
[ext_deps]: datetime, logging, uuid, os, typing
...
[ext_deps]: logging, sqlalchemy, json, asyncio, traceback, threading, typing
...
[local_deps]: app.schemas.document, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.services.storage_service, app.models.audit, app.models.pipeline, app.services.deduplication_service, app.models.document, app.models.user, app.tasks.voice_tasks
[ext_deps]: concurrent, datetime, logging, sqlalchemy, json, asyncio, fastapi, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: time, logging, httpx, random, asyncio, os
[fn]: _base_urls()
...
[ext_deps]: sentence_transformers, logging, torch, numpy, asyncio, threading, os, psutil, gc, typing
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.services.llm_gateway, app.models.document
[ext_deps]: datetime, logging, sqlalchemy, json, warnings, asyncio, typing
...
[local_deps]: app.services.context_block_service, app.models.document, app.models.knowledge_graph, app.services.agent_identity, app.services.llm_gateway
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: datetime, logging, enum, re, json, warnings, typing
...
[ext_deps]: datetime, logging, httpx, tenacity, json, collections, os, typing
...
[ext_deps]: logging, itertools, __future__, json, models, asyncpg, spacy
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, enum, __future__, uuid, pydantic
...
[ext_deps]: logging, __future__, json, models, asyncpg, extraction
...
[ext_deps]: logging, typing, collections
...
[local_deps]: app.services.ollama_service, app.services.minimax_service, app.services.kimi_service, app.services.pii_detection_service, app.services.openrouter_service
[ext_deps]: logging, enum, dataclasses, collections, typing
...
[ext_deps]: logging, asyncio, collections, os, nats, typing
...
[local_deps]: app.services.monitoring, app.services.base_llm_service
[ext_deps]: logging, httpx, json, collections, os, typing
...
[ext_deps]: datetime, logging, prometheus_client, redis, re, dataclasses, collections, threading, os, psutil, subprocess, typing
...
[ext_deps]: time, logging, enum, numpy, paddleocr, cv2, PIL, os, io, PyPDF2, typing, pytesseract
...
[local_deps]: app.services.base_llm_service
[ext_deps]: logging, httpx, tenacity, json, collections, os, typing
...
[local_deps]: app.services.monitoring, app.core.redis_url, app.services.cache_monitor
[ext_deps]: datetime, logging, httpx, redis, tenacity, json, hashlib, collections, os, typing
[fn]: _get_redis_client()
...
[ext_deps]: sentence_transformers, datetime, logging, sqlalchemy, psutil, typing
...
[local_deps]: app.services.agent_identity, app.models.document, app.models.knowledge_graph, app.models.user, app.services.llm_gateway
...
[local_deps]: app.services.context_block_service, app.models.collection, app.services.agent_identity, app.models.document, app.models.user, app.services.llm_gateway
[ext_deps]: datetime, logging, sqlalchemy, uuid, os, reportlab, io, typing
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.context_block_service, app.services.search_service, app.database, app.services.agent_identity, app.models.document, app.services.search_cache, app.models.user, app.services.llm_router
[ext_deps]: time, search_models, logging, sqlalchemy, re, json, asyncio, uuid, typing
...
[local_deps]: app.core.redis_url
[ext_deps]: logging, redis, json, hashlib, typing
[fn]: _get_redis()
...
[ext_deps]: logging, sqlalchemy, re, asyncio, typing
...
[ext_deps]: logging, sqlalchemy, re, numpy, typing
...
[local_deps]: app.models.smart_folder, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.report_generator, app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser, app.services.smart_folder.agent.planner, app.models.user, app.services.smart_folder.agent.executor
[ext_deps]: logging, sqlalchemy, re, uuid, typing
...
[ext_deps]: datetime, logging, sqlalchemy, dataclasses, uuid, typing
...
[ext_deps]: logging, re, json, dataclasses, uuid, typing
...
[local_deps]: app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.base, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.general_narrative
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.skills.base, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator
[ext_deps]: logging, typing
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.skills.base, app.services.smart_folder.report_generator, app.services.smart_folder.tools.document_reader, app.services.smart_folder.retrieval
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator
...
[ext_deps]: logging, re, json, csv, io, typing
...
[local_deps]: app.models.collection, app.services.search_service, app.models.document, app.models.user, app.services.llm_gateway
[ext_deps]: datetime, logging, sqlalchemy, re, uuid, typing
...
[local_deps]: app.models.bookmark, app.models.tag, app.models.note, app.models.space, app.models.document, app.models.user
[ext_deps]: sqlalchemy, logging, uuid
[fn]: _escape_like(value)
...
[ext_deps]: datetime, logging, cryptography, pathlib, uuid, base64, os
...
[ext_deps]: time, datetime, logging, contextlib, pathlib, json, sys, collections, os, typing
...
[ext_deps]: datetime, logging, enum, abc, json, asyncio, uuid, nats, typing
...
[local_deps]: app.services.messaging
[ext_deps]: time, datetime, logging, enum, json, hashlib, dataclasses, nats, typing
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, logging, enum, json, asyncio, uuid, dataclasses, nats, typing
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, logging, json, nats, typing
...
[local_deps]: app.services.context_block_service, app.models.document, app.models.knowledge_graph, app.services.agent_identity, app.services.llm_gateway
[ext_deps]: datetime, logging, sqlalchemy, json, collections, typing
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: datetime, logging, sqlalchemy, collections, typing
...
[local_deps]: app.tasks.base, app.services.monitoring, app.models.processing, app.celery_app, app.core.redis_url, app.services.cache_monitor, app.database, app.services.alert_service, app.tasks.document_tasks, app.models.document
[ext_deps]: datetime, logging, redis, asyncio, celery, os
...
[local_deps]: app.tasks.base, app.models.article, app.database, app.services.embed_client, app.services.article_generation_service, app.models.document
...
[local_deps]: app.models.article, app.tasks.article_tasks, app.database, app.tasks.embedding_tasks, app.tasks.document_tasks, app.models.document
...
[ext_deps]: logging, sqlalchemy, json, asyncio, uuid, celery, typing
...
[local_deps]: app.services.context_block_service, app.tasks.base, app.services.text_extractor, app.models.processing, app.services.collection_service, app.services.prometheus_metrics, app.database, app.services.ocr_service, app.tasks.embedding_tasks, app.services.embed_client, app.services.entity_extraction_service, app.models.document, app.tasks.article_tasks, app.services.chunking_service, app.services.dlq_service
[ext_deps]: datetime, logging, sqlalchemy, langdetect, uuid, asyncio, traceback, celery, os, tempfile
...
[local_deps]: app.tasks.base, app.celery_app, app.database, app.services.embed_client, app.models.document
...
[local_deps]: app.celery_app, app.core.redis_url, app.models.pipeline, app.database, app.models.document
[ext_deps]: datetime, logging, sqlalchemy, redis, smtplib, os, email
[fn]: _smtp_configured()
...
[local_deps]: app.tasks.pipeline_tasks, app.core.redis_url, app.models.pipeline, app.database, app.models.document
[ext_deps]: datetime, logging, redis, uuid, celery
...
[local_deps]: app.celery_app, app.tasks.pipeline_orchestrator, app.core.redis_url, app.models.pipeline, app.database, app.models.document
[ext_deps]: datetime, logging, sqlalchemy, redis, os
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.knowledge_graph.extraction, app.services.text_extractor, app.celery_app, app.services.knowledge_graph.pool, app.models.pipeline, app.database, app.services.ocr_service, app.tasks.article_tasks, app.services.embed_client, app.tasks.document_tasks, app.models.document, app.services.entity_extraction_service, app.services.chunking_service, app.services.dlq_service
[ext_deps]: time, datetime, logging, asyncio, uuid, traceback, celery, os, gc, tempfile
...
[ext_deps]: time, datetime, logging, sqlalchemy, openpyxl, celery, os, fpdf
...
[local_deps]: app.models.document, app.services.smart_folder.agent_runner, app.models.smart_folder, app.models.audit, app.database, app.tasks.base, app.models.user, app.services.smart_folder_service
[ext_deps]: datetime, logging, sqlalchemy, json, asyncio, uuid, celery, typing
...
[ext_deps]: datetime, logging, sqlalchemy, httpx, smtplib, os, calendar, email
...
[local_deps]: app.models.push_subscription, app.celery_app, app.models.task, app.database, app.services.task_service, app.core.push
...
[ext_deps]: logging, sqlalchemy, asyncio, os, tempfile
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: time, logging, functools, asyncio, collections, threading, typing
...
[ext_deps]: datetime, logging, sqlalchemy, jose, bcrypt, dotenv, fastapi, os, typing
