...
[local_deps]: app.models.chat, app.schemas.admin, app.core.redis_url, app.models.article, app.database, app.api.deps, app.models.failed_task, app.tasks.document_tasks, app.schemas.user, app.models.user, app.utils.security, app.models.audit, app.models.processing, app.models.document, app.services.whisper_service, app.models.pipeline, app.services.alert_service
[ext_deps]: os, fastapi, redis, sqlalchemy, uuid, logging, json, datetime, typing
...
[local_deps]: app.schemas.token, app.database, app.api.deps, app.schemas.user, app.models.user, app.utils.constants, app.utils.security, app.services.token_blacklist, app.middleware.csrf, app.schemas.auth, app.limiter, app.core.redis_url
[ext_deps]: os, fastapi, redis, time, hashlib, sqlalchemy, secrets, uuid, httpx, logging, datetime, dotenv
...
[local_deps]: app.schemas.bookmark, app.schemas.tag, app.services.bookmark_service, app.database, app.api.deps, app.models.user, app.services.space_service
[ext_deps]: logging, sqlalchemy, fastapi, uuid
...
[local_deps]: app.models.chat, app.services.input_guard, app.schemas.chat, app.database, app.api.deps, app.models.user, app.services.chat_service, app.limiter
[ext_deps]: fastapi, sqlalchemy, uuid, logging, json
...
[local_deps]: app.models.article, app.database, app.api.deps, app.tasks.document_tasks, app.services.collection_chat_service, app.models.user, app.models.collection, app.models.audit, app.services.collection_service, app.services.llm_gateway, app.services.input_guard, app.schemas.collection
[ext_deps]: fastapi, io, datetime, sqlalchemy, uuid, reportlab, logging, json, typing
...
[local_deps]: app.api.documents_common, app.database, app.api.deps, app.tasks.document_tasks, app.tasks.embedding_tasks, app.models.user, app.services.similarity_service, app.models.audit, app.services.storage_service, app.models.document, app.schemas.document, app.api.documents_journal, app.models.processing, app.models.pipeline, app.api.documents_upload
[ext_deps]: fastapi, sqlalchemy, uuid, logging, datetime, typing
...
[local_deps]: app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.models.user, app.models.audit, app.schemas.document, app.models.document, app.models.pipeline
[ext_deps]: os, json, fastapi, concurrent, mimetypes, sqlalchemy, uuid, logging, asyncio, pydantic, datetime, typing
...
[local_deps]: app.api.documents_common, app.database, app.api.deps, app.models.user, app.models.audit, app.services.storage_service, app.models.document, app.schemas.document, app.services.whisper_service
[ext_deps]: os, fastapi, tempfile, sqlalchemy, logging, datetime
...
[local_deps]: app.api.documents_common, app.database, app.api.deps, app.models.user, app.models.audit, app.services.storage_service, app.models.document, app.schemas.document, app.services.deduplication_service, app.services.document_orchestrator
[ext_deps]: fastapi, sqlalchemy, uuid, logging, typing
...
[local_deps]: app.services.graph_rag_service, app.services.progressive_revelation_service, app.database, app.api.deps, app.services.search_service, app.models.user, app.services.synthesis_service, app.models.audit, app.models.document, app.services.temporal_reasoning_service
[ext_deps]: fastapi, sqlalchemy, uuid, logging, json, typing
...
[ext_deps]: os, fastapi, redis, sqlalchemy, httpx, logging, asyncio, datetime, nats, typing
...
[local_deps]: app.models.knowledge_graph, app.services.timeline_service, app.database, app.api.deps, app.services.relationship_service, app.models.user, app.models.document, app.services.entity_extraction_service
[ext_deps]: fastapi, sqlalchemy, uuid, logging, datetime, typing
...
[local_deps]: app.schemas.tag, app.models.note_audio, app.schemas.note, app.database, app.api.deps, app.models.user, app.services.space_service, app.services.note_service, app.models.note
[ext_deps]: os, fastapi, sqlalchemy, uuid, logging, datetime
...
[local_deps]: app.database, app.api.deps, app.tasks.pipeline_orchestrator, app.models.document, app.celery_app, app.models.pipeline, app.core.redis_url
...
[local_deps]: app.tasks.report_tasks, app.api.deps, app.models.user, app.schemas.reports, app.celery_app
[ext_deps]: logging, celery, fastapi, typing
...
[local_deps]: app.services.search_agent, app.database, app.api.deps, app.services.search_models, app.services.search_service, app.models.user, app.models.document, app.services.input_guard
[ext_deps]: json, fastapi, time, sqlalchemy, uuid, logging, asyncio
...
[ext_deps]: fastapi, hashlib, sqlalchemy, uuid, logging, pydantic
...
[local_deps]: app.schemas.smart_folder, app.tasks.collection_report_tasks, app.database, app.api.deps, app.models.user, app.tasks.smart_folder_tasks, app.models.audit, app.models.smart_folder, app.celery_app, app.schemas.collection, app.models.note
[ext_deps]: fastapi, asyncio, celery, sqlalchemy, uuid, logging, json, typing
...
[local_deps]: app.schemas.tag, app.database, app.api.deps, app.schemas.space, app.tasks.space_tasks, app.models.user, app.services.space_service
[ext_deps]: logging, sqlalchemy, fastapi, uuid
...
[local_deps]: app.api.deps, app.tasks.pipeline_orchestrator, app.models.user, app.services.llm_gateway, app.core.redis_url
...
[local_deps]: app.models.note_audio, app.api.deps, app.models.user, app.services.storage_service, app.models.document, app.services.whisper_service, app.models.note
[ext_deps]: os, fastapi, io, tempfile, sqlalchemy, uuid, logging, asyncio
...
[ext_deps]: os, pathlib, urllib, pydantic_settings, logging, pydantic
...
[ext_deps]: os, fastapi, pgvector, sqlalchemy, dotenv, collections, typing
...
[local_deps]: app.middleware.transaction, app.services.prometheus_metrics, app.services.messaging, app.database, app.middleware.rls, app.api, app.middleware.csrf, app.limiter, app.core.redis_url
[ext_deps]: os, fastapi, slowapi, redis, time, uvicorn, contextlib, starlette, threading, sqlalchemy, uuid, logging, dotenv, collections, typing
...
[local_deps]: app.services.prometheus_metrics, app.services.monitoring, app.database, app.api, app.services.embedding_service, app.services.cache_monitor, app.core.redis_url
[ext_deps]: os, fastapi, redis, time, uvicorn, contextlib, sqlalchemy, httpx, logging, datetime, dotenv
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[local_deps]: app.models.space, app.models.failed_task, app.models.tag, app.models.processing, app.models.document, app.models.milestone, app.models.article, app.models.chat, app.models.knowledge_graph, app.models.user, app.models.collection, app.models.smart_folder, app.models.pipeline, app.models.note, app.models.bookmark, app.models.note_audio, app.models.base, app.models.audit, app.models.pattern_insight
...
[ext_deps]: time, tenacity, functools, httpx, logging, asyncio, collections, typing
...
[local_deps]: app.schemas.token, app.schemas.admin, app.schemas.chat, app.schemas.pagination, app.schemas.smart_folder, app.schemas.user, app.schemas.search, app.schemas.document, app.schemas.collection
...
[ext_deps]: enum, uuid, datetime, pydantic, typing
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: enum, re, uuid, datetime, pydantic, typing
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.researcher_agent, app.services.agents.answer_agent, app.services.agents.verification_agent, app.services.agents.agent_orchestrator, app.services.agents.clarification_agent

---
### FILE: backend/app/services/agents/agent_orchestrator.py
[local_deps]: app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.clarification_agent, app.services.agents.answer_agent
[ext_deps]: enum, dataclasses, time, logging, datetime, collections, typing
...
[ext_deps]: dataclasses, re, logging, json, typing
...
[local_deps]: app.services.graph_rag_service, app.services.knowledge_graph.models, app.services.knowledge_graph.traversal, app.services.search_service, app.services.knowledge_graph.pool, app.services.agent_identity, app.services.llm_gateway, app.services.embed_client
[ext_deps]: dataclasses, re, logging, json, collections, typing
...
[ext_deps]: json, hashlib, httpx, logging, asyncio, typing
...
[ext_deps]: json, warnings, sqlalchemy, uuid, logging, datetime, typing
...
[local_deps]: app.models.chat, app.services.llm_router, app.services.prometheus_metrics, app.database, app.services.search_service, app.services.context_block_service, app.models.user, app.services.agent_identity, app.models.document, app.services.cache_monitor, app.services.llm_gateway, app.services.pii_detection_service
[ext_deps]: json, time, re, sqlalchemy, uuid, logging, asyncio, collections, typing
...
[local_deps]: app.models.chat, app.services.context_block_service, app.models.user, app.models.collection, app.models.audit, app.services.agent_identity, app.models.document, app.services.llm_gateway
[ext_deps]: sqlalchemy, uuid, logging, json, typing
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.search_service, app.models.user, app.models.collection, app.services.agent_identity, app.models.document, app.services.llm_gateway, app.services.intent_parser, app.schemas.collection, app.services.search_cache
[ext_deps]: asyncio, sqlalchemy, uuid, logging, datetime, typing
...
[local_deps]: app.services.llm_gateway
[ext_deps]: os, uuid, logging, datetime, typing
...
[ext_deps]: asyncio, traceback, sqlalchemy, threading, logging, json, typing
...
[local_deps]: app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.models.user, app.models.audit, app.services.storage_service, app.schemas.document, app.models.document, app.services.deduplication_service, app.tasks.voice_tasks, app.models.pipeline
[ext_deps]: fastapi, concurrent, asyncio, sqlalchemy, logging, json, datetime, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: logging, datetime, os, sendgrid
...
[ext_deps]: os, time, random, httpx, logging, asyncio
[fn]: _base_urls()
...
[ext_deps]: os, gc, psutil, torch, threading, numpy, sentence_transformers, logging, asyncio, typing
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity, app.models.knowledge_graph, app.models.document
[ext_deps]: warnings, datetime, asyncio, sqlalchemy, logging, json, typing
...
[local_deps]: app.models.knowledge_graph, app.services.context_block_service, app.services.agent_identity, app.models.document, app.services.llm_gateway
...
[ext_deps]: dataclasses, redis, hashlib, re, logging
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: enum, warnings, re, logging, json, datetime, typing
...
[ext_deps]: os, collections, tenacity, httpx, logging, json, datetime, typing
...
[ext_deps]: models, spacy, asyncpg, logging, json, __future__, itertools
[fn]: _vec_to_str(vec)
...
[ext_deps]: enum, uuid, datetime, __future__, pydantic
...
[ext_deps]: models, extraction, asyncpg, logging, json, __future__
...
[local_deps]: app.services.ollama_service, app.services.kimi_service, app.services.openrouter_service, app.services.minimax_service, app.services.pii_detection_service
...
[ext_deps]: os, logging, asyncio, collections, nats, typing
...
[ext_deps]: os, httpx, logging, json, collections, typing
...
[ext_deps]: os, psutil, dataclasses, redis, collections, subprocess, re, threading, prometheus_client, logging, datetime, typing
...
[ext_deps]: os, enum, PIL, io, time, paddleocr, PyPDF2, pytesseract, cv2, numpy, logging, typing
...
[local_deps]: app.services.base_llm_service
[ext_deps]: os, tenacity, httpx, logging, json, collections, typing
...
[ext_deps]: os, redis, datetime, tenacity, hashlib, httpx, logging, json, collections, typing
...
[ext_deps]: psutil, sqlalchemy, sentence_transformers, logging, datetime, typing
...
[ext_deps]: time, collections, functools, logging, typing
...
[ext_deps]: logging, sqlalchemy, collections, typing
...
[ext_deps]: os, io, sqlalchemy, uuid, reportlab, logging, datetime, typing
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.llm_router, app.database, app.services.search_service, app.services.context_block_service, app.models.user, app.services.agent_identity, app.models.document, app.services.search_cache
[ext_deps]: json, time, search_models, re, sqlalchemy, uuid, logging, asyncio, typing
...
[local_deps]: app.models.user, app.models.document, app.services.rerank_service, app.services.pii_detection_service, app.services.search_cache, app.services.embed_client
[ext_deps]: re, sqlalchemy, logging, asyncio, typing
...
[ext_deps]: dataclasses, logging, json, collections, typing
...
[ext_deps]: re, sqlalchemy, numpy, logging, typing
...
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.entity_resolver, app.services.smart_folder.report_generator, app.services.smart_folder.analysis, app.services.smart_folder.query_parser
...
[local_deps]: app.services.smart_folder.agent.planner, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.synthesizer, app.models.user, app.services.smart_folder.agent.executor, app.services.smart_folder.report_generator, app.models.smart_folder, app.services.smart_folder.query_parser
[ext_deps]: re, sqlalchemy, uuid, logging, typing
...
[ext_deps]: dataclasses, sqlalchemy, uuid, logging, datetime, typing
...
[ext_deps]: dataclasses, sqlalchemy, difflib, logging, typing
...
[ext_deps]: dataclasses, re, uuid, logging, json, typing
...
[local_deps]: app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.base, app.services.smart_folder.skills.legal_review
...
[local_deps]: app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.asset_reader
[ext_deps]: logging, typing
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.tools.document_reader, app.services.smart_folder.report_generator, app.services.smart_folder.analysis, app.services.smart_folder.skills.base
...
[ext_deps]: csv, io, re, logging, json, typing
...
[local_deps]: app.services.search_service, app.models.user, app.models.collection, app.models.document, app.services.llm_gateway
[ext_deps]: re, sqlalchemy, uuid, logging, datetime, typing
...
[local_deps]: app.models.space, app.models.bookmark, app.models.tag, app.models.user, app.models.document, app.models.note
[ext_deps]: logging, sqlalchemy, uuid
[fn]: _escape_like(value)
...
[ext_deps]: cryptography, os, pathlib, base64, uuid, logging, datetime
...
[ext_deps]: os, pathlib, time, datetime, sys, contextlib, logging, json, collections, typing
...
[ext_deps]: enum, json, uuid, abc, logging, asyncio, datetime, nats, typing
...
[local_deps]: app.services.messaging
[ext_deps]: enum, dataclasses, time, hashlib, logging, json, datetime, nats, typing
...
[local_deps]: app.services.messaging
[ext_deps]: enum, json, dataclasses, uuid, logging, asyncio, datetime, nats, typing
...
[local_deps]: app.models.knowledge_graph, app.services.context_block_service, app.services.agent_identity, app.models.document, app.services.llm_gateway
[ext_deps]: json, sqlalchemy, logging, datetime, collections, typing
...
[ext_deps]: os, httpx, logging, json, datetime
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: sqlalchemy, logging, datetime, collections, typing
...
[ext_deps]: csv, zipfile, pathlib, xlrd, pptx, html, subprocess, xml, PyPDF2, docx, openpyxl, re, logging, json, ebooklib, typing
...
[local_deps]: app.core.redis_url, app.services.monitoring, app.database, app.tasks.document_tasks, app.tasks.base, app.models.processing, app.models.document, app.celery_app, app.services.cache_monitor, app.services.alert_service
[ext_deps]: os, redis, celery, asyncio, logging, datetime
...
[local_deps]: app.models.article, app.database, app.tasks.base, app.services.article_generation_service, app.models.document, app.services.embed_client
[ext_deps]: celery, httpx, uuid, logging, asyncio
...
[local_deps]: app.tasks.article_tasks, app.models.article, app.database, app.tasks.document_tasks, app.tasks.embedding_tasks, app.models.document
...
[ext_deps]: os, psutil, traceback, logging, asyncio
...
[local_deps]: app.services.report_service, app.database, app.models.user, app.tasks.base, app.models.audit
[ext_deps]: json, celery, sqlalchemy, uuid, logging, asyncio, typing
...
[local_deps]: app.tasks.article_tasks, app.services.ocr_service, app.services.prometheus_metrics, app.database, app.services.context_block_service, app.services.dlq_service, app.tasks.embedding_tasks, app.tasks.base, app.models.processing, app.services.collection_service, app.models.document, app.services.text_extractor, app.services.chunking_service, app.services.entity_extraction_service, app.services.embed_client
[ext_deps]: os, celery, langdetect, asyncio, sqlalchemy, traceback, uuid, tempfile, logging, datetime
...
[local_deps]: app.database, app.tasks.base, app.models.document, app.celery_app, app.services.embed_client
...
[ext_deps]: redis, celery, uuid, logging, datetime
...
[local_deps]: app.database, app.tasks.pipeline_orchestrator, app.models.document, app.celery_app, app.models.pipeline, app.core.redis_url
[ext_deps]: os, redis, sqlalchemy, logging, datetime
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.tasks.article_tasks, app.database, app.tasks.document_tasks, app.services.knowledge_graph.extraction, app.services.entity_extraction_service, app.services.dlq_service, app.services.knowledge_graph.pool, app.services.text_extractor, app.models.document, app.celery_app, app.services.chunking_service, app.services.ocr_service, app.models.pipeline, app.services.embed_client
[ext_deps]: os, gc, time, celery, traceback, tempfile, uuid, logging, asyncio, datetime
...
[ext_deps]: os, time, celery, openpyxl, sqlalchemy, logging, datetime, fpdf
...
[local_deps]: app.services.smart_folder_service, app.database, app.models.user, app.tasks.base, app.models.audit, app.models.document, app.models.smart_folder, app.services.smart_folder.agent_runner
[ext_deps]: json, datetime, celery, sqlalchemy, uuid, logging, asyncio, typing
...
[local_deps]: app.tasks.base, app.models.space, app.database, app.services.space_service
...
[ext_deps]: os, tempfile, sqlalchemy, logging, asyncio
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: time, functools, threading, logging, asyncio, collections, typing
...
[ext_deps]: os, bcrypt, fastapi, jose, sqlalchemy, logging, datetime, dotenv, typing
