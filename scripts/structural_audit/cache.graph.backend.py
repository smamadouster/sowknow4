...
[local_deps]: app.models.user, app.schemas.admin, app.services.whisper_service, app.celery_app, app.models.chat, app.api.deps, app.tasks.pipeline_tasks, app.schemas.user, app.services.storage_service, app.core.redis_url, app.models.pipeline, app.models.processing, app.services.embed_client, app.models.failed_task, app.models.document, app.models.article, app.utils.security, app.services.alert_service, app.models.audit, app.api.documents_common, app.tasks.pipeline_orchestrator, app.database
[ext_deps]: concurrent, os, uuid, typing, fastapi, sqlalchemy, asyncio, pydantic, json, logging, datetime, redis
...
[local_deps]: app.models.user, app.models.document, app.api.deps, app.schemas.article, app.models.article, app.tasks.article_tasks
...
[local_deps]: app.schemas.auth, app.models.user, app.limiter, app.services.token_blacklist, app.utils.constants, app.api.deps, app.schemas.token, app.core.redis_url, app.database, app.schemas.user, app.utils.security, app.middleware.csrf
[ext_deps]: httpx, os, time, dotenv, hashlib, uuid, fastapi, sqlalchemy, logging, datetime, redis, secrets
...
[local_deps]: app.models.user, app.schemas.bookmark, app.api.deps, app.services.bookmark_service, app.services.space_service, app.schemas.tag, app.database
[ext_deps]: uuid, fastapi, logging, sqlalchemy
...
[local_deps]: app.models.user, app.limiter, app.schemas.chat, app.services.chat_service, app.models.chat, app.api.deps, app.services.input_guard, app.database
[ext_deps]: uuid, fastapi, sqlalchemy, json, logging
...
[local_deps]: app.tasks.document_tasks, app.models.user, app.models.audit, app.services.collection_service, app.api.deps, app.services.input_guard, app.models.article, app.models.collection, app.services.collection_chat_service, app.database, app.services.llm_gateway, app.schemas.collection
[ext_deps]: uuid, typing, fastapi, io, sqlalchemy, reportlab, json, logging, datetime
...
[local_deps]: app.utils.constants, app.services.token_blacklist, app.models.user, app.database, app.utils.security
...
[local_deps]: app.api.documents_upload, app.services.similarity_service, app.tasks.document_tasks, app.models.document, app.models.user, app.tasks.embedding_tasks, app.models.audit, app.schemas.document, app.api.documents_journal, app.api.deps, app.services.storage_service, app.api.documents_common, app.tasks.pipeline_orchestrator, app.models.pipeline, app.tasks.pipeline_tasks, app.database, app.models.processing
[ext_deps]: concurrent, uuid, typing, fastapi, sqlalchemy, asyncio, logging, datetime
...
[local_deps]: app.models.user, app.models.document, app.models.audit, app.schemas.document, app.core.redis_url, app.tasks.pipeline_orchestrator, app.models.pipeline, app.tasks.pipeline_tasks
[ext_deps]: concurrent, os, uuid, typing, fastapi, asyncio, sqlalchemy, pydantic, json, logging, datetime, redis, mimetypes
...
[local_deps]: app.models.document, app.models.user, app.services.whisper_service, app.models.audit, app.schemas.document, app.api.deps, app.services.storage_service, app.api.documents_common, app.database
[ext_deps]: os, fastapi, sqlalchemy, logging, datetime, tempfile
...
[local_deps]: app.services.deduplication_service, app.services.document_orchestrator, app.models.document, app.models.user, app.models.audit, app.schemas.document, app.api.deps, app.services.storage_service, app.api.documents_common, app.database
[ext_deps]: uuid, typing, fastapi, sqlalchemy, logging
...
[local_deps]: app.models.user, app.models.document, app.services.graph_rag_service, app.services.search_service, app.models.audit, app.api.deps, app.services.progressive_revelation_service, app.services.temporal_reasoning_service, app.database, app.services.synthesis_service
[ext_deps]: uuid, typing, fastapi, sqlalchemy, json, logging
...
[ext_deps]: nats, httpx, os, typing, fastapi, asyncio, sqlalchemy, logging, datetime, redis
...
[local_deps]: app.api.documents_upload, app.database, app.models.user, app.schemas.document
...
[local_deps]: app.services.timeline_service, app.models.user, app.models.document, app.api.deps, app.services.relationship_service, app.models.knowledge_graph, app.database, app.services.entity_extraction_service
[ext_deps]: uuid, typing, fastapi, sqlalchemy, logging, datetime
...
[local_deps]: app.models.user, app.models.note, app.api.deps, app.models.note_audio, app.services.note_service, app.services.space_service, app.schemas.tag, app.database, app.schemas.note
[ext_deps]: os, uuid, fastapi, sqlalchemy, logging, datetime
...
[local_deps]: app.models.document, app.celery_app, app.api.deps, app.core.redis_url, app.tasks.pipeline_orchestrator, app.models.pipeline, app.database
...
[local_deps]: app.models.user, app.models.push_subscription, app.schemas.push, app.api.deps, app.database
[ext_deps]: os, uuid, fastapi, sqlalchemy, logging
...
[local_deps]: app.models.user, app.celery_app, app.tasks.report_tasks, app.api.deps, app.schemas.reports
...
[local_deps]: app.models.user, app.models.document, app.services.search_agent, app.services.search_service, app.services.search_models, app.api.deps, app.services.input_guard, app.database
[ext_deps]: time, uuid, fastapi, asyncio, sqlalchemy, json, logging
...
[ext_deps]: hashlib, uuid, fastapi, sqlalchemy, pydantic, logging
...
[local_deps]: app.schemas.smart_folder, app.models.user, app.models.note, app.celery_app, app.models.audit, app.tasks.collection_report_tasks, app.tasks.smart_folder_tasks, app.api.deps, app.database, app.schemas.collection, app.models.smart_folder
[ext_deps]: celery, uuid, typing, fastapi, sqlalchemy, asyncio, json, logging
...
[local_deps]: app.models.user, app.tasks.space_tasks, app.api.deps, app.services.space_service, app.schemas.tag, app.database, app.schemas.space
[ext_deps]: uuid, fastapi, logging, sqlalchemy
...
[local_deps]: app.models.user, app.api.deps, app.core.redis_url, app.tasks.pipeline_orchestrator, app.services.llm_gateway
...
[local_deps]: app.schemas.subscription, app.tasks.subscription_tasks, app.models.user, app.models.subscription, app.api.deps, app.database
[ext_deps]: uuid, fastapi, logging, sqlalchemy
[fn]: _parse_uuid(s)
...
[local_deps]: app.models.user, app.services.task_service, app.api.deps, app.services.space_service, app.schemas.tag, app.database, app.schemas.task
[ext_deps]: uuid, fastapi, logging, sqlalchemy
...
[local_deps]: app.models.user, app.models.document, app.models.note, app.services.whisper_service, app.api.deps, app.models.note_audio, app.services.storage_service
[ext_deps]: os, uuid, io, fastapi, asyncio, sqlalchemy, logging, tempfile
...
[ext_deps]: os, pydantic_settings, pydantic, logging, urllib, pathlib
...
[ext_deps]: httpx, time, os, cryptography, json, base64, logging, urllib, struct
...
[ext_deps]: pgvector, os, dotenv, typing, fastapi, sqlalchemy, collections
...
[local_deps]: app.services.prometheus_metrics, app.limiter, app.api, app.middleware.rls, app.core.redis_url, app.services.messaging, app.database, app.middleware.csrf, app.middleware.transaction
[ext_deps]: starlette, time, os, dotenv, contextlib, uuid, typing, fastapi, slowapi, sqlalchemy, logging, uvicorn, collections, redis, threading
...
[local_deps]: app.services.cache_monitor, app.services.prometheus_metrics, app.services.embedding_service, app.services.monitoring, app.api, app.core.redis_url, app.database
[ext_deps]: httpx, time, os, dotenv, contextlib, fastapi, sqlalchemy, logging, datetime, uvicorn, redis
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[local_deps]: app.models.space, app.models.tag, app.models.user, app.models.chat, app.models.collection, app.models.smart_folder, app.models.knowledge_graph, app.models.pipeline, app.models.bookmark, app.models.processing, app.models.failed_task, app.models.document, app.models.pattern_insight, app.models.milestone, app.models.note_audio, app.models.article, app.models.task, app.models.subscription, app.models.note, app.models.audit, app.models.push_subscription, app.models.base
...
[ext_deps]: httpx, time, typing, asyncio, functools, logging, collections, tenacity
...
[local_deps]: app.schemas.smart_folder, app.schemas.admin, app.schemas.document, app.schemas.chat, app.schemas.search, app.schemas.token, app.schemas.pagination, app.schemas.user, app.schemas.collection
...
[ext_deps]: uuid, typing, pydantic, datetime, enum
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: uuid, typing, datetime, pydantic
...
[ext_deps]: uuid, typing, pydantic, datetime, re, enum
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.answer_agent, app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.clarification_agent, app.services.agents.agent_orchestrator
...
[ext_deps]: time, typing, logging, datetime, collections, enum, dataclasses
...
[ext_deps]: typing, json, logging, re, dataclasses
...
[local_deps]: app.services.knowledge_graph.models, app.services.graph_rag_service, app.services.search_service, app.services.agent_identity, app.services.knowledge_graph.pool, app.services.embed_client, app.services.llm_gateway, app.services.knowledge_graph.traversal
[ext_deps]: typing, json, logging, re, collections, dataclasses
...
[ext_deps]: httpx, hashlib, typing, asyncio, json, logging
...
[ext_deps]: uuid, typing, warnings, sqlalchemy, json, logging, datetime
...
[ext_deps]: typing, json, logging, datetime, threading
...
[local_deps]: app.services.pii_detection_service, app.services.prometheus_metrics, app.services.cache_monitor, app.models.user, app.services.context_block_service, app.models.document, app.services.search_service, app.services.agent_identity, app.models.chat, app.database, app.services.llm_gateway, app.services.llm_router
[ext_deps]: time, uuid, typing, asyncio, sqlalchemy, json, logging, re, collections
...
[local_deps]: app.models.user, app.services.context_block_service, app.models.document, app.services.agent_identity, app.models.audit, app.models.chat, app.models.collection, app.services.llm_gateway
...
[local_deps]: app.models.user, app.models.document, app.services.search_service, app.services.agent_identity, app.services.intent_parser, app.models.collection, app.services.search_cache, app.services.llm_gateway, app.schemas.collection
[ext_deps]: uuid, typing, sqlalchemy, asyncio, logging, datetime
...
[ext_deps]: traceback, typing, sqlalchemy, asyncio, json, logging, threading
...
[local_deps]: app.services.deduplication_service, app.models.user, app.models.document, app.models.audit, app.schemas.document, app.services.storage_service, app.tasks.pipeline_orchestrator, app.models.pipeline, app.tasks.pipeline_tasks, app.tasks.voice_tasks
[ext_deps]: concurrent, typing, fastapi, sqlalchemy, asyncio, json, logging, datetime
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: httpx, time, os, asyncio, random, logging
[fn]: _base_urls()
...
[ext_deps]: os, sentence_transformers, typing, torch, asyncio, gc, numpy, logging, psutil, threading
...
[ext_deps]: os, transformers, onnxruntime, numpy, logging, pathlib
...
[local_deps]: app.services.agent_identity, app.models.knowledge_graph, app.models.document, app.services.llm_gateway
[ext_deps]: typing, warnings, sqlalchemy, asyncio, json, logging, datetime
...
[ext_deps]: typing, sqlalchemy, logging, re, collections
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: typing, warnings, json, logging, datetime, re, enum
...
[ext_deps]: httpx, os, typing, json, logging, datetime, collections, tenacity
...
[ext_deps]: itertools, models, asyncpg, json, logging, spacy, __future__
[fn]: _vec_to_str(vec)
...
[local_deps]: app.services.kimi_service, app.services.pii_detection_service, app.services.ollama_service, app.services.openrouter_service, app.services.minimax_service
...
[ext_deps]: nats, os, typing, asyncio, logging, collections
...
[ext_deps]: httpx, os, typing, json, logging, collections
...
[ext_deps]: os, typing, subprocess, logging, datetime, prometheus_client, re, psutil, collections, redis, threading, dataclasses
...
[ext_deps]: time, os, paddleocr, typing, io, cv2, numpy, pytesseract, logging, PyPDF2, PIL, enum
...
[local_deps]: app.services.base_llm_service
[ext_deps]: httpx, os, typing, json, logging, collections, tenacity
...
[ext_deps]: httpx, os, hashlib, typing, json, logging, datetime, collections, redis, tenacity
[fn]: _get_redis_client()
...
[ext_deps]: sentence_transformers, typing, sqlalchemy, logging, datetime, psutil
...
[local_deps]: app.models.user, app.models.document, app.services.agent_identity, app.models.knowledge_graph, app.services.llm_gateway
...
[local_deps]: app.models.user, app.models.document, app.services.context_block_service, app.services.agent_identity, app.models.collection, app.services.llm_gateway
[ext_deps]: os, uuid, typing, io, sqlalchemy, reportlab, logging, datetime
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.models.user, app.models.document, app.services.context_block_service, app.services.search_service, app.services.agent_identity, app.database, app.services.search_cache, app.services.llm_router
[ext_deps]: time, uuid, typing, asyncio, sqlalchemy, json, logging, re, search_models
...
[local_deps]: app.core.redis_url
[ext_deps]: hashlib, typing, json, logging, redis
[fn]: _get_redis()
...
[local_deps]: app.services.pii_detection_service, app.models.user, app.models.document, app.services.rerank_service, app.services.embed_client, app.services.search_cache
...
[ext_deps]: typing, json, logging, collections, dataclasses
...
[ext_deps]: typing, sqlalchemy, numpy, logging, re
...
[local_deps]: app.services.smart_folder.query_parser, app.services.smart_folder.analysis, app.services.smart_folder.report_generator, app.services.smart_folder.retrieval, app.services.smart_folder.entity_resolver
...
[local_deps]: app.services.smart_folder.agent.planner, app.models.user, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.agent.executor, app.services.smart_folder.entity_resolver, app.models.smart_folder
[ext_deps]: uuid, typing, sqlalchemy, logging, re
...
[ext_deps]: uuid, typing, sqlalchemy, logging, datetime, dataclasses
...
[ext_deps]: difflib, typing, sqlalchemy, logging, dataclasses
...
[local_deps]: app.services.llm_router
[ext_deps]: typing, json, logging, datetime, dataclasses
...
[ext_deps]: uuid, typing, json, logging, re, dataclasses
...
[local_deps]: app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.base, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.sentiment_tracker
...
[local_deps]: app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.skills.base, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator
[ext_deps]: typing, logging
...
[local_deps]: app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.refinement_parser
...
[ext_deps]: typing, io, json, logging, csv, re
...
[local_deps]: app.models.user, app.models.document, app.services.search_service, app.models.collection, app.services.llm_gateway
[ext_deps]: uuid, typing, sqlalchemy, logging, datetime, re
...
[local_deps]: app.models.space, app.models.document, app.models.tag, app.models.user, app.models.note, app.models.bookmark
[ext_deps]: uuid, logging, sqlalchemy
[fn]: _escape_like(value)
...
[ext_deps]: os, uuid, cryptography, base64, logging, datetime, pathlib
...
[ext_deps]: os, time, contextlib, typing, json, logging, datetime, collections, pathlib, sys
...
[ext_deps]: hitl_bridge, base_agent, flock_alerter, registry

---
### FILE: backend/app/services/swarm/v2/base_agent.py
[local_deps]: app.services.messaging
[ext_deps]: nats, uuid, typing, asyncio, enum, json, logging, datetime, abc
...
[local_deps]: app.services.messaging
[ext_deps]: nats, time, hashlib, typing, json, logging, datetime, enum, dataclasses
...
[local_deps]: app.services.messaging
[ext_deps]: nats, uuid, typing, asyncio, json, logging, datetime, enum, dataclasses
...
[local_deps]: app.models.document, app.services.context_block_service, app.services.agent_identity, app.models.knowledge_graph, app.services.llm_gateway
[ext_deps]: typing, sqlalchemy, json, logging, datetime, collections
...
[ext_deps]: httpx, os, json, logging, datetime
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: typing, sqlalchemy, logging, datetime, collections
...
[ext_deps]: os, docx, html, typing, ebooklib, zipfile, subprocess, json, logging, csv, PyPDF2, xml, re, pathlib, pptx, sys
...
[local_deps]: app.services.cache_monitor, app.models.document, app.services.monitoring, app.services.alert_service, app.celery_app, app.tasks.base, app.core.redis_url, app.tasks.pipeline_orchestrator, app.database, app.models.processing
[ext_deps]: os, celery, asyncio, logging, datetime, redis
...
[local_deps]: app.models.document, app.tasks.base, app.models.article, app.services.article_generation_service, app.database, app.services.embed_client
[ext_deps]: httpx, celery, uuid, asyncio, logging
...
[local_deps]: app.models.document, app.tasks.pipeline_orchestrator, app.models.article, app.database, app.tasks.article_tasks, app.tasks.embedding_tasks
...
[ext_deps]: os, traceback, asyncio, logging, psutil
...
[local_deps]: app.models.user, app.models.audit, app.tasks.base, app.database, app.services.report_service
[ext_deps]: celery, uuid, typing, asyncio, sqlalchemy, json, logging
...
[local_deps]: app.services.prometheus_metrics, app.services.text_extractor, app.models.document, app.services.context_block_service, app.tasks.embedding_tasks, app.services.dlq_service, app.services.entity_extraction_service, app.services.collection_service, app.services.ocr_service, app.tasks.base, app.tasks.pipeline_orchestrator, app.services.chunking_service, app.database, app.services.embed_client, app.tasks.article_tasks, app.models.processing
[ext_deps]: celery, os, traceback, uuid, asyncio, sqlalchemy, logging, datetime, langdetect, tempfile
...
[local_deps]: app.models.document, app.celery_app, app.tasks.base, app.database, app.services.embed_client
...
[local_deps]: app.models.document, app.celery_app, app.core.redis_url, app.models.pipeline, app.database
[ext_deps]: os, smtplib, email, sqlalchemy, logging, datetime, redis
[fn]: _smtp_configured()
...
[ext_deps]: celery, uuid, logging, datetime, redis
...
[local_deps]: app.models.document, app.celery_app, app.core.redis_url, app.tasks.pipeline_orchestrator, app.models.pipeline, app.database
[ext_deps]: os, sqlalchemy, logging, datetime, redis
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.text_extractor, app.tasks.document_tasks, app.models.document, app.services.dlq_service, app.services.entity_extraction_service, app.celery_app, app.services.ocr_service, app.services.knowledge_graph.pool, app.services.chunking_service, app.models.pipeline, app.services.knowledge_graph.extraction, app.database, app.services.embed_client, app.tasks.article_tasks
[ext_deps]: time, os, celery, traceback, uuid, asyncio, logging, datetime, gc, tempfile
...
[ext_deps]: time, os, celery, sqlalchemy, openpyxl, logging, datetime, fpdf
...
[local_deps]: app.models.user, app.models.document, app.services.smart_folder_service, app.models.audit, app.tasks.base, app.database, app.services.smart_folder.agent_runner, app.models.smart_folder
[ext_deps]: celery, uuid, typing, asyncio, sqlalchemy, json, logging, datetime
...
[ext_deps]: httpx, os, smtplib, email, sqlalchemy, calendar, logging, datetime
...
[local_deps]: app.core.push, app.celery_app, app.services.task_service, app.models.push_subscription, app.database, app.models.task
[ext_deps]: logging, sqlalchemy
[fn]: check_task_alarms()

---
### FILE: backend/app/tasks/voice_tasks.py
[local_deps]: app.celery_app, app.database, app.services.storage_service, app.services.whisper_service
[ext_deps]: os, sqlalchemy, asyncio, logging, tempfile
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: time, typing, asyncio, functools, logging, collections, threading
...
[ext_deps]: os, dotenv, typing, fastapi, sqlalchemy, jose, bcrypt, logging, datetime
