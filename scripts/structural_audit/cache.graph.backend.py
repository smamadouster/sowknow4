...
[local_deps]: app.api.deps, app.services.storage_service, app.tasks.pipeline_orchestrator, app.schemas.admin, app.services.search_service, app.models.user, app.services.embed_client, app.api.documents_common, app.core.redis_url, app.utils.security, app.models.audit, app.models.failed_task, app.schemas.user, app.models.chat, app.database, app.models.document, app.tasks.pipeline_tasks, app.models.article, app.celery_app, app.models.processing, app.services.alert_service, app.services.whisper_service, app.models.pipeline
[ext_deps]: logging, os, pydantic, concurrent, typing, sqlalchemy, time, json, redis, asyncio, uuid, datetime, fastapi
...
[local_deps]: app.models.user, app.api.deps, app.schemas.article, app.models.document, app.tasks.article_tasks, app.models.article
[ext_deps]: uuid, fastapi, logging, sqlalchemy
...
[local_deps]: app.models.user, app.schemas.token, app.core.redis_url, app.middleware.csrf, app.schemas.auth, app.database, app.api.deps, app.utils.security, app.utils.constants, app.schemas.user, app.limiter, app.services.token_blacklist
[ext_deps]: httpx, logging, os, fastapi, sqlalchemy, time, dotenv, redis, uuid, datetime, hashlib, secrets
...
[local_deps]: app.models.user, app.services.space_service, app.database, app.api.deps, app.services.bookmark_service, app.schemas.tag, app.schemas.bookmark
[ext_deps]: uuid, fastapi, logging, sqlalchemy
...
[local_deps]: app.models.user, app.schemas.chat, app.services.chat_service, app.database, app.api.deps, app.limiter, app.models.chat, app.services.input_guard
[ext_deps]: logging, sqlalchemy, json, uuid, fastapi
...
[local_deps]: app.services.llm_gateway, app.models.user, app.schemas.collection, app.database, app.api.deps, app.models.collection, app.models.audit, app.services.collection_chat_service, app.tasks.document_tasks, app.services.input_guard, app.services.collection_service, app.models.article
[ext_deps]: reportlab, logging, typing, sqlalchemy, json, io, uuid, datetime, fastapi
...
[local_deps]: app.tasks.document_tasks, app.api.deps, app.services.storage_service, app.tasks.pipeline_orchestrator, app.services.search_service, app.tasks.embedding_tasks, app.models.user, app.api.documents_common, app.models.audit, app.services.similarity_service, app.api.documents_upload, app.database, app.models.document, app.schemas.document, app.tasks.pipeline_tasks, app.models.processing, app.api.documents_journal, app.services.semantic_cache, app.models.pipeline
[ext_deps]: logging, concurrent, typing, sqlalchemy, time, asyncio, uuid, datetime, fastapi
...
[local_deps]: app.models.user, app.core.redis_url, app.models.audit, app.tasks.pipeline_orchestrator, app.models.document, app.schemas.document, app.models.pipeline, app.tasks.pipeline_tasks
[ext_deps]: logging, os, mimetypes, pydantic, concurrent, typing, sqlalchemy, json, redis, uuid, datetime, fastapi, asyncio
...
[local_deps]: app.models.user, app.api.documents_common, app.database, app.api.deps, app.models.audit, app.services.whisper_service, app.services.storage_service, app.models.document, app.schemas.document
[ext_deps]: logging, tempfile, os, sqlalchemy, datetime, fastapi
...
[local_deps]: app.models.user, app.api.documents_common, app.database, app.api.deps, app.models.audit, app.services.storage_service, app.services.document_orchestrator, app.models.document, app.services.semantic_cache, app.schemas.document, app.services.deduplication_service
[ext_deps]: logging, sqlalchemy, typing, uuid, fastapi
...
[local_deps]: app.models.user, app.database, app.api.deps, app.models.audit, app.services.graph_rag_service, app.models.document, app.services.progressive_revelation_service, app.services.search_service, app.services.synthesis_service, app.services.temporal_reasoning_service
[ext_deps]: logging, typing, sqlalchemy, json, uuid, fastapi
...
[local_deps]: app.celery_app, app.database, app.utils.security, app.core.redis_url
[ext_deps]: nats, httpx, logging, os, typing, redis, sqlalchemy, datetime, fastapi, asyncio
...
[local_deps]: app.api.documents_upload, app.models.user, app.database, app.schemas.document
...
[local_deps]: app.models.user, app.services.timeline_service, app.database, app.api.deps, app.services.entity_extraction_service, app.models.knowledge_graph, app.services.relationship_service, app.models.document
[ext_deps]: logging, sqlalchemy, typing, uuid, datetime, fastapi
...
[local_deps]: app.models.user, app.services.note_service, app.services.space_service, app.schemas.note, app.database, app.api.deps, app.models.note_audio, app.models.note, app.schemas.tag
[ext_deps]: logging, os, sqlalchemy, uuid, datetime, fastapi
...
[local_deps]: app.celery_app, app.core.redis_url, app.database, app.api.deps, app.tasks.pipeline_orchestrator, app.models.document, app.models.pipeline
...
[local_deps]: app.models.user, app.schemas.push, app.models.push_subscription, app.database, app.api.deps
[ext_deps]: logging, os, sqlalchemy, uuid, fastapi
...
[local_deps]: app.celery_app, app.models.user, app.schemas.reports, app.api.deps, app.tasks.report_tasks
...
[local_deps]: app.models.user, app.services.embed_client, app.database, app.api.deps, app.services.search_agent, app.services.search_models, app.models.document, app.services.search_service, app.services.input_guard
[ext_deps]: logging, sqlalchemy, time, json, uuid, fastapi, asyncio
...
[ext_deps]: logging, pydantic, sqlalchemy, uuid, hashlib, fastapi
...
[local_deps]: app.models.user, app.database, app.api.deps, app.models.document
[ext_deps]: sqlalchemy, fastapi, logging
...
[local_deps]: app.celery_app, app.models.user, app.schemas.collection, app.database, app.api.deps, app.models.audit, app.tasks.collection_report_tasks, app.models.note, app.schemas.smart_folder, app.models.smart_folder, app.tasks.smart_folder_tasks
[ext_deps]: logging, typing, sqlalchemy, json, celery, asyncio, uuid, fastapi
...
[local_deps]: app.models.user, app.services.space_service, app.database, app.api.deps, app.schemas.space, app.tasks.space_tasks, app.schemas.tag
[ext_deps]: uuid, fastapi, logging, sqlalchemy
...
[local_deps]: app.services.rollback_monitor, app.services.llm_gateway, app.models.user, app.core.redis_url, app.api.deps, app.tasks.pipeline_orchestrator
...
[local_deps]: app.models.user, app.database, app.models.subscription, app.schemas.subscription, app.api.deps, app.tasks.subscription_tasks
[ext_deps]: uuid, fastapi, logging, sqlalchemy
[fn]: _parse_uuid(s)
...
[local_deps]: app.models.user, app.services.space_service, app.schemas.task, app.database, app.api.deps, app.services.task_service, app.schemas.tag
[ext_deps]: uuid, fastapi, logging, sqlalchemy
...
[local_deps]: app.models.user, app.services.whisper_service, app.api.deps, app.models.note_audio, app.services.storage_service, app.models.document, app.models.note
[ext_deps]: logging, tempfile, os, sqlalchemy, io, uuid, fastapi, asyncio
...
[ext_deps]: logging, os, pydantic, pydantic_settings, pathlib, urllib
...
[ext_deps]: httpx, logging, os, urllib, time, base64, json, cryptography, struct
...
[ext_deps]: os, typing, dotenv, collections, pgvector, sqlalchemy, fastapi
...
[local_deps]: app.api, app.services.messaging, app.core.redis_url, app.middleware.csrf, app.middleware.transaction, app.database, app.middleware.rls, app.services.llm_http_client, app.services.prometheus_metrics, app.limiter, app.core.config
[ext_deps]: contextlib, logging, os, uvicorn, slowapi, typing, time, sqlalchemy, collections, dotenv, starlette, redis, threading, uuid, fastapi
...
[local_deps]: app.services.monitoring, app.api, app.core.redis_url, app.database, app.services.prometheus_metrics, app.services.cache_monitor, app.services.embedding_service
[ext_deps]: contextlib, httpx, logging, os, uvicorn, time, dotenv, redis, sqlalchemy, datetime, fastapi
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: secrets, logging, hmac, starlette
...
[ext_deps]: dataclasses, logging, jose, starlette, sqlalchemy
...
[local_deps]: app.models.knowledge_graph, app.models.user, app.models.tag, app.models.audit, app.models.failed_task, app.models.bookmark, app.models.chat, app.models.base, app.models.collection, app.models.space, app.models.document, app.models.note, app.models.smart_folder, app.models.milestone, app.models.article, app.models.task, app.models.pattern_insight, app.models.processing, app.models.push_subscription, app.models.subscription, app.models.note_audio, app.models.pipeline
...
[local_deps]: app.models.base
[ext_deps]: pgvector, sqlalchemy, uuid, enum
...
[ext_deps]: httpx, functools, logging, typing, time, tenacity, collections, asyncio
...
[local_deps]: app.database
[ext_deps]: sqlalchemy, json, hashlib, functools
...
[local_deps]: app.schemas.collection, app.schemas.token, app.schemas.chat, app.schemas.pagination, app.schemas.user, app.schemas.admin, app.schemas.document, app.schemas.smart_folder, app.schemas.search
...
[ext_deps]: pydantic, base64, json, typing
...
[ext_deps]: pydantic, uuid, datetime, typing
...
[ext_deps]: re, pydantic, typing, uuid, datetime, enum
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.agent_orchestrator, app.services.agents.researcher_agent, app.services.agents.answer_agent, app.services.agents.clarification_agent, app.services.agents.verification_agent
...
[ext_deps]: dataclasses, logging, typing, time, collections, datetime, enum
...
[ext_deps]: dataclasses, re, logging, typing, json
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: dataclasses, json, logging, typing
...
[local_deps]: app.services.llm_gateway, app.services.embed_client, app.services.knowledge_graph.traversal, app.services.agent_identity, app.services.graph_rag_service, app.services.knowledge_graph.models, app.services.search_service, app.services.knowledge_graph.pool
[ext_deps]: dataclasses, re, logging, typing, collections, json
...
[ext_deps]: httpx, logging, typing, json, hashlib, asyncio
...
[ext_deps]: logging, typing, sqlalchemy, warnings, json, uuid, datetime
...
[ext_deps]: logging, typing, json, threading, datetime
...
[local_deps]: app.services.llm_gateway, app.models.user, app.services.context_block_service, app.database, app.services.agent_identity, app.services.prometheus_metrics, app.services.cache_monitor, app.models.document, app.services.pii_detection_service, app.models.chat, app.services.search_service
[ext_deps]: re, logging, typing, time, sqlalchemy, collections, json, uuid, asyncio
...
[local_deps]: app.services.llm_gateway, app.models.user, app.services.context_block_service, app.models.collection, app.models.audit, app.services.agent_identity, app.models.document, app.models.chat
[ext_deps]: logging, sqlalchemy, typing, json, uuid
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.llm_gateway, app.models.user, app.schemas.collection, app.services.intent_parser, app.models.collection, app.services.agent_identity, app.models.document, app.services.search_cache, app.services.search_service
[ext_deps]: logging, sqlalchemy, typing, uuid, datetime, asyncio
...
[ext_deps]: logging, difflib, sqlalchemy, datetime, hashlib
...
[local_deps]: app.services.llm_gateway
[ext_deps]: logging, os, typing, uuid, datetime
...
[ext_deps]: logging, typing, json, threading, sqlalchemy, asyncio, traceback
...
[local_deps]: app.models.user, app.tasks.voice_tasks, app.models.audit, app.services.storage_service, app.tasks.pipeline_orchestrator, app.models.document, app.schemas.document, app.models.pipeline, app.tasks.pipeline_tasks, app.services.deduplication_service
[ext_deps]: logging, concurrent, typing, json, asyncio, sqlalchemy, datetime, fastapi
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: httpx, random, logging, os, time, asyncio
[fn]: _base_urls()
...
[ext_deps]: sentence_transformers, logging, os, psutil, torch, typing, gc, numpy, threading, asyncio
...
[ext_deps]: logging, os, pathlib, numpy, onnxruntime, transformers
...
[local_deps]: app.services.llm_gateway, app.services.rollback_monitor, app.services.agent_identity, app.models.document, app.models.knowledge_graph
[ext_deps]: logging, typing, warnings, json, sqlalchemy, datetime, asyncio
...
[local_deps]: app.services.llm_gateway, app.services.context_block_service, app.services.agent_identity, app.models.document, app.models.knowledge_graph
[ext_deps]: re, logging, typing, collections, sqlalchemy
...
[ext_deps]: dataclasses, re, logging, redis, hashlib
...
[ext_deps]: re, logging, typing, warnings, json, datetime, enum
...
[ext_deps]: httpx, logging, os, typing, tenacity, collections, json, datetime
...
[ext_deps]: __future__, logging, models, itertools, asyncpg, json, spacy
[fn]: _vec_to_str(vec)
...
[ext_deps]: __future__, pydantic, uuid, datetime, enum
...
[ext_deps]: __future__, logging, extraction, models, asyncpg, json
...
[local_deps]: app.services.rollback_monitor, app.services.monitoring, app.core.context, app.services.semantic_cache, app.services.user_quota, app.services.llm_router
[ext_deps]: logging, typing, time, collections, asyncio
...
[local_deps]: app.services.ollama_service, app.services.together_service, app.services.openrouter_service, app.services.minimax_service, app.services.pii_detection_service, app.services.kimi_service
[ext_deps]: dataclasses, logging, typing, collections, enum
...
[ext_deps]: nats, logging, os, typing, collections, asyncio
...
[ext_deps]: httpx, logging, os, typing, collections, json
...
[ext_deps]: dataclasses, re, logging, os, psutil, prometheus_client, typing, subprocess, collections, redis, threading, datetime
...
[ext_deps]: logging, os, cv2, PyPDF2, PIL, pytesseract, typing, time, numpy, io, paddleocr, enum
...
[local_deps]: app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: httpx, logging, os, typing, tenacity, collections, json
...
[local_deps]: app.services.monitoring, app.core.redis_url, app.services.llm_http_client, app.services.cache_monitor, app.services.openrouter_throttle
[ext_deps]: httpx, logging, os, typing, tenacity, collections, json, redis, datetime, hashlib, asyncio
[fn]: _get_redis_client()
...
[ext_deps]: __future__, logging, typing, time, datetime
...
[ext_deps]: sentence_transformers, logging, psutil, typing, sqlalchemy, datetime
...
[ext_deps]: functools, logging, typing, time, collections
...
[local_deps]: app.services.llm_gateway, app.models.user, app.services.rollback_monitor, app.services.monitoring, app.services.context_block_service, app.models.collection, app.services.agent_identity, app.models.document
[ext_deps]: reportlab, logging, os, typing, sqlalchemy, io, uuid, datetime
[class]: ReportFormat { methods: [] }
...
[ext_deps]: httpx, logging, os, typing
[fn]: _get_client()
...
[local_deps]: app.core.redis_url
[ext_deps]: logging, os, typing, time, collections, redis, datetime
[fn]: _get_redis()
...
[local_deps]: app.models.user, app.services.context_block_service, app.database, app.services.agent_identity, app.models.document, app.services.search_cache, app.services.search_service, app.services.llm_router
[ext_deps]: re, logging, typing, time, sqlalchemy, json, uuid, search_models, asyncio
...
[local_deps]: app.core.redis_url
[ext_deps]: logging, typing, redis, json, hashlib
[fn]: _get_redis()
...
[local_deps]: app.models.user, app.services.embed_client, app.models.document, app.services.pii_detection_service, app.services.search_cache, app.services.rerank_service
[ext_deps]: re, logging, typing, sqlalchemy, asyncio
...
[local_deps]: app.services.embed_client, app.services.openrouter_service, app.services.search_cache
[ext_deps]: __future__, logging, typing, time, json, numpy, hashlib
...
[ext_deps]: dataclasses, logging, typing, collections, json
...
[ext_deps]: re, logging, typing, numpy, sqlalchemy
...
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.report_generator, app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser, app.services.smart_folder.retrieval
...
[local_deps]: app.services.smart_folder.agent.synthesizer, app.models.user, app.services.smart_folder.report_generator, app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser, app.services.smart_folder.agent.executor, app.models.smart_folder, app.services.smart_folder.agent.planner
[ext_deps]: re, logging, sqlalchemy, typing, uuid
...
[ext_deps]: dataclasses, logging, typing, sqlalchemy, uuid, datetime
...
[ext_deps]: dataclasses, logging, typing, difflib, sqlalchemy
...
[ext_deps]: dataclasses, logging, typing, json, datetime
...
[local_deps]: app.services.smart_folder.retrieval, app.services.smart_folder.analysis, app.services.llm_router
[ext_deps]: dataclasses, re, logging, typing, json, uuid
...
[local_deps]: app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.base
...
[local_deps]: app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.skills.base
[ext_deps]: logging, typing
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.report_generator, app.services.smart_folder.tools.document_reader, app.services.smart_folder.retrieval, app.services.smart_folder.skills.base
...
[local_deps]: app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.ratio_calculator
...
[ext_deps]: re, logging, typing, csv, json, io
...
[local_deps]: app.services.llm_gateway, app.models.user, app.models.collection, app.models.document, app.services.search_service
[ext_deps]: re, logging, typing, sqlalchemy, uuid, datetime
...
[local_deps]: app.models.user, app.models.tag, app.models.space, app.models.bookmark, app.models.document, app.models.note
[ext_deps]: uuid, logging, sqlalchemy
[fn]: _escape_like(value)
...
[ext_deps]: symspellpy, logging, os, typing
[fn]: _get_symspell()
...
[ext_deps]: logging, os, pathlib, base64, cryptography, uuid, datetime
...
[ext_deps]: sys, contextlib, logging, os, pathlib, typing, time, collections, json, datetime
...
[ext_deps]: flock_alerter, base_agent, hitl_bridge, registry

---
### FILE: backend/app/services/swarm/v2/base_agent.py
[local_deps]: app.services.messaging
[ext_deps]: nats, logging, typing, json, uuid, datetime, asyncio, enum, abc
...
[local_deps]: app.services.messaging
[ext_deps]: dataclasses, logging, typing, time, json, datetime, hashlib, nats, enum
...
[local_deps]: app.services.messaging
[ext_deps]: dataclasses, nats, logging, typing, json, uuid, datetime, asyncio, enum
...
[local_deps]: app.services.messaging
[ext_deps]: logging, typing, json, datetime, nats
...
[local_deps]: app.services.llm_gateway, app.services.rollback_monitor, app.services.context_block_service, app.services.agent_identity, app.models.document, app.models.knowledge_graph
[ext_deps]: logging, typing, collections, json, sqlalchemy, datetime
...
[ext_deps]: httpx, logging, os, json, datetime
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: logging, typing, collections, sqlalchemy, datetime
...
[ext_deps]: sys, re, logging, os, PyPDF2, ebooklib, html, pathlib, typing, csv, subprocess, zipfile, json, pptx, docx, xml
...
[local_deps]: app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: httpx, logging, os, typing, collections, json, datetime
...
[local_deps]: app.celery_app, app.tasks.base, app.services.monitoring, app.models.processing, app.core.redis_url, app.services.alert_service, app.database, app.services.cache_monitor, app.tasks.pipeline_orchestrator, app.models.document
[ext_deps]: logging, os, redis, celery, datetime, asyncio
...
[local_deps]: app.services.embed_client, app.tasks.base, app.database, app.services.article_generation_service, app.models.document, app.models.article
[ext_deps]: httpx, logging, celery, uuid, asyncio
...
[local_deps]: app.database, app.tasks.pipeline_orchestrator, app.models.document, app.tasks.article_tasks, app.tasks.embedding_tasks, app.models.article
...
[ext_deps]: logging, os, psutil, asyncio, traceback
...
[local_deps]: app.models.user, app.tasks.base, app.database, app.services.report_service, app.models.audit
[ext_deps]: logging, typing, sqlalchemy, celery, json, uuid, asyncio
...
[local_deps]: app.tasks.base, app.services.embed_client, app.services.context_block_service, app.models.processing, app.services.dlq_service, app.database, app.services.chunking_service, app.services.prometheus_metrics, app.tasks.pipeline_orchestrator, app.services.text_extractor, app.models.document, app.services.entity_extraction_service, app.tasks.article_tasks, app.services.collection_service, app.tasks.embedding_tasks, app.services.ocr_service
[ext_deps]: logging, os, tempfile, sqlalchemy, celery, langdetect, uuid, datetime, asyncio, traceback
...
[local_deps]: app.celery_app, app.tasks.base, app.services.embed_client, app.database, app.models.document
...
[local_deps]: app.celery_app, app.core.redis_url, app.database, app.models.document, app.models.pipeline
[ext_deps]: logging, os, smtplib, email, redis, sqlalchemy, datetime
[fn]: _smtp_configured()
...
[local_deps]: app.core.redis_url, app.database, app.models.document, app.models.pipeline, app.tasks.pipeline_tasks
[ext_deps]: logging, celery, redis, uuid, datetime
...
[local_deps]: app.celery_app, app.core.redis_url, app.database, app.tasks.pipeline_orchestrator, app.models.document, app.models.pipeline
[ext_deps]: logging, os, redis, sqlalchemy, datetime
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.celery_app, app.services.embed_client, app.services.dlq_service, app.database, app.tasks.document_tasks, app.services.chunking_service, app.services.text_extractor, app.models.document, app.services.entity_extraction_service, app.services.knowledge_graph.extraction, app.models.pipeline, app.tasks.article_tasks, app.services.knowledge_graph.pool, app.services.ocr_service
[ext_deps]: logging, os, tempfile, time, gc, celery, uuid, datetime, asyncio, traceback
...
[local_deps]: app.tasks.base, app.database, app.models.document, app.models.audit
[ext_deps]: logging, os, fpdf, openpyxl, time, celery, sqlalchemy, datetime
...
[local_deps]: app.tasks.base, app.models.user, app.database, app.models.audit, app.services.smart_folder_service, app.services.smart_folder.agent_runner, app.models.document, app.models.smart_folder
[ext_deps]: logging, typing, sqlalchemy, celery, json, uuid, datetime, asyncio
...
[ext_deps]: httpx, logging, os, smtplib, calendar, email, sqlalchemy, datetime
...
[local_deps]: app.celery_app, app.models.task, app.models.push_subscription, app.database, app.services.task_service, app.core.push
...
[ext_deps]: logging, tempfile, os, sqlalchemy, asyncio
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: functools, logging, typing, time, collections, threading, asyncio
...
[ext_deps]: bcrypt, logging, os, jose, typing, dotenv, sqlalchemy, datetime, fastapi
