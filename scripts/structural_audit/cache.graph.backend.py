...
[local_deps]: app.models.audit, app.models.processing, app.tasks.document_tasks, app.api.deps, app.models.failed_task, app.database, app.schemas.admin, app.models.user, app.utils.security, app.services.alert_service, app.services.whisper_service, app.schemas.user, app.models.pipeline, app.core.redis_url, app.models.chat, app.models.article, app.models.document
[ext_deps]: uuid, sqlalchemy, fastapi, redis, typing, os, logging, datetime, json
...
[local_deps]: app.schemas.article, app.api.deps, app.models.user, app.tasks.article_tasks, app.models.article, app.models.document
...
[local_deps]: app.core.redis_url, app.schemas.token, app.api.deps, app.database, app.utils.security, app.models.user, app.limiter, app.schemas.user, app.utils.constants, app.services.token_blacklist, app.schemas.auth, app.middleware.csrf
[ext_deps]: hashlib, secrets, uuid, sqlalchemy, fastapi, dotenv, redis, httpx, time, os, logging, datetime
...
[local_deps]: app.api.deps, app.schemas.bookmark, app.database, app.models.user, app.services.bookmark_service, app.services.space_service, app.schemas.tag
[ext_deps]: sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.schemas.chat, app.services.chat_service, app.api.deps, app.database, app.models.user, app.limiter, app.services.input_guard, app.models.chat
[ext_deps]: uuid, sqlalchemy, fastapi, logging, json
...
[local_deps]: app.schemas.collection, app.services.collection_chat_service, app.models.audit, app.tasks.document_tasks, app.models.collection, app.api.deps, app.database, app.models.user, app.services.collection_service, app.services.llm_gateway, app.services.input_guard, app.models.article
[ext_deps]: reportlab, uuid, io, sqlalchemy, fastapi, typing, logging, datetime, json
...
[local_deps]: app.database, app.utils.security, app.models.user, app.utils.constants, app.services.token_blacklist
...
[local_deps]: app.services.similarity_service, app.models.audit, app.models.processing, app.tasks.document_tasks, app.api.deps, app.api.documents_common, app.api.documents_upload, app.database, app.models.user, app.tasks.embedding_tasks, app.schemas.document, app.services.storage_service, app.api.documents_journal, app.models.pipeline, app.models.document
[ext_deps]: uuid, sqlalchemy, fastapi, typing, logging, datetime
...
[local_deps]: app.models.audit, app.models.user, app.schemas.document, app.tasks.pipeline_orchestrator, app.models.pipeline, app.models.document, app.tasks.pipeline_tasks
[ext_deps]: concurrent, uuid, sqlalchemy, pydantic, fastapi, asyncio, typing, os, logging, datetime, json
...
[local_deps]: app.models.audit, app.services.whisper_service, app.api.deps, app.api.documents_common, app.database, app.models.user, app.schemas.document, app.services.storage_service, app.models.document
[ext_deps]: tempfile, sqlalchemy, fastapi, os, logging, datetime
...
[local_deps]: app.services.deduplication_service, app.models.audit, app.api.deps, app.api.documents_common, app.database, app.services.document_orchestrator, app.models.user, app.schemas.document, app.services.storage_service, app.models.document
[ext_deps]: uuid, sqlalchemy, fastapi, typing, logging
...
[local_deps]: app.models.audit, app.api.deps, app.database, app.services.graph_rag_service, app.models.user, app.services.temporal_reasoning_service, app.services.progressive_revelation_service, app.services.synthesis_service, app.models.document, app.services.search_service
[ext_deps]: uuid, sqlalchemy, fastapi, typing, logging, json
...
[ext_deps]: sqlalchemy, nats, fastapi, httpx, redis, asyncio, typing, os, logging, datetime
...
[ext_deps]: sqlalchemy, fastapi, os, logging, hmac
...
[local_deps]: app.api.deps, app.database, app.models.user, app.services.entity_extraction_service, app.services.timeline_service, app.models.knowledge_graph, app.models.document, app.services.relationship_service
[ext_deps]: uuid, sqlalchemy, fastapi, typing, logging, datetime
...
[local_deps]: app.schemas.note, app.models.note, app.api.deps, app.database, app.models.user, app.models.note_audio, app.services.note_service, app.services.space_service, app.schemas.tag
[ext_deps]: uuid, sqlalchemy, fastapi, os, logging, datetime
...
[local_deps]: app.core.redis_url, app.api.deps, app.database, app.celery_app, app.tasks.pipeline_orchestrator, app.models.pipeline, app.models.document
...
[local_deps]: app.api.deps, app.models.user, app.schemas.reports, app.celery_app, app.tasks.report_tasks
...
[local_deps]: app.services.search_agent, app.api.deps, app.database, app.models.user, app.services.search_models, app.services.input_guard, app.models.document, app.services.search_service
[ext_deps]: uuid, sqlalchemy, fastapi, time, asyncio, logging, json
...
[local_deps]: app.schemas.collection, app.models.note, app.models.audit, app.api.deps, app.database, app.models.user, app.schemas.smart_folder, app.celery_app, app.tasks.smart_folder_tasks, app.models.smart_folder, app.tasks.collection_report_tasks
[ext_deps]: uuid, sqlalchemy, celery, fastapi, asyncio, typing, logging, json
...
[local_deps]: app.schemas.space, app.api.deps, app.database, app.tasks.space_tasks, app.models.user, app.services.space_service, app.schemas.tag
[ext_deps]: sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.models.note, app.services.whisper_service, app.api.deps, app.models.user, app.models.note_audio, app.services.storage_service, app.models.document
[ext_deps]: uuid, tempfile, io, sqlalchemy, fastapi, asyncio, os, logging
...
[ext_deps]: urllib, pydantic, pydantic_settings, pathlib, os, logging
...
[ext_deps]: sqlalchemy, fastapi, dotenv, pgvector, typing, os, collections
...
[local_deps]: app.core.redis_url, app.database, app.services.prometheus_metrics, app.limiter, app.middleware.transaction, app.middleware.rls, app.middleware.csrf, app.api, app.services.messaging
[ext_deps]: contextlib, starlette, uuid, sqlalchemy, uvicorn, fastapi, dotenv, time, threading, slowapi, typing, redis, os, logging, collections
...
[local_deps]: app.services.monitoring, app.core.redis_url, app.database, app.services.prometheus_metrics, app.services.cache_monitor, app.services.embedding_service, app.api
[ext_deps]: contextlib, sqlalchemy, uvicorn, fastapi, dotenv, time, httpx, redis, os, logging, datetime
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[local_deps]: app.models.user, app.models.chat, app.models.bookmark, app.models.collection, app.models.space, app.models.article, app.models.milestone, app.models.note, app.models.base, app.models.pipeline, app.models.knowledge_graph, app.models.audit, app.models.processing, app.models.failed_task, app.models.tag, app.models.pattern_insight, app.models.note_audio, app.models.smart_folder, app.models.document
...
[ext_deps]: functools, tenacity, httpx, time, asyncio, typing, logging, collections
...
[local_deps]: app.schemas.collection, app.schemas.token, app.schemas.admin, app.schemas.smart_folder, app.schemas.document, app.schemas.user, app.schemas.search, app.schemas.chat, app.schemas.pagination
...
[ext_deps]: uuid, pydantic, typing, enum, datetime
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: uuid, pydantic, typing, enum, datetime, re
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.verification_agent, app.services.agents.answer_agent, app.services.agents.researcher_agent, app.services.agents.clarification_agent, app.services.agents.agent_orchestrator
...
[ext_deps]: dataclasses, time, enum, typing, logging, collections, datetime
...
[ext_deps]: dataclasses, typing, re, logging, json
...
[local_deps]: app.services.agent_identity, app.services.embed_client, app.services.graph_rag_service, app.services.knowledge_graph.models, app.services.llm_gateway, app.services.knowledge_graph.traversal, app.services.knowledge_graph.pool, app.services.search_service
[ext_deps]: dataclasses, typing, logging, json, collections, re
...
[local_deps]: app.services.llm_gateway
[ext_deps]: hashlib, asyncio, typing, logging, json
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway, app.models.tag, app.models.document
[ext_deps]: uuid, warnings, sqlalchemy, typing, logging, datetime, json
...
[ext_deps]: threading, typing, logging, datetime, json
...
[local_deps]: app.services.agent_identity, app.services.llm_router, app.database, app.services.prometheus_metrics, app.models.user, app.services.cache_monitor, app.services.llm_gateway, app.services.pii_detection_service, app.models.chat, app.models.document, app.services.search_service, app.services.context_block_service
[ext_deps]: uuid, sqlalchemy, time, asyncio, typing, logging, json, collections, re
...
[local_deps]: app.services.agent_identity, app.models.audit, app.models.collection, app.models.user, app.services.llm_gateway, app.models.chat, app.models.document, app.services.context_block_service
[ext_deps]: uuid, sqlalchemy, typing, logging, json
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.agent_identity, app.schemas.collection, app.models.collection, app.models.user, app.services.intent_parser, app.services.llm_gateway, app.services.search_cache, app.models.document, app.services.search_service
[ext_deps]: uuid, sqlalchemy, asyncio, typing, logging, datetime
...
[local_deps]: app.services.llm_gateway
[ext_deps]: uuid, typing, os, logging, datetime
...
[ext_deps]: sqlalchemy, threading, asyncio, typing, logging, traceback, json
...
[local_deps]: app.services.deduplication_service, app.models.audit, app.tasks.voice_tasks, app.models.user, app.schemas.document, app.tasks.pipeline_orchestrator, app.services.storage_service, app.models.pipeline, app.models.document, app.tasks.pipeline_tasks
[ext_deps]: concurrent, sqlalchemy, fastapi, asyncio, typing, logging, datetime
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: itertools, httpx, time, asyncio, os, logging
[fn]: _base_urls()
[fn]: _base_url()
...
[ext_deps]: psutil, sentence_transformers, numpy, threading, gc, asyncio, typing, torch, os, logging
...
[local_deps]: app.services.agent_identity, app.models.knowledge_graph, app.services.llm_gateway, app.models.document
[ext_deps]: warnings, sqlalchemy, asyncio, typing, logging, datetime, json
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway, app.models.knowledge_graph, app.models.document, app.services.context_block_service
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: warnings, enum, typing, logging, json, datetime, re
...
[ext_deps]: tenacity, httpx, typing, os, logging, collections, datetime, json
...
[ext_deps]: __future__, itertools, spacy, models, asyncpg, logging, json
[fn]: _vec_to_str(vec)
...
[ext_deps]: __future__, uuid, pydantic, enum, datetime
...
[ext_deps]: __future__, extraction, models, asyncpg, logging, json
...
[local_deps]: app.services.openrouter_service, app.services.kimi_service, app.services.ollama_service, app.services.pii_detection_service, app.services.minimax_service
[ext_deps]: dataclasses, typing, enum, logging, collections
...
[ext_deps]: nats, asyncio, typing, os, logging, collections
...
[ext_deps]: httpx, typing, os, logging, collections, json
...
[ext_deps]: psutil, subprocess, dataclasses, threading, redis, typing, prometheus_client, os, logging, collections, datetime, re
...
[ext_deps]: io, numpy, cv2, paddleocr, PIL, time, PyPDF2, enum, typing, os, logging, pytesseract
...
[local_deps]: app.services.base_llm_service
[ext_deps]: tenacity, httpx, typing, os, logging, collections, json
...
[ext_deps]: hashlib, httpx, redis, typing, os, logging, collections, datetime, json
...
[ext_deps]: psutil, sentence_transformers, sqlalchemy, typing, logging, datetime
...
[ext_deps]: functools, time, typing, logging, collections
...
[local_deps]: app.services.agent_identity, app.models.collection, app.models.user, app.services.llm_gateway, app.models.document, app.services.context_block_service
[ext_deps]: reportlab, uuid, io, sqlalchemy, typing, os, logging, datetime
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.agent_identity, app.services.llm_router, app.database, app.models.user, app.services.search_cache, app.models.document, app.services.search_service, app.services.context_block_service
[ext_deps]: uuid, sqlalchemy, search_models, time, asyncio, typing, logging, json, re
...
[local_deps]: app.services.embed_client, app.services.rerank_service, app.models.user, app.services.search_cache, app.services.pii_detection_service, app.models.document
[ext_deps]: sqlalchemy, asyncio, typing, logging, re
...
[local_deps]: app.services.smart_folder.query_parser, app.services.smart_folder.analysis, app.services.smart_folder.retrieval, app.services.smart_folder.report_generator, app.services.smart_folder.entity_resolver
...
[local_deps]: app.services.smart_folder.agent.executor, app.services.smart_folder.agent.planner, app.services.smart_folder.query_parser, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.report_generator, app.models.user, app.services.smart_folder.entity_resolver, app.models.smart_folder
[ext_deps]: uuid, sqlalchemy, typing, logging, re
...
[ext_deps]: uuid, dataclasses, sqlalchemy, typing, logging, datetime
...
[ext_deps]: uuid, dataclasses, typing, logging, json, re
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.general_narrative
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer
[ext_deps]: logging, typing
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.retrieval, app.services.smart_folder.analysis, app.services.smart_folder.report_generator, app.services.smart_folder.tools.document_reader
...
[local_deps]: app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.refinement_parser
...
[ext_deps]: logging, io, typing, csv, json, re
...
[local_deps]: app.models.collection, app.models.user, app.services.llm_gateway, app.models.document, app.services.search_service
[ext_deps]: uuid, sqlalchemy, typing, logging, datetime, re
...
[local_deps]: app.models.note, app.models.bookmark, app.models.user, app.models.tag, app.models.space, app.models.document
[ext_deps]: sqlalchemy, logging, uuid
[fn]: _escape_like(value)
...
[ext_deps]: base64, uuid, cryptography, pathlib, os, logging, datetime
...
[ext_deps]: contextlib, sys, time, typing, pathlib, os, logging, collections, datetime, json
...
[ext_deps]: uuid, nats, abc, asyncio, enum, typing, logging, datetime, json
...
[local_deps]: app.services.messaging
[ext_deps]: hashlib, dataclasses, nats, time, enum, typing, logging, datetime, json
...
[local_deps]: app.services.messaging
[ext_deps]: uuid, dataclasses, nats, asyncio, enum, typing, logging, datetime, json
...
[local_deps]: app.services.messaging
[ext_deps]: logging, typing, nats, datetime, json
...
[ext_deps]: httpx, os, logging, datetime, json
...
[ext_deps]: docx, zipfile, xml, csv, html, ebooklib, PyPDF2, typing, pathlib, logging, re, openpyxl, pptx, subprocess, json
...
[local_deps]: app.services.monitoring, app.models.processing, app.tasks.document_tasks, app.services.alert_service, app.core.redis_url, app.database, app.services.cache_monitor, app.celery_app, app.tasks.base, app.models.document
[ext_deps]: celery, redis, asyncio, os, logging, datetime
...
[local_deps]: app.services.embed_client, app.database, app.services.article_generation_service, app.tasks.base, app.models.article, app.models.document
[ext_deps]: uuid, celery, httpx, asyncio, logging
...
[local_deps]: app.tasks.document_tasks, app.database, app.tasks.embedding_tasks, app.tasks.article_tasks, app.models.article, app.models.document
...
[ext_deps]: uuid, sqlalchemy, celery, asyncio, typing, logging, json
...
[local_deps]: app.services.embed_client, app.services.ocr_service, app.models.processing, app.database, app.services.prometheus_metrics, app.services.collection_service, app.tasks.embedding_tasks, app.services.dlq_service, app.services.entity_extraction_service, app.services.chunking_service, app.tasks.article_tasks, app.services.text_extractor, app.tasks.base, app.models.document, app.services.context_block_service
[ext_deps]: uuid, tempfile, sqlalchemy, celery, langdetect, asyncio, os, logging, traceback, datetime
...
[local_deps]: app.services.embed_client, app.database, app.celery_app, app.tasks.base, app.models.document
[ext_deps]: logging, time, uuid, sentence_transformers
...
[ext_deps]: logging, redis, celery, datetime
...
[local_deps]: app.core.redis_url, app.database, app.celery_app, app.tasks.pipeline_orchestrator, app.models.pipeline, app.models.document
[ext_deps]: sqlalchemy, redis, os, logging, datetime
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.ocr_service, app.services.embed_client, app.tasks.document_tasks, app.database, app.services.dlq_service, app.services.entity_extraction_service, app.celery_app, app.services.chunking_service, app.services.knowledge_graph.extraction, app.tasks.article_tasks, app.services.knowledge_graph.pool, app.models.pipeline, app.services.text_extractor, app.models.document
[ext_deps]: uuid, tempfile, celery, time, gc, asyncio, os, logging, traceback, datetime
...
[ext_deps]: sqlalchemy, celery, time, fpdf, os, logging, openpyxl, datetime
...
[local_deps]: app.models.audit, app.database, app.services.smart_folder.agent_runner, app.models.user, app.services.smart_folder_service, app.models.smart_folder, app.tasks.base, app.models.document
[ext_deps]: uuid, sqlalchemy, celery, asyncio, typing, logging, datetime, json
...
[ext_deps]: functools, time, threading, asyncio, typing, logging, collections
...
[ext_deps]: bcrypt, sqlalchemy, jose, fastapi, dotenv, typing, os, logging, datetime
