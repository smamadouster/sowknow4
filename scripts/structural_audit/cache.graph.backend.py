...
[local_deps]: app.models.pipeline, app.models.article, app.schemas.user, app.services.alert_service, app.models.document, app.schemas.admin, app.models.chat, app.tasks.pipeline_orchestrator, app.celery_app, app.services.storage_service, app.utils.security, app.services.whisper_service, app.models.audit, app.tasks.pipeline_tasks, app.core.redis_url, app.models.user, app.models.processing, app.models.failed_task, app.services.search_service, app.services.embed_client, app.api.deps, app.api.documents_common, app.database
[ext_deps]: json, sqlalchemy, urllib, asyncio, fastapi, typing, datetime, redis, logging, pydantic, concurrent, uuid, time, os
...
[local_deps]: app.tasks.article_tasks, app.models.article, app.models.document, app.api.deps, app.models.user, app.schemas.article
...
[local_deps]: app.schemas.user, app.services.token_blacklist, app.utils.constants, app.schemas.token, app.api.deps, app.models.user, app.schemas.auth, app.utils.security, app.database, app.limiter, app.core.redis_url, app.middleware.csrf
[ext_deps]: sqlalchemy, dotenv, asyncio, fastapi, httpx, secrets, datetime, redis, logging, time, uuid, hashlib, hmac, os
...
[local_deps]: app.services.bookmark_service, app.schemas.tag, app.api.deps, app.models.user, app.schemas.bookmark, app.services.space_service, app.database
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.models.chat, app.services.input_guard, app.api.deps, app.models.user, app.schemas.chat, app.services.chat_service, app.database, app.limiter
[ext_deps]: json, sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.models.article, app.services.llm_gateway, app.services.collection_chat_service, app.services.input_guard, app.api.deps, app.models.user, app.services.collection_service, app.database, app.tasks.document_tasks, app.models.audit, app.schemas.collection, app.models.collection
[ext_deps]: json, sqlalchemy, reportlab, fastapi, typing, datetime, logging, uuid, io
...
[local_deps]: app.utils.constants, app.services.token_blacklist, app.models.user, app.utils.security, app.database
...
[local_deps]: app.models.pipeline, app.models.document, app.services.semantic_cache, app.services.similarity_service, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.services.storage_service, app.models.audit, app.schemas.document, app.tasks.pipeline_tasks, app.models.user, app.models.processing, app.tasks.document_tasks, app.services.search_service, app.api.documents_journal, app.api.documents_upload, app.api.deps, app.api.documents_common, app.database
[ext_deps]: sqlalchemy, asyncio, fastapi, typing, datetime, logging, concurrent, uuid, time
...
[local_deps]: app.models.pipeline, app.schemas.document, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.models.document, app.services.document_orchestrator, app.core.redis_url, app.models.user, app.models.audit
[ext_deps]: json, sqlalchemy, asyncio, fastapi, typing, datetime, redis, logging, pydantic, concurrent, uuid, os
...
[local_deps]: app.schemas.document, app.models.document, app.services.storage_service, app.api.deps, app.api.documents_common, app.models.user, app.database, app.services.whisper_service, app.models.audit
[ext_deps]: sqlalchemy, fastapi, datetime, logging, tempfile, hmac, os
...
[local_deps]: app.schemas.document, app.models.document, app.services.storage_service, app.services.document_orchestrator, app.api.deps, app.api.documents_common, app.models.user, app.services.semantic_cache, app.database, app.limiter, app.models.audit, app.services.deduplication_service
[ext_deps]: sqlalchemy, fastapi, typing, logging, uuid, hmac
...
[local_deps]: app.services.synthesis_service, app.models.document, app.services.temporal_reasoning_service, app.api.deps, app.models.user, app.database, app.models.audit, app.services.progressive_revelation_service, app.services.graph_rag_service, app.services.search_service
[ext_deps]: json, sqlalchemy, fastapi, typing, logging, uuid
...
[ext_deps]: sqlalchemy, asyncio, httpx, fastapi, typing, datetime, redis, nats, logging, os
...
[local_deps]: app.schemas.document, app.api.documents_upload, app.api.documents_common, app.models.user, app.database, app.limiter
[ext_deps]: sqlalchemy, fastapi, logging, hmac, os
...
[local_deps]: app.models.knowledge_graph, app.models.document, app.services.relationship_service, app.services.entity_extraction_service, app.api.deps, app.models.user, app.database, app.services.timeline_service
[ext_deps]: sqlalchemy, fastapi, typing, datetime, logging, uuid
...
[local_deps]: app.main, app.services.embedding_service, app.services.prometheus_metrics, app.core.redis_url, app.services.monitoring, app.services.cache_monitor
[ext_deps]: fastapi, typing, datetime, redis, logging, time, os
[fn]: _get_redis_info()
...
[local_deps]: app.schemas.note, app.models.note_audio, app.services.space_service, app.schemas.tag, app.api.deps, app.models.user, app.services.note_service, app.models.note, app.database
[ext_deps]: sqlalchemy, asyncio, fastapi, datetime, logging, uuid, os
...
[local_deps]: app.models.pipeline, app.tasks.pipeline_orchestrator, app.celery_app, app.models.document, app.api.deps, app.core.redis_url, app.database
[ext_deps]: fastapi, sqlalchemy, redis, asyncio
[async_fn]: pipeline_status(db)
[async_fn]: retry_failed_pipeline_stages(stage, limit, db)

---
### FILE: backend/app/api/push.py
[local_deps]: app.models.push_subscription, app.schemas.push, app.api.deps, app.models.user, app.database
[ext_deps]: sqlalchemy, fastapi, logging, uuid, os
...
[local_deps]: app.celery_app, app.api.deps, app.models.user, app.schemas.reports, app.tasks.report_tasks
[ext_deps]: fastapi, celery, logging, typing
...
[local_deps]: app.services.search_agent, app.services.embed_client, app.services.search_models, app.models.document, app.services.agents.agent_orchestrator, app.services.input_guard, app.api.deps, app.models.user, app.database, app.services.search_service
[ext_deps]: json, sqlalchemy, asyncio, fastapi, logging, uuid, time
...
[ext_deps]: sqlalchemy, fastapi, logging, pydantic, uuid, hashlib
...
[local_deps]: app.database, app.api.deps, app.models.user, app.models.document
[ext_deps]: fastapi, sqlalchemy, logging
...
[local_deps]: app.schemas.smart_folder, app.tasks.collection_report_tasks, app.models.smart_folder, app.celery_app, app.tasks.smart_folder_tasks, app.api.deps, app.models.user, app.models.note, app.database, app.models.audit, app.schemas.collection
[ext_deps]: json, sqlalchemy, celery, asyncio, fastapi, typing, logging, uuid
...
[local_deps]: app.schemas.space, app.schemas.tag, app.api.deps, app.models.user, app.services.space_service, app.database, app.tasks.space_tasks
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.services.llm_gateway, app.services.rollback_monitor, app.tasks.pipeline_orchestrator, app.core.redis_url, app.api.deps, app.models.user
[ext_deps]: fastapi, redis, typing
...
[local_deps]: app.schemas.subscription, app.tasks.subscription_tasks, app.api.deps, app.models.user, app.database, app.models.subscription
[ext_deps]: fastapi, uuid, sqlalchemy, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.task, app.services.space_service, app.schemas.tag, app.api.deps, app.models.user, app.services.task_service, app.database
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.models.note_audio, app.models.document, app.services.storage_service, app.api.deps, app.models.user, app.models.note, app.services.whisper_service
[ext_deps]: sqlalchemy, asyncio, fastapi, uuid, logging, tempfile, io, os
...
[ext_deps]: urllib, pathlib, pydantic_settings, logging, pydantic, os
...
[ext_deps]: json, urllib, httpx, cryptography, logging, struct, base64, time, os
...
[ext_deps]: sqlalchemy, dotenv, fastapi, pgvector, collections, typing, os
...
[local_deps]: app.core.config, app.middleware.rls, app.services.llm_http_client, app.api, app.middleware.transaction, app.services.openrouter_service, app.services.prometheus_metrics, app.core.redis_url, app.services.monitoring, app.database, app.limiter, app.services.search_cache, app.middleware.csrf
[ext_deps]: contextlib, sqlalchemy, dotenv, fastapi, uvicorn, collections, typing, threading, redis, logging, slowapi, uuid, time, starlette, os
...
[ext_deps]: sqlalchemy, dataclasses, logging, jose, starlette
...
[local_deps]: app.models.pipeline, app.models.knowledge_graph, app.models.article, app.models.document, app.models.tag, app.models.milestone, app.models.chat, app.models.space, app.models.audit, app.models.subscription, app.models.pattern_insight, app.models.note_audio, app.models.user, app.models.processing, app.models.note, app.models.bookmark, app.models.failed_task, app.models.collection, app.models.push_subscription, app.models.smart_folder, app.models.task, app.models.base
...
[local_deps]: app.models.base
[ext_deps]: uuid, sqlalchemy, datetime, enum
...
[ext_deps]: tenacity, asyncio, httpx, collections, typing, functools, logging, time
...
[local_deps]: app.schemas.pagination, app.schemas.user, app.schemas.document, app.schemas.search, app.schemas.token, app.schemas.admin, app.schemas.chat, app.schemas.smart_folder, app.schemas.collection

---
### FILE: backend/app/schemas/admin.py
[local_deps]: app.schemas.user
[ext_deps]: datetime, uuid, pydantic, re
...
[ext_deps]: enum, typing, datetime, pydantic, uuid
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: enum, typing, re, datetime, pydantic, uuid
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.clarification_agent, app.services.agents.researcher_agent, app.services.agents.agent_orchestrator, app.services.agents.answer_agent, app.services.agents.verification_agent

---
### FILE: backend/app/services/agents/agent_orchestrator.py
[local_deps]: app.services.agents.clarification_agent, app.services.agents.researcher_agent, app.services.agents.verification_agent, app.services.agents.answer_agent
[ext_deps]: dataclasses, enum, collections, typing, datetime, logging, time
...
[ext_deps]: json, dataclasses, typing, re, logging
...
[local_deps]: app.services.knowledge_graph.traversal, app.services.embed_client, app.services.knowledge_graph.models, app.services.llm_gateway, app.services.knowledge_graph.pool, app.services.graph_rag_service, app.services.search_service, app.services.agent_identity
[ext_deps]: json, dataclasses, collections, typing, re, logging
...
[ext_deps]: json, asyncio, httpx, typing, logging, hashlib
...
[local_deps]: app.services.llm_gateway, app.models.tag, app.models.document, app.services.agent_identity
[ext_deps]: sqlalchemy, json, typing, warnings, datetime, logging, uuid
...
[ext_deps]: uuid, urllib, logging, sqlalchemy
...
[ext_deps]: json, typing, threading, datetime, logging
...
[local_deps]: app.models.chat, app.services.cache_monitor, app.services.llm_gateway, app.models.document, app.services.pii_detection_service, app.services.prometheus_metrics, app.services.context_block_service, app.models.user, app.database, app.services.search_service, app.services.agent_identity
[ext_deps]: json, sqlalchemy, asyncio, collections, typing, re, logging, uuid, time
...
[local_deps]: app.models.chat, app.services.llm_gateway, app.models.document, app.models.user, app.services.context_block_service, app.models.audit, app.models.collection, app.services.agent_identity
[ext_deps]: json, sqlalchemy, typing, logging, uuid
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.llm_gateway, app.models.document, app.models.user, app.services.intent_parser, app.services.search_cache, app.schemas.collection, app.models.collection, app.services.search_service, app.services.agent_identity
[ext_deps]: sqlalchemy, asyncio, typing, datetime, logging, uuid
...
[ext_deps]: datetime, redis, logging, sqlalchemy
[fn]: _get_redis()
...
[ext_deps]: sqlalchemy, difflib, datetime, logging, hashlib
...
[local_deps]: app.services.llm_gateway
[ext_deps]: typing, datetime, logging, uuid, os
...
[ext_deps]: json, sqlalchemy, traceback, asyncio, typing, threading, logging
...
[local_deps]: app.models.pipeline, app.schemas.document, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.models.document, app.services.storage_service, app.models.user, app.tasks.voice_tasks, app.models.audit, app.services.deduplication_service
[ext_deps]: json, sqlalchemy, asyncio, fastapi, typing, datetime, logging, concurrent
...
[ext_deps]: httpx, asyncio, random, atexit, logging, time, os
[fn]: _base_urls()
...
[ext_deps]: gc, asyncio, typing, threading, sentence_transformers, psutil, logging, torch, numpy, os
...
[ext_deps]: pathlib, transformers, logging, numpy, onnxruntime, os
...
[local_deps]: app.models.knowledge_graph, app.services.llm_gateway, app.services.rollback_monitor, app.models.document, app.services.agent_identity
[ext_deps]: json, sqlalchemy, asyncio, typing, warnings, datetime, logging
...
[local_deps]: app.models.knowledge_graph, app.services.llm_gateway, app.models.document, app.services.context_block_service, app.services.agent_identity
[ext_deps]: sqlalchemy, collections, typing, re, logging
...
[ext_deps]: dataclasses, re, redis, logging, hashlib
...
[ext_deps]: json, enum, typing, warnings, re, datetime, logging
...
[ext_deps]: tenacity, json, httpx, collections, typing, datetime, logging, os
...
[ext_deps]: json, __future__, models, spacy, itertools, asyncpg, logging
[fn]: _vec_to_str(vec)
...
[local_deps]: app.services.rollback_monitor, app.services.user_quota, app.core.context, app.services.semantic_cache, app.services.monitoring, app.services.llm_router, app.services.token_utils
[ext_deps]: asyncio, collections, typing, logging, time
...
[local_deps]: app.services.minimax_service, app.services.kimi_service, app.services.openrouter_service, app.services.pii_detection_service
[ext_deps]: dataclasses, enum, collections, typing, logging
...
[ext_deps]: asyncio, collections, typing, nats, logging, os
...
[ext_deps]: json, httpx, collections, typing, logging, os
...
[ext_deps]: prometheus_client, dataclasses, subprocess, shutil, collections, typing, threading, re, datetime, psutil, redis, logging, os
...
[ext_deps]: cv2, enum, pytesseract, typing, paddleocr, PIL, logging, PyPDF2, numpy, time, io, os
...
[ext_deps]: tenacity, json, httpx, collections, typing, logging, os
...
[local_deps]: app.services.llm_http_client, app.services.openrouter_throttle, app.core.redis_url, app.services.prometheus_metrics, app.services.monitoring, app.services.token_utils, app.services.cache_monitor
[ext_deps]: tenacity, json, asyncio, httpx, collections, typing, datetime, redis, logging, hashlib, os
...
[ext_deps]: __future__, typing, datetime, logging, time
...
[ext_deps]: sqlalchemy, typing, datetime, psutil, sentence_transformers, logging
...
[local_deps]: app.models.knowledge_graph, app.services.llm_gateway, app.models.document, app.models.user, app.services.agent_identity
...
[ext_deps]: collections, typing, functools, logging, time
...
[local_deps]: app.services.llm_gateway, app.services.rollback_monitor, app.models.document, app.services.context_block_service, app.models.user, app.services.monitoring, app.models.collection, app.services.agent_identity
[ext_deps]: sqlalchemy, reportlab, typing, datetime, logging, uuid, io, os
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.core.redis_url
[ext_deps]: collections, typing, datetime, redis, logging, time, os
[fn]: _get_redis()
...
[local_deps]: app.models.document, app.services.context_block_service, app.models.user, app.services.llm_router, app.database, app.services.search_cache, app.services.search_service, app.services.agent_identity
[ext_deps]: json, sqlalchemy, asyncio, typing, re, search_models, logging, uuid, time
...
[ext_deps]: json, typing, redis, logging, hashlib
[fn]: close_redis_client()
[fn]: _get_redis()
...
[local_deps]: app.services.embed_client, app.models.document, app.services.pii_detection_service, app.services.rerank_service, app.models.user, app.services.search_cache
...
[local_deps]: app.services.embed_client, app.services.openrouter_service, app.services.prometheus_metrics, app.services.search_cache, app.utils.query_normalizer
[ext_deps]: json, __future__, typing, time, logging, numpy, hashlib, os
...
[ext_deps]: sqlalchemy, typing, re, logging, numpy
...
[local_deps]: app.services.smart_folder.agent.planner, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.agent.executor, app.services.smart_folder.query_parser, app.models.smart_folder, app.services.smart_folder.report_generator, app.models.user, app.services.smart_folder.entity_resolver
[ext_deps]: sqlalchemy, typing, re, logging, uuid
...
[ext_deps]: sqlalchemy, dataclasses, typing, datetime, logging, uuid
...
[ext_deps]: sqlalchemy, dataclasses, difflib, typing, logging
...
[ext_deps]: json, dataclasses, typing, datetime, logging
...
[ext_deps]: json, dataclasses, typing, re, logging, uuid
...
[local_deps]: app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.base, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.financial_analysis
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.skills.base, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader
[ext_deps]: logging, typing
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.tools.document_reader, app.services.smart_folder.report_generator, app.services.smart_folder.skills.base, app.services.smart_folder.analysis, app.services.smart_folder.retrieval
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader
...
[ext_deps]: json, typing, re, logging, io, csv
...
[local_deps]: app.services.llm_gateway, app.models.document, app.models.user, app.models.collection, app.services.search_service
[ext_deps]: sqlalchemy, typing, re, datetime, logging, uuid
...
[local_deps]: app.models.document, app.models.space, app.models.user, app.models.note, app.models.bookmark, app.models.tag
[ext_deps]: uuid, sqlalchemy, logging
[fn]: _escape_like(value)
...
[ext_deps]: pathlib, cryptography, asyncio, datetime, logging, base64, uuid, os
[class]: EncryptionError { methods: [] }
[fn]: _base64_encode(data)
[fn]: get_encryption_key()
[class]: StorageService { methods: [__init__, _init_encryption, encryption_enabled, _ensure_directories, _encrypt_data, _decrypt_data, encrypt_text, decrypt_bytes_lenient, encryption_ready, get_bucket_path, _safe_bucket_file_path, generate_filename, _is_encrypted_file, save_file, save_file_async, delete_file, get_file, get_file_plaintext, encrypt_file, decrypt_file, needs_migration, file_exists, get_file_info] }

---
### FILE: backend/app/services/structured_logging.py
[ext_deps]: json, contextlib, pathlib, collections, sys, typing, datetime, logging, time, os
...
[ext_deps]: json, asyncio, enum, typing, datetime, nats, abc, logging, uuid
...
[local_deps]: app.services.messaging
[ext_deps]: json, dataclasses, enum, typing, datetime, nats, logging, time, hashlib
...
[local_deps]: app.services.messaging
[ext_deps]: json, dataclasses, asyncio, enum, typing, datetime, nats, logging, uuid
...
[local_deps]: app.services.messaging
[ext_deps]: json, typing, datetime, nats, logging
...
[local_deps]: app.models.knowledge_graph, app.services.llm_gateway, app.services.rollback_monitor, app.models.document, app.services.context_block_service, app.services.agent_identity
[ext_deps]: sqlalchemy, json, collections, typing, datetime, logging
...
[ext_deps]: json, httpx, datetime, logging, os
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: sqlalchemy, collections, typing, datetime, logging
...
[ext_deps]: html, json, subprocess, pathlib, ebooklib, zipfile, typing, sys, re, docx, pptx, logging, xml, PyPDF2, csv, os
...
[local_deps]: app.services.token_utils, app.services.llm_http_client, app.services.base_llm_service
[ext_deps]: json, httpx, collections, typing, datetime, logging, os
...
[ext_deps]: datetime, __future__, logging, typing
...
[ext_deps]: os, faster_whisper, logging, asyncio
...
[local_deps]: app.tasks.base, app.services.alert_service, app.tasks.pipeline_orchestrator, app.celery_app, app.models.document, app.core.redis_url, app.models.processing, app.services.monitoring, app.database, app.services.cache_monitor
[ext_deps]: celery, asyncio, datetime, redis, logging, os
...
[local_deps]: app.tasks.base, app.services.embed_client, app.models.article, app.models.document, app.database, app.services.article_generation_service
[ext_deps]: celery, httpx, asyncio, logging, uuid
...
[local_deps]: app.tasks.article_tasks, app.models.article, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.models.document, app.database
...
[ext_deps]: traceback, asyncio, psutil, logging, os
...
[local_deps]: app.services.report_service, app.tasks.base, app.models.user, app.database, app.models.audit
[ext_deps]: celery, sqlalchemy, json, asyncio, typing, logging, uuid
...
[local_deps]: app.tasks.article_tasks, app.tasks.base, app.services.embed_client, app.services.dlq_service, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.models.document, app.services.auto_tagging_service, app.services.entity_extraction_service, app.services.prometheus_metrics, app.services.collection_service, app.models.processing, app.services.chunking_service, app.database, app.services.ocr_service, app.services.context_block_service, app.services.text_extractor
[ext_deps]: celery, sqlalchemy, traceback, asyncio, tempfile, langdetect, datetime, logging, uuid, os
...
[local_deps]: app.tasks.base, app.services.embed_client, app.celery_app, app.models.document, app.database
...
[local_deps]: app.models.pipeline, app.celery_app, app.models.document, app.core.redis_url, app.database
[ext_deps]: sqlalchemy, os, email, datetime, redis, logging, smtplib
[fn]: _smtp_configured()
...
[local_deps]: app.models.pipeline, app.tasks.pipeline_tasks, app.models.document, app.core.redis_url, app.database
[ext_deps]: celery, datetime, redis, logging, uuid
...
[local_deps]: app.models.pipeline, app.tasks.pipeline_orchestrator, app.celery_app, app.models.document, app.core.redis_url, app.database
[ext_deps]: sqlalchemy, datetime, redis, logging, os
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.models.pipeline, app.tasks.article_tasks, app.services.embed_client, app.services.dlq_service, app.celery_app, app.models.document, app.services.knowledge_graph.pool, app.services.storage_service, app.services.entity_extraction_service, app.services.chunking_service, app.database, app.services.ocr_service, app.tasks.document_tasks, app.services.knowledge_graph.extraction, app.services.text_extractor
[ext_deps]: gc, celery, sqlalchemy, traceback, asyncio, tempfile, datetime, logging, uuid, time, os
...
[local_deps]: app.database, app.models.audit, app.tasks.base, app.models.document
[ext_deps]: celery, sqlalchemy, fpdf, datetime, logging, time, openpyxl, os
...
[local_deps]: app.tasks.base, app.models.smart_folder, app.models.document, app.services.smart_folder.agent_runner, app.models.user, app.database, app.models.audit, app.services.smart_folder_service
[ext_deps]: celery, sqlalchemy, json, asyncio, typing, datetime, logging, uuid
...
[ext_deps]: smtplib, sqlalchemy, httpx, os, email, datetime, logging, calendar
...
[local_deps]: app.models.push_subscription, app.celery_app, app.core.push, app.models.task, app.services.task_service, app.database
[ext_deps]: sqlalchemy, logging
[fn]: check_task_alarms()

---
### FILE: backend/app/tasks/voice_tasks.py
[local_deps]: app.database, app.services.whisper_service, app.services.storage_service, app.celery_app
[ext_deps]: sqlalchemy, asyncio, logging, tempfile, os
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: asyncio, collections, typing, threading, functools, logging, time
...
[ext_deps]: sqlalchemy, dotenv, fastapi, typing, datetime, bcrypt, logging, jose, os
