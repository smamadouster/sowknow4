...
[local_deps]: app.models.user, app.schemas.user, app.services.search_service, app.tasks.pipeline_orchestrator, app.models.audit, app.models.chat, app.tasks.pipeline_tasks, app.utils.security, app.models.processing, app.database, app.models.pipeline, app.services.alert_service, app.models.article, app.models.failed_task, app.services.whisper_service, app.models.document, app.services.storage_service, app.api.deps, app.core.redis_url, app.services.embed_client, app.celery_app, app.schemas.admin, app.api.documents_common
[ext_deps]: sqlalchemy, fastapi, redis, logging, pydantic, time, json, datetime, os, asyncio, uuid, typing, concurrent
...
[local_deps]: app.models.user, app.schemas.article, app.models.article, app.api.deps, app.tasks.article_tasks, app.models.document
...
[local_deps]: app.models.user, app.schemas.token, app.schemas.user, app.utils.constants, app.services.token_blacklist, app.api.deps, app.core.redis_url, app.utils.security, app.limiter, app.schemas.auth, app.middleware.csrf, app.database
[ext_deps]: hashlib, sqlalchemy, dotenv, fastapi, logging, time, httpx, datetime, os, uuid, secrets, redis
...
[local_deps]: app.schemas.bookmark, app.models.user, app.api.deps, app.services.bookmark_service, app.services.space_service, app.schemas.tag, app.database
[ext_deps]: logging, sqlalchemy, fastapi, uuid
...
[local_deps]: app.models.user, app.schemas.chat, app.services.chat_service, app.api.deps, app.services.input_guard, app.models.chat, app.limiter, app.database
[ext_deps]: sqlalchemy, fastapi, logging, json, uuid
...
[local_deps]: app.models.user, app.models.collection, app.services.collection_service, app.services.llm_gateway, app.models.article, app.api.deps, app.models.audit, app.services.input_guard, app.tasks.document_tasks, app.services.collection_chat_service, app.schemas.collection, app.database
[ext_deps]: sqlalchemy, fastapi, logging, reportlab, io, json, datetime, uuid, typing
...
[local_deps]: app.models.user, app.utils.constants, app.services.token_blacklist, app.utils.security, app.database
...
[local_deps]: app.models.pipeline, app.models.user, app.services.storage_service, app.tasks.pipeline_orchestrator, app.api.deps, app.models.audit, app.schemas.document, app.tasks.document_tasks, app.tasks.pipeline_tasks, app.api.documents_journal, app.services.similarity_service, app.services.search_service, app.models.document, app.api.documents_upload, app.tasks.embedding_tasks, app.api.documents_common, app.models.processing, app.database
[ext_deps]: sqlalchemy, fastapi, logging, time, datetime, asyncio, uuid, typing, concurrent
...
[local_deps]: app.models.pipeline, app.models.user, app.tasks.pipeline_orchestrator, app.schemas.document, app.models.audit, app.core.redis_url, app.tasks.pipeline_tasks, app.models.document
[ext_deps]: concurrent, sqlalchemy, fastapi, logging, pydantic, json, asyncio, os, datetime, uuid, mimetypes, typing, redis
...
[local_deps]: app.models.user, app.services.storage_service, app.api.deps, app.models.audit, app.schemas.document, app.services.whisper_service, app.models.document, app.api.documents_common, app.database
[ext_deps]: sqlalchemy, fastapi, logging, tempfile, datetime, os
...
[local_deps]: app.models.user, app.services.deduplication_service, app.services.storage_service, app.api.deps, app.models.audit, app.schemas.document, app.models.document, app.services.document_orchestrator, app.api.documents_common, app.database
[ext_deps]: sqlalchemy, fastapi, logging, uuid, typing
...
[local_deps]: app.models.user, app.services.graph_rag_service, app.api.deps, app.models.audit, app.services.temporal_reasoning_service, app.services.search_service, app.models.document, app.services.progressive_revelation_service, app.services.synthesis_service, app.database
[ext_deps]: sqlalchemy, fastapi, logging, json, uuid, typing
...
[ext_deps]: sqlalchemy, fastapi, logging, nats, httpx, asyncio, os, datetime, typing, redis
...
[ext_deps]: sqlalchemy, fastapi, logging, os, hmac
...
[local_deps]: app.models.user, app.services.entity_extraction_service, app.api.deps, app.services.relationship_service, app.services.timeline_service, app.models.document, app.models.knowledge_graph, app.database
[ext_deps]: sqlalchemy, fastapi, logging, datetime, uuid, typing
...
[local_deps]: app.models.user, app.api.deps, app.models.note_audio, app.services.note_service, app.services.space_service, app.models.note, app.schemas.tag, app.schemas.note, app.database
[ext_deps]: sqlalchemy, fastapi, logging, datetime, os, uuid
...
[local_deps]: app.models.pipeline, app.tasks.pipeline_orchestrator, app.api.deps, app.core.redis_url, app.celery_app, app.models.document, app.database
[ext_deps]: sqlalchemy, asyncio, fastapi, redis
[async_fn]: pipeline_status(db)
[async_fn]: retry_failed_pipeline_stages(stage, limit, db)

---
### FILE: backend/app/api/push.py
[local_deps]: app.models.user, app.api.deps, app.models.push_subscription, app.schemas.push, app.database
[ext_deps]: sqlalchemy, fastapi, logging, os, uuid
...
[local_deps]: app.models.user, app.schemas.reports, app.api.deps, app.celery_app, app.tasks.report_tasks
...
[local_deps]: app.services.search_agent, app.models.user, app.api.deps, app.services.input_guard, app.services.embed_client, app.services.search_models, app.services.search_service, app.models.document, app.database
[ext_deps]: sqlalchemy, fastapi, logging, time, json, asyncio, uuid
...
[ext_deps]: hashlib, sqlalchemy, fastapi, logging, pydantic, uuid
...
[local_deps]: app.models.user, app.models.smart_folder, app.tasks.collection_report_tasks, app.api.deps, app.models.audit, app.celery_app, app.tasks.smart_folder_tasks, app.models.note, app.schemas.collection, app.schemas.smart_folder, app.database
[ext_deps]: sqlalchemy, fastapi, logging, json, asyncio, uuid, typing, celery
...
[local_deps]: app.tasks.space_tasks, app.models.user, app.api.deps, app.schemas.space, app.services.space_service, app.schemas.tag, app.database
[ext_deps]: logging, sqlalchemy, fastapi, uuid
...
[local_deps]: app.models.user, app.api.deps, app.tasks.subscription_tasks, app.models.subscription, app.schemas.subscription, app.database
[ext_deps]: logging, sqlalchemy, fastapi, uuid
[fn]: _parse_uuid(s)
...
[local_deps]: app.models.user, app.services.task_service, app.api.deps, app.schemas.task, app.services.space_service, app.schemas.tag, app.database
[ext_deps]: logging, sqlalchemy, fastapi, uuid
...
[local_deps]: app.models.user, app.services.storage_service, app.api.deps, app.services.whisper_service, app.models.note_audio, app.models.document, app.models.note
[ext_deps]: sqlalchemy, fastapi, logging, io, tempfile, asyncio, os, uuid
...
[ext_deps]: pydantic_settings, logging, pydantic, urllib, pathlib, os
...
[ext_deps]: struct, logging, urllib, time, cryptography, httpx, json, base64, os
...
[ext_deps]: sqlalchemy, dotenv, fastapi, collections, os, typing, pgvector
...
[ext_deps]: urllib, slowapi, os
[fn]: _limiter_redis_url()

---
### FILE: backend/app/main.py
[local_deps]: app.services.messaging, app.middleware.rls, app.core.config, app.services.llm_http_client, app.core.redis_url, app.limiter, app.api, app.middleware.transaction, app.middleware.csrf, app.services.prometheus_metrics, app.database
[ext_deps]: sqlalchemy, starlette, dotenv, fastapi, logging, time, contextlib, collections, slowapi, uvicorn, os, uuid, threading, typing, redis
...
[local_deps]: app.services.monitoring, app.services.cache_monitor, app.core.redis_url, app.api, app.services.embedding_service, app.services.prometheus_metrics, app.database
[ext_deps]: sqlalchemy, dotenv, fastapi, logging, time, contextlib, httpx, datetime, os, uvicorn, redis
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[local_deps]: app.models.user, app.models.space, app.models.base, app.models.subscription, app.models.knowledge_graph, app.models.tag, app.models.task, app.models.audit, app.models.chat, app.models.push_subscription, app.models.note, app.models.processing, app.models.pipeline, app.models.smart_folder, app.models.article, app.models.failed_task, app.models.note_audio, app.models.document, app.models.milestone, app.models.collection, app.models.pattern_insight, app.models.bookmark
...
[ext_deps]: logging, time, collections, httpx, asyncio, tenacity, typing, functools
...
[local_deps]: app.schemas.token, app.schemas.chat, app.schemas.user, app.schemas.search, app.schemas.pagination, app.schemas.document, app.schemas.admin, app.schemas.collection, app.schemas.smart_folder

---
### FILE: backend/app/schemas/admin.py
[local_deps]: app.schemas.user
[ext_deps]: pydantic, re, datetime, uuid
...
[ext_deps]: pydantic, enum, datetime, uuid, typing
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: json, base64, typing, pydantic
...
[ext_deps]: pydantic, enum, datetime, re, uuid, typing
[class]: UserRole { methods: [] }
...
[ext_deps]: dataclasses, logging, time, collections, enum, datetime, typing
...
[local_deps]: app.services.graph_rag_service, app.services.knowledge_graph.traversal, app.services.llm_gateway, app.services.knowledge_graph.pool, app.services.embed_client, app.services.agent_identity, app.services.search_service, app.services.knowledge_graph.models
[ext_deps]: dataclasses, logging, collections, json, re, typing
...
[ext_deps]: hashlib, logging, httpx, json, asyncio, typing
...
[ext_deps]: sqlalchemy, warnings, logging, json, datetime, uuid, typing
...
[ext_deps]: logging, json, datetime, threading, typing
...
[local_deps]: app.models.user, app.services.llm_gateway, app.services.cache_monitor, app.models.chat, app.services.agent_identity, app.services.search_service, app.models.document, app.services.pii_detection_service, app.services.context_block_service, app.services.prometheus_metrics, app.database
[ext_deps]: sqlalchemy, logging, time, collections, json, re, asyncio, uuid, typing
...
[local_deps]: app.models.user, app.models.collection, app.services.llm_gateway, app.models.audit, app.models.chat, app.services.agent_identity, app.models.document, app.services.context_block_service
...
[local_deps]: app.models.user, app.models.collection, app.services.llm_gateway, app.services.intent_parser, app.services.agent_identity, app.models.document, app.services.search_service, app.schemas.collection, app.services.search_cache
[ext_deps]: sqlalchemy, logging, datetime, asyncio, uuid, typing
...
[ext_deps]: logging, sqlalchemy, datetime, redis
[fn]: _get_redis()
...
[ext_deps]: sqlalchemy, hashlib, logging, difflib, datetime
...
[local_deps]: app.services.llm_gateway
[ext_deps]: logging, datetime, os, uuid, typing
...
[ext_deps]: sqlalchemy, logging, json, traceback, asyncio, threading, typing
...
[local_deps]: app.models.pipeline, app.models.user, app.services.deduplication_service, app.services.storage_service, app.tasks.pipeline_orchestrator, app.schemas.document, app.models.audit, app.tasks.voice_tasks, app.tasks.pipeline_tasks, app.models.document
[ext_deps]: sqlalchemy, fastapi, logging, json, datetime, asyncio, typing, concurrent
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: logging, sendgrid, datetime, os
...
[ext_deps]: logging, time, random, httpx, asyncio, os
[fn]: _base_urls()
...
[ext_deps]: psutil, logging, sentence_transformers, asyncio, os, threading, gc, torch, typing, numpy
...
[ext_deps]: logging, onnxruntime, transformers, pathlib, os, numpy
...
[ext_deps]: sqlalchemy, warnings, logging, json, datetime, asyncio, typing
...
[ext_deps]: sqlalchemy, logging, collections, re, typing
...
[ext_deps]: hashlib, dataclasses, logging, re, redis
...
[ext_deps]: warnings, logging, json, re, datetime, enum, typing
...
[ext_deps]: logging, collections, httpx, json, datetime, os, tenacity, typing
...
[ext_deps]: __future__, itertools, logging, asyncpg, json, spacy, models
[fn]: _vec_to_str(vec)
...
[ext_deps]: __future__, pydantic, enum, datetime, uuid
...
[ext_deps]: __future__, extraction, logging, asyncpg, json, models
...
[local_deps]: app.services.user_quota, app.services.monitoring, app.services.rollback_monitor, app.services.llm_router, app.services.semantic_cache, app.core.context
...
[local_deps]: app.services.minimax_service, app.services.together_service, app.services.pii_detection_service, app.services.openrouter_service, app.services.ollama_service, app.services.kimi_service
[ext_deps]: dataclasses, logging, collections, enum, typing
...
[ext_deps]: logging, nats, collections, asyncio, os, typing
...
[ext_deps]: logging, collections, httpx, json, os, typing
...
[ext_deps]: psutil, dataclasses, logging, collections, re, datetime, os, threading, prometheus_client, subprocess, typing, redis
...
[ext_deps]: pytesseract, logging, time, PIL, io, enum, PyPDF2, os, cv2, paddleocr, typing, numpy
...
[local_deps]: app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: logging, collections, httpx, json, tenacity, os, typing
...
[local_deps]: app.services.monitoring, app.services.cache_monitor, app.services.llm_http_client, app.core.redis_url, app.services.openrouter_throttle
[ext_deps]: hashlib, logging, collections, httpx, json, asyncio, os, datetime, tenacity, typing, redis
[fn]: _get_redis_client()
...
[ext_deps]: __future__, logging, time, datetime, typing
...
[ext_deps]: psutil, sqlalchemy, logging, sentence_transformers, datetime, typing
...
[local_deps]: app.models.user, app.services.llm_gateway, app.services.agent_identity, app.models.document, app.models.knowledge_graph
...
[ext_deps]: logging, time, collections, typing, functools
...
[ext_deps]: logging, sqlalchemy, typing, collections
...
[local_deps]: app.models.user, app.models.collection, app.services.monitoring, app.services.llm_gateway, app.services.rollback_monitor, app.services.agent_identity, app.models.document, app.services.context_block_service
[ext_deps]: sqlalchemy, logging, reportlab, io, datetime, os, uuid, typing
[class]: ReportFormat { methods: [] }
...
[ext_deps]: logging, typing, os, httpx
[fn]: _get_client()
...
[local_deps]: app.core.redis_url
[ext_deps]: logging, time, collections, datetime, os, typing, redis
[fn]: _get_redis()
...
[local_deps]: app.models.user, app.database, app.services.llm_router, app.services.agent_identity, app.models.document, app.services.search_service, app.services.context_block_service, app.services.search_cache
[ext_deps]: sqlalchemy, logging, time, json, re, asyncio, uuid, typing, search_models
...
[local_deps]: app.core.redis_url
[ext_deps]: hashlib, logging, json, typing, redis
[fn]: _get_redis()
...
[local_deps]: app.models.user, app.services.embed_client, app.models.document, app.services.pii_detection_service, app.services.rerank_service, app.services.search_cache
[ext_deps]: sqlalchemy, logging, re, asyncio, typing
...
[ext_deps]: __future__, hashlib, logging, time, json, typing, numpy
...
[ext_deps]: sqlalchemy, logging, re, typing, numpy
...
[local_deps]: app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser, app.services.smart_folder.retrieval, app.services.smart_folder.report_generator, app.services.smart_folder.analysis
...
[local_deps]: app.services.smart_folder.agent.planner, app.models.user, app.models.smart_folder, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.agent.executor
[ext_deps]: sqlalchemy, logging, re, uuid, typing
...
[ext_deps]: sqlalchemy, dataclasses, logging, datetime, uuid, typing
...
[ext_deps]: dataclasses, logging, json, datetime, typing
...
[ext_deps]: dataclasses, logging, json, re, uuid, typing
...
[local_deps]: app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.base
...
[local_deps]: app.services.smart_folder.tools.asset_reader, app.services.smart_folder.skills.base, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer
[ext_deps]: logging, typing
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.tools.document_reader, app.services.smart_folder.report_generator, app.services.smart_folder.retrieval, app.services.smart_folder.analysis, app.services.smart_folder.skills.base
...
[local_deps]: app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.citation_marker

---
### FILE: backend/app/services/smart_folder/tools/asset_reader.py
[local_deps]: app.models.document
[ext_deps]: logging, sqlalchemy, typing, uuid
...
[ext_deps]: logging, io, json, re, csv, typing
...
[local_deps]: app.models.user, app.models.collection, app.services.llm_gateway, app.services.search_service, app.models.document
[ext_deps]: sqlalchemy, logging, re, datetime, uuid, typing
...
[local_deps]: app.models.user, app.models.space, app.models.bookmark, app.models.document, app.models.note, app.models.tag
[ext_deps]: logging, sqlalchemy, uuid
[fn]: _escape_like(value)
...
[ext_deps]: logging, cryptography, pathlib, base64, datetime, os, uuid
...
[ext_deps]: sys, logging, time, contextlib, collections, pathlib, json, datetime, os, typing
...
[ext_deps]: abc, logging, nats, json, enum, asyncio, datetime, uuid, typing
...
[local_deps]: app.services.messaging
[ext_deps]: hashlib, dataclasses, logging, nats, time, json, enum, datetime, typing
...
[local_deps]: app.services.messaging
[ext_deps]: dataclasses, logging, nats, json, enum, asyncio, datetime, uuid, typing
...
[local_deps]: app.services.messaging
[ext_deps]: logging, nats, json, datetime, typing
...
[local_deps]: app.services.llm_gateway, app.services.rollback_monitor, app.services.agent_identity, app.models.document, app.models.knowledge_graph, app.services.context_block_service
[ext_deps]: sqlalchemy, logging, collections, json, datetime, typing
...
[ext_deps]: logging, httpx, json, datetime, os
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: sqlalchemy, logging, collections, datetime, typing
...
[ext_deps]: sys, pptx, html, logging, docx, xml, pathlib, zipfile, json, re, PyPDF2, os, ebooklib, csv, subprocess, typing
...
[local_deps]: app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: logging, collections, httpx, json, datetime, os, typing
...
[local_deps]: app.core.redis_url
[ext_deps]: logging, hashlib, redis
[fn]: _client()
[fn]: _key(token)
[fn]: blacklist_token(token, expires_in_seconds)
[fn]: is_token_blacklisted(token)
...
[local_deps]: app.utils.circuit_breaker
[ext_deps]: logging, asyncio, os, faster_whisper
...
[local_deps]: app.services.monitoring, app.services.alert_service, app.services.cache_monitor, app.tasks.pipeline_orchestrator, app.core.redis_url, app.celery_app, app.models.document, app.tasks.base, app.models.processing, app.database
[ext_deps]: logging, datetime, os, asyncio, redis, celery
...
[local_deps]: app.services.article_generation_service, app.models.article, app.services.embed_client, app.models.document, app.tasks.base, app.database
[ext_deps]: logging, httpx, asyncio, uuid, celery
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.article, app.tasks.article_tasks, app.models.document, app.tasks.embedding_tasks, app.database
...
[ext_deps]: psutil, logging, traceback, asyncio, os
...
[ext_deps]: sqlalchemy, logging, json, asyncio, uuid, typing, celery
...
[local_deps]: app.services.text_extractor, app.services.entity_extraction_service, app.services.collection_service, app.services.dlq_service, app.tasks.pipeline_orchestrator, app.services.embed_client, app.services.ocr_service, app.services.chunking_service, app.tasks.article_tasks, app.models.document, app.tasks.base, app.tasks.embedding_tasks, app.models.processing, app.services.context_block_service, app.services.prometheus_metrics, app.database
[ext_deps]: celery, sqlalchemy, logging, traceback, tempfile, datetime, asyncio, os, uuid, langdetect
...
[local_deps]: app.services.embed_client, app.celery_app, app.models.document, app.tasks.base, app.database
[ext_deps]: logging, time, sentence_transformers, uuid
...
[local_deps]: app.models.pipeline, app.core.redis_url, app.celery_app, app.models.document, app.database
[ext_deps]: sqlalchemy, logging, smtplib, email, datetime, os, redis
[fn]: _smtp_configured()
...
[local_deps]: app.models.pipeline, app.core.redis_url, app.tasks.pipeline_tasks, app.models.document, app.database
[ext_deps]: logging, datetime, uuid, redis, celery
...
[local_deps]: app.models.pipeline, app.tasks.pipeline_orchestrator, app.core.redis_url, app.celery_app, app.models.document, app.database
[ext_deps]: sqlalchemy, logging, datetime, os, redis
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.models.pipeline, app.services.text_extractor, app.services.entity_extraction_service, app.services.knowledge_graph.extraction, app.services.dlq_service, app.tasks.document_tasks, app.services.embed_client, app.services.knowledge_graph.pool, app.services.ocr_service, app.celery_app, app.services.chunking_service, app.tasks.article_tasks, app.models.document, app.database
[ext_deps]: logging, time, traceback, tempfile, asyncio, os, datetime, uuid, gc, celery
...
[ext_deps]: sqlalchemy, openpyxl, logging, time, datetime, os, fpdf, celery
...
[local_deps]: app.models.user, app.services.smart_folder.agent_runner, app.models.smart_folder, app.models.audit, app.tasks.base, app.models.document, app.services.smart_folder_service, app.database
[ext_deps]: sqlalchemy, logging, json, asyncio, datetime, uuid, typing, celery
...
[ext_deps]: logging, sqlalchemy, asyncio, celery
...
[ext_deps]: sqlalchemy, logging, smtplib, httpx, email, datetime, os, calendar
...
[local_deps]: app.models.task, app.services.task_service, app.celery_app, app.models.push_subscription, app.core.push, app.database
...
[ext_deps]: sqlalchemy, logging, tempfile, asyncio, os
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: logging, time, collections, asyncio, threading, typing, functools
...
[ext_deps]: sqlalchemy, dotenv, fastapi, logging, bcrypt, jose, datetime, os, typing
