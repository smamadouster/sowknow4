...
[local_deps]: app.services.alert_service, app.api.deps, app.models.chat, app.api.documents_common, app.models.pipeline, app.celery_app, app.core.redis_url, app.utils.security, app.models.processing, app.models.user, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.document, app.schemas.admin, app.services.search_service, app.database, app.services.whisper_service, app.models.article, app.services.storage_service, app.services.embed_client, app.models.failed_task, app.models.audit, app.schemas.user
[ext_deps]: datetime, os, asyncio, concurrent, fastapi, typing, logging, uuid, json, redis, sqlalchemy, pydantic, time
...
[local_deps]: app.api.deps, app.models.article, app.schemas.article, app.models.document, app.tasks.article_tasks, app.models.user
[ext_deps]: logging, uuid, sqlalchemy, fastapi
...
[local_deps]: app.schemas.token, app.api.deps, app.middleware.csrf, app.schemas.auth, app.database, app.utils.constants, app.core.redis_url, app.utils.security, app.services.token_blacklist, app.limiter, app.models.user, app.schemas.user
[ext_deps]: datetime, os, hashlib, fastapi, logging, uuid, httpx, sqlalchemy, secrets, redis, dotenv, time
...
[local_deps]: app.schemas.tag, app.api.deps, app.schemas.bookmark, app.database, app.services.space_service, app.services.bookmark_service, app.models.user
[ext_deps]: logging, uuid, sqlalchemy, fastapi
...
[local_deps]: app.schemas.chat, app.services.input_guard, app.api.deps, app.models.chat, app.database, app.limiter, app.models.user, app.services.chat_service
[ext_deps]: fastapi, logging, uuid, json, sqlalchemy
...
[local_deps]: app.services.input_guard, app.api.deps, app.models.collection, app.database, app.services.collection_service, app.tasks.document_tasks, app.schemas.collection, app.models.article, app.services.collection_chat_service, app.services.llm_gateway, app.models.audit, app.models.user
[ext_deps]: reportlab, datetime, fastapi, typing, logging, uuid, json, sqlalchemy, io
...
[local_deps]: app.utils.constants, app.database, app.utils.security, app.services.token_blacklist, app.models.user
...
[local_deps]: app.api.deps, app.api.documents_common, app.database, app.schemas.document, app.services.search_service, app.tasks.document_tasks, app.tasks.pipeline_orchestrator, app.tasks.embedding_tasks, app.tasks.pipeline_tasks, app.models.pipeline, app.api.documents_journal, app.api.documents_upload, app.models.document, app.services.storage_service, app.models.processing, app.services.similarity_service, app.models.audit, app.models.user
[ext_deps]: datetime, asyncio, concurrent, fastapi, typing, logging, uuid, sqlalchemy, time
...
[local_deps]: app.schemas.document, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.pipeline, app.core.redis_url, app.models.document, app.models.audit, app.models.user
[ext_deps]: datetime, os, asyncio, concurrent, fastapi, mimetypes, logging, typing, json, uuid, redis, sqlalchemy, pydantic
...
[local_deps]: app.api.deps, app.api.documents_common, app.database, app.schemas.document, app.services.whisper_service, app.services.storage_service, app.models.document, app.models.audit, app.models.user
[ext_deps]: tempfile, datetime, os, fastapi, logging, sqlalchemy
...
[local_deps]: app.services.document_orchestrator, app.api.deps, app.services.deduplication_service, app.api.documents_common, app.database, app.schemas.document, app.services.storage_service, app.models.document, app.models.audit, app.models.user
[ext_deps]: fastapi, typing, logging, uuid, sqlalchemy
...
[local_deps]: app.services.synthesis_service, app.services.graph_rag_service, app.services.temporal_reasoning_service, app.api.deps, app.services.search_service, app.database, app.services.progressive_revelation_service, app.models.document, app.models.audit, app.models.user
[ext_deps]: fastapi, typing, logging, uuid, json, sqlalchemy
...
[local_deps]: app.database, app.core.redis_url, app.utils.security, app.celery_app
[ext_deps]: datetime, os, asyncio, nats, fastapi, typing, logging, httpx, redis, sqlalchemy
...
[local_deps]: app.models.knowledge_graph, app.api.deps, app.database, app.services.timeline_service, app.models.document, app.services.relationship_service, app.models.user, app.services.entity_extraction_service
[ext_deps]: datetime, fastapi, typing, logging, uuid, sqlalchemy
...
[local_deps]: app.models.note, app.schemas.tag, app.api.deps, app.database, app.models.note_audio, app.services.space_service, app.services.note_service, app.schemas.note, app.models.user
[ext_deps]: datetime, os, fastapi, logging, uuid, sqlalchemy
...
[local_deps]: app.api.deps, app.tasks.pipeline_orchestrator, app.database, app.models.pipeline, app.celery_app, app.core.redis_url, app.models.document
...
[local_deps]: app.api.deps, app.database, app.schemas.push, app.models.user, app.models.push_subscription
[ext_deps]: os, fastapi, logging, uuid, sqlalchemy
...
[local_deps]: app.api.deps, app.celery_app, app.schemas.reports, app.tasks.report_tasks, app.models.user
...
[local_deps]: app.services.search_models, app.services.input_guard, app.api.deps, app.services.search_service, app.database, app.services.embed_client, app.models.document, app.models.user, app.services.search_agent
[ext_deps]: asyncio, fastapi, logging, uuid, json, sqlalchemy, time
...
[ext_deps]: hashlib, fastapi, logging, uuid, sqlalchemy, pydantic
...
[local_deps]: app.models.note, app.tasks.collection_report_tasks, app.api.deps, app.schemas.smart_folder, app.database, app.tasks.smart_folder_tasks, app.celery_app, app.schemas.collection, app.models.smart_folder, app.models.audit, app.models.user
[ext_deps]: celery, asyncio, fastapi, typing, logging, uuid, json, sqlalchemy
...
[local_deps]: app.schemas.tag, app.api.deps, app.database, app.tasks.space_tasks, app.schemas.space, app.services.space_service, app.models.user
[ext_deps]: logging, uuid, sqlalchemy, fastapi
...
[local_deps]: app.api.deps, app.database, app.tasks.subscription_tasks, app.schemas.subscription, app.models.subscription, app.models.user
[ext_deps]: logging, uuid, sqlalchemy, fastapi
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.tag, app.api.deps, app.schemas.task, app.database, app.services.task_service, app.services.space_service, app.models.user
[ext_deps]: logging, uuid, sqlalchemy, fastapi
...
[local_deps]: app.models.note, app.api.deps, app.models.note_audio, app.services.whisper_service, app.services.storage_service, app.models.document, app.models.user
[ext_deps]: tempfile, os, asyncio, fastapi, logging, uuid, sqlalchemy, io
...
[ext_deps]: os, struct, cryptography, logging, urllib, json, httpx, base64, time
...
[ext_deps]: os, pgvector, fastapi, typing, sqlalchemy, dotenv, collections
...
[local_deps]: app.api, app.middleware.transaction, app.middleware.csrf, app.database, app.services.llm_http_client, app.middleware.rls, app.core.redis_url, app.services.messaging, app.core.config, app.limiter, app.services.prometheus_metrics
[ext_deps]: os, starlette, slowapi, fastapi, typing, logging, contextlib, uuid, redis, sqlalchemy, dotenv, collections, threading, time, uvicorn
...
[local_deps]: app.api, app.database, app.services.cache_monitor, app.core.redis_url, app.services.monitoring, app.services.embedding_service, app.services.prometheus_metrics
[ext_deps]: datetime, os, fastapi, logging, contextlib, httpx, sqlalchemy, redis, dotenv, time, uvicorn
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: starlette, logging, sqlalchemy, jose, dataclasses
...
[local_deps]: app.models.knowledge_graph, app.models.chat, app.models.milestone, app.models.pipeline, app.models.processing, app.models.user, app.models.pattern_insight, app.models.task, app.models.collection, app.models.space, app.models.note_audio, app.models.document, app.models.smart_folder, app.models.tag, app.models.base, app.models.push_subscription, app.models.note, app.models.bookmark, app.models.article, app.models.subscription, app.models.failed_task, app.models.audit
...
[ext_deps]: tenacity, asyncio, functools, typing, logging, httpx, collections, time
...
[local_deps]: app.schemas.chat, app.schemas.token, app.schemas.admin, app.schemas.smart_folder, app.schemas.document, app.schemas.collection, app.schemas.search, app.schemas.pagination, app.schemas.user
...
[ext_deps]: datetime, enum, typing, uuid, pydantic
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: pydantic, datetime, typing, uuid, re, enum
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.clarification_agent, app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.agent_orchestrator, app.services.agents.answer_agent
...
[ext_deps]: datetime, typing, logging, dataclasses, collections, enum, time
...
[ext_deps]: typing, logging, json, dataclasses, re
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: typing, logging, dataclasses, json
...
[local_deps]: app.services.graph_rag_service, app.services.knowledge_graph.pool, app.services.search_service, app.services.llm_gateway, app.services.knowledge_graph.traversal, app.services.embed_client, app.services.agent_identity, app.services.knowledge_graph.models
[ext_deps]: typing, logging, json, dataclasses, collections, re
...
[ext_deps]: hashlib, asyncio, typing, logging, json, httpx
...
[ext_deps]: warnings, datetime, typing, logging, uuid, json, sqlalchemy
...
[ext_deps]: datetime, typing, logging, json, threading
...
[local_deps]: app.models.chat, app.services.search_service, app.database, app.services.cache_monitor, app.services.llm_gateway, app.services.context_block_service, app.services.agent_identity, app.models.document, app.services.pii_detection_service, app.models.user, app.services.prometheus_metrics
[ext_deps]: asyncio, typing, logging, json, uuid, sqlalchemy, collections, re, time
...
[local_deps]: app.models.chat, app.models.collection, app.services.llm_gateway, app.services.context_block_service, app.services.agent_identity, app.models.document, app.models.audit, app.models.user
...
[local_deps]: app.models.collection, app.services.search_service, app.services.intent_parser, app.schemas.collection, app.services.llm_gateway, app.models.document, app.services.agent_identity, app.services.search_cache, app.models.user
[ext_deps]: datetime, asyncio, typing, logging, uuid, sqlalchemy
...
[ext_deps]: logging, datetime, sqlalchemy, redis
[fn]: _get_redis()
...
[local_deps]: app.services.llm_gateway
[ext_deps]: datetime, os, typing, logging, uuid
...
[ext_deps]: asyncio, typing, logging, json, sqlalchemy, traceback, threading
...
[local_deps]: app.services.deduplication_service, app.schemas.document, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.pipeline, app.tasks.voice_tasks, app.services.storage_service, app.models.document, app.models.audit, app.models.user
[ext_deps]: datetime, asyncio, concurrent, fastapi, typing, logging, json, sqlalchemy
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: logging, datetime, sendgrid, os
...
[ext_deps]: os, asyncio, logging, httpx, random, time
[fn]: _base_urls()
...
[ext_deps]: torch, os, asyncio, typing, logging, psutil, numpy, sentence_transformers, gc, threading
...
[ext_deps]: onnxruntime, os, pathlib, transformers, logging, numpy
...
[local_deps]: app.models.knowledge_graph, app.services.llm_gateway, app.models.document, app.services.agent_identity, app.services.rollback_monitor
[ext_deps]: warnings, datetime, asyncio, typing, logging, json, sqlalchemy
...
[ext_deps]: typing, logging, sqlalchemy, collections, re
...
[ext_deps]: hashlib, logging, redis, dataclasses, re
...
[ext_deps]: warnings, datetime, typing, logging, json, re, enum
...
[ext_deps]: tenacity, datetime, os, typing, logging, json, httpx, collections
...
[ext_deps]: asyncpg, spacy, logging, itertools, json, models, __future__
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, enum, uuid, __future__, pydantic
...
[ext_deps]: asyncpg, extraction, logging, json, models, __future__
...
[local_deps]: app.services.semantic_cache, app.services.user_quota, app.core.context, app.services.monitoring, app.services.rollback_monitor, app.services.llm_router
[ext_deps]: asyncio, typing, logging, collections, time
...
[local_deps]: app.services.minimax_service, app.services.ollama_service, app.services.pii_detection_service, app.services.kimi_service, app.services.openrouter_service
[ext_deps]: typing, logging, dataclasses, collections, enum
...
[ext_deps]: os, asyncio, nats, typing, logging, collections
...
[ext_deps]: os, typing, logging, json, httpx, collections
...
[ext_deps]: datetime, prometheus_client, os, typing, logging, psutil, subprocess, redis, dataclasses, collections, re, threading
...
[ext_deps]: PyPDF2, os, PIL, pytesseract, paddleocr, typing, logging, numpy, cv2, io, enum, time
...
[local_deps]: app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: tenacity, os, typing, logging, json, httpx, collections
...
[local_deps]: app.services.cache_monitor, app.services.llm_http_client, app.core.redis_url, app.services.monitoring, app.services.openrouter_throttle
[ext_deps]: tenacity, datetime, os, hashlib, asyncio, typing, logging, json, httpx, redis, collections
[fn]: _get_redis_client()
...
[ext_deps]: datetime, typing, logging, psutil, sentence_transformers, sqlalchemy
...
[local_deps]: app.models.knowledge_graph, app.services.llm_gateway, app.models.document, app.services.agent_identity, app.models.user
...
[ext_deps]: functools, typing, logging, collections, time
...
[local_deps]: app.services.monitoring, app.models.collection, app.services.llm_gateway, app.services.context_block_service, app.models.document, app.services.agent_identity, app.services.rollback_monitor, app.models.user
[ext_deps]: reportlab, datetime, os, typing, logging, uuid, sqlalchemy, io
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.core.redis_url
[ext_deps]: datetime, os, typing, logging, redis, collections, time
[fn]: _get_redis()
...
[local_deps]: app.services.search_service, app.database, app.services.context_block_service, app.models.document, app.services.agent_identity, app.services.search_cache, app.models.user, app.services.llm_router
[ext_deps]: search_models, asyncio, typing, logging, json, uuid, sqlalchemy, re, time
...
[local_deps]: app.core.redis_url
[ext_deps]: hashlib, typing, logging, json, redis
[fn]: _get_redis()
...
[local_deps]: app.services.rerank_service, app.services.embed_client, app.models.document, app.services.search_cache, app.services.pii_detection_service, app.models.user
[ext_deps]: asyncio, typing, logging, sqlalchemy, re
...
[ext_deps]: hashlib, typing, logging, json, numpy, __future__, time
...
[ext_deps]: typing, logging, json, dataclasses, collections
...
[ext_deps]: typing, logging, numpy, sqlalchemy, re
...
[local_deps]: app.services.smart_folder.agent.synthesizer, app.services.smart_folder.agent.executor, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.entity_resolver, app.models.smart_folder, app.services.smart_folder.agent.planner, app.models.user
[ext_deps]: typing, logging, uuid, sqlalchemy, re
...
[ext_deps]: datetime, typing, logging, uuid, sqlalchemy, dataclasses
...
[ext_deps]: datetime, typing, logging, json, dataclasses
...
[ext_deps]: typing, logging, json, uuid, dataclasses, re
...
[local_deps]: app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.base, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.skills.base, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.chart_generator
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.tools.document_reader, app.services.smart_folder.report_generator, app.services.smart_folder.retrieval, app.services.smart_folder.skills.base, app.services.smart_folder.analysis
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.chart_generator

---
### FILE: backend/app/services/smart_folder/tools/asset_reader.py
[local_deps]: app.models.document
[ext_deps]: typing, logging, uuid, sqlalchemy
...
[ext_deps]: csv, typing, logging, json, io, re
...
[ext_deps]: datetime, typing, logging, uuid, sqlalchemy, re
...
[local_deps]: app.models.note, app.models.bookmark, app.models.space, app.models.document, app.models.tag, app.models.user
[ext_deps]: logging, uuid, sqlalchemy
[fn]: _escape_like(value)
...
[ext_deps]: datetime, os, pathlib, logging, uuid, base64, cryptography
...
[ext_deps]: datetime, os, pathlib, sys, typing, logging, contextlib, json, collections, time
...
[ext_deps]: datetime, asyncio, nats, typing, logging, uuid, json, abc, enum
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, hashlib, nats, typing, logging, json, dataclasses, enum, time
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, asyncio, nats, typing, logging, uuid, json, dataclasses, enum
...
[local_deps]: app.services.messaging
[ext_deps]: datetime, nats, typing, logging, json
...
[local_deps]: app.models.knowledge_graph, app.services.llm_gateway, app.services.context_block_service, app.models.document, app.services.agent_identity, app.services.rollback_monitor
[ext_deps]: datetime, typing, logging, json, sqlalchemy, collections
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: datetime, typing, logging, sqlalchemy, collections
...
[ext_deps]: html, PyPDF2, docx, csv, os, pathlib, sys, zipfile, typing, logging, subprocess, pptx, json, xml, ebooklib, re
...
[ext_deps]: typing, logging, datetime, __future__
...
[local_deps]: app.services.alert_service, app.tasks.pipeline_orchestrator, app.database, app.services.cache_monitor, app.celery_app, app.core.redis_url, app.models.document, app.tasks.base, app.services.monitoring, app.models.processing
[ext_deps]: celery, datetime, os, asyncio, logging, redis
...
[local_deps]: app.database, app.models.article, app.services.embed_client, app.tasks.base, app.models.document, app.services.article_generation_service
[ext_deps]: celery, asyncio, logging, uuid, httpx
...
[ext_deps]: os, asyncio, logging, psutil, traceback
...
[local_deps]: app.database, app.services.report_service, app.tasks.base, app.models.audit, app.models.user
[ext_deps]: celery, asyncio, typing, logging, uuid, json, sqlalchemy
...
[local_deps]: app.services.dlq_service, app.tasks.pipeline_orchestrator, app.database, app.services.collection_service, app.services.entity_extraction_service, app.services.ocr_service, app.services.chunking_service, app.services.embed_client, app.tasks.base, app.models.document, app.services.context_block_service, app.tasks.embedding_tasks, app.tasks.article_tasks, app.models.processing, app.services.text_extractor, app.services.prometheus_metrics
[ext_deps]: celery, tempfile, datetime, os, asyncio, langdetect, logging, uuid, sqlalchemy, traceback
...
[ext_deps]: logging, sentence_transformers, uuid, time
...
[ext_deps]: datetime, os, email, smtplib, logging, redis, sqlalchemy
[fn]: _smtp_configured()
...
[local_deps]: app.tasks.pipeline_tasks, app.database, app.models.pipeline, app.core.redis_url, app.models.document
[ext_deps]: celery, datetime, logging, uuid, redis
...
[local_deps]: app.tasks.pipeline_orchestrator, app.database, app.models.pipeline, app.celery_app, app.core.redis_url, app.models.document
[ext_deps]: datetime, os, logging, redis, sqlalchemy
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.knowledge_graph.pool, app.services.dlq_service, app.database, app.services.ocr_service, app.models.pipeline, app.tasks.document_tasks, app.services.chunking_service, app.celery_app, app.services.knowledge_graph.extraction, app.services.embed_client, app.models.document, app.tasks.article_tasks, app.services.text_extractor, app.services.entity_extraction_service
[ext_deps]: celery, tempfile, datetime, os, asyncio, logging, uuid, gc, traceback, time
...
[ext_deps]: celery, datetime, os, fpdf, openpyxl, logging, sqlalchemy, time
...
[local_deps]: app.database, app.models.smart_folder, app.tasks.base, app.services.smart_folder_service, app.models.document, app.models.audit, app.models.user, app.services.smart_folder.agent_runner
[ext_deps]: celery, datetime, asyncio, typing, logging, uuid, json, sqlalchemy
...
[ext_deps]: celery, logging, sqlalchemy, asyncio
...
[ext_deps]: datetime, os, email, smtplib, logging, calendar, httpx, sqlalchemy
...
[local_deps]: app.models.task, app.core.push, app.database, app.services.task_service, app.celery_app, app.models.push_subscription
...
[ext_deps]: tempfile, os, asyncio, logging, sqlalchemy
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: asyncio, functools, typing, logging, collections, threading, time
...
[ext_deps]: datetime, os, fastapi, typing, logging, sqlalchemy, jose, bcrypt, dotenv
