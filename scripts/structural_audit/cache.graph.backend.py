...
[local_deps]: app.models.processing, app.database, app.core.redis_url, app.services.alert_service, app.models.audit, app.utils.security, app.services.whisper_service, app.models.document, app.services.storage_service, app.models.pipeline, app.models.article, app.tasks.pipeline_tasks, app.models.chat, app.schemas.admin, app.tasks.pipeline_orchestrator, app.models.failed_task, app.api.documents_common, app.services.search_service, app.models.user, app.api.deps, app.schemas.user, app.services.embed_client, app.celery_app
[ext_deps]: typing, datetime, os, pydantic, redis, asyncio, fastapi, concurrent, time, sqlalchemy, uuid, json, logging
...
[local_deps]: app.models.user, app.api.deps, app.schemas.article, app.tasks.article_tasks, app.models.document, app.models.article
...
[local_deps]: app.limiter, app.schemas.auth, app.database, app.utils.constants, app.schemas.token, app.services.token_blacklist, app.core.redis_url, app.models.user, app.middleware.csrf, app.api.deps, app.utils.security, app.schemas.user
[ext_deps]: hashlib, redis, os, datetime, dotenv, fastapi, httpx, sqlalchemy, uuid, time, secrets, logging
...
[local_deps]: app.database, app.schemas.bookmark, app.models.user, app.schemas.tag, app.api.deps, app.services.space_service, app.services.bookmark_service
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.models.chat, app.limiter, app.database, app.services.input_guard, app.services.chat_service, app.models.user, app.api.deps, app.schemas.chat
[ext_deps]: fastapi, sqlalchemy, uuid, json, logging
...
[local_deps]: app.services.llm_gateway, app.database, app.services.collection_service, app.tasks.document_tasks, app.services.input_guard, app.models.user, app.schemas.collection, app.services.collection_chat_service, app.api.deps, app.models.audit, app.models.article, app.models.collection
[ext_deps]: io, reportlab, typing, datetime, fastapi, sqlalchemy, uuid, json, logging
...
[local_deps]: app.tasks.pipeline_tasks, app.api.documents_journal, app.models.processing, app.database, app.services.search_service, app.tasks.document_tasks, app.models.pipeline, app.tasks.embedding_tasks, app.models.user, app.tasks.pipeline_orchestrator, app.api.documents_upload, app.schemas.document, app.api.documents_common, app.api.deps, app.models.audit, app.services.similarity_service, app.models.document, app.services.storage_service
[ext_deps]: typing, datetime, asyncio, fastapi, concurrent, sqlalchemy, uuid, time, logging
...
[local_deps]: app.tasks.pipeline_tasks, app.core.redis_url, app.models.user, app.tasks.pipeline_orchestrator, app.schemas.document, app.models.audit, app.models.document, app.models.pipeline
[ext_deps]: typing, os, datetime, pydantic, redis, asyncio, fastapi, concurrent, sqlalchemy, uuid, json, mimetypes, logging
...
[local_deps]: app.database, app.models.user, app.schemas.document, app.api.documents_common, app.api.deps, app.models.audit, app.services.whisper_service, app.models.document, app.services.storage_service
[ext_deps]: os, datetime, fastapi, sqlalchemy, tempfile, logging
...
[local_deps]: app.database, app.services.document_orchestrator, app.models.user, app.schemas.document, app.services.deduplication_service, app.api.documents_common, app.api.deps, app.models.audit, app.models.document, app.services.storage_service
[ext_deps]: typing, fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.services.progressive_revelation_service, app.database, app.services.search_service, app.services.graph_rag_service, app.models.user, app.api.deps, app.models.audit, app.models.document, app.services.temporal_reasoning_service, app.services.synthesis_service
[ext_deps]: typing, fastapi, sqlalchemy, uuid, json, logging
...
[ext_deps]: nats, typing, os, datetime, redis, asyncio, fastapi, httpx, sqlalchemy, logging
...
[local_deps]: app.schemas.document, app.models.user, app.database, app.api.documents_upload
[ext_deps]: os, fastapi, sqlalchemy, hmac, logging
...
[local_deps]: app.services.relationship_service, app.database, app.models.user, app.api.deps, app.models.knowledge_graph, app.services.entity_extraction_service, app.models.document, app.services.timeline_service
[ext_deps]: typing, datetime, fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.models.note_audio, app.database, app.services.note_service, app.models.user, app.schemas.tag, app.schemas.note, app.api.deps, app.services.space_service, app.models.note
[ext_deps]: os, datetime, fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.database, app.core.redis_url, app.tasks.pipeline_orchestrator, app.celery_app, app.models.document, app.api.deps, app.models.pipeline
...
[local_deps]: app.schemas.push, app.database, app.models.user, app.models.push_subscription, app.api.deps
[ext_deps]: os, fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.tasks.report_tasks, app.models.user, app.celery_app, app.api.deps, app.schemas.reports
...
[local_deps]: app.database, app.services.search_service, app.services.embed_client, app.services.input_guard, app.models.user, app.api.deps, app.models.document, app.services.search_models, app.services.search_agent
[ext_deps]: asyncio, fastapi, time, sqlalchemy, uuid, json, logging
...
[ext_deps]: hashlib, pydantic, fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.models.document, app.api.deps, app.database, app.models.user
[ext_deps]: fastapi, sqlalchemy, logging
...
[local_deps]: app.tasks.collection_report_tasks, app.schemas.smart_folder, app.database, app.models.user, app.models.smart_folder, app.schemas.collection, app.celery_app, app.tasks.smart_folder_tasks, app.api.deps, app.models.audit, app.models.note
[ext_deps]: typing, asyncio, fastapi, celery, sqlalchemy, uuid, json, logging
...
[local_deps]: app.database, app.models.user, app.schemas.tag, app.schemas.space, app.api.deps, app.tasks.space_tasks, app.services.space_service
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[local_deps]: app.services.llm_gateway, app.services.rollback_monitor, app.core.redis_url, app.models.user, app.tasks.pipeline_orchestrator, app.api.deps
...
[local_deps]: app.database, app.models.user, app.schemas.subscription, app.tasks.subscription_tasks, app.api.deps, app.models.subscription
[ext_deps]: fastapi, uuid, sqlalchemy, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.database, app.models.user, app.schemas.tag, app.services.task_service, app.api.deps, app.services.space_service, app.schemas.task
[ext_deps]: fastapi, uuid, sqlalchemy, logging
...
[ext_deps]: os, uuid, asyncio, fastapi, sqlalchemy, io, tempfile, logging
...
[ext_deps]: pathlib, urllib, os, pydantic, pydantic_settings, logging
...
[ext_deps]: base64, urllib, struct, os, cryptography, time, httpx, json, logging
...
[ext_deps]: collections, typing, dotenv, os, fastapi, sqlalchemy, pgvector
...
[local_deps]: app.middleware.transaction, app.limiter, app.database, app.services.prometheus_metrics, app.services.messaging, app.core.redis_url, app.middleware.rls, app.middleware.csrf, app.core.config, app.services.llm_http_client, app.api
[ext_deps]: collections, contextlib, starlette, typing, os, dotenv, redis, slowapi, threading, fastapi, sqlalchemy, uuid, uvicorn, time, logging
...
[local_deps]: app.services.cache_monitor, app.database, app.services.prometheus_metrics, app.services.monitoring, app.core.redis_url, app.services.embedding_service, app.api
[ext_deps]: contextlib, redis, os, datetime, dotenv, fastapi, httpx, sqlalchemy, uvicorn, time, logging
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[local_deps]: app.models.processing, app.models.pattern_insight, app.models.milestone, app.models.audit, app.models.knowledge_graph, app.models.pipeline, app.models.document, app.models.article, app.models.note, app.models.tag, app.models.note_audio, app.models.chat, app.models.space, app.models.failed_task, app.models.collection, app.models.task, app.models.user, app.models.push_subscription, app.models.base, app.models.bookmark, app.models.smart_folder, app.models.subscription

---
### FILE: backend/app/models/article.py
[local_deps]: app.models.document, app.models.base
[ext_deps]: sqlalchemy, pgvector, enum, uuid
...
[local_deps]: app.models.base
[ext_deps]: sqlalchemy, datetime, enum, uuid
...
[ext_deps]: tenacity, collections, typing, functools, asyncio, httpx, time, logging
...
[local_deps]: app.database
[ext_deps]: json, hashlib, functools, sqlalchemy
...
[local_deps]: app.schemas.smart_folder, app.schemas.pagination, app.schemas.token, app.schemas.admin, app.schemas.collection, app.schemas.document, app.schemas.search, app.schemas.chat, app.schemas.user
...
[ext_deps]: typing, datetime, pydantic, uuid, enum
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: typing, datetime, re, pydantic, uuid, enum
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.verification_agent, app.services.agents.agent_orchestrator, app.services.agents.researcher_agent, app.services.agents.clarification_agent, app.services.agents.answer_agent

---
### FILE: backend/app/services/agents/agent_orchestrator.py
[local_deps]: app.services.agents.researcher_agent, app.services.agents.verification_agent, app.services.agents.clarification_agent, app.services.agents.answer_agent
[ext_deps]: collections, typing, datetime, dataclasses, time, enum, logging
...
[local_deps]: app.services.llm_gateway, app.services.search_service, app.services.embed_client, app.services.graph_rag_service, app.services.knowledge_graph.models, app.services.agent_identity, app.services.knowledge_graph.pool, app.services.knowledge_graph.traversal
[ext_deps]: collections, typing, re, dataclasses, json, logging
...
[ext_deps]: hashlib, typing, asyncio, httpx, json, logging
...
[ext_deps]: typing, datetime, sqlalchemy, uuid, json, warnings, logging
...
[ext_deps]: typing, datetime, threading, json, logging
...
[local_deps]: app.models.chat, app.services.llm_gateway, app.database, app.services.prometheus_metrics, app.services.search_service, app.services.cache_monitor, app.models.user, app.services.agent_identity, app.services.pii_detection_service, app.services.context_block_service, app.models.document
[ext_deps]: collections, typing, re, asyncio, time, sqlalchemy, uuid, json, logging
...
[local_deps]: app.models.chat, app.services.llm_gateway, app.models.user, app.services.agent_identity, app.models.audit, app.services.context_block_service, app.models.document, app.models.collection
[ext_deps]: typing, sqlalchemy, uuid, json, logging
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.llm_gateway, app.services.search_service, app.services.intent_parser, app.models.user, app.schemas.collection, app.services.agent_identity, app.services.search_cache, app.models.document, app.models.collection
[ext_deps]: typing, datetime, asyncio, sqlalchemy, uuid, logging
...
[ext_deps]: hashlib, datetime, sqlalchemy, difflib, logging
...
[local_deps]: app.services.llm_gateway
[ext_deps]: typing, os, datetime, uuid, logging
...
[ext_deps]: traceback, typing, asyncio, threading, sqlalchemy, json, logging
...
[local_deps]: app.tasks.pipeline_tasks, app.models.pipeline, app.tasks.voice_tasks, app.models.user, app.tasks.pipeline_orchestrator, app.schemas.document, app.services.deduplication_service, app.models.audit, app.models.document, app.services.storage_service
[ext_deps]: typing, datetime, asyncio, fastapi, concurrent, sqlalchemy, json, logging
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: random, os, asyncio, httpx, time, logging
[fn]: _base_urls()
...
[ext_deps]: gc, typing, os, torch, sentence_transformers, numpy, asyncio, threading, psutil, logging
...
[ext_deps]: pathlib, onnxruntime, os, numpy, transformers, logging
...
[local_deps]: app.services.llm_gateway, app.services.rollback_monitor, app.services.agent_identity, app.models.knowledge_graph, app.models.document
[ext_deps]: typing, datetime, asyncio, sqlalchemy, json, warnings, logging
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity, app.models.knowledge_graph, app.services.context_block_service, app.models.document
[ext_deps]: collections, typing, re, sqlalchemy, logging
...
[ext_deps]: hashlib, redis, re, dataclasses, logging
...
[ext_deps]: enum, typing, datetime, re, json, warnings, logging
...
[ext_deps]: tenacity, collections, typing, datetime, os, httpx, json, logging
...
[ext_deps]: asyncpg, __future__, spacy, models, itertools, json, logging
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, pydantic, __future__, uuid, enum
...
[local_deps]: app.core.context, app.services.rollback_monitor, app.services.monitoring, app.services.user_quota, app.services.semantic_cache, app.services.llm_router
[ext_deps]: collections, typing, asyncio, time, logging
...
[local_deps]: app.services.kimi_service, app.services.pii_detection_service, app.services.ollama_service, app.services.minimax_service, app.services.openrouter_service
[ext_deps]: collections, typing, dataclasses, enum, logging
...
[ext_deps]: collections, nats, typing, os, asyncio, logging
...
[ext_deps]: collections, typing, os, httpx, json, logging
...
[ext_deps]: prometheus_client, subprocess, collections, typing, os, datetime, redis, re, dataclasses, threading, psutil, logging
...
[ext_deps]: PIL, paddleocr, typing, os, pytesseract, numpy, cv2, io, PyPDF2, time, enum, logging
...
[local_deps]: app.services.base_llm_service, app.services.llm_http_client
[ext_deps]: tenacity, collections, typing, os, httpx, json, logging
...
[local_deps]: app.services.cache_monitor, app.services.monitoring, app.services.openrouter_throttle, app.core.redis_url, app.services.llm_http_client
[ext_deps]: tenacity, hashlib, collections, typing, os, datetime, redis, asyncio, httpx, json, logging
[fn]: _get_redis_client()
...
[ext_deps]: typing, datetime, __future__, time, logging
...
[ext_deps]: typing, datetime, sentence_transformers, sqlalchemy, psutil, logging
...
[local_deps]: app.services.llm_gateway, app.models.user, app.services.agent_identity, app.models.knowledge_graph, app.models.document
...
[ext_deps]: collections, typing, functools, time, logging
...
[local_deps]: app.services.llm_gateway, app.services.rollback_monitor, app.services.monitoring, app.models.user, app.services.agent_identity, app.services.context_block_service, app.models.document, app.models.collection
[ext_deps]: io, reportlab, typing, datetime, os, sqlalchemy, uuid, logging
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.core.redis_url
[ext_deps]: collections, typing, datetime, os, redis, time, logging
[fn]: _get_redis()
...
[local_deps]: app.database, app.services.search_service, app.models.user, app.services.agent_identity, app.services.search_cache, app.services.context_block_service, app.models.document, app.services.llm_router
[ext_deps]: typing, re, asyncio, time, sqlalchemy, uuid, json, search_models, logging
...
[local_deps]: app.core.redis_url
[ext_deps]: hashlib, typing, redis, json, logging
[fn]: _get_redis()
...
[local_deps]: app.services.embed_client, app.models.user, app.services.pii_detection_service, app.services.search_cache, app.models.document, app.services.rerank_service
[ext_deps]: typing, re, asyncio, sqlalchemy, logging
...
[ext_deps]: hashlib, typing, __future__, numpy, time, json, logging
...
[ext_deps]: typing, re, numpy, sqlalchemy, logging
...
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.agent.planner, app.services.smart_folder.entity_resolver, app.models.user, app.models.smart_folder, app.services.smart_folder.query_parser, app.services.smart_folder.agent.executor, app.services.smart_folder.agent.synthesizer
[ext_deps]: typing, re, sqlalchemy, uuid, logging
...
[ext_deps]: typing, datetime, dataclasses, sqlalchemy, uuid, logging
...
[ext_deps]: typing, re, dataclasses, uuid, json, logging
...
[local_deps]: app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.base, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.sentiment_tracker
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.vault_search, app.services.smart_folder.skills.base, app.services.smart_folder.tools.chart_generator
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.retrieval, app.services.smart_folder.analysis, app.services.smart_folder.skills.base, app.services.smart_folder.tools.document_reader
...
[local_deps]: app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.citation_marker
...
[ext_deps]: csv, typing, re, io, json, logging
...
[local_deps]: app.services.llm_gateway, app.services.search_service, app.models.user, app.models.document, app.models.collection
[ext_deps]: typing, datetime, re, sqlalchemy, uuid, logging
...
[local_deps]: app.models.space, app.models.user, app.models.document, app.models.bookmark, app.models.tag, app.models.note
[ext_deps]: uuid, sqlalchemy, logging
[fn]: _escape_like(value)
...
[ext_deps]: base64, pathlib, os, datetime, cryptography, uuid, logging
...
[ext_deps]: collections, logging, contextlib, pathlib, typing, os, datetime, time, json, sys
...
[ext_deps]: nats, typing, datetime, abc, asyncio, uuid, json, enum, logging
...
[local_deps]: app.services.messaging
[ext_deps]: hashlib, nats, typing, datetime, dataclasses, time, json, enum, logging
...
[local_deps]: app.services.messaging
[ext_deps]: nats, typing, datetime, asyncio, dataclasses, uuid, json, enum, logging
...
[local_deps]: app.services.messaging
[ext_deps]: nats, typing, datetime, json, logging
...
[local_deps]: app.services.llm_gateway, app.services.rollback_monitor, app.services.agent_identity, app.models.knowledge_graph, app.services.context_block_service, app.models.document
[ext_deps]: collections, typing, datetime, sqlalchemy, json, logging
...
[ext_deps]: datetime, os, httpx, json, logging
...
[ext_deps]: PyPDF2, pathlib, sys, pptx, csv, typing, os, ebooklib, html, re, zipfile, xml, subprocess, json, docx, logging
...
[local_deps]: app.models.processing, app.services.cache_monitor, app.database, app.services.monitoring, app.core.redis_url, app.tasks.pipeline_orchestrator, app.celery_app, app.services.alert_service, app.models.document, app.tasks.base
[ext_deps]: redis, datetime, os, asyncio, celery, logging
...
[local_deps]: app.database, app.services.embed_client, app.models.document, app.models.article, app.services.article_generation_service, app.tasks.base
[ext_deps]: asyncio, celery, httpx, uuid, logging
...
[local_deps]: app.database, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.models.document, app.tasks.article_tasks, app.models.article
...
[ext_deps]: traceback, os, asyncio, psutil, logging
...
[local_deps]: app.database, app.services.report_service, app.models.user, app.models.audit, app.tasks.base
[ext_deps]: typing, asyncio, celery, sqlalchemy, uuid, json, logging
...
[local_deps]: app.models.processing, app.database, app.services.collection_service, app.services.embed_client, app.services.prometheus_metrics, app.services.dlq_service, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.services.text_extractor, app.services.entity_extraction_service, app.tasks.article_tasks, app.models.document, app.services.chunking_service, app.services.context_block_service, app.tasks.base, app.services.ocr_service
[ext_deps]: traceback, datetime, os, tempfile, asyncio, celery, sqlalchemy, uuid, langdetect, logging
...
[local_deps]: app.database, app.services.embed_client, app.celery_app, app.models.document, app.tasks.base
...
[local_deps]: app.database, app.core.redis_url, app.celery_app, app.models.document, app.models.pipeline
[ext_deps]: email, redis, os, datetime, sqlalchemy, smtplib, logging
[fn]: _smtp_configured()
...
[local_deps]: app.tasks.pipeline_tasks, app.database, app.core.redis_url, app.models.document, app.models.pipeline
[ext_deps]: redis, datetime, celery, uuid, logging
...
[local_deps]: app.database, app.core.redis_url, app.tasks.pipeline_orchestrator, app.celery_app, app.models.document, app.models.pipeline
[ext_deps]: redis, os, datetime, sqlalchemy, logging
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.database, app.tasks.document_tasks, app.services.embed_client, app.services.dlq_service, app.celery_app, app.models.document, app.services.knowledge_graph.extraction, app.tasks.article_tasks, app.services.entity_extraction_service, app.models.pipeline, app.services.chunking_service, app.services.knowledge_graph.pool, app.services.text_extractor, app.services.ocr_service
[ext_deps]: traceback, gc, os, datetime, asyncio, celery, uuid, time, tempfile, logging
...
[ext_deps]: openpyxl, os, datetime, celery, sqlalchemy, time, fpdf, logging
...
[local_deps]: app.database, app.models.user, app.models.smart_folder, app.services.smart_folder.agent_runner, app.models.audit, app.models.document, app.tasks.base, app.services.smart_folder_service
[ext_deps]: typing, datetime, asyncio, celery, sqlalchemy, uuid, json, logging
...
[ext_deps]: calendar, email, os, datetime, httpx, sqlalchemy, smtplib, logging
...
[ext_deps]: os, asyncio, sqlalchemy, tempfile, logging
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: collections, typing, functools, asyncio, threading, time, logging
...
[ext_deps]: jose, bcrypt, typing, os, datetime, dotenv, fastapi, sqlalchemy, logging
