...
[local_deps]: app.utils.security, app.models.document, app.models.user, app.services.whisper_service, app.celery_app, app.schemas.admin, app.schemas.user, app.models.chat, app.api.documents_common, app.services.storage_service, app.tasks.pipeline_tasks, app.database, app.services.alert_service, app.api.deps, app.tasks.pipeline_orchestrator, app.models.audit, app.models.pipeline, app.services.embed_client, app.models.processing, app.core.redis_url, app.models.article, app.models.failed_task
[ext_deps]: fastapi, uuid, datetime, logging, os, pydantic, sqlalchemy, redis, typing, concurrent, json, asyncio
...
[local_deps]: app.api.deps, app.tasks.article_tasks, app.models.document, app.models.user, app.schemas.article, app.models.article
...
[local_deps]: app.api.deps, app.utils.security, app.services.token_blacklist, app.schemas.token, app.schemas.auth, app.utils.constants, app.middleware.csrf, app.models.user, app.limiter, app.core.redis_url, app.database, app.schemas.user
[ext_deps]: hashlib, fastapi, uuid, secrets, datetime, time, logging, httpx, os, sqlalchemy, redis, dotenv
...
[local_deps]: app.api.deps, app.services.space_service, app.services.bookmark_service, app.schemas.bookmark, app.schemas.tag, app.models.user, app.database
[ext_deps]: logging, uuid, sqlalchemy, fastapi
...
[local_deps]: app.api.deps, app.models.chat, app.schemas.chat, app.models.user, app.limiter, app.services.input_guard, app.database, app.services.chat_service
[ext_deps]: fastapi, uuid, logging, sqlalchemy, json
...
[local_deps]: app.api.deps, app.schemas.collection, app.models.audit, app.models.collection, app.services.llm_gateway, app.models.user, app.tasks.document_tasks, app.services.input_guard, app.services.collection_service, app.database, app.models.article, app.services.collection_chat_service
[ext_deps]: fastapi, uuid, datetime, io, logging, sqlalchemy, typing, json, reportlab
...
[local_deps]: app.utils.security, app.services.token_blacklist, app.utils.constants, app.models.user, app.database
...
[local_deps]: app.api.deps, app.database, app.services.search_service, app.api.documents_journal, app.api.documents_common, app.tasks.pipeline_orchestrator, app.models.audit, app.services.storage_service, app.tasks.embedding_tasks, app.schemas.document, app.tasks.pipeline_tasks, app.models.document, app.models.pipeline, app.services.similarity_service, app.models.user, app.models.processing, app.tasks.document_tasks, app.api.documents_upload
[ext_deps]: fastapi, uuid, datetime, logging, sqlalchemy, typing, concurrent, asyncio
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.audit, app.schemas.document, app.tasks.pipeline_tasks, app.models.document, app.models.pipeline, app.models.user, app.core.redis_url
[ext_deps]: fastapi, uuid, datetime, logging, os, pydantic, sqlalchemy, redis, mimetypes, typing, concurrent, json, asyncio
...
[local_deps]: app.api.deps, app.api.documents_common, app.models.audit, app.services.storage_service, app.schemas.document, app.models.document, app.services.whisper_service, app.models.user, app.database
[ext_deps]: fastapi, tempfile, datetime, logging, os, sqlalchemy
...
[local_deps]: app.api.deps, app.services.deduplication_service, app.api.documents_common, app.services.document_orchestrator, app.models.audit, app.services.storage_service, app.schemas.document, app.models.document, app.models.user, app.database
...
[local_deps]: app.api.deps, app.services.temporal_reasoning_service, app.services.search_service, app.models.audit, app.services.graph_rag_service, app.models.document, app.services.synthesis_service, app.models.user, app.services.progressive_revelation_service, app.database
[ext_deps]: fastapi, uuid, logging, sqlalchemy, typing, json
...
[ext_deps]: fastapi, datetime, logging, httpx, os, sqlalchemy, redis, nats, typing, asyncio
...
[ext_deps]: fastapi, logging, os, sqlalchemy, hmac
...
[local_deps]: app.api.deps, app.models.knowledge_graph, app.services.timeline_service, app.services.entity_extraction_service, app.models.document, app.services.relationship_service, app.models.user, app.database
[ext_deps]: fastapi, uuid, datetime, logging, sqlalchemy, typing
...
[local_deps]: app.api.deps, app.models.note, app.services.space_service, app.services.note_service, app.schemas.tag, app.models.note_audio, app.models.user, app.schemas.note, app.database
[ext_deps]: fastapi, uuid, datetime, logging, os, sqlalchemy
...
[local_deps]: app.api.deps, app.tasks.pipeline_orchestrator, app.models.pipeline, app.models.document, app.celery_app, app.core.redis_url, app.database
...
[local_deps]: app.api.deps, app.models.push_subscription, app.models.user, app.database, app.schemas.push
[ext_deps]: fastapi, uuid, logging, os, sqlalchemy
...
[local_deps]: app.api.deps, app.tasks.report_tasks, app.schemas.reports, app.models.user, app.celery_app
[ext_deps]: logging, celery, typing, fastapi
...
[local_deps]: app.api.deps, app.services.search_service, app.models.document, app.services.search_models, app.models.user, app.services.input_guard, app.database, app.services.search_agent
[ext_deps]: fastapi, uuid, time, logging, sqlalchemy, json, asyncio
...
[ext_deps]: hashlib, fastapi, uuid, logging, pydantic, sqlalchemy
...
[local_deps]: app.api.deps, app.models.note, app.schemas.smart_folder, app.schemas.collection, app.tasks.smart_folder_tasks, app.models.audit, app.celery_app, app.models.user, app.database, app.tasks.collection_report_tasks, app.models.smart_folder
[ext_deps]: fastapi, uuid, logging, sqlalchemy, typing, celery, json, asyncio
...
[local_deps]: app.api.deps, app.services.space_service, app.schemas.space, app.tasks.space_tasks, app.schemas.tag, app.models.user, app.database
[ext_deps]: logging, uuid, sqlalchemy, fastapi
...
[local_deps]: app.api.deps, app.tasks.pipeline_orchestrator, app.services.llm_gateway, app.models.user, app.core.redis_url
...
[local_deps]: app.api.deps, app.schemas.subscription, app.models.subscription, app.tasks.subscription_tasks, app.models.user, app.database
[ext_deps]: logging, uuid, sqlalchemy, fastapi
[fn]: _parse_uuid(s)
...
[local_deps]: app.api.deps, app.services.task_service, app.services.space_service, app.schemas.tag, app.models.user, app.database, app.schemas.task
[ext_deps]: logging, uuid, sqlalchemy, fastapi
...
[local_deps]: app.api.deps, app.models.note, app.services.storage_service, app.models.document, app.services.whisper_service, app.models.note_audio, app.models.user
[ext_deps]: fastapi, tempfile, uuid, io, logging, os, sqlalchemy, asyncio
...
[ext_deps]: pydantic_settings, urllib, pathlib, logging, os, pydantic
...
[ext_deps]: struct, urllib, time, logging, httpx, os, cryptography, base64, json
...
[ext_deps]: fastapi, collections, os, sqlalchemy, dotenv, typing, pgvector
...
[local_deps]: app.middleware.rls, app.middleware.csrf, app.core.redis_url, app.limiter, app.services.messaging, app.database, app.services.prometheus_metrics, app.api, app.middleware.transaction
[ext_deps]: fastapi, collections, uuid, time, slowapi, logging, starlette, os, sqlalchemy, redis, dotenv, typing, threading, contextlib, uvicorn
...
[local_deps]: app.services.embedding_service, app.services.monitoring, app.services.cache_monitor, app.core.redis_url, app.database, app.services.prometheus_metrics, app.api
[ext_deps]: fastapi, time, datetime, logging, httpx, os, sqlalchemy, redis, dotenv, contextlib, uvicorn
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[local_deps]: app.utils.security
[ext_deps]: starlette, logging, sqlalchemy, dataclasses, jose
...
[local_deps]: app.models.knowledge_graph, app.models.note, app.models.collection, app.models.milestone, app.models.document, app.models.space, app.models.task, app.models.user, app.models.smart_folder, app.models.pattern_insight, app.models.base, app.models.subscription, app.models.tag, app.models.chat, app.models.note_audio, app.models.bookmark, app.models.audit, app.models.pipeline, app.models.push_subscription, app.models.processing, app.models.article, app.models.failed_task
...
[local_deps]: app.models.base
[ext_deps]: enum, uuid, sqlalchemy, datetime
...
[ext_deps]: collections, time, logging, httpx, tenacity, functools, typing, asyncio
...
[local_deps]: app.database
[ext_deps]: hashlib, json, sqlalchemy, functools
...
[local_deps]: app.schemas.smart_folder, app.schemas.collection, app.schemas.token, app.schemas.document, app.schemas.chat, app.schemas.pagination, app.schemas.search, app.schemas.admin, app.schemas.user
...
[ext_deps]: enum, uuid, pydantic, datetime
[class]: BookmarkBucket { methods: [] }
...
[ext_deps]: uuid, datetime, re, pydantic, typing, enum
[class]: UserRole { methods: [] }
...
[ext_deps]: openpyxl, xlrd, sys, json
...
[local_deps]: app.services.agents.verification_agent, app.services.agents.researcher_agent, app.services.agents.agent_orchestrator, app.services.agents.clarification_agent, app.services.agents.answer_agent
...
[ext_deps]: collections, time, datetime, logging, dataclasses, typing, enum
...
[ext_deps]: logging, re, dataclasses, typing, json
...
[local_deps]: app.services.search_service, app.services.graph_rag_service, app.services.agent_identity, app.services.llm_gateway, app.services.embed_client, app.services.knowledge_graph.pool, app.services.knowledge_graph.models, app.services.knowledge_graph.traversal
[ext_deps]: collections, logging, re, dataclasses, typing, json
...
[ext_deps]: hashlib, logging, httpx, typing, json, asyncio
...
[ext_deps]: uuid, datetime, warnings, logging, sqlalchemy, typing, json
...
[ext_deps]: logging, urllib, uuid, sqlalchemy
...
[ext_deps]: datetime, logging, typing, threading, json
...
[local_deps]: app.services.search_service, app.models.chat, app.services.context_block_service, app.services.agent_identity, app.services.llm_gateway, app.models.document, app.services.cache_monitor, app.models.user, app.services.llm_router, app.services.pii_detection_service, app.database, app.services.prometheus_metrics
[ext_deps]: collections, uuid, time, logging, re, sqlalchemy, typing, json, asyncio
...
[local_deps]: app.models.chat, app.services.context_block_service, app.models.audit, app.models.collection, app.services.agent_identity, app.services.llm_gateway, app.models.document, app.models.user
[ext_deps]: uuid, logging, sqlalchemy, typing, json
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.search_service, app.schemas.collection, app.models.collection, app.services.search_cache, app.services.agent_identity, app.models.document, app.services.llm_gateway, app.models.user, app.services.intent_parser
[ext_deps]: uuid, datetime, logging, sqlalchemy, typing, asyncio
...
[ext_deps]: hashlib, datetime, logging, sqlalchemy, difflib
...
[ext_deps]: traceback, logging, sqlalchemy, typing, threading, json, asyncio
...
[local_deps]: app.services.deduplication_service, app.tasks.pipeline_orchestrator, app.models.audit, app.services.storage_service, app.schemas.document, app.tasks.pipeline_tasks, app.models.document, app.models.pipeline, app.models.user, app.tasks.voice_tasks
[ext_deps]: fastapi, datetime, logging, sqlalchemy, typing, concurrent, json, asyncio
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: time, logging, httpx, os, random, asyncio
[fn]: _base_urls()
...
[ext_deps]: logging, os, gc, numpy, typing, torch, threading, psutil, sentence_transformers, asyncio
...
[ext_deps]: pathlib, transformers, logging, onnxruntime, os, numpy
...
[ext_deps]: datetime, warnings, logging, sqlalchemy, typing, json, asyncio
...
[local_deps]: app.models.knowledge_graph, app.services.context_block_service, app.services.agent_identity, app.services.llm_gateway, app.models.document
[ext_deps]: collections, logging, re, sqlalchemy, typing
...
[ext_deps]: hashlib, logging, re, redis, dataclasses
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: datetime, warnings, logging, re, typing, enum, json
...
[ext_deps]: collections, datetime, logging, httpx, os, tenacity, typing, json
...
[ext_deps]: spacy, itertools, models, __future__, logging, asyncpg, json
[fn]: _vec_to_str(vec)
...
[ext_deps]: uuid, __future__, datetime, pydantic, enum
...
[ext_deps]: models, __future__, logging, extraction, asyncpg, json
...
[ext_deps]: logging, collections, typing
...
[local_deps]: app.services.kimi_service, app.services.minimax_service, app.services.pii_detection_service, app.services.openrouter_service, app.services.ollama_service
[ext_deps]: collections, logging, dataclasses, typing, enum
...
[ext_deps]: collections, logging, os, nats, typing, asyncio
...
[ext_deps]: collections, logging, httpx, os, typing, json
...
[ext_deps]: collections, datetime, logging, re, os, subprocess, redis, dataclasses, prometheus_client, typing, threading, psutil
...
[ext_deps]: paddleocr, time, io, logging, os, pytesseract, PyPDF2, numpy, typing, enum, cv2, PIL
...
[local_deps]: app.services.base_llm_service
[ext_deps]: collections, logging, httpx, os, tenacity, typing, json
...
[local_deps]: app.core.redis_url, app.services.cache_monitor, app.services.monitoring
[ext_deps]: hashlib, collections, datetime, logging, httpx, os, tenacity, redis, typing, json, asyncio
[fn]: _get_redis_client()
...
[ext_deps]: datetime, logging, sqlalchemy, typing, psutil, sentence_transformers
...
[ext_deps]: collections, time, logging, functools, typing
...
[local_deps]: app.services.context_block_service, app.models.collection, app.services.agent_identity, app.models.document, app.services.llm_gateway, app.models.user
[ext_deps]: uuid, datetime, io, logging, os, sqlalchemy, typing, reportlab
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.search_service, app.services.context_block_service, app.services.search_cache, app.services.agent_identity, app.models.document, app.models.user, app.services.llm_router, app.database
[ext_deps]: uuid, time, logging, re, search_models, sqlalchemy, typing, json, asyncio
...
[local_deps]: app.services.rerank_service, app.services.search_cache, app.models.document, app.services.embed_client, app.models.user, app.services.pii_detection_service
[ext_deps]: logging, re, sqlalchemy, typing, asyncio
[class]: SearchResult { methods: [__init__] }
[fn]: _get_regconfig(language_code)
[class]: HybridSearchService { methods: [__init__, _get_user_bucket_filter, semantic_search, keyword_search, tag_search, _filename_search, article_semantic_search, _trigram_fallback_search, article_keyword_search, hybrid_search, _sanitize_tsquery, _keyword_search, _keyword_search_with_metadata, _get_highlighted_text, _get_bucket_filter_for_role, _search_bookmarks, _search_notes, _search_spaces, search_all_types, _search_documents_simple] }

---
### FILE: backend/app/services/silent_agent_loop.py
[ext_deps]: collections, logging, dataclasses, typing, json
...
[ext_deps]: logging, re, sqlalchemy, numpy, typing
...
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.retrieval, app.services.smart_folder.entity_resolver, app.services.smart_folder.analysis, app.services.smart_folder.query_parser
...
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.agent.planner, app.services.smart_folder.entity_resolver, app.models.user, app.services.smart_folder.agent.executor, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.query_parser, app.models.smart_folder
[ext_deps]: uuid, logging, re, sqlalchemy, typing
...
[ext_deps]: uuid, datetime, logging, sqlalchemy, dataclasses, typing
...
[ext_deps]: logging, sqlalchemy, dataclasses, typing, difflib
...
[local_deps]: app.services.llm_router
[ext_deps]: datetime, logging, dataclasses, typing, json
...
[ext_deps]: uuid, logging, re, dataclasses, typing, json
...
[local_deps]: app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.base, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.custom_query
...
[local_deps]: app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.skills.base, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.vault_search
[ext_deps]: logging, typing
...
[local_deps]: app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.refinement_parser
...
[ext_deps]: io, logging, re, csv, typing, json
...
[ext_deps]: uuid, datetime, logging, re, sqlalchemy, typing
...
[local_deps]: app.models.note, app.models.tag, app.models.document, app.models.space, app.models.user, app.models.bookmark
[ext_deps]: logging, uuid, sqlalchemy
[fn]: _escape_like(value)
...
[ext_deps]: logging, symspellpy, os, typing
[fn]: _get_symspell()
...
[ext_deps]: uuid, pathlib, datetime, logging, cryptography, os, base64
...
[ext_deps]: collections, pathlib, datetime, time, logging, os, sys, typing, contextlib, json
...
[ext_deps]: uuid, datetime, logging, nats, typing, abc, enum, json, asyncio
...
[local_deps]: app.services.messaging
[ext_deps]: hashlib, time, datetime, logging, dataclasses, nats, typing, enum, json
...
[local_deps]: app.services.messaging
[ext_deps]: uuid, datetime, logging, dataclasses, nats, typing, enum, json, asyncio
...
[local_deps]: app.models.knowledge_graph, app.services.context_block_service, app.services.agent_identity, app.services.llm_gateway, app.models.document
[ext_deps]: collections, datetime, logging, sqlalchemy, typing, json
...
[ext_deps]: datetime, logging, httpx, os, json
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: collections, datetime, logging, sqlalchemy, typing
...
[ext_deps]: ebooklib, zipfile, pathlib, xml, pptx, logging, re, os, subprocess, sys, html, docx, csv, PyPDF2, typing, json
...
[local_deps]: app.services.monitoring, app.tasks.pipeline_orchestrator, app.models.document, app.tasks.base, app.services.cache_monitor, app.celery_app, app.models.processing, app.core.redis_url, app.database, app.services.alert_service
[ext_deps]: datetime, logging, os, redis, celery, asyncio
...
[local_deps]: app.services.article_generation_service, app.models.document, app.services.embed_client, app.tasks.base, app.database, app.models.article
[ext_deps]: uuid, logging, httpx, celery, asyncio
...
[local_deps]: app.tasks.pipeline_orchestrator, app.tasks.embedding_tasks, app.tasks.article_tasks, app.models.document, app.database, app.models.article
...
[ext_deps]: traceback, logging, os, psutil, asyncio
...
[local_deps]: app.models.audit, app.tasks.base, app.services.report_service, app.models.user, app.database
[ext_deps]: uuid, logging, sqlalchemy, typing, celery, json, asyncio
...
[local_deps]: app.services.dlq_service, app.services.entity_extraction_service, app.services.context_block_service, app.tasks.pipeline_orchestrator, app.tasks.embedding_tasks, app.tasks.article_tasks, app.services.ocr_service, app.models.document, app.services.embed_client, app.tasks.base, app.services.chunking_service, app.services.text_extractor, app.models.processing, app.services.collection_service, app.database, app.services.prometheus_metrics
[ext_deps]: traceback, tempfile, uuid, datetime, logging, os, sqlalchemy, celery, langdetect, asyncio
...
[ext_deps]: sentence_transformers, logging, uuid, time
...
[local_deps]: app.models.pipeline, app.models.document, app.celery_app, app.core.redis_url, app.database
[ext_deps]: email, datetime, logging, os, sqlalchemy, redis, smtplib
[fn]: _smtp_configured()
...
[local_deps]: app.tasks.pipeline_tasks, app.models.document, app.models.pipeline, app.core.redis_url, app.database
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.pipeline, app.models.document, app.celery_app, app.core.redis_url, app.database
[ext_deps]: datetime, logging, os, sqlalchemy, redis
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.dlq_service, app.services.entity_extraction_service, app.tasks.article_tasks, app.services.ocr_service, app.models.document, app.models.pipeline, app.services.chunking_service, app.services.embed_client, app.celery_app, app.services.text_extractor, app.services.knowledge_graph.pool, app.tasks.document_tasks, app.database, app.services.knowledge_graph.extraction
[ext_deps]: traceback, tempfile, uuid, time, datetime, logging, os, gc, celery, asyncio
...
[ext_deps]: time, datetime, openpyxl, logging, os, sqlalchemy, fpdf, celery
...
[local_deps]: app.models.audit, app.services.smart_folder_service, app.models.document, app.tasks.base, app.services.smart_folder.agent_runner, app.models.user, app.database, app.models.smart_folder
[ext_deps]: uuid, datetime, logging, sqlalchemy, typing, celery, json, asyncio
...
[ext_deps]: logging, celery, sqlalchemy, asyncio
...
[ext_deps]: email, datetime, logging, httpx, os, sqlalchemy, smtplib, calendar
...
[local_deps]: app.services.task_service, app.models.push_subscription, app.models.task, app.celery_app, app.database, app.core.push
...
[ext_deps]: tempfile, logging, os, sqlalchemy, asyncio
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: collections, time, logging, functools, typing, threading, asyncio
...
[ext_deps]: fastapi, datetime, logging, os, sqlalchemy, dotenv, bcrypt, typing, jose
