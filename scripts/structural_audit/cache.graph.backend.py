...
[local_deps]: app.models.chat, app.schemas.user, app.services.alert_service, app.services.whisper_service, app.schemas.admin, app.models.article, app.tasks.document_tasks, app.models.pipeline, app.models.processing, app.core.redis_url, app.models.failed_task, app.database, app.api.deps, app.models.audit, app.utils.security, app.models.user, app.models.document
[ext_deps]: json, fastapi, redis, uuid, os, logging, sqlalchemy, datetime, typing
...
[local_deps]: app.tasks.article_tasks, app.schemas.article, app.models.article, app.api.deps, app.models.user, app.models.document
...
[local_deps]: app.limiter, app.schemas.user, app.middleware.csrf, app.schemas.token, app.services.token_blacklist, app.utils.constants, app.core.redis_url, app.database, app.api.deps, app.schemas.auth, app.utils.security, app.models.user
[ext_deps]: redis, fastapi, dotenv, uuid, secrets, hashlib, os, logging, httpx, sqlalchemy, datetime, time
...
[local_deps]: app.services.space_service, app.schemas.bookmark, app.schemas.tag, app.services.bookmark_service, app.database, app.api.deps, app.models.user
[ext_deps]: logging, uuid, sqlalchemy, fastapi
...
[local_deps]: app.limiter, app.models.chat, app.database, app.services.chat_service, app.api.deps, app.services.input_guard, app.models.user, app.schemas.chat
...
[local_deps]: app.models.article, app.tasks.document_tasks, app.services.collection_chat_service, app.models.collection, app.database, app.api.deps, app.services.input_guard, app.services.llm_gateway, app.services.collection_service, app.models.audit, app.models.user, app.schemas.collection
[ext_deps]: json, fastapi, uuid, io, logging, sqlalchemy, datetime, reportlab, typing
...
[local_deps]: app.utils.constants, app.services.token_blacklist, app.database, app.utils.security, app.models.user
...
[local_deps]: app.schemas.document, app.tasks.document_tasks, app.models.pipeline, app.tasks.embedding_tasks, app.services.storage_service, app.models.processing, app.database, app.services.similarity_service, app.api.documents_upload, app.api.documents_common, app.api.documents_journal, app.models.audit, app.models.user, app.models.document, app.api.deps
[ext_deps]: fastapi, uuid, logging, sqlalchemy, datetime, typing
...
[local_deps]: app.schemas.document, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.pipeline, app.models.audit, app.models.user, app.models.document
[ext_deps]: json, datetime, fastapi, pydantic, uuid, os, concurrent, logging, sqlalchemy, asyncio, typing
...
[local_deps]: app.services.whisper_service, app.schemas.document, app.database, app.api.deps, app.api.documents_common, app.models.audit, app.models.user, app.models.document, app.services.storage_service
[ext_deps]: fastapi, tempfile, os, logging, sqlalchemy, datetime
...
[local_deps]: app.schemas.document, app.database, app.services.deduplication_service, app.api.deps, app.api.documents_common, app.services.document_orchestrator, app.models.audit, app.models.user, app.models.document, app.services.storage_service
...
[local_deps]: app.services.synthesis_service, app.services.progressive_revelation_service, app.services.search_service, app.database, app.services.graph_rag_service, app.api.deps, app.services.temporal_reasoning_service, app.models.audit, app.models.user, app.models.document
...
[ext_deps]: fastapi, redis, os, asyncio, nats, logging, httpx, sqlalchemy, datetime, typing
...
[ext_deps]: fastapi, hmac, os, logging, sqlalchemy
...
[local_deps]: app.services.relationship_service, app.services.timeline_service, app.services.entity_extraction_service, app.database, app.api.deps, app.models.knowledge_graph, app.models.user, app.models.document
[ext_deps]: fastapi, uuid, logging, sqlalchemy, datetime, typing
...
[local_deps]: app.services.space_service, app.models.note, app.schemas.note, app.services.note_service, app.models.note_audio, app.schemas.tag, app.database, app.api.deps, app.models.user
[ext_deps]: fastapi, uuid, os, logging, sqlalchemy, datetime
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.pipeline, app.celery_app, app.core.redis_url, app.database, app.api.deps, app.models.document
...
[local_deps]: app.celery_app, app.schemas.reports, app.api.deps, app.tasks.report_tasks, app.models.user
...
[local_deps]: app.services.search_models, app.services.search_service, app.services.search_agent, app.database, app.api.deps, app.services.input_guard, app.models.user, app.models.document
[ext_deps]: json, fastapi, uuid, logging, time, sqlalchemy, asyncio
...
[ext_deps]: fastapi, pydantic, uuid, hashlib, logging, sqlalchemy
...
[local_deps]: app.schemas.smart_folder, app.models.note, app.tasks.collection_report_tasks, app.celery_app, app.models.smart_folder, app.database, app.api.deps, app.tasks.smart_folder_tasks, app.models.audit, app.models.user, app.schemas.collection
[ext_deps]: json, fastapi, uuid, celery, logging, sqlalchemy, asyncio, typing
...
[local_deps]: app.services.space_service, app.tasks.space_tasks, app.schemas.tag, app.database, app.api.deps, app.models.user, app.schemas.space
[ext_deps]: logging, uuid, sqlalchemy, fastapi
...
[local_deps]: app.services.whisper_service, app.models.note, app.models.note_audio, app.api.deps, app.models.user, app.models.document, app.services.storage_service
[ext_deps]: fastapi, uuid, tempfile, io, os, logging, sqlalchemy, asyncio
...
[ext_deps]: pydantic, pathlib, os, urllib, logging, pydantic_settings
...
[ext_deps]: pgvector, fastapi, dotenv, os, collections, sqlalchemy, typing
...
[local_deps]: app.limiter, app.middleware.rls, app.middleware.csrf, app.api, app.services.messaging, app.middleware.transaction, app.services.prometheus_metrics, app.core.redis_url, app.database
[ext_deps]: contextlib, fastapi, redis, starlette, dotenv, uuid, uvicorn, os, collections, slowapi, logging, threading, time, sqlalchemy, typing
...
[local_deps]: app.api, app.services.monitoring, app.services.prometheus_metrics, app.services.cache_monitor, app.services.embedding_service, app.core.redis_url, app.database
[ext_deps]: httpx, contextlib, fastapi, redis, dotenv, uvicorn, os, logging, time, sqlalchemy, datetime
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: starlette, jose, dataclasses, logging, sqlalchemy
...
[local_deps]: app.models.knowledge_graph, app.models.chat, app.models.article, app.models.note, app.models.pipeline, app.models.base, app.models.bookmark, app.models.user, app.models.space, app.models.pattern_insight, app.models.collection, app.models.note_audio, app.models.processing, app.models.smart_folder, app.models.failed_task, app.models.milestone, app.models.tag, app.models.audit, app.models.document
...
[ext_deps]: httpx, tenacity, functools, collections, logging, time, asyncio, typing
...
[local_deps]: app.schemas.user, app.schemas.document, app.schemas.admin, app.schemas.token, app.schemas.search, app.schemas.pagination, app.schemas.collection, app.schemas.smart_folder, app.schemas.chat
...
[ext_deps]: pydantic, enum, uuid, datetime, typing
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: pydantic, enum, uuid, re, datetime, typing
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.answer_agent, app.services.agents.researcher_agent, app.services.agents.verification_agent, app.services.agents.clarification_agent, app.services.agents.agent_orchestrator
...
[ext_deps]: enum, collections, dataclasses, logging, time, datetime, typing
...
[local_deps]: app.services.embed_client, app.services.knowledge_graph.traversal, app.services.search_service, app.services.knowledge_graph.models, app.services.knowledge_graph.pool, app.services.llm_gateway, app.services.graph_rag_service, app.services.agent_identity
[ext_deps]: json, dataclasses, collections, re, logging, typing
...
[local_deps]: app.services.llm_gateway
[ext_deps]: json, hashlib, logging, asyncio, typing
...
[ext_deps]: json, warnings, uuid, logging, sqlalchemy, datetime, typing
...
[local_deps]: app.models.chat, app.services.llm_router, app.services.pii_detection_service, app.services.prometheus_metrics, app.services.search_service, app.services.cache_monitor, app.database, app.services.llm_gateway, app.services.context_block_service, app.services.agent_identity, app.models.user, app.models.document
[ext_deps]: json, uuid, collections, re, logging, time, sqlalchemy, asyncio, typing
...
[local_deps]: app.models.chat, app.models.collection, app.services.llm_gateway, app.services.context_block_service, app.models.audit, app.services.agent_identity, app.models.user, app.models.document
...
[local_deps]: app.services.search_cache, app.models.collection, app.services.search_service, app.services.intent_parser, app.schemas.collection, app.services.llm_gateway, app.services.agent_identity, app.models.user, app.models.document
[ext_deps]: uuid, asyncio, logging, sqlalchemy, datetime, typing
...
[ext_deps]: difflib, hashlib, logging, sqlalchemy, datetime
...
[ext_deps]: json, traceback, logging, threading, sqlalchemy, asyncio, typing
...
[local_deps]: app.schemas.document, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.pipeline, app.tasks.voice_tasks, app.services.deduplication_service, app.services.storage_service, app.models.audit, app.models.user, app.models.document
[ext_deps]: fastapi, asyncio, concurrent, logging, sqlalchemy, datetime, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: httpx, os, itertools, logging, time, asyncio
[fn]: _base_urls()
[fn]: _base_url()
...
[ext_deps]: torch, sentence_transformers, numpy, psutil, os, logging, threading, asyncio, gc, typing
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.models.document, app.services.llm_gateway
[ext_deps]: json, warnings, asyncio, logging, sqlalchemy, datetime, typing
...
[local_deps]: app.services.llm_gateway, app.services.context_block_service, app.models.knowledge_graph, app.services.agent_identity, app.models.document
[ext_deps]: collections, re, logging, sqlalchemy, typing
...
[ext_deps]: redis, hashlib, dataclasses, re, logging
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: json, warnings, enum, re, logging, datetime, typing
...
[ext_deps]: json, tenacity, os, collections, logging, httpx, datetime, typing
...
[ext_deps]: json, spacy, asyncpg, models, __future__, itertools, logging
[fn]: _vec_to_str(vec)
...
[ext_deps]: json, asyncpg, models, __future__, extraction, logging
...
[ext_deps]: enum, collections, dataclasses, logging, typing
...
[ext_deps]: json, os, collections, logging, httpx, typing
...
[ext_deps]: redis, psutil, prometheus_client, os, collections, dataclasses, re, subprocess, logging, threading, datetime, typing
...
[ext_deps]: enum, pytesseract, PIL, paddleocr, PyPDF2, numpy, io, cv2, os, logging, time, typing
...
[local_deps]: app.services.base_llm_service
[ext_deps]: json, tenacity, os, collections, logging, httpx, typing
...
[ext_deps]: json, redis, hashlib, os, collections, logging, httpx, datetime, typing
...
[ext_deps]: sentence_transformers, psutil, logging, sqlalchemy, datetime, typing
...
[ext_deps]: functools, collections, logging, time, typing
...
[local_deps]: app.models.collection, app.services.llm_gateway, app.services.context_block_service, app.services.agent_identity, app.models.user, app.models.document
[ext_deps]: uuid, io, os, logging, sqlalchemy, datetime, reportlab, typing
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.search_cache, app.services.llm_router, app.services.search_service, app.database, app.services.context_block_service, app.services.agent_identity, app.models.user, app.models.document
[ext_deps]: json, uuid, search_models, re, logging, time, sqlalchemy, asyncio, typing
...
[local_deps]: app.core.redis_url
[ext_deps]: json, redis, hashlib, logging, typing
[fn]: _get_redis()
...
[local_deps]: app.services.search_cache, app.services.embed_client, app.services.rerank_service, app.services.pii_detection_service, app.models.user, app.models.document
...
[ext_deps]: numpy, re, logging, sqlalchemy, typing
...
[local_deps]: app.services.smart_folder.entity_resolver, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.agent.executor, app.models.smart_folder, app.services.smart_folder.agent.planner, app.services.smart_folder.agent.synthesizer, app.models.user
...
[ext_deps]: uuid, dataclasses, logging, sqlalchemy, datetime, typing
...
[ext_deps]: difflib, dataclasses, logging, sqlalchemy, typing
...
[local_deps]: app.services.llm_router
[ext_deps]: json, dataclasses, logging, datetime, typing
...
[ext_deps]: json, uuid, dataclasses, re, logging, typing
...
[local_deps]: app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.base, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.sentiment_tracker
...
[local_deps]: app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.skills.base, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer
[ext_deps]: logging, typing
...
[local_deps]: app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.trend_analyzer

---
### FILE: backend/app/services/smart_folder/tools/asset_reader.py
[local_deps]: app.models.document
[ext_deps]: logging, uuid, sqlalchemy, typing
...
[ext_deps]: json, csv, io, re, logging, typing
...
[ext_deps]: uuid, re, logging, sqlalchemy, datetime, typing
...
[local_deps]: app.models.note, app.models.user, app.models.bookmark, app.models.tag, app.models.space, app.models.document
[ext_deps]: logging, uuid, sqlalchemy
[fn]: _escape_like(value)
...
[ext_deps]: base64, uuid, pathlib, os, logging, cryptography, datetime
...
[ext_deps]: json, contextlib, pathlib, os, collections, logging, sys, datetime, time, typing
...
[ext_deps]: json, datetime, enum, uuid, nats, logging, asyncio, abc, typing
...
[local_deps]: app.services.messaging
[ext_deps]: json, enum, hashlib, nats, dataclasses, logging, time, datetime, typing
...
[local_deps]: app.services.messaging
[ext_deps]: json, datetime, enum, uuid, nats, dataclasses, logging, asyncio, typing
...
[local_deps]: app.services.messaging
[ext_deps]: json, nats, logging, datetime, typing
...
[local_deps]: app.services.llm_gateway, app.services.context_block_service, app.models.knowledge_graph, app.services.agent_identity, app.models.document
[ext_deps]: json, collections, logging, sqlalchemy, datetime, typing
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: collections, logging, sqlalchemy, datetime, typing
...
[ext_deps]: json, docx, openpyxl, csv, PyPDF2, pptx, pathlib, xml, zipfile, html, subprocess, re, ebooklib, logging, typing
...
[local_deps]: app.services.alert_service, app.services.monitoring, app.tasks.document_tasks, app.tasks.base, app.celery_app, app.models.processing, app.services.cache_monitor, app.core.redis_url, app.database, app.models.document
[ext_deps]: redis, celery, os, asyncio, logging, datetime
...
[local_deps]: app.services.embed_client, app.models.article, app.tasks.base, app.services.article_generation_service, app.database, app.models.document
[ext_deps]: uuid, celery, logging, httpx, asyncio
...
[local_deps]: app.tasks.article_tasks, app.models.article, app.tasks.document_tasks, app.tasks.embedding_tasks, app.database, app.models.document
...
[ext_deps]: json, uuid, celery, logging, sqlalchemy, asyncio, typing
...
[local_deps]: app.tasks.article_tasks, app.services.embed_client, app.services.text_extractor, app.tasks.base, app.services.entity_extraction_service, app.tasks.embedding_tasks, app.models.processing, app.services.prometheus_metrics, app.services.context_block_service, app.services.chunking_service, app.database, app.services.ocr_service, app.services.dlq_service, app.services.collection_service, app.models.document
[ext_deps]: traceback, uuid, langdetect, celery, tempfile, asyncio, os, logging, sqlalchemy, datetime
...
[local_deps]: app.tasks.pipeline_tasks, app.models.pipeline, app.core.redis_url, app.database
[ext_deps]: logging, datetime, redis, celery
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.pipeline, app.celery_app, app.core.redis_url, app.database, app.models.document
[ext_deps]: redis, os, logging, sqlalchemy, datetime
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.tasks.article_tasks, app.services.embed_client, app.services.text_extractor, app.tasks.document_tasks, app.models.pipeline, app.services.entity_extraction_service, app.celery_app, app.services.knowledge_graph.extraction, app.services.chunking_service, app.database, app.services.ocr_service, app.services.dlq_service, app.services.knowledge_graph.pool, app.models.document
[ext_deps]: traceback, datetime, uuid, celery, tempfile, os, logging, time, asyncio, gc
...
[ext_deps]: openpyxl, celery, os, fpdf, logging, time, sqlalchemy, datetime
...
[local_deps]: app.services.smart_folder.agent_runner, app.tasks.base, app.services.smart_folder_service, app.models.smart_folder, app.database, app.models.audit, app.models.user, app.models.document
[ext_deps]: json, datetime, uuid, celery, logging, sqlalchemy, asyncio, typing
...
[ext_deps]: functools, collections, logging, threading, time, asyncio, typing
...
[ext_deps]: fastapi, dotenv, bcrypt, jose, os, logging, sqlalchemy, datetime, typing
