...
[local_deps]: app.services.embed_client, app.schemas.admin, app.database, app.tasks.pipeline_orchestrator, app.services.alert_service, app.models.processing, app.services.search_service, app.models.failed_task, app.services.whisper_service, app.models.article, app.models.chat, app.schemas.user, app.models.pipeline, app.models.user, app.celery_app, app.api.documents_common, app.core.redis_url, app.models.audit, app.models.document, app.services.storage_service, app.utils.security, app.api.deps, app.tasks.pipeline_tasks
[ext_deps]: pydantic, concurrent, logging, sqlalchemy, json, time, datetime, uuid, asyncio, redis, fastapi, os, typing
...
[local_deps]: app.api.deps, app.models.article, app.models.user, app.schemas.article, app.models.document, app.tasks.article_tasks
...
[local_deps]: app.utils.constants, app.schemas.user, app.utils.security, app.api.deps, app.schemas.token, app.schemas.auth, app.core.redis_url, app.database, app.limiter, app.models.user, app.middleware.csrf, app.services.token_blacklist
[ext_deps]: logging, sqlalchemy, dotenv, time, hashlib, datetime, uuid, redis, fastapi, httpx, os, secrets
...
[local_deps]: app.api.deps, app.schemas.bookmark, app.services.bookmark_service, app.database, app.models.user, app.services.space_service, app.schemas.tag
[ext_deps]: sqlalchemy, logging, uuid, fastapi
...
[local_deps]: app.api.deps, app.schemas.chat, app.database, app.models.chat, app.limiter, app.models.user, app.services.chat_service, app.services.input_guard
[ext_deps]: sqlalchemy, logging, json, uuid, fastapi
...
[local_deps]: app.services.collection_chat_service, app.api.deps, app.schemas.collection, app.models.article, app.services.llm_gateway, app.services.collection_service, app.database, app.models.user, app.models.collection, app.tasks.document_tasks, app.models.audit, app.services.input_guard
[ext_deps]: logging, sqlalchemy, json, datetime, uuid, io, reportlab, fastapi, typing
...
[local_deps]: app.utils.constants, app.utils.security, app.database, app.models.user, app.services.token_blacklist
...
[local_deps]: app.models.processing, app.api.deps, app.schemas.document, app.tasks.pipeline_tasks, app.services.search_service, app.api.documents_upload, app.tasks.embedding_tasks, app.api.documents_journal, app.models.pipeline, app.database, app.models.user, app.services.similarity_service, app.api.documents_common, app.tasks.document_tasks, app.models.audit, app.models.document, app.tasks.pipeline_orchestrator, app.services.storage_service
[ext_deps]: concurrent, logging, sqlalchemy, time, datetime, uuid, asyncio, fastapi, typing
...
[local_deps]: app.schemas.document, app.tasks.pipeline_tasks, app.models.pipeline, app.models.user, app.core.redis_url, app.models.audit, app.models.document, app.tasks.pipeline_orchestrator
[ext_deps]: typing, pydantic, logging, sqlalchemy, concurrent, json, datetime, uuid, asyncio, redis, fastapi, os, mimetypes
...
[local_deps]: app.api.deps, app.schemas.document, app.services.whisper_service, app.database, app.models.user, app.api.documents_common, app.models.audit, app.models.document, app.services.storage_service
[ext_deps]: logging, sqlalchemy, datetime, fastapi, tempfile, os
...
[local_deps]: app.api.deps, app.schemas.document, app.services.document_orchestrator, app.database, app.models.user, app.api.documents_common, app.models.audit, app.models.document, app.services.deduplication_service, app.services.storage_service
[ext_deps]: sqlalchemy, logging, uuid, fastapi, typing
...
[local_deps]: app.api.deps, app.services.search_service, app.services.synthesis_service, app.services.temporal_reasoning_service, app.services.graph_rag_service, app.database, app.models.user, app.models.audit, app.models.document, app.services.progressive_revelation_service
[ext_deps]: logging, sqlalchemy, json, uuid, fastapi, typing
...
[ext_deps]: logging, sqlalchemy, nats, datetime, asyncio, redis, fastapi, httpx, os, typing
...
[local_deps]: app.database, app.api.documents_upload, app.schemas.document, app.models.user
[ext_deps]: sqlalchemy, logging, fastapi, hmac, os
...
[local_deps]: app.api.deps, app.services.entity_extraction_service, app.models.knowledge_graph, app.database, app.models.user, app.services.timeline_service, app.services.relationship_service, app.models.document
[ext_deps]: sqlalchemy, logging, datetime, uuid, fastapi, typing
...
[local_deps]: app.services.note_service, app.api.deps, app.models.note_audio, app.database, app.models.user, app.models.note, app.services.space_service, app.schemas.tag, app.schemas.note
[ext_deps]: sqlalchemy, logging, datetime, uuid, fastapi, os
...
[local_deps]: app.api.deps, app.models.pipeline, app.database, app.celery_app, app.core.redis_url, app.models.document, app.tasks.pipeline_orchestrator
...
[local_deps]: app.models.push_subscription, app.schemas.push, app.api.deps, app.database, app.models.user
[ext_deps]: sqlalchemy, logging, uuid, fastapi, os
...
[local_deps]: app.schemas.reports, app.api.deps, app.models.user, app.tasks.report_tasks, app.celery_app
...
[local_deps]: app.services.search_agent, app.api.deps, app.services.input_guard, app.services.embed_client, app.services.search_service, app.services.search_models, app.database, app.models.user, app.models.document
[ext_deps]: logging, sqlalchemy, json, time, uuid, asyncio, fastapi
...
[ext_deps]: pydantic, logging, sqlalchemy, hashlib, uuid, fastapi
...
[local_deps]: app.models.smart_folder, app.api.deps, app.schemas.collection, app.tasks.smart_folder_tasks, app.schemas.smart_folder, app.database, app.models.user, app.celery_app, app.models.note, app.models.audit, app.tasks.collection_report_tasks
[ext_deps]: logging, sqlalchemy, celery, json, uuid, asyncio, fastapi, typing
...
[local_deps]: app.schemas.space, app.api.deps, app.database, app.models.user, app.services.space_service, app.tasks.space_tasks, app.schemas.tag
[ext_deps]: sqlalchemy, logging, uuid, fastapi
...
[local_deps]: app.api.deps, app.services.llm_gateway, app.models.user, app.core.redis_url, app.tasks.pipeline_orchestrator
...
[local_deps]: app.api.deps, app.models.subscription, app.database, app.models.user, app.tasks.subscription_tasks, app.schemas.subscription
[ext_deps]: sqlalchemy, logging, uuid, fastapi
[fn]: _parse_uuid(s)
...
[local_deps]: app.api.deps, app.services.task_service, app.schemas.task, app.database, app.models.user, app.services.space_service, app.schemas.tag
[ext_deps]: sqlalchemy, logging, uuid, fastapi
...
[local_deps]: app.api.deps, app.models.note_audio, app.services.whisper_service, app.models.user, app.models.note, app.models.document, app.services.storage_service
[ext_deps]: logging, sqlalchemy, uuid, io, asyncio, tempfile, fastapi, os
...
[ext_deps]: pydantic, logging, pathlib, pydantic_settings, urllib, os
...
[ext_deps]: logging, json, time, os, urllib, cryptography, struct, httpx, base64
...
[ext_deps]: sqlalchemy, dotenv, pgvector, fastapi, collections, os, typing
...
[local_deps]: app.services.prometheus_metrics, app.services.llm_http_client, app.middleware.rls, app.core.redis_url, app.database, app.limiter, app.core.config, app.middleware.transaction, app.middleware.csrf, app.services.messaging, app.api
[ext_deps]: contextlib, logging, threading, sqlalchemy, dotenv, starlette, uvicorn, time, uuid, redis, fastapi, slowapi, collections, os, typing
...
[local_deps]: app.services.embedding_service, app.services.prometheus_metrics, app.database, app.services.monitoring, app.core.redis_url, app.services.cache_monitor, app.api
[ext_deps]: contextlib, logging, sqlalchemy, uvicorn, dotenv, time, datetime, redis, fastapi, httpx, os
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: starlette, sqlalchemy, logging, dataclasses, jose
...
[local_deps]: app.models.base, app.models.knowledge_graph, app.models.subscription, app.models.space, app.models.processing, app.models.smart_folder, app.models.bookmark, app.models.failed_task, app.models.task, app.models.article, app.models.chat, app.models.pipeline, app.models.tag, app.models.user, app.models.collection, app.models.note, app.models.audit, app.models.document, app.models.milestone, app.models.push_subscription, app.models.note_audio, app.models.pattern_insight
...
[local_deps]: app.models.base
[ext_deps]: datetime, sqlalchemy, uuid, enum
...
[ext_deps]: logging, time, asyncio, functools, tenacity, collections, typing, httpx
...
[local_deps]: app.database
[ext_deps]: json, hashlib, sqlalchemy, functools
...
[local_deps]: app.schemas.user, app.schemas.document, app.schemas.pagination, app.schemas.token, app.schemas.collection, app.schemas.admin, app.schemas.chat, app.schemas.smart_folder, app.schemas.search
...
[ext_deps]: pydantic, datetime, uuid, typing, enum
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: pydantic, datetime, uuid, re, typing, enum
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.clarification_agent, app.services.agents.agent_orchestrator, app.services.agents.answer_agent, app.services.agents.researcher_agent, app.services.agents.verification_agent
...
[ext_deps]: logging, time, datetime, dataclasses, collections, typing, enum
...
[ext_deps]: logging, json, dataclasses, re, typing
...
[local_deps]: app.services.embed_client, app.services.search_service, app.services.knowledge_graph.pool, app.services.llm_gateway, app.services.graph_rag_service, app.services.agent_identity, app.services.knowledge_graph.models, app.services.knowledge_graph.traversal
...
[ext_deps]: logging, json, hashlib, asyncio, httpx, typing
...
[ext_deps]: logging, sqlalchemy, json, datetime, uuid, typing, warnings
...
[ext_deps]: threading, logging, json, datetime, typing
...
[local_deps]: app.services.prometheus_metrics, app.services.search_service, app.services.context_block_service, app.services.pii_detection_service, app.services.llm_gateway, app.models.user, app.models.chat, app.database, app.models.document, app.services.agent_identity, app.services.cache_monitor
[ext_deps]: logging, sqlalchemy, json, time, uuid, asyncio, re, collections, typing
...
[local_deps]: app.models.document, app.services.context_block_service, app.services.llm_gateway, app.models.user, app.models.chat, app.models.collection, app.models.audit, app.services.agent_identity
[ext_deps]: logging, sqlalchemy, json, uuid, typing
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.intent_parser, app.schemas.collection, app.services.search_service, app.services.llm_gateway, app.models.user, app.models.collection, app.services.search_cache, app.models.document, app.services.agent_identity
[ext_deps]: logging, sqlalchemy, datetime, uuid, asyncio, typing
...
[ext_deps]: datetime, logging, redis, sqlalchemy
[fn]: _get_redis()
...
[ext_deps]: difflib, logging, sqlalchemy, datetime, hashlib
...
[local_deps]: app.services.llm_gateway
[ext_deps]: logging, datetime, uuid, os, typing
...
[ext_deps]: threading, logging, sqlalchemy, json, asyncio, traceback, typing
...
[local_deps]: app.schemas.document, app.tasks.pipeline_tasks, app.models.pipeline, app.models.user, app.tasks.voice_tasks, app.models.audit, app.models.document, app.tasks.pipeline_orchestrator, app.services.deduplication_service, app.services.storage_service
[ext_deps]: concurrent, logging, sqlalchemy, json, datetime, asyncio, fastapi, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: logging, random, time, asyncio, httpx, os
[fn]: _base_urls()
...
[ext_deps]: threading, logging, gc, sentence_transformers, numpy, asyncio, torch, os, typing, psutil
...
[ext_deps]: logging, pathlib, numpy, transformers, os, onnxruntime
...
[local_deps]: app.services.llm_gateway, app.models.document, app.models.knowledge_graph, app.services.agent_identity
[ext_deps]: logging, sqlalchemy, json, datetime, asyncio, typing, warnings
...
[local_deps]: app.models.knowledge_graph, app.services.context_block_service, app.services.llm_gateway, app.models.document, app.services.agent_identity
...
[ext_deps]: logging, hashlib, redis, re, dataclasses
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity
[ext_deps]: logging, json, datetime, re, typing, enum, warnings
...
[ext_deps]: logging, json, datetime, tenacity, collections, os, httpx, typing
...
[ext_deps]: logging, json, __future__, spacy, itertools, models, asyncpg
[fn]: _vec_to_str(vec)
...
[ext_deps]: pydantic, __future__, datetime, uuid, enum
...
[ext_deps]: logging, json, __future__, extraction, models, asyncpg
...
[local_deps]: app.core.context, app.services.monitoring, app.services.semantic_cache, app.services.user_quota, app.services.llm_router
[ext_deps]: asyncio, logging, typing, collections
...
[local_deps]: app.services.openrouter_service, app.services.ollama_service, app.services.pii_detection_service, app.services.minimax_service, app.services.kimi_service
...
[ext_deps]: logging, nats, asyncio, collections, os, typing
...
[ext_deps]: threading, logging, prometheus_client, subprocess, datetime, redis, dataclasses, re, collections, os, typing, psutil
...
[ext_deps]: logging, PyPDF2, cv2, time, paddleocr, io, numpy, PIL, pytesseract, os, typing, enum
...
[local_deps]: app.services.llm_http_client, app.services.base_llm_service
[ext_deps]: logging, json, tenacity, collections, os, httpx, typing
...
[local_deps]: app.services.llm_http_client, app.services.openrouter_throttle, app.services.monitoring, app.core.redis_url, app.services.cache_monitor
[ext_deps]: logging, json, hashlib, datetime, asyncio, redis, tenacity, collections, os, httpx, typing
[fn]: _get_redis_client()
...
[ext_deps]: logging, __future__, time, datetime, typing
...
[ext_deps]: logging, sqlalchemy, datetime, sentence_transformers, typing, psutil
...
[ext_deps]: logging, time, functools, collections, typing
...
[ext_deps]: collections, logging, typing, sqlalchemy
...
[local_deps]: app.services.context_block_service, app.services.llm_gateway, app.models.user, app.models.collection, app.models.document, app.services.agent_identity
[ext_deps]: logging, sqlalchemy, datetime, os, uuid, io, reportlab, typing
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.search_service, app.services.context_block_service, app.models.user, app.database, app.services.search_cache, app.models.document, app.services.llm_router, app.services.agent_identity
[ext_deps]: logging, sqlalchemy, json, time, uuid, search_models, asyncio, re, typing
...
[local_deps]: app.core.redis_url
[ext_deps]: logging, json, hashlib, redis, typing
[fn]: _get_redis()
...
[local_deps]: app.services.embed_client, app.services.pii_detection_service, app.models.user, app.services.search_cache, app.models.document, app.services.rerank_service
[ext_deps]: sqlalchemy, logging, asyncio, re, typing
...
[ext_deps]: logging, json, __future__, hashlib, time, numpy, typing
...
[ext_deps]: sqlalchemy, logging, numpy, re, typing
...
[local_deps]: app.services.smart_folder.report_generator, app.services.smart_folder.retrieval, app.services.smart_folder.analysis, app.services.smart_folder.query_parser, app.services.smart_folder.entity_resolver
...
[local_deps]: app.services.smart_folder.agent.planner, app.models.smart_folder, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.agent.executor, app.services.smart_folder.report_generator, app.models.user, app.services.smart_folder.query_parser, app.services.smart_folder.entity_resolver
...
[ext_deps]: logging, sqlalchemy, datetime, uuid, dataclasses, typing
...
[ext_deps]: logging, json, datetime, dataclasses, typing
...
[ext_deps]: logging, json, uuid, re, dataclasses, typing
...
[local_deps]: app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.base, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.custom_query
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.chart_generator
[ext_deps]: logging, typing
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.chart_generator
...
[ext_deps]: logging, json, io, csv, re, typing
...
[local_deps]: app.services.search_service, app.services.llm_gateway, app.models.user, app.models.collection, app.models.document
[ext_deps]: logging, sqlalchemy, datetime, uuid, re, typing
...
[local_deps]: app.models.bookmark, app.models.tag, app.models.user, app.models.note, app.models.document, app.models.space
[ext_deps]: logging, uuid, sqlalchemy
[fn]: _escape_like(value)
...
[ext_deps]: logging, base64, pathlib, datetime, uuid, cryptography, os
...
[ext_deps]: typing, contextlib, logging, json, pathlib, datetime, time, collections, os, sys
...
[ext_deps]: hitl_bridge, registry, flock_alerter, base_agent

---
### FILE: backend/app/services/swarm/v2/base_agent.py
[local_deps]: app.services.messaging
[ext_deps]: logging, nats, json, abc, datetime, uuid, asyncio, typing, enum
...
[local_deps]: app.services.messaging
[ext_deps]: logging, nats, json, time, hashlib, datetime, dataclasses, typing, enum
...
[local_deps]: app.services.messaging
[ext_deps]: logging, nats, json, datetime, uuid, asyncio, dataclasses, typing, enum
...
[local_deps]: app.models.knowledge_graph, app.services.context_block_service, app.services.llm_gateway, app.models.document, app.services.agent_identity
[ext_deps]: logging, sqlalchemy, json, datetime, collections, typing
...
[ext_deps]: logging, json, datetime, httpx, os
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: logging, sqlalchemy, datetime, collections, typing
...
[ext_deps]: logging, PyPDF2, docx, subprocess, pathlib, json, os, xml, ebooklib, html, csv, re, pptx, typing, zipfile, sys
...
[local_deps]: app.utils.circuit_breaker
[ext_deps]: os, asyncio, logging, faster_whisper
...
[local_deps]: app.models.processing, app.tasks.base, app.database, app.services.monitoring, app.celery_app, app.core.redis_url, app.models.document, app.services.cache_monitor, app.tasks.pipeline_orchestrator, app.services.alert_service
[ext_deps]: logging, celery, datetime, asyncio, redis, os
...
[local_deps]: app.services.article_generation_service, app.services.embed_client, app.models.article, app.tasks.base, app.database, app.models.document
[ext_deps]: logging, celery, uuid, asyncio, httpx
...
[local_deps]: app.tasks.embedding_tasks, app.models.article, app.database, app.models.document, app.tasks.pipeline_orchestrator, app.tasks.article_tasks
...
[ext_deps]: logging, asyncio, traceback, os, psutil
...
[local_deps]: app.services.report_service, app.tasks.base, app.database, app.models.user, app.models.audit
[ext_deps]: logging, sqlalchemy, celery, json, uuid, asyncio, typing
...
[local_deps]: app.models.processing, app.tasks.article_tasks, app.services.dlq_service, app.services.embed_client, app.services.prometheus_metrics, app.services.chunking_service, app.services.entity_extraction_service, app.tasks.embedding_tasks, app.tasks.base, app.services.context_block_service, app.services.collection_service, app.database, app.services.text_extractor, app.models.document, app.tasks.pipeline_orchestrator, app.services.ocr_service
[ext_deps]: logging, sqlalchemy, celery, datetime, uuid, asyncio, langdetect, traceback, tempfile, os
...
[local_deps]: app.services.embed_client, app.tasks.base, app.database, app.celery_app, app.models.document
...
[local_deps]: app.models.pipeline, app.database, app.celery_app, app.core.redis_url, app.models.document
[ext_deps]: smtplib, logging, sqlalchemy, datetime, redis, email, os
[fn]: _smtp_configured()
...
[local_deps]: app.tasks.pipeline_tasks, app.models.pipeline, app.database, app.core.redis_url, app.models.document
[ext_deps]: logging, celery, datetime, uuid, redis
...
[local_deps]: app.models.pipeline, app.database, app.celery_app, app.core.redis_url, app.models.document, app.tasks.pipeline_orchestrator
[ext_deps]: logging, sqlalchemy, datetime, redis, os
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.tasks.article_tasks, app.services.dlq_service, app.services.chunking_service, app.services.embed_client, app.services.entity_extraction_service, app.services.knowledge_graph.extraction, app.services.knowledge_graph.pool, app.models.pipeline, app.database, app.celery_app, app.tasks.document_tasks, app.models.document, app.services.text_extractor, app.services.ocr_service
[ext_deps]: logging, celery, time, datetime, uuid, asyncio, traceback, tempfile, os, gc
...
[ext_deps]: logging, sqlalchemy, celery, time, datetime, openpyxl, fpdf, os
...
[local_deps]: app.models.smart_folder, app.tasks.base, app.services.smart_folder.agent_runner, app.database, app.models.user, app.models.audit, app.models.document, app.services.smart_folder_service
[ext_deps]: logging, sqlalchemy, celery, json, datetime, uuid, asyncio, typing
...
[ext_deps]: smtplib, logging, calendar, sqlalchemy, datetime, email, httpx, os
...
[local_deps]: app.models.push_subscription, app.services.task_service, app.core.push, app.models.task, app.database, app.celery_app
...
[ext_deps]: sqlalchemy, logging, asyncio, tempfile, os
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: threading, logging, time, asyncio, functools, collections, typing
...
[ext_deps]: logging, sqlalchemy, dotenv, datetime, fastapi, bcrypt, os, jose, typing
