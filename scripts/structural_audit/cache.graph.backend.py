...
[local_deps]: app.models.user, app.api.documents_common, app.core.redis_url, app.utils.security, app.services.embed_client, app.services.alert_service, app.models.pipeline, app.services.whisper_service, app.models.article, app.tasks.pipeline_orchestrator, app.models.audit, app.schemas.user, app.models.failed_task, app.tasks.pipeline_tasks, app.models.document, app.celery_app, app.services.search_service, app.schemas.admin, app.api.deps, app.services.storage_service, app.models.processing, app.database, app.models.chat
[ext_deps]: fastapi, asyncio, redis, json, datetime, logging, os, uuid, concurrent, time, pydantic, sqlalchemy, typing
...
[local_deps]: app.models.article, app.models.user, app.api.deps, app.tasks.article_tasks, app.models.document, app.schemas.article
...
[local_deps]: app.models.user, app.core.redis_url, app.utils.constants, app.utils.security, app.middleware.csrf, app.api.deps, app.limiter, app.database, app.schemas.token, app.services.token_blacklist, app.schemas.user, app.schemas.auth
[ext_deps]: secrets, fastapi, redis, datetime, hashlib, logging, os, dotenv, uuid, time, httpx, sqlalchemy
...
[local_deps]: app.models.user, app.schemas.tag, app.services.space_service, app.services.bookmark_service, app.api.deps, app.database, app.schemas.bookmark
[ext_deps]: fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.models.user, app.services.chat_service, app.api.deps, app.limiter, app.database, app.models.chat, app.schemas.chat, app.services.input_guard
[ext_deps]: fastapi, json, logging, uuid, sqlalchemy
...
[local_deps]: app.models.article, app.models.user, app.api.deps, app.models.audit, app.models.collection, app.database, app.schemas.collection, app.services.collection_chat_service, app.services.input_guard, app.tasks.document_tasks, app.services.llm_gateway, app.services.collection_service
[ext_deps]: fastapi, json, datetime, logging, uuid, reportlab, sqlalchemy, typing, io
...
[local_deps]: app.models.user, app.utils.constants, app.utils.security, app.database, app.services.token_blacklist
...
[local_deps]: app.api.documents_common, app.models.user, app.services.semantic_cache, app.api.documents_upload, app.tasks.document_tasks, app.schemas.document, app.models.pipeline, app.tasks.pipeline_orchestrator, app.services.similarity_service, app.tasks.embedding_tasks, app.models.audit, app.tasks.pipeline_tasks, app.models.document, app.services.search_service, app.api.deps, app.services.storage_service, app.models.processing, app.database, app.api.documents_journal
[ext_deps]: fastapi, asyncio, datetime, logging, uuid, concurrent, time, sqlalchemy, typing
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.user, app.core.redis_url, app.tasks.pipeline_tasks, app.models.audit, app.models.document, app.schemas.document, app.models.pipeline
[ext_deps]: fastapi, asyncio, redis, json, datetime, logging, os, mimetypes, uuid, concurrent, pydantic, sqlalchemy, typing
...
[local_deps]: app.api.documents_common, app.models.user, app.api.deps, app.models.audit, app.services.storage_service, app.database, app.models.document, app.schemas.document, app.services.whisper_service
[ext_deps]: fastapi, datetime, logging, os, sqlalchemy, tempfile
...
[local_deps]: app.api.documents_common, app.models.user, app.services.semantic_cache, app.services.document_orchestrator, app.services.deduplication_service, app.api.deps, app.models.audit, app.services.storage_service, app.database, app.models.document, app.schemas.document
[ext_deps]: fastapi, logging, uuid, sqlalchemy, typing
...
[local_deps]: app.services.temporal_reasoning_service, app.models.user, app.services.search_service, app.services.synthesis_service, app.api.deps, app.models.audit, app.services.graph_rag_service, app.database, app.models.document, app.services.progressive_revelation_service
[ext_deps]: fastapi, json, logging, uuid, sqlalchemy, typing
...
[ext_deps]: fastapi, asyncio, redis, datetime, logging, os, nats, httpx, sqlalchemy, typing
...
[ext_deps]: fastapi, logging, os, hmac, sqlalchemy
...
[local_deps]: app.models.user, app.services.timeline_service, app.services.relationship_service, app.services.entity_extraction_service, app.api.deps, app.models.knowledge_graph, app.database, app.models.document
[ext_deps]: fastapi, datetime, logging, uuid, sqlalchemy, typing
...
[local_deps]: app.schemas.note, app.models.user, app.schemas.tag, app.models.note_audio, app.services.space_service, app.api.deps, app.database, app.models.note, app.services.note_service
[ext_deps]: fastapi, datetime, logging, os, uuid, sqlalchemy
...
[local_deps]: app.tasks.pipeline_orchestrator, app.core.redis_url, app.celery_app, app.api.deps, app.database, app.models.document, app.models.pipeline
...
[ext_deps]: fastapi, logging, os, uuid, sqlalchemy
...
[local_deps]: app.models.user, app.celery_app, app.api.deps, app.schemas.reports, app.tasks.report_tasks
[ext_deps]: fastapi, celery, typing, logging
...
[local_deps]: app.models.user, app.services.search_service, app.services.embed_client, app.services.search_models, app.api.deps, app.database, app.models.document, app.services.input_guard, app.services.search_agent
[ext_deps]: fastapi, asyncio, json, logging, uuid, time, sqlalchemy
...
[ext_deps]: fastapi, hashlib, logging, uuid, pydantic, sqlalchemy
...
[local_deps]: app.database, app.models.user, app.api.deps, app.models.document
[ext_deps]: fastapi, sqlalchemy, logging
...
[local_deps]: app.models.user, app.celery_app, app.api.deps, app.models.audit, app.database, app.schemas.collection, app.tasks.collection_report_tasks, app.models.note, app.tasks.smart_folder_tasks, app.schemas.smart_folder, app.models.smart_folder
[ext_deps]: fastapi, celery, asyncio, json, logging, uuid, sqlalchemy, typing
...
[local_deps]: app.models.user, app.schemas.tag, app.schemas.space, app.services.space_service, app.tasks.space_tasks, app.api.deps, app.database
[ext_deps]: fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.user, app.core.redis_url, app.api.deps, app.services.rollback_monitor, app.services.llm_gateway
...
[local_deps]: app.models.user, app.api.deps, app.models.subscription, app.database, app.tasks.subscription_tasks, app.schemas.subscription
[ext_deps]: fastapi, sqlalchemy, uuid, logging
[fn]: _parse_uuid(s)
...
[local_deps]: app.models.user, app.schemas.tag, app.services.space_service, app.api.deps, app.database, app.schemas.task, app.services.task_service
[ext_deps]: fastapi, sqlalchemy, uuid, logging
...
[local_deps]: app.models.user, app.models.note_audio, app.api.deps, app.services.storage_service, app.models.document, app.models.note, app.services.whisper_service
[ext_deps]: fastapi, asyncio, logging, os, uuid, sqlalchemy, tempfile, io
...
[ext_deps]: urllib, pathlib, pydantic, logging, os, pydantic_settings
...
[ext_deps]: urllib, cryptography, base64, json, logging, os, time, httpx, struct
...
[ext_deps]: fastapi, pgvector, os, dotenv, sqlalchemy, typing, collections
...
[local_deps]: app.services.prometheus_metrics, app.core.redis_url, app.services.openrouter_service, app.services.search_cache, app.middleware.csrf, app.api, app.services.llm_http_client, app.limiter, app.database, app.middleware.rls, app.middleware.transaction, app.services.messaging, app.core.config
[ext_deps]: fastapi, redis, logging, os, contextlib, dotenv, uuid, time, threading, slowapi, starlette, sqlalchemy, typing, uvicorn, collections
...
[local_deps]: app.services.cache_monitor, app.services.prometheus_metrics, app.core.redis_url, app.services.monitoring, app.services.embedding_service, app.api, app.services.llm_http_client, app.database, app.core.config
[ext_deps]: fastapi, redis, datetime, logging, os, contextlib, dotenv, time, httpx, sqlalchemy, uvicorn
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: jose, dataclasses, logging, starlette, sqlalchemy
...
[local_deps]: app.models.user, app.models.pipeline, app.models.article, app.models.base, app.models.audit, app.models.knowledge_graph, app.models.bookmark, app.models.smart_folder, app.models.failed_task, app.models.note_audio, app.models.document, app.models.space, app.models.pattern_insight, app.models.subscription, app.models.collection, app.models.chat, app.models.milestone, app.models.processing, app.models.note, app.models.task, app.models.tag, app.models.push_subscription
...
[ext_deps]: asyncio, functools, logging, tenacity, time, httpx, typing, collections
...
[local_deps]: app.schemas.admin, app.schemas.search, app.schemas.chat, app.schemas.token, app.schemas.pagination, app.schemas.collection, app.schemas.document, app.schemas.smart_folder, app.schemas.user
...
[ext_deps]: base64, json, typing, pydantic
...
[ext_deps]: datetime, uuid, enum, pydantic, typing, re
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.verification_agent, app.services.agents.clarification_agent, app.services.agents.agent_orchestrator, app.services.agents.answer_agent, app.services.agents.researcher_agent
...
[ext_deps]: datetime, dataclasses, logging, time, enum, typing, collections
...
[ext_deps]: json, dataclasses, logging, typing, re
...
[local_deps]: app.services.knowledge_graph.pool, app.services.knowledge_graph.models, app.services.search_service, app.services.embed_client, app.services.knowledge_graph.traversal, app.services.graph_rag_service, app.services.agent_identity, app.services.llm_gateway
[ext_deps]: json, dataclasses, logging, typing, re, collections
...
[ext_deps]: asyncio, json, hashlib, logging, httpx, typing
...
[local_deps]: app.models.document, app.services.llm_gateway, app.models.tag, app.services.agent_identity
[ext_deps]: warnings, datetime, json, logging, uuid, sqlalchemy, typing
...
[ext_deps]: json, datetime, logging, threading, typing
...
[local_deps]: app.services.pii_detection_service, app.services.prometheus_metrics, app.models.user, app.services.cache_monitor, app.services.search_service, app.services.agent_identity, app.models.chat, app.database, app.models.document, app.services.context_block_service, app.services.llm_gateway
[ext_deps]: asyncio, json, logging, collections, uuid, time, sqlalchemy, typing, re
...
[local_deps]: app.models.user, app.models.audit, app.services.agent_identity, app.models.chat, app.models.collection, app.models.document, app.services.context_block_service, app.services.llm_gateway
...
[local_deps]: app.models.user, app.services.intent_parser, app.services.search_service, app.services.search_cache, app.services.agent_identity, app.models.document, app.schemas.collection, app.models.collection, app.services.llm_gateway
[ext_deps]: asyncio, datetime, logging, uuid, sqlalchemy, typing
...
[ext_deps]: datetime, hashlib, logging, sqlalchemy, difflib
...
[local_deps]: app.services.llm_gateway
[ext_deps]: datetime, logging, os, uuid, typing
...
[ext_deps]: asyncio, json, traceback, logging, threading, sqlalchemy, typing
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.user, app.tasks.pipeline_tasks, app.services.deduplication_service, app.services.storage_service, app.models.audit, app.models.document, app.tasks.voice_tasks, app.schemas.document, app.models.pipeline
[ext_deps]: fastapi, asyncio, json, datetime, logging, concurrent, sqlalchemy, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: asyncio, atexit, logging, os, time, httpx, random
[fn]: _base_urls()
...
[ext_deps]: sentence_transformers, asyncio, torch, psutil, numpy, gc, logging, os, threading, typing
...
[ext_deps]: warnings, asyncio, json, datetime, logging, sqlalchemy, typing
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.models.document, app.services.context_block_service, app.services.llm_gateway
[ext_deps]: logging, sqlalchemy, typing, re, collections
...
[ext_deps]: redis, dataclasses, hashlib, logging, re
...
[ext_deps]: warnings, json, datetime, logging, enum, typing, re
...
[ext_deps]: json, datetime, logging, os, tenacity, httpx, typing, collections
...
[ext_deps]: __future__, itertools, json, asyncpg, logging, models, spacy
[fn]: _vec_to_str(vec)
...
[ext_deps]: datetime, __future__, uuid, pydantic, enum
...
[ext_deps]: __future__, json, asyncpg, extraction, logging, models
...
[local_deps]: app.services.user_quota, app.services.token_utils, app.services.semantic_cache, app.services.monitoring, app.services.llm_router, app.services.rollback_monitor, app.core.context
...
[local_deps]: app.services.ollama_service, app.services.pii_detection_service, app.services.minimax_service, app.services.openrouter_service, app.services.together_service, app.services.kimi_service
[ext_deps]: dataclasses, logging, enum, typing, collections
...
[ext_deps]: asyncio, logging, os, nats, typing, collections
...
[ext_deps]: json, logging, os, httpx, typing, collections
...
[ext_deps]: prometheus_client, redis, datetime, psutil, dataclasses, logging, os, threading, subprocess, typing, re, collections
...
[ext_deps]: pytesseract, paddleocr, PyPDF2, numpy, logging, os, PIL, time, cv2, typing, io, enum
...
[ext_deps]: json, logging, os, tenacity, httpx, typing, collections
...
[local_deps]: app.services.cache_monitor, app.core.redis_url, app.services.token_utils, app.services.monitoring, app.services.openrouter_throttle, app.services.llm_http_client
[ext_deps]: asyncio, redis, json, datetime, hashlib, logging, os, tenacity, httpx, typing, collections
...
[ext_deps]: __future__, datetime, logging, time, typing
...
[ext_deps]: sentence_transformers, datetime, psutil, logging, sqlalchemy, typing
...
[local_deps]: app.models.user, app.services.monitoring, app.services.agent_identity, app.models.document, app.models.collection, app.services.rollback_monitor, app.services.context_block_service, app.services.llm_gateway
[ext_deps]: datetime, logging, os, uuid, reportlab, sqlalchemy, typing, io
[class]: ReportFormat { methods: [] }
...
[ext_deps]: os, typing, httpx, logging
[fn]: _get_client()
...
[local_deps]: app.core.redis_url
[ext_deps]: redis, datetime, logging, os, time, typing, collections
[fn]: _get_redis()
...
[local_deps]: app.models.user, app.services.search_service, app.services.search_cache, app.services.llm_router, app.services.agent_identity, app.models.document, app.database, app.services.context_block_service
[ext_deps]: asyncio, json, logging, search_models, uuid, time, sqlalchemy, typing, re
...
[local_deps]: app.core.redis_url
[ext_deps]: redis, json, hashlib, logging, typing
[fn]: close_redis_client()
[fn]: _get_redis()
...
[local_deps]: app.services.pii_detection_service, app.models.user, app.services.embed_client, app.services.search_cache, app.services.rerank_service, app.models.document
[ext_deps]: asyncio, logging, sqlalchemy, typing, re
...
[ext_deps]: __future__, json, numpy, hashlib, logging, time, typing
...
[ext_deps]: numpy, logging, sqlalchemy, typing, re
...
[local_deps]: app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.entity_resolver, app.services.smart_folder.retrieval, app.services.smart_folder.analysis

---
### FILE: backend/app/services/smart_folder/agent/__init__.py
[local_deps]: app.services.smart_folder.agent.executor, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.agent.planner
...
[local_deps]: app.models.user, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.agent.planner, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.executor, app.models.smart_folder, app.services.smart_folder.agent.synthesizer
[ext_deps]: logging, uuid, sqlalchemy, typing, re
...
[ext_deps]: datetime, dataclasses, logging, uuid, sqlalchemy, typing
...
[ext_deps]: dataclasses, logging, sqlalchemy, typing, difflib
...
[ext_deps]: json, datetime, dataclasses, logging, typing
...
[ext_deps]: json, dataclasses, logging, uuid, typing, re
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.legal_review, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker
...
[local_deps]: app.services.smart_folder.skills.base, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator
[ext_deps]: typing, logging
...
[local_deps]: app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.refinement_parser
...
[ext_deps]: csv, json, logging, typing, io, re
...
[local_deps]: app.models.user, app.services.search_service, app.models.collection, app.models.document, app.services.llm_gateway
[ext_deps]: datetime, logging, uuid, sqlalchemy, typing, re
...
[local_deps]: app.models.user, app.models.document, app.models.note, app.models.bookmark, app.models.space, app.models.tag
[ext_deps]: sqlalchemy, uuid, logging
[fn]: _escape_like(value)
...
[ext_deps]: pathlib, cryptography, base64, datetime, logging, os, uuid
...
[ext_deps]: pathlib, json, datetime, logging, os, contextlib, time, typing, sys, collections
...
[ext_deps]: hitl_bridge, registry, base_agent, flock_alerter

---
### FILE: backend/app/services/swarm/v2/base_agent.py
[local_deps]: app.services.messaging
[ext_deps]: asyncio, json, datetime, logging, uuid, nats, enum, typing, abc
...
[local_deps]: app.services.messaging
[ext_deps]: json, datetime, dataclasses, hashlib, logging, time, nats, typing, enum
...
[local_deps]: app.services.messaging
[ext_deps]: asyncio, json, datetime, dataclasses, logging, uuid, nats, typing, enum
...
[local_deps]: app.services.messaging
[ext_deps]: json, datetime, logging, nats, typing
...
[local_deps]: app.models.knowledge_graph, app.services.agent_identity, app.models.document, app.services.rollback_monitor, app.services.context_block_service, app.services.llm_gateway
[ext_deps]: datetime, json, logging, sqlalchemy, typing, collections
...
[ext_deps]: json, datetime, logging, os, httpx
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: datetime, logging, sqlalchemy, typing, collections
...
[ext_deps]: ebooklib, pathlib, typing, PyPDF2, json, html, re, logging, os, pptx, xml, zipfile, subprocess, sys, csv, docx
...
[local_deps]: app.services.token_utils, app.services.llm_http_client, app.services.base_llm_service
[ext_deps]: json, datetime, logging, os, httpx, typing, collections
...
[local_deps]: app.services.cache_monitor, app.tasks.pipeline_orchestrator, app.core.redis_url, app.celery_app, app.services.monitoring, app.services.alert_service, app.models.processing, app.database, app.models.document, app.tasks.base
[ext_deps]: redis, asyncio, datetime, logging, os, celery
...
[local_deps]: app.models.article, app.services.article_generation_service, app.services.embed_client, app.database, app.models.document, app.tasks.base
[ext_deps]: asyncio, logging, uuid, httpx, celery
...
[local_deps]: app.tasks.pipeline_orchestrator, app.models.article, app.tasks.embedding_tasks, app.tasks.article_tasks, app.database, app.models.document
...
[ext_deps]: asyncio, psutil, traceback, logging, os
...
[local_deps]: app.models.user, app.models.audit, app.database, app.services.report_service, app.tasks.base
[ext_deps]: asyncio, json, logging, uuid, sqlalchemy, celery, typing
...
[local_deps]: app.services.prometheus_metrics, app.tasks.pipeline_orchestrator, app.services.embed_client, app.services.dlq_service, app.services.entity_extraction_service, app.services.chunking_service, app.tasks.embedding_tasks, app.tasks.article_tasks, app.models.processing, app.database, app.models.document, app.services.context_block_service, app.services.text_extractor, app.tasks.base, app.services.collection_service, app.services.ocr_service
[ext_deps]: langdetect, asyncio, datetime, traceback, logging, os, uuid, tempfile, sqlalchemy, celery
...
[local_deps]: app.core.redis_url, app.celery_app, app.database, app.models.document, app.models.pipeline
[ext_deps]: email, redis, datetime, logging, os, sqlalchemy, smtplib
[fn]: _smtp_configured()
...
[local_deps]: app.core.redis_url, app.tasks.pipeline_tasks, app.database, app.models.document, app.models.pipeline
[ext_deps]: redis, datetime, logging, uuid, celery
...
[local_deps]: app.tasks.pipeline_orchestrator, app.core.redis_url, app.celery_app, app.database, app.models.document, app.models.pipeline
[ext_deps]: redis, datetime, logging, os, sqlalchemy
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.services.knowledge_graph.pool, app.celery_app, app.services.embed_client, app.services.dlq_service, app.services.chunking_service, app.services.entity_extraction_service, app.tasks.article_tasks, app.services.knowledge_graph.extraction, app.database, app.models.document, app.tasks.document_tasks, app.services.text_extractor, app.models.pipeline, app.services.ocr_service
[ext_deps]: asyncio, datetime, gc, traceback, logging, os, uuid, time, tempfile, celery
...
[ext_deps]: fpdf, datetime, logging, os, time, sqlalchemy, celery, openpyxl
...
[local_deps]: app.models.user, app.models.audit, app.services.smart_folder_service, app.database, app.models.document, app.tasks.base, app.models.smart_folder, app.services.smart_folder.agent_runner
[ext_deps]: asyncio, datetime, json, logging, uuid, sqlalchemy, celery, typing
...
[ext_deps]: email, calendar, datetime, logging, os, httpx, sqlalchemy, smtplib
...
[local_deps]: app.celery_app, app.database, app.models.task, app.services.task_service, app.core.push, app.models.push_subscription
[ext_deps]: sqlalchemy, logging
[fn]: check_task_alarms()

---
### FILE: backend/app/tasks/voice_tasks.py
[local_deps]: app.database, app.services.storage_service, app.celery_app, app.services.whisper_service
[ext_deps]: asyncio, logging, os, sqlalchemy, tempfile
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: asyncio, functools, logging, time, threading, typing, collections
...
[ext_deps]: fastapi, jose, datetime, logging, os, dotenv, sqlalchemy, typing, bcrypt
