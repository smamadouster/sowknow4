...
[local_deps]: app.models.pipeline, app.schemas.admin, app.celery_app, app.services.whisper_service, app.models.failed_task, app.schemas.user, app.database, app.models.audit, app.models.article, app.utils.security, app.api.deps, app.services.storage_service, app.services.embed_client, app.models.processing, app.services.alert_service, app.api.documents_common, app.models.user, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.core.redis_url, app.models.chat, app.models.document
[ext_deps]: sqlalchemy, logging, asyncio, json, pydantic, datetime, os, typing, fastapi, redis, uuid, concurrent
...
[local_deps]: app.middleware.csrf, app.schemas.auth, app.schemas.user, app.database, app.models.user, app.utils.constants, app.schemas.token, app.utils.security, app.api.deps, app.core.redis_url, app.services.token_blacklist, app.limiter
[ext_deps]: hashlib, sqlalchemy, logging, httpx, time, secrets, datetime, os, dotenv, fastapi, redis, uuid
...
[local_deps]: app.schemas.bookmark, app.database, app.models.user, app.services.bookmark_service, app.api.deps, app.schemas.tag, app.services.space_service
[ext_deps]: sqlalchemy, logging, fastapi, uuid
...
[local_deps]: app.services.input_guard, app.database, app.models.user, app.api.deps, app.models.chat, app.schemas.chat, app.services.chat_service, app.limiter
[ext_deps]: sqlalchemy, logging, json, fastapi, uuid
...
[local_deps]: app.services.input_guard, app.tasks.document_tasks, app.database, app.services.llm_gateway, app.models.article, app.services.collection_chat_service, app.models.user, app.api.deps, app.schemas.collection, app.services.collection_service, app.models.collection, app.models.audit
[ext_deps]: sqlalchemy, logging, reportlab, json, io, datetime, typing, fastapi, uuid
...
[local_deps]: app.api.documents_common, app.models.pipeline, app.tasks.document_tasks, app.database, app.schemas.document, app.models.user, app.api.documents_upload, app.tasks.embedding_tasks, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.api.deps, app.services.storage_service, app.models.processing, app.models.document, app.services.similarity_service, app.models.audit, app.api.documents_journal
[ext_deps]: sqlalchemy, logging, asyncio, datetime, typing, fastapi, uuid, concurrent
...
[local_deps]: app.models.pipeline, app.schemas.document, app.models.user, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.core.redis_url, app.models.document, app.models.audit
[ext_deps]: sqlalchemy, logging, asyncio, json, mimetypes, pydantic, datetime, os, typing, fastapi, redis, uuid, concurrent
...
[local_deps]: app.api.documents_common, app.database, app.schemas.document, app.models.user, app.api.deps, app.services.storage_service, app.services.whisper_service, app.models.document, app.models.audit
[ext_deps]: tempfile, logging, sqlalchemy, datetime, os, fastapi
...
[local_deps]: app.api.documents_common, app.services.deduplication_service, app.database, app.schemas.document, app.models.user, app.services.document_orchestrator, app.api.deps, app.services.storage_service, app.models.document, app.models.audit
[ext_deps]: logging, fastapi, typing, sqlalchemy, uuid
...
[local_deps]: app.services.search_service, app.database, app.services.progressive_revelation_service, app.models.user, app.services.synthesis_service, app.api.deps, app.services.temporal_reasoning_service, app.models.document, app.services.graph_rag_service, app.models.audit
[ext_deps]: sqlalchemy, logging, json, typing, fastapi, uuid
...
[ext_deps]: sqlalchemy, logging, asyncio, httpx, datetime, os, typing, nats, fastapi, redis
...
[ext_deps]: logging, hmac, os, fastapi, sqlalchemy
...
[local_deps]: app.database, app.services.entity_extraction_service, app.models.user, app.api.deps, app.services.timeline_service, app.services.relationship_service, app.models.document, app.models.knowledge_graph
[ext_deps]: logging, fastapi, datetime, typing, sqlalchemy, uuid
...
[local_deps]: app.database, app.models.note_audio, app.models.user, app.models.note, app.schemas.note, app.api.deps, app.services.note_service, app.schemas.tag, app.services.space_service
[ext_deps]: logging, datetime, os, fastapi, sqlalchemy, uuid
...
[local_deps]: app.models.pipeline, app.database, app.tasks.pipeline_orchestrator, app.api.deps, app.core.redis_url, app.celery_app, app.models.document
...
[local_deps]: app.database, app.models.user, app.api.deps, app.models.push_subscription, app.schemas.push
[ext_deps]: logging, os, fastapi, sqlalchemy, uuid
...
[local_deps]: app.tasks.report_tasks, app.models.user, app.api.deps, app.celery_app, app.schemas.reports
...
[local_deps]: app.services.search_service, app.services.input_guard, app.services.search_models, app.database, app.models.user, app.api.deps, app.models.document, app.services.search_agent
[ext_deps]: sqlalchemy, logging, asyncio, json, time, fastapi, uuid
...
[ext_deps]: hashlib, sqlalchemy, logging, pydantic, fastapi, uuid
...
[local_deps]: app.database, app.models.user, app.api.deps, app.celery_app, app.schemas.collection, app.tasks.smart_folder_tasks, app.tasks.collection_report_tasks, app.models.smart_folder, app.models.note, app.schemas.smart_folder, app.models.audit
[ext_deps]: sqlalchemy, logging, asyncio, json, celery, typing, fastapi, uuid
...
[local_deps]: app.database, app.models.user, app.api.deps, app.schemas.space, app.tasks.space_tasks, app.schemas.tag, app.services.space_service
[ext_deps]: sqlalchemy, logging, fastapi, uuid
...
[local_deps]: app.services.llm_gateway, app.models.user, app.tasks.pipeline_orchestrator, app.core.redis_url, app.api.deps
...
[local_deps]: app.tasks.subscription_tasks, app.database, app.models.subscription, app.schemas.subscription, app.models.user, app.api.deps
[ext_deps]: sqlalchemy, logging, fastapi, uuid
[fn]: _parse_uuid(s)
...
[local_deps]: app.schemas.task, app.database, app.models.user, app.api.deps, app.services.task_service, app.schemas.tag, app.services.space_service
[ext_deps]: sqlalchemy, logging, fastapi, uuid
...
[local_deps]: app.models.note_audio, app.models.user, app.api.deps, app.services.storage_service, app.services.whisper_service, app.models.document, app.models.note
[ext_deps]: tempfile, logging, sqlalchemy, asyncio, io, os, fastapi, uuid
...
[ext_deps]: logging, pathlib, pydantic_settings, urllib, pydantic, os
...
[ext_deps]: cryptography, logging, json, base64, time, urllib, httpx, os, struct
...
[ext_deps]: sqlalchemy, pgvector, os, typing, fastapi, dotenv, collections
...
[local_deps]: app.middleware.csrf, app.database, app.services.prometheus_metrics, app.middleware.rls, app.core.redis_url, app.middleware.transaction, app.services.messaging, app.limiter, app.api
[ext_deps]: slowapi, logging, threading, sqlalchemy, starlette, uvicorn, redis, contextlib, time, os, typing, fastapi, dotenv, uuid, collections
...
[local_deps]: app.database, app.services.embedding_service, app.services.prometheus_metrics, app.services.cache_monitor, app.api, app.core.redis_url, app.services.monitoring
[ext_deps]: sqlalchemy, logging, uvicorn, contextlib, httpx, time, datetime, os, dotenv, fastapi, redis
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: starlette, logging, jose, dataclasses, sqlalchemy
...
[local_deps]: app.models.pipeline, app.models.subscription, app.models.note, app.models.tag, app.models.smart_folder, app.models.failed_task, app.models.knowledge_graph, app.models.task, app.models.base, app.models.pattern_insight, app.models.push_subscription, app.models.collection, app.models.audit, app.models.article, app.models.processing, app.models.bookmark, app.models.note_audio, app.models.space, app.models.user, app.models.chat, app.models.document, app.models.milestone
...
[ext_deps]: logging, asyncio, time, tenacity, functools, httpx, typing, collections
...
[local_deps]: app.schemas.search, app.schemas.user, app.schemas.admin, app.schemas.document, app.schemas.token, app.schemas.pagination, app.schemas.collection, app.schemas.chat, app.schemas.smart_folder
...
[ext_deps]: enum, pydantic, datetime, typing, uuid
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: re, enum, pydantic, datetime, typing, uuid
[class]: UserRole { methods: [] }
...
[ext_deps]: logging, enum, time, datetime, typing, dataclasses, collections
...
[ext_deps]: logging, re, json, typing, dataclasses
...
[local_deps]: app.services.search_service, app.services.llm_gateway, app.services.agent_identity, app.services.knowledge_graph.traversal, app.services.embed_client, app.services.knowledge_graph.models, app.services.graph_rag_service, app.services.knowledge_graph.pool
[ext_deps]: logging, re, json, typing, dataclasses, collections
...
[ext_deps]: hashlib, logging, asyncio, json, httpx, typing
...
[local_deps]: app.models.document, app.services.agent_identity, app.models.tag, app.services.llm_gateway
[ext_deps]: logging, uuid, json, datetime, typing, sqlalchemy, warnings
...
[ext_deps]: logging, threading, json, datetime, typing
...
[local_deps]: app.services.search_service, app.database, app.services.llm_gateway, app.services.prometheus_metrics, app.services.agent_identity, app.models.user, app.services.pii_detection_service, app.models.chat, app.services.context_block_service, app.models.document, app.services.llm_router, app.services.cache_monitor
[ext_deps]: logging, asyncio, re, json, time, typing, sqlalchemy, uuid, collections
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity, app.models.user, app.models.chat, app.services.context_block_service, app.models.document, app.models.collection, app.models.audit
[ext_deps]: logging, json, typing, sqlalchemy, uuid
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.services.search_service, app.services.llm_gateway, app.services.agent_identity, app.models.user, app.schemas.collection, app.models.document, app.services.search_cache, app.services.intent_parser, app.models.collection
[ext_deps]: logging, asyncio, datetime, typing, sqlalchemy, uuid
...
[ext_deps]: hashlib, logging, difflib, datetime, sqlalchemy
...
[local_deps]: app.services.llm_gateway
[ext_deps]: logging, datetime, os, typing, uuid
...
[ext_deps]: logging, threading, asyncio, json, traceback, typing, sqlalchemy
...
[local_deps]: app.services.deduplication_service, app.models.pipeline, app.tasks.voice_tasks, app.schemas.document, app.models.user, app.tasks.pipeline_tasks, app.tasks.pipeline_orchestrator, app.services.storage_service, app.models.document, app.models.audit
[ext_deps]: sqlalchemy, logging, asyncio, json, datetime, typing, fastapi, concurrent
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: logging, asyncio, time, httpx, os, random
[fn]: _base_urls()
...
[ext_deps]: torch, gc, logging, threading, asyncio, numpy, sentence_transformers, psutil, os, typing
...
[local_deps]: app.models.document, app.services.agent_identity, app.models.knowledge_graph, app.services.llm_gateway
[ext_deps]: logging, asyncio, json, datetime, typing, sqlalchemy, warnings
...
[ext_deps]: logging, re, typing, sqlalchemy, collections
...
[local_deps]: app.services.agent_identity, app.services.llm_gateway
[ext_deps]: logging, re, json, enum, datetime, typing, warnings
...
[ext_deps]: logging, json, httpx, tenacity, datetime, os, typing, collections
...
[ext_deps]: logging, models, asyncpg, json, spacy, itertools, __future__
[fn]: _vec_to_str(vec)
...
[ext_deps]: enum, pydantic, datetime, uuid, __future__
...
[ext_deps]: logging, models, asyncpg, json, extraction, __future__
...
[ext_deps]: logging, asyncio, os, typing, nats, collections
...
[ext_deps]: logging, json, httpx, os, typing, collections
...
[ext_deps]: logging, threading, prometheus_client, re, psutil, subprocess, datetime, os, typing, dataclasses, redis, collections
...
[ext_deps]: PyPDF2, logging, PIL, enum, numpy, pytesseract, time, paddleocr, cv2, io, os, typing
...
[local_deps]: app.services.base_llm_service
[ext_deps]: logging, json, tenacity, httpx, os, typing, collections
...
[ext_deps]: hashlib, logging, json, httpx, tenacity, datetime, os, typing, redis, collections
[fn]: _get_redis_client()
...
[ext_deps]: logging, sentence_transformers, psutil, datetime, typing, sqlalchemy
...
[ext_deps]: logging, time, functools, typing, collections
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity, app.models.user, app.services.context_block_service, app.models.document, app.models.collection
[ext_deps]: logging, reportlab, io, datetime, os, typing, sqlalchemy, uuid
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.services.search_service, app.database, app.services.agent_identity, app.models.user, app.services.context_block_service, app.models.document, app.services.llm_router, app.services.search_cache
[ext_deps]: logging, asyncio, re, json, time, typing, search_models, sqlalchemy, uuid
...
[local_deps]: app.models.user, app.services.pii_detection_service, app.services.embed_client, app.models.document, app.services.search_cache, app.services.rerank_service
[ext_deps]: logging, asyncio, re, typing, sqlalchemy
...
[ext_deps]: logging, re, numpy, typing, sqlalchemy
...
[local_deps]: app.services.smart_folder.entity_resolver, app.services.smart_folder.analysis, app.services.smart_folder.report_generator, app.services.smart_folder.query_parser, app.services.smart_folder.retrieval
...
[local_deps]: app.services.smart_folder.entity_resolver, app.models.user, app.services.smart_folder.agent.planner, app.services.smart_folder.report_generator, app.services.smart_folder.query_parser, app.services.smart_folder.agent.executor, app.models.smart_folder, app.services.smart_folder.agent.synthesizer
[ext_deps]: logging, re, typing, sqlalchemy, uuid
...
[ext_deps]: logging, datetime, typing, dataclasses, sqlalchemy, uuid
...
[ext_deps]: logging, difflib, typing, dataclasses, sqlalchemy
...
[ext_deps]: logging, re, json, typing, dataclasses, uuid
...
[local_deps]: app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.base, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.legal_review
...
[local_deps]: app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.skills.base, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.trend_analyzer
[ext_deps]: typing, logging
[class]: FinancialAnalysisSkill { methods: [analyze] }

---
### FILE: backend/app/services/smart_folder/skills/general_narrative.py
[local_deps]: app.services.smart_folder.analysis, app.services.smart_folder.skills.base, app.services.smart_folder.report_generator, app.services.smart_folder.retrieval, app.services.smart_folder.tools.document_reader
...
[local_deps]: app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.refinement_parser, app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.trend_analyzer
...
[local_deps]: app.services.search_service, app.services.llm_gateway, app.models.user, app.models.document, app.models.collection
[ext_deps]: logging, re, datetime, typing, sqlalchemy, uuid
...
[local_deps]: app.models.bookmark, app.models.space, app.models.user, app.models.document, app.models.tag, app.models.note
[ext_deps]: logging, sqlalchemy, uuid
[fn]: _escape_like(value)
...
[ext_deps]: cryptography, logging, pathlib, base64, datetime, os, uuid
...
[ext_deps]: sys, logging, pathlib, json, contextlib, time, datetime, os, typing, collections
...
[ext_deps]: logging, asyncio, json, enum, abc, datetime, typing, nats, uuid
...
[local_deps]: app.services.messaging
[ext_deps]: hashlib, nats, logging, json, enum, time, datetime, typing, dataclasses
...
[local_deps]: app.services.messaging
[ext_deps]: nats, logging, asyncio, json, enum, datetime, typing, dataclasses, uuid
...
[local_deps]: app.services.messaging
[ext_deps]: logging, json, datetime, typing, nats
...
[local_deps]: app.services.llm_gateway, app.services.agent_identity, app.services.context_block_service, app.models.document, app.models.knowledge_graph
[ext_deps]: logging, json, datetime, typing, sqlalchemy, collections
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: logging, datetime, typing, sqlalchemy, collections
...
[ext_deps]: PyPDF2, sys, pptx, logging, ebooklib, re, pathlib, json, zipfile, html, docx, csv, subprocess, os, typing, xml
...
[local_deps]: app.database, app.services.cache_monitor, app.services.alert_service, app.tasks.pipeline_orchestrator, app.core.redis_url, app.celery_app, app.models.processing, app.tasks.base, app.models.document, app.services.monitoring
[ext_deps]: logging, asyncio, celery, datetime, os, redis
...
[local_deps]: app.database, app.models.article, app.services.article_generation_service, app.services.embed_client, app.tasks.base, app.models.document
[ext_deps]: logging, asyncio, celery, httpx, uuid
...
[local_deps]: app.database, app.models.article, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.tasks.article_tasks, app.models.document
...
[ext_deps]: logging, asyncio, traceback, psutil, os
...
[local_deps]: app.database, app.services.report_service, app.models.user, app.tasks.base, app.models.audit
[ext_deps]: logging, asyncio, json, celery, typing, sqlalchemy, uuid
...
[local_deps]: app.services.chunking_service, app.database, app.services.prometheus_metrics, app.services.entity_extraction_service, app.services.text_extractor, app.tasks.embedding_tasks, app.tasks.pipeline_orchestrator, app.services.ocr_service, app.services.embed_client, app.services.collection_service, app.models.processing, app.tasks.base, app.tasks.article_tasks, app.models.document, app.services.context_block_service, app.services.dlq_service
[ext_deps]: tempfile, logging, asyncio, langdetect, celery, traceback, datetime, os, sqlalchemy, uuid
...
[local_deps]: app.models.pipeline, app.database, app.core.redis_url, app.celery_app, app.models.document
[ext_deps]: email, logging, smtplib, datetime, os, sqlalchemy, redis
[fn]: _smtp_configured()
...
[ext_deps]: logging, celery, datetime, redis, uuid
...
[local_deps]: app.models.pipeline, app.database, app.tasks.pipeline_orchestrator, app.core.redis_url, app.celery_app, app.models.document
[ext_deps]: logging, datetime, os, sqlalchemy, redis
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.models.pipeline, app.services.chunking_service, app.tasks.document_tasks, app.database, app.services.text_extractor, app.services.entity_extraction_service, app.services.ocr_service, app.services.embed_client, app.celery_app, app.tasks.article_tasks, app.models.document, app.services.knowledge_graph.extraction, app.services.dlq_service, app.services.knowledge_graph.pool
[ext_deps]: tempfile, logging, asyncio, celery, time, traceback, datetime, os, gc, uuid
...
[ext_deps]: logging, fpdf, celery, time, datetime, os, openpyxl, sqlalchemy
...
[local_deps]: app.services.smart_folder.agent_runner, app.database, app.services.smart_folder_service, app.models.user, app.tasks.base, app.models.document, app.models.smart_folder, app.models.audit
[ext_deps]: logging, asyncio, json, celery, datetime, typing, sqlalchemy, uuid
...
[ext_deps]: email, logging, httpx, smtplib, datetime, os, sqlalchemy, calendar
...
[local_deps]: app.database, app.core.push, app.celery_app, app.models.push_subscription, app.models.task, app.services.task_service
...
[ext_deps]: tempfile, logging, asyncio, os, sqlalchemy
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: logging, threading, asyncio, time, functools, typing, collections
...
[ext_deps]: sqlalchemy, logging, jose, bcrypt, datetime, os, typing, fastapi, dotenv
