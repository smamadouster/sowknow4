...
[local_deps]: app.models.document, app.tasks.pipeline_tasks, app.models.processing, app.database, app.models.failed_task, app.models.article, app.celery_app, app.models.pipeline, app.services.search_service, app.services.embed_client, app.schemas.admin, app.schemas.user, app.models.audit, app.services.alert_service, app.services.whisper_service, app.api.documents_common, app.models.chat, app.core.redis_url, app.utils.security, app.models.user, app.api.deps, app.services.storage_service, app.tasks.pipeline_orchestrator
[ext_deps]: concurrent, redis, logging, uuid, datetime, json, asyncio, sqlalchemy, os, fastapi, time, typing, pydantic
...
[local_deps]: app.models.document, app.api.deps, app.tasks.article_tasks, app.schemas.article, app.models.user, app.models.article
...
[local_deps]: app.schemas.user, app.services.token_blacklist, app.utils.security, app.api.deps, app.limiter, app.core.redis_url, app.schemas.token, app.database, app.schemas.auth, app.utils.constants, app.middleware.csrf, app.models.user
[ext_deps]: secrets, redis, logging, uuid, hashlib, datetime, dotenv, sqlalchemy, os, fastapi, time, httpx
...
[local_deps]: app.schemas.bookmark, app.services.space_service, app.api.deps, app.services.bookmark_service, app.database, app.models.user, app.schemas.tag
[ext_deps]: sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.services.chat_service, app.models.chat, app.api.deps, app.limiter, app.services.input_guard, app.database, app.models.user, app.schemas.chat
[ext_deps]: logging, uuid, json, sqlalchemy, fastapi
...
[local_deps]: app.services.llm_gateway, app.api.deps, app.schemas.collection, app.services.collection_chat_service, app.services.collection_service, app.services.input_guard, app.models.audit, app.models.collection, app.database, app.models.user, app.models.article, app.tasks.document_tasks
[ext_deps]: io, logging, uuid, json, datetime, sqlalchemy, reportlab, fastapi, typing
...
[local_deps]: app.utils.security, app.services.token_blacklist, app.utils.constants, app.database, app.models.user
...
[local_deps]: app.api.documents_upload, app.models.pipeline, app.services.similarity_service, app.models.document, app.api.documents_common, app.services.search_service, app.schemas.document, app.api.deps, app.services.storage_service, app.api.documents_journal, app.models.processing, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.tasks.embedding_tasks, app.models.audit, app.database, app.models.user, app.tasks.document_tasks
[ext_deps]: concurrent, logging, datetime, uuid, asyncio, sqlalchemy, fastapi, time, typing
...
[local_deps]: app.models.pipeline, app.models.document, app.schemas.document, app.core.redis_url, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.audit, app.models.user
[ext_deps]: concurrent, redis, logging, json, uuid, datetime, asyncio, sqlalchemy, os, fastapi, typing, mimetypes, pydantic
...
[local_deps]: app.models.document, app.api.documents_common, app.services.whisper_service, app.schemas.document, app.api.deps, app.services.storage_service, app.models.audit, app.database, app.models.user
[ext_deps]: tempfile, logging, datetime, sqlalchemy, os, fastapi
...
[local_deps]: app.models.document, app.api.documents_common, app.services.deduplication_service, app.schemas.document, app.api.deps, app.services.storage_service, app.models.audit, app.database, app.models.user, app.services.document_orchestrator
[ext_deps]: logging, uuid, sqlalchemy, fastapi, typing
...
[local_deps]: app.services.temporal_reasoning_service, app.models.document, app.services.search_service, app.api.deps, app.services.progressive_revelation_service, app.models.audit, app.services.graph_rag_service, app.database, app.models.user, app.services.synthesis_service
[ext_deps]: logging, uuid, json, sqlalchemy, fastapi, typing
...
[ext_deps]: redis, logging, datetime, asyncio, sqlalchemy, os, fastapi, typing, httpx, nats
...
[ext_deps]: logging, sqlalchemy, os, fastapi, hmac
...
[local_deps]: app.models.document, app.services.entity_extraction_service, app.api.deps, app.services.timeline_service, app.services.relationship_service, app.database, app.models.knowledge_graph, app.models.user
[ext_deps]: logging, uuid, datetime, sqlalchemy, fastapi, typing
...
[local_deps]: app.services.note_service, app.models.note, app.models.note_audio, app.services.space_service, app.api.deps, app.schemas.note, app.database, app.models.user, app.schemas.tag
[ext_deps]: logging, uuid, datetime, sqlalchemy, os, fastapi
...
[local_deps]: app.celery_app, app.models.pipeline, app.models.document, app.api.deps, app.core.redis_url, app.tasks.pipeline_orchestrator, app.database
[ext_deps]: asyncio, sqlalchemy, redis, fastapi
[async_fn]: pipeline_status(db)
[async_fn]: retry_failed_pipeline_stages(stage, limit, db)

---
### FILE: backend/app/api/push.py
[local_deps]: app.api.deps, app.schemas.push, app.models.push_subscription, app.database, app.models.user
[ext_deps]: logging, uuid, sqlalchemy, os, fastapi
...
[local_deps]: app.celery_app, app.schemas.reports, app.api.deps, app.models.user, app.tasks.report_tasks
...
[local_deps]: app.models.document, app.services.search_service, app.services.embed_client, app.services.search_agent, app.api.deps, app.services.input_guard, app.services.search_models, app.database, app.models.user
[ext_deps]: logging, uuid, json, asyncio, sqlalchemy, time, fastapi
...
[local_deps]: app.celery_app, app.models.note, app.models.smart_folder, app.tasks.collection_report_tasks, app.api.deps, app.schemas.collection, app.schemas.smart_folder, app.tasks.smart_folder_tasks, app.models.audit, app.database, app.models.user
[ext_deps]: logging, uuid, json, asyncio, sqlalchemy, celery, fastapi, typing
...
[local_deps]: app.schemas.space, app.services.space_service, app.api.deps, app.tasks.space_tasks, app.database, app.models.user, app.schemas.tag
[ext_deps]: sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.services.rollback_monitor, app.api.deps, app.core.redis_url, app.tasks.pipeline_orchestrator, app.services.llm_gateway, app.models.user
...
[local_deps]: app.tasks.subscription_tasks, app.api.deps, app.models.subscription, app.database, app.models.user, app.schemas.subscription
[ext_deps]: sqlalchemy, fastapi, logging, uuid
[fn]: _parse_uuid(s)
...
[local_deps]: app.services.task_service, app.schemas.task, app.services.space_service, app.api.deps, app.database, app.models.user, app.schemas.tag
[ext_deps]: sqlalchemy, fastapi, logging, uuid
...
[local_deps]: app.models.note, app.models.document, app.models.note_audio, app.services.whisper_service, app.api.deps, app.services.storage_service, app.models.user
[ext_deps]: tempfile, io, logging, uuid, asyncio, sqlalchemy, os, fastapi
...
[ext_deps]: pathlib, pydantic_settings, urllib, logging, os, pydantic
...
[ext_deps]: struct, urllib, logging, json, os, time, cryptography, base64, httpx
...
[ext_deps]: dotenv, pgvector, sqlalchemy, os, collections, fastapi, typing
...
[local_deps]: app.api, app.services.llm_http_client, app.services.prometheus_metrics, app.services.messaging, app.middleware.transaction, app.limiter, app.core.redis_url, app.database, app.core.config, app.middleware.rls, app.middleware.csrf
[ext_deps]: threading, redis, logging, uuid, dotenv, starlette, uvicorn, sqlalchemy, os, collections, time, fastapi, contextlib, typing, slowapi
...
[local_deps]: app.api, app.services.prometheus_metrics, app.core.redis_url, app.services.cache_monitor, app.services.embedding_service, app.services.monitoring, app.database
[ext_deps]: redis, logging, datetime, dotenv, uvicorn, sqlalchemy, os, time, fastapi, contextlib, httpx
[async_fn]: lifespan(app)
[async_fn]: root()
[async_fn]: health()
...
[ext_deps]: jose, logging, starlette, sqlalchemy, dataclasses
...
[local_deps]: app.models.base, app.models.document, app.models.note_audio, app.models.pattern_insight, app.models.task, app.models.collection, app.models.bookmark, app.models.processing, app.models.knowledge_graph, app.models.failed_task, app.models.article, app.models.note, app.models.pipeline, app.models.smart_folder, app.models.milestone, app.models.audit, app.models.space, app.models.chat, app.models.push_subscription, app.models.subscription, app.models.user, app.models.tag
...
[ext_deps]: tenacity, logging, functools, asyncio, collections, time, typing, httpx
...
[local_deps]: app.database
[ext_deps]: sqlalchemy, hashlib, functools, json
...
[local_deps]: app.schemas.pagination, app.schemas.admin, app.schemas.user, app.schemas.document, app.schemas.smart_folder, app.schemas.collection, app.schemas.token, app.schemas.chat, app.schemas.search
...
[ext_deps]: enum, uuid, datetime, pydantic
[class]: BookmarkBucket { methods: [] }
...
[ext_deps]: enum, uuid, datetime, typing, pydantic
[class]: CollectionVisibility { methods: [] }
[class]: CollectionType { methods: [] }
...
[ext_deps]: enum, re, datetime, uuid, typing, pydantic
[class]: UserRole { methods: [] }
...
[local_deps]: app.services.agents.answer_agent, app.services.agents.researcher_agent, app.services.agents.clarification_agent, app.services.agents.agent_orchestrator, app.services.agents.verification_agent
...
[ext_deps]: enum, logging, datetime, collections, time, typing, dataclasses
...
[local_deps]: app.services.search_service, app.services.embed_client, app.services.knowledge_graph.traversal, app.services.agent_identity, app.services.graph_rag_service, app.services.llm_gateway, app.services.knowledge_graph.pool, app.services.knowledge_graph.models
[ext_deps]: re, logging, json, collections, typing, dataclasses
...
[ext_deps]: logging, json, hashlib, asyncio, typing, httpx
...
[ext_deps]: warnings, logging, datetime, uuid, json, sqlalchemy, typing
...
[ext_deps]: threading, logging, datetime, json, typing
...
[local_deps]: app.services.pii_detection_service, app.services.search_service, app.models.document, app.services.context_block_service, app.services.prometheus_metrics, app.models.chat, app.services.cache_monitor, app.services.agent_identity, app.database, app.services.llm_gateway, app.models.user
[ext_deps]: re, logging, json, uuid, asyncio, sqlalchemy, collections, time, typing
...
[local_deps]: app.models.document, app.services.context_block_service, app.models.chat, app.services.agent_identity, app.models.audit, app.models.collection, app.services.llm_gateway, app.models.user
[ext_deps]: logging, uuid, json, sqlalchemy, typing
[async_fn]: create_audit_log(db, user_id, action, resource_type, resource_id, details)
...
[local_deps]: app.models.document, app.services.search_service, app.schemas.collection, app.services.agent_identity, app.services.intent_parser, app.models.collection, app.services.llm_gateway, app.models.user, app.services.search_cache
[ext_deps]: logging, datetime, uuid, asyncio, sqlalchemy, typing
...
[ext_deps]: redis, sqlalchemy, logging, datetime
[fn]: _get_redis()
...
[ext_deps]: difflib, logging, datetime, hashlib, sqlalchemy
...
[local_deps]: app.services.llm_gateway
[ext_deps]: logging, uuid, datetime, os, typing
...
[ext_deps]: threading, logging, json, asyncio, sqlalchemy, typing, traceback
...
[local_deps]: app.models.pipeline, app.models.document, app.services.deduplication_service, app.schemas.document, app.tasks.voice_tasks, app.services.storage_service, app.tasks.pipeline_orchestrator, app.tasks.pipeline_tasks, app.models.audit, app.models.user
[ext_deps]: concurrent, logging, datetime, json, asyncio, sqlalchemy, fastapi, typing
[fn]: get_file_extension(filename)
[fn]: get_mime_type(filename, content)
[fn]: validate_magic_bytes(filename, content)
...
[ext_deps]: sendgrid, os, logging, datetime
...
[ext_deps]: random, logging, asyncio, os, time, httpx
[fn]: _base_urls()
...
[ext_deps]: threading, sentence_transformers, psutil, gc, logging, asyncio, os, numpy, typing, torch
...
[ext_deps]: pathlib, logging, os, numpy, transformers, onnxruntime
...
[ext_deps]: warnings, logging, datetime, json, asyncio, sqlalchemy, typing
...
[ext_deps]: re, logging, sqlalchemy, collections, typing
...
[ext_deps]: re, redis, logging, hashlib, dataclasses
...
[ext_deps]: enum, warnings, re, logging, datetime, json, typing
...
[ext_deps]: tenacity, logging, datetime, json, os, collections, typing, httpx
...
[ext_deps]: __future__, logging, json, models, spacy, asyncpg, itertools
[fn]: _vec_to_str(vec)
...
[ext_deps]: __future__, enum, datetime, uuid, pydantic
...
[ext_deps]: __future__, logging, json, models, asyncpg, extraction
...
[local_deps]: app.services.semantic_cache, app.services.user_quota, app.services.rollback_monitor, app.core.context, app.services.monitoring, app.services.llm_router
[ext_deps]: logging, asyncio, collections, time, typing
...
[local_deps]: app.services.pii_detection_service, app.services.minimax_service, app.services.kimi_service, app.services.ollama_service, app.services.openrouter_service, app.services.together_service
[ext_deps]: enum, logging, collections, typing, dataclasses
...
[ext_deps]: logging, asyncio, os, collections, typing, nats
...
[ext_deps]: logging, json, os, collections, typing, httpx
...
[ext_deps]: threading, re, psutil, subprocess, redis, logging, datetime, os, collections, prometheus_client, typing, dataclasses
...
[ext_deps]: enum, io, PIL, cv2, paddleocr, logging, os, time, pytesseract, numpy, typing, PyPDF2
...
[local_deps]: app.services.llm_http_client, app.services.base_llm_service
[ext_deps]: tenacity, logging, json, os, collections, typing, httpx
...
[local_deps]: app.services.llm_http_client, app.core.redis_url, app.services.cache_monitor, app.services.monitoring, app.services.openrouter_throttle
[ext_deps]: tenacity, redis, logging, json, hashlib, datetime, asyncio, os, collections, typing, httpx
[fn]: _get_redis_client()
...
[ext_deps]: __future__, logging, datetime, time, typing
...
[ext_deps]: sentence_transformers, psutil, logging, datetime, sqlalchemy, typing
...
[local_deps]: app.models.document, app.services.agent_identity, app.models.knowledge_graph, app.services.llm_gateway, app.models.user
...
[ext_deps]: logging, functools, collections, time, typing
...
[local_deps]: app.models.document, app.services.context_block_service, app.services.rollback_monitor, app.services.agent_identity, app.models.collection, app.services.monitoring, app.services.llm_gateway, app.models.user
[ext_deps]: io, logging, datetime, uuid, sqlalchemy, os, reportlab, typing
[class]: ReportFormat { methods: [] }
...
[local_deps]: app.core.redis_url
[ext_deps]: redis, logging, datetime, os, collections, time, typing
[fn]: _get_redis()
...
[local_deps]: app.models.document, app.services.search_service, app.services.context_block_service, app.services.agent_identity, app.database, app.models.user, app.services.llm_router, app.services.search_cache
[ext_deps]: re, search_models, logging, json, uuid, asyncio, sqlalchemy, time, typing
...
[local_deps]: app.services.pii_detection_service, app.models.document, app.services.embed_client, app.services.rerank_service, app.models.user, app.services.search_cache
[ext_deps]: re, logging, asyncio, sqlalchemy, typing
...
[ext_deps]: __future__, logging, json, hashlib, time, numpy, typing
...
[ext_deps]: logging, json, collections, typing, dataclasses
...
[ext_deps]: re, logging, sqlalchemy, numpy, typing
...
[local_deps]: app.services.smart_folder.entity_resolver, app.services.smart_folder.analysis, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.retrieval
...
[local_deps]: app.models.smart_folder, app.services.smart_folder.entity_resolver, app.services.smart_folder.agent.synthesizer, app.services.smart_folder.agent.executor, app.services.smart_folder.query_parser, app.services.smart_folder.report_generator, app.services.smart_folder.agent.planner, app.models.user
[ext_deps]: re, logging, uuid, sqlalchemy, typing
...
[ext_deps]: logging, uuid, datetime, sqlalchemy, typing, dataclasses
...
[ext_deps]: difflib, logging, sqlalchemy, typing, dataclasses
...
[ext_deps]: logging, datetime, json, typing, dataclasses
...
[ext_deps]: re, logging, json, uuid, typing, dataclasses
...
[local_deps]: app.services.smart_folder.skills.sentiment_tracker, app.services.smart_folder.skills.financial_analysis, app.services.smart_folder.skills.general_narrative, app.services.smart_folder.skills.custom_query, app.services.smart_folder.skills.project_postmortem, app.services.smart_folder.skills.base, app.services.smart_folder.skills.legal_review
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.skills.base
[ext_deps]: logging, typing
...
[local_deps]: app.services.smart_folder.tools.vault_search, app.services.smart_folder.tools.ratio_calculator, app.services.smart_folder.tools.citation_marker, app.services.smart_folder.tools.chart_generator, app.services.smart_folder.tools.table_extractor, app.services.smart_folder.tools.trend_analyzer, app.services.smart_folder.tools.asset_reader, app.services.smart_folder.tools.refinement_parser

---
### FILE: backend/app/services/smart_folder/tools/asset_reader.py
[local_deps]: app.models.document
[ext_deps]: sqlalchemy, logging, uuid, typing
...
[ext_deps]: re, io, logging, json, typing, csv
...
[ext_deps]: re, logging, uuid, datetime, sqlalchemy, typing
...
[local_deps]: app.models.note, app.models.document, app.models.bookmark, app.models.space, app.models.user, app.models.tag
[ext_deps]: sqlalchemy, logging, uuid
[fn]: _escape_like(value)
...
[ext_deps]: pathlib, logging, datetime, uuid, os, cryptography, base64
...
[ext_deps]: pathlib, logging, json, datetime, os, collections, typing, time, sys, contextlib
...
[ext_deps]: registry, hitl_bridge, flock_alerter, base_agent

---
### FILE: backend/app/services/swarm/v2/base_agent.py
[local_deps]: app.services.messaging
[ext_deps]: enum, abc, logging, uuid, json, datetime, asyncio, typing, nats
...
[local_deps]: app.services.messaging
[ext_deps]: enum, logging, json, hashlib, datetime, time, typing, nats, dataclasses
...
[local_deps]: app.services.messaging
[ext_deps]: enum, logging, uuid, json, datetime, asyncio, typing, nats, dataclasses
...
[local_deps]: app.services.messaging
[ext_deps]: logging, datetime, json, typing, nats
...
[ext_deps]: logging, datetime, json, sqlalchemy, collections, typing
...
[ext_deps]: logging, datetime, json, os, httpx
...
[local_deps]: app.models.knowledge_graph
[ext_deps]: logging, datetime, sqlalchemy, collections, typing
...
[ext_deps]: pathlib, pptx, html, subprocess, ebooklib, re, docx, zipfile, logging, json, os, sys, typing, csv, xml, PyPDF2
...
[local_deps]: app.services.llm_http_client, app.services.base_llm_service
[ext_deps]: logging, datetime, json, os, collections, typing, httpx
...
[ext_deps]: __future__, logging, datetime, typing
...
[local_deps]: app.celery_app, app.models.document, app.core.redis_url, app.services.cache_monitor, app.tasks.pipeline_orchestrator, app.tasks.base, app.database, app.services.alert_service, app.services.monitoring, app.models.processing
...
[local_deps]: app.models.document, app.services.embed_client, app.services.article_generation_service, app.tasks.base, app.database, app.models.article
[ext_deps]: logging, uuid, asyncio, celery, httpx
...
[local_deps]: app.models.document, app.tasks.pipeline_orchestrator, app.tasks.embedding_tasks, app.models.article, app.database, app.tasks.article_tasks
...
[ext_deps]: psutil, logging, asyncio, os, traceback
...
[local_deps]: app.tasks.base, app.models.audit, app.services.report_service, app.database, app.models.user
[ext_deps]: logging, uuid, json, asyncio, celery, sqlalchemy, typing
...
[local_deps]: app.models.document, app.services.embed_client, app.services.prometheus_metrics, app.services.context_block_service, app.services.entity_extraction_service, app.services.ocr_service, app.services.dlq_service, app.tasks.pipeline_orchestrator, app.tasks.base, app.services.collection_service, app.tasks.embedding_tasks, app.database, app.services.text_extractor, app.models.processing, app.services.chunking_service, app.tasks.article_tasks
[ext_deps]: tempfile, logging, datetime, uuid, asyncio, celery, sqlalchemy, os, langdetect, traceback
...
[local_deps]: app.celery_app, app.models.pipeline, app.models.document, app.core.redis_url, app.database
[ext_deps]: redis, logging, datetime, sqlalchemy, os, email, smtplib
[fn]: _smtp_configured()
...
[ext_deps]: asyncio, logging, psutil
...
[ext_deps]: redis, logging, datetime, uuid, celery
...
[local_deps]: app.celery_app, app.models.pipeline, app.models.document, app.core.redis_url, app.tasks.pipeline_orchestrator, app.database
[ext_deps]: redis, logging, datetime, sqlalchemy, os
[fn]: pipeline_sweeper()

---
### FILE: backend/app/tasks/pipeline_tasks.py
[local_deps]: app.celery_app, app.models.pipeline, app.models.document, app.services.embed_client, app.services.knowledge_graph.extraction, app.services.entity_extraction_service, app.services.ocr_service, app.services.dlq_service, app.services.text_extractor, app.services.knowledge_graph.pool, app.database, app.services.chunking_service, app.tasks.article_tasks, app.tasks.document_tasks
[ext_deps]: tempfile, gc, logging, uuid, datetime, asyncio, celery, os, time, traceback
...
[ext_deps]: logging, datetime, celery, os, sqlalchemy, time, fpdf, openpyxl
...
[local_deps]: app.models.document, app.models.smart_folder, app.services.smart_folder.agent_runner, app.tasks.base, app.services.smart_folder_service, app.models.audit, app.database, app.models.user
[ext_deps]: logging, uuid, datetime, json, asyncio, celery, sqlalchemy, typing
...
[ext_deps]: calendar, logging, datetime, sqlalchemy, os, email, smtplib, httpx
...
[local_deps]: app.celery_app, app.services.task_service, app.core.push, app.models.task, app.models.push_subscription, app.database
...
[ext_deps]: tempfile, logging, asyncio, sqlalchemy, os
[fn]: transcribe_voice_note(self, audio_file_path, document_id)

---
### FILE: backend/app/utils/circuit_breaker.py
[ext_deps]: threading, logging, functools, asyncio, collections, time, typing
...
[ext_deps]: jose, logging, datetime, dotenv, sqlalchemy, os, fastapi, typing, bcrypt
